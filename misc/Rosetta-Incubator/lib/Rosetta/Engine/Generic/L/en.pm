...
module Rosetta::Engine::Generic::L::en-0.150.0 {
...
This document describes Rosetta::Engine::Generic::L::en version 0.150.0.
...
Rosetta::Engine::Generic is Copyright (c) 2002-2006, Darren R. Duncan.

See the LICENCE AND COPYRIGHT of L<Rosetta::Engine::Generic> for details.

=head1 ACKNOWLEDGEMENTS

The ACKNOWLEDGEMENTS in L<Rosetta::Engine::Generic> apply to this file too.
