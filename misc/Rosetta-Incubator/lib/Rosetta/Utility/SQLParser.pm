...
class Rosetta::Utility::SQLParser-0.30.0 {
    ...
    # Attributes of every Rosetta::Utility::SQLParser object:
    # (None Yet)
...
} # class Rosetta::Utility::SQLParser
...
Rosetta::Utility::SQLParser: L<Rosetta::Engine::Generic>.
...
Rosetta::Utility::SQLParser is free software; you can redistribute it
...
files is making a combined work based on Rosetta::Utility::SQLParser.
Thus, the terms and conditions of the GPL cover the whole combination.  As
a special exception, the copyright holders of Rosetta::Utility::SQLParser
give you permission to link Rosetta::Utility::SQLParser with independent
...
Any versions of Rosetta::Utility::SQLParser that you modify and distribute
...
notice and other credits.  Rosetta::Utility::SQLParser is distributed in
the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the
implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.

While it is by no means required, the copyright holders of
Rosetta::Utility::SQLParser would appreciate being informed any time you
create a modified version of Rosetta::Utility::SQLParser that you are
