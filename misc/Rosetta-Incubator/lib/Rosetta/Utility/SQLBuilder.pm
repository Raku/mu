...
class Rosetta::Utility::SQLBuilder-0.230.0 {

    # External packages used by the Rosetta::Utility::SQLBuilder class, that do export symbols:
    # (None Yet)

    # Attributes of every Rosetta::Utility::SQLBuilder object:
    # (None Yet)
...
} # class Rosetta::Utility::SQLBuilder
...
This document describes Rosetta::Utility::SQLBuilder version 0.230.0.
...
Rosetta::Utility::SQLBuilder: L<Rosetta::Engine::Generic>.
...
This file is part of the Rosetta::Utility::SQLBuilder reference
implementation of a SQL:2003 string builder that uses the Rosetta::Model
database portability library.

Rosetta::Utility::SQLBuilder is Copyright (c) 2002-2006, Darren R. Duncan.
All rights reserved.  Address comments, suggestions, and bug reports to
C<perl@DarrenDuncan.net>, or visit L<http://www.DarrenDuncan.net/> for more
information.

Rosetta::Utility::SQLBuilder is free software; you can redistribute it
...
files is making a combined work based on Rosetta::Utility::SQLBuilder.
Thus, the terms and conditions of the GPL cover the whole combination.  As
a special exception, the copyright holders of Rosetta::Utility::SQLBuilder
give you permission to link Rosetta::Utility::SQLBuilder with independent
files, regardless of the license terms of these independent files, and to
copy and distribute the resulting combined work under terms of your choice,
...
notice and other credits.  Rosetta::Utility::SQLBuilder is distributed in
...
create a modified version of Rosetta::Utility::SQLBuilder that you are
willing to distribute, because that is a practical way of suggesting
improvements to the standard version.
