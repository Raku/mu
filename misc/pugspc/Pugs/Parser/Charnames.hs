...
import UTF8 (unsafePackAddressLen, hash)
...
_NameToCode = unsafePerformIO $! hashList
    [ (unsafePerformIO $ unsafePackAddressLen 4 "NULL"#, 0x0000)
    , (unsafePerformIO $ unsafePackAddressLen 16 "START OF HEADING"#, 0x0001)
    , (unsafePerformIO $ unsafePackAddressLen 13 "START OF TEXT"#, 0x0002)
    , (unsafePerformIO $ unsafePackAddressLen 11 "END OF TEXT"#, 0x0003)
    , (unsafePerformIO $ unsafePackAddressLen 19 "END OF TRANSMISSION"#, 0x0004)
    , (unsafePerformIO $ unsafePackAddressLen 7 "ENQUIRY"#, 0x0005)] {-
