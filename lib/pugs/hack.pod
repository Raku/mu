...
F<util/cperl6-mode.el> Emacs mode. If you don't use it, then perl-mode
works better than cperl-mode.
...
If you use Emacs with cperl6-mode, you can set these code conventions
