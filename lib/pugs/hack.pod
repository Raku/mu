...
If you use BBEdit, you can configure it to auto-expand tabs like this:
    ...
    0. Launch the BBEdit application.
    1. In the 'BBEdit' (application) menu, choose 'Preferences'.
    2. In the resulting dialog box, choose 'Editor Defaults' from the left col.
    3. In the resulting panel, ensure 'Auto-Expand Tabs' is checked.
    4. Also ensure the 'Default Font' is set to '4 spaces per tab'.
...
You can also just say C<./pugs -Iblib6/lib t/.../mumble.t>.
