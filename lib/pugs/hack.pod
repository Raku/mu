...
Expanding this one level deeper:
    ...
    |   |-- Set-Infinite       Infinite sets, recurrences, and spans
...
C<svn:ignore> property accordingly to tell Subversion to ignore automatically
generated files like C<Makefile> or C<blib/>.

    $ svn propget svn:ignore ext/Some-Other-Module
    $ svn propedit svn:ignore ext/Your-New-Module
