...
=head1 SYNOPSIS
    ...
    # Optionally, submit your smoke report to a public server:
...
Expanding this one level deeper:
    ...
    |   |-- Perl6-MetaModel2.0 Prototype Perl 6 metaclass model: Perl 5,
    |   |                      version 2.0
...
There is a F<util/perl6.vim> Vim syntax file.  There is no emacs mode yet,
but perl-mode works better than cperl-mode.


=head2 Testing

See L<pugs::run> and F<t/README>.  If you wish to use the C<prove> utility
...
You can also just say F<./pugs -Iblib6/lib t/.../mumble.t>.
...
L<http://rt.openfoundry.org/Foundry/Project/Source/index.html/pugs/browse/>
Browsable Pugs vcs.  You sometimes get a blank page the first time you
access a URL (a timeout) - just click again.

=item *

L<http://svn.perl.org/perl6/pugs/trunk/> Mirror of Pugs vcs head.
Usually faster and more reliable than the openfoundry browser.
