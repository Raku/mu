...
backends are C<Pugs>, C<Parrot>, and C<Haskell>.
...
outputs a short summary of the available command line options. No programs are
executed.
...
outputs short configuration information for C<I<item>>.
