...
The Pugs source tree includes several major sections:
    ...
    |-- t_pugs       Tests specific to the Pugs implementation of Perl 6
...
Expanding this one level deeper:
    ...
    |   |-- bugs               Uncategorized tests for known broken behavior
    ...
    |
    |-- t_pugs             Tests specific to the Pugs implementation of Perl 6
    |   `-- invocation         Tests for pugs command-line arguments
    |
    `-- util               Utilities for hacking and testing Pugs
