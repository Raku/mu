...
::dispatch(::meta('Foo'), 'add_method', ('bar' => Perl6::Instance::Method->new('Foo' => sub { 'BAR' })));

can_ok($foo, 'bar');
is($foo->bar(), 'BAR', '... $foo->bar() works');

::dispatch(::meta('Perl6::Object'), 'add_method', ('a_method' => Perl6::Instance::Method->new('Perl6::Object' => sub { 'Perl6::Object::a_method' })));
