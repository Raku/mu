...
::dispatch(Foo->meta, 'add_method', ('bar' => Perl6::Instance::Method->new('Foo' => sub { 'BAR' })));

can_ok($foo, 'bar');
is($foo->bar(), 'BAR', '... $foo->bar() works');

::dispatch(Perl6::Object->meta, 'add_method', ('a_method' => Perl6::Instance::Method->new('Perl6::Object' => sub { 'Perl6::Object::a_method' })));
