...
use the following syntactic categories:
     ...
     rule rule_backslash:<w> { ... }     # define your own \w and \W
     rule rule_assertion:<*> { ... }     # define your own <*stuff>
...
of those things are subs or methods rather than rules or macros.
(The numeric rule modifiers are recognized by fallback macros defined
