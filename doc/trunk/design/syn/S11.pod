...
is redundant, except insofar as it makes C<use strict> the default.)
...
The syntax of a versioned module or class declaration has three hyphen
separated parts:
...
version and author, but you needn't declare them.
...
Saying C<1.2.1> specifies an I<exact> match on the version
number, not a minimum match.
...
degree of specificity.  And someone ever forks Perl, you can say

    use Perl-6-cpan:TPF

to guarantee you get the standard one.  C<:-)>

Any valid smartmatch selector works:
