...
you may add a statement modifier at the end to make it a "repeat at
least once" loop.  Unlike C<do> in Perl 5, it's a real loop block,
so you may use loop modifiers.
