...
C<Code> argument. Within the code, the special C<call> and C<callv> functions will invoke
...
argument, and arranges that the call to C<call> or C<callv> invokes the previous
