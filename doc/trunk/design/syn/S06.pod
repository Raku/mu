...
Parentheses, square brackets, curlies, angle brackets, semicolons,
commas, and backslashes may be part of the name only if backslashed.
Whitespace may never be part of the name.  A null operator name does
not define a null or whitespace operator, but a default matching rule
...
C<$?BLOCKLABEL> contains the block of the current block, if any.
