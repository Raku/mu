...
Alternately, you can associate a class method with the current eigenclass instance,
...
so it's possible to call this as C<Dog.count> or C<$dog.count>.  However,
best practice is probably to call such a class method as C<Dog.^count>
