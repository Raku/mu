...
Characters indexed by hex, octal, and decimal can be interpolated into
strings using either C<"\x123"> (with C<\o> and C<\d> behaving
respectively) or using square brackets: C<"\x[123]">. 
