...
# my original first attempts, head.pl, tail.pl, rev.pl, mid.pl,
# wc.pl, developed with a very early version of Pugs (6.0.10)
...
#
# To test head.pl, tail.pl, rev.pl, mid.pl, wc.pl for correctness,
...
usage: perl tsanta.pl
   or: perl tsanta.pl head.pl tail.pl rev.pl mid.pl wc.pl
GROK
   exit(1);
}
