...
is($?PACKAGE, "A", "switching package, file scope");
is($GLOBAL, "main global", "'our' is lexically scoped, even across namespaces");
eval_is('$main::GLOBAL', "main global", "fully qualified name, main::");
#is($::GLOBAL, "main global", "fully qualified name, main");

eval '$A::GLOBAL = "A global"';

eval_is('$A::GLOBAL', "A global", "fully qualified name, other package");

package B;

is($?PACKAGE, "B", "switching package, file scope");

eval '$B::GLOBAL = "A global"';

eval_is('$A::GLOBAL', "A global", "fully qualified name, other package");
eval_is('$B::GLOBAL', "A global", "fully qualified name, my own package");
