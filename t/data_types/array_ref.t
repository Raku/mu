...
todo_is +$array11,      2, "AoA created using ';' contains correct number of elems";
todo_is +$array11[0],   3, "AoA's subarray created using ';' contains correct number of elems";
todo_is $array11[1][1], "e", "AoA created using ';' contains correct elem";
