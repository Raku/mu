...
# This time we return a single value.
{
  ...
  is @array[3],  16, "context inside of array subscripts when used with &postfix:<++>", :todo<bug>;
  is %hash<c>,   24, "context inside of hash subscripts when used with &postfix:<++>", :todo<bug>;
}
