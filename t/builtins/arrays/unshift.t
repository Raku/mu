...

{
    ...
    is(+@unshift, 0, 'we have an empty list');

    unshift(@unshift, 1);
    is(+@unshift, 1, 'we have 1 element in the list');
    is(@unshift[0], 1, 'we found the right element');

    unshift(@unshift, 2);
    is(+@unshift, 2, 'we have 2 elements in the list');
    is(@unshift[0], 2, 'we found the right element');
    is(@unshift[1], 1, 'we found the right element');

    unshift(@unshift, 3);
    is(+@unshift, 3, 'we have 3 element in the list');
    ...
    unshift(@unshift, 4);
    is(+@unshift, 4, 'we have 4 element in the list');
...

{
    ...
    unshift @unshift, $val;
    is(+@unshift, 1, 'we have 1 element in the list');
    is(@unshift[0], $val, 'unshift @list, $val worked');

    @unshift.unshift(200);
    is(+@unshift, 2, 'we have 2 elements in the list');
    is(@unshift[0], 200, '@unshift.unshift(200) works');
    is(@unshift[1], $val, 'unshift @list, $val worked');

    @unshift.unshift(400);
    is(+@unshift, 3, 'we have 3 elements in the list');
    is(@unshift[0], 400, '@unshift.unshift(400) works');
    is(@unshift[1], 200, '@unshift.unshift(200) works');
    is(@unshift[2], $val, 'unshift @list, $val worked');
}
...

{
    ...
    is(+@unshift, 5, 'we have 5 elements in the list');
    ...
    is(+@unshift, 8, 'we have 8 elements in the list');
...

{
    ...
    is(+@unshift, 2, 'we have 1 element in the list');
...
#    todo_throws_ok { 'unshift @unshift, 10' }, '?? what should this error message be ??', 'cannot unshift onto a Inf list';
#}
