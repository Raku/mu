...
{    
    ...
    isa_ok(@b, 'Array');
    my $b = @a.reverse;
    isa_ok($b, 'Array'); # unTODOme
    is(@b[0], "foo", 'our list is reversed properly'); 
    is($b[0], "foo", 'but our list reference was not'); # unTODOme
...

{
    ...
    is($b[0], "bar", 'our array-ref is reversed'); # unTODOme
    is($b[1], "foo", 'our array-ref is reversed'); # unTODOme
...

{
    ...
    is(@b[0], "oof", 'string in the array has been reversed'); # unTODOme
