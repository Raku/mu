...
#?rakudo eval "multiple adverbs not implemented"
...
#?rakudo eval "rakudo doesn't like dotty methods [perl #57740]"
is $str.=subst(/l/,'i'),      'heilo', '.. and with the .= modifier';
#?rakudo eval "skipped because the one before was skipped"
is $str,                      'heilo', '.. it changes the receiver';

# not sure about this. Maybe '$1$0' should work.

#?rakudo eval '$/ not involved in .subst yet'
