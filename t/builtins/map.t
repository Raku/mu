...
todo_is(+@result1, 5, 'we got a list back'); # unTODOme
todo_is(@result1[0], 2, 'got the value we expected'); # unTODOme
todo_is(@result1[1], 4, 'got the value we expected'); # unTODOme
todo_is(@result1[2], 6, 'got the value we expected'); # unTODOme
todo_is(@result1[3], 8, 'got the value we expected'); # unTODOme
todo_is(@result1[4], 10, 'got the value we expected'); # unTODOme
