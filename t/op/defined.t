...
if (eval 'defined(1)')   { say "ok 2" } else { say "ok 2 # TODO defined" }
if (eval 'defined("")')  { say "ok 3" } else { say "ok 3 # TODO defined" }
if (eval 'defined("a")') { say "ok 4" } else { say "ok 4 # TODO defined" }
if (eval 'defined(0)')   { say "ok 5" } else { say "ok 5 # TODO defined" }
...
if (eval 'defined($foo)') { say "not ok 12 # TODO defined" } else { 
    say "ok 12"
}
