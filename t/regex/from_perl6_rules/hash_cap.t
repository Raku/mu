...
ok(eval(q{!defined($/<chars>{' b'})}), 'Second simple value undefined');
...
ok(eval(q{!defined($/<first>{' b'})}), 'Second sequential value undefined');
ok($/<last>{"\tc"}:exists, 'Third sequential key captured');
ok(eval(q{!defined($/<last>{"\tc"})}), 'Third sequential value undefined');
...
ok(eval(q{$/<foo><x>}), 'y', 'Nested value 2 multicaptured');
...
ok(eval(q{!defined($/<chars><b>)}), 'Outer hash no capture value 2');
ok($/<chars>{'c'}:exists, 'Outer hash capture key 3');
ok(eval(q{!defined($/<chars><c>)}), 'Outer hash no capture value 3');
ok($/<chars>.keys == 3, 'Outer hash no extra captures');

ok($/<spaces>{'  '}:exists, 'Inner hash capture key 1');
ok(eval(q{!defined($/<spaces>{'  '})}), 'Inner hash no capture value 1');
ok($/<spaces>{' '}:exists, 'Inner hash capture key 2');
ok(eval(q{!defined($/<spaces>{' '})}), 'Inner hash no capture value 2');
...
ok(eval(q{!defined($/<chars><b>)}), 'Outer subrule hash no capture value 2');
ok($/<chars>{'c'}:exists, 'Outer subrule hash capture key 3');
ok(eval(q{!defined($/<chars><c>)}), 'Outer subrule hash no capture value 3');
...
ok(eval(q{!defined($/<chars><b>)}), 'Outer rule nested hash value multicapture');
ok($/<chars>{'c'}:exists, 'Outer rule nested hash key multicapture');
ok(eval(q{!defined($/<chars><c>)}), 'Outer rule nested hash value multicapture');
...
ok(eval(q{!defined(%bases{c})}), 'No c value');
ok(!%bases{'g'}:exists, 'No g key');
ok(%bases{'G'}:exists, 'G key');
ok(eval(q{!defined(%bases{G})}), 'No G value');
ok(%bases{'t'}:exists, 't key');
ok(eval(q{!defined(%bases{t})}), 'No t value');
