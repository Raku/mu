...

{
    ...
    ok(eval('$foo ~~ Foo2'), '... our Foo2 instance was created', :todo<feature>);
    ok(eval('$foo.can("bar")'), '.. checking autogenerated accessor existence', :todo<feature>);
    is(eval('$foo.bar()'), "baz", '.. autogenerated accessor works', :todo<feature>);
    is(eval('$foo.bar'), "baz", '.. autogenerated accessor works w/out parens', :todo<feature>);    
