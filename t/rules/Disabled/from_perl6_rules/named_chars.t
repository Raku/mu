...
ok(not "\x[c]\x[a]" ~~ m/^ <-[\c[FORM FEED (FF); LINE FEED (LF)]]>/, 'Negative charclass FORM FEED (FF); LINE FEED (LF)');
ok(not "\x[c]" ~~ m/^ \C[FORM FEED (FF)]/, 'Negative named FORM FEED (FF) nomatch');
ok("\x[a]" ~~ m/^ \C[FORM FEED (FF)]/, 'Negative named FORM FEED (FF) match');
ok(not "\x[c]" ~~ m/^ <[\C[FORM FEED (FF)]]>/, 'Negative charclass named FORM FEED (FF) nomatch');
ok("\x[a]" ~~ m/^ <[\C[FORM FEED (FF)]]>/, 'Negative charclass named FORM FEED (FF) match');
ok(not "\x[c]" ~~ m/^ \X[C]/, 'Negative hex \X[C] nomatch');
ok(not "\x[c]" ~~ m/^ <[\X[C]]>/, 'Negative charclass hex \X[C] nomatch');
...
ok(not "\x[d]\x[c]" ~~ m/^ <-[\c[CARRIAGE RETURN (CR); FORM FEED (FF)]]>/, 'Negative charclass CARRIAGE RETURN (CR); FORM FEED (FF)');
ok(not "\x[d]" ~~ m/^ \C[CARRIAGE RETURN (CR)]/, 'Negative named CARRIAGE RETURN (CR) nomatch');
ok("\x[c]" ~~ m/^ \C[CARRIAGE RETURN (CR)]/, 'Negative named CARRIAGE RETURN (CR) match');
ok(not "\x[d]" ~~ m/^ <[\C[CARRIAGE RETURN (CR)]]>/, 'Negative charclass named CARRIAGE RETURN (CR) nomatch');
ok("\x[c]" ~~ m/^ <[\C[CARRIAGE RETURN (CR)]]>/, 'Negative charclass named CARRIAGE RETURN (CR) match');
ok(not "\x[d]" ~~ m/^ \X[D]/, 'Negative hex \X[D] nomatch');
ok(not "\x[d]" ~~ m/^ <[\X[D]]>/, 'Negative charclass hex \X[D] nomatch');
...
ok(not "\x[85]\x[d]" ~~ m/^ <-[\c[NEXT LINE (NEL); CARRIAGE RETURN (CR)]]>/, 'Negative charclass NEXT LINE (NEL); CARRIAGE RETURN (CR)');
ok(not "\x[85]" ~~ m/^ \C[NEXT LINE (NEL)]/, 'Negative named NEXT LINE (NEL) nomatch');
ok("\x[d]" ~~ m/^ \C[NEXT LINE (NEL)]/, 'Negative named NEXT LINE (NEL) match');
ok(not "\x[85]" ~~ m/^ <[\C[NEXT LINE (NEL)]]>/, 'Negative charclass named NEXT LINE (NEL) nomatch');
ok("\x[d]" ~~ m/^ <[\C[NEXT LINE (NEL)]]>/, 'Negative charclass named NEXT LINE (NEL) match');
ok(not "\x[85]" ~~ m/^ \X[85]/, 'Negative hex \X[85] nomatch');
ok(not "\x[85]" ~~ m/^ <[\X[85]]>/, 'Negative charclass hex \X[85] nomatch');
...
ok(not "\c[LINE FEED]\x[85]" ~~ m/^ <-[\c[LINE FEED; NEXT LINE (NEL)]]>/, 'Negative charclass LINE FEED; NEXT LINE (NEL)');
ok(not "\c[LINE FEED]" ~~ m/^ \C[LINE FEED]/, 'Negative named LINE FEED nomatch');
ok("\x[85]" ~~ m/^ \C[LINE FEED]/, 'Negative named LINE FEED match');
ok(not "\c[LINE FEED]" ~~ m/^ <[\C[LINE FEED]]>/, 'Negative charclass named LINE FEED nomatch');
...
ok(not "\c[FORM FEED]\c[LINE FEED]" ~~ m/^ <-[\c[FORM FEED; LINE FEED]]>/, 'Negative charclass FORM FEED; LINE FEED');
ok(not "\c[FORM FEED]" ~~ m/^ \C[FORM FEED]/, 'Negative named FORM FEED nomatch');
ok("\c[LINE FEED]" ~~ m/^ \C[FORM FEED]/, 'Negative named FORM FEED match');
ok(not "\c[FORM FEED]" ~~ m/^ <[\C[FORM FEED]]>/, 'Negative charclass named FORM FEED nomatch');
...
ok(not "\c[CARRIAGE RETURN]\c[FORM FEED]" ~~ m/^ <-[\c[CARRIAGE RETURN;FORM FEED]]>/, 'Negative charclass CARRIAGE RETURN;FORM FEED');
ok(not "\c[CARRIAGE RETURN]" ~~ m/^ \C[CARRIAGE RETURN]/, 'Negative named CARRIAGE RETURN nomatch');
ok("\c[FORM FEED]" ~~ m/^ \C[CARRIAGE RETURN]/, 'Negative named CARRIAGE RETURN match');
ok(not "\c[CARRIAGE RETURN]" ~~ m/^ <[\C[CARRIAGE RETURN]]>/, 'Negative charclass named CARRIAGE RETURN nomatch');
...
ok(not "\c[NEXT LINE]\c[CARRIAGE RETURN]" ~~ m/^ <-[\c[NEXT LINE;CARRIAGE RETURN]]>/, 'Negative charclass NEXT LINE;CARRIAGE RETURN');
ok(not "\c[NEXT LINE]" ~~ m/^ \C[NEXT LINE]/, 'Negative named NEXT LINE nomatch');
ok("\c[CARRIAGE RETURN]" ~~ m/^ \C[NEXT LINE]/, 'Negative named NEXT LINE match');
ok(not "\c[NEXT LINE]" ~~ m/^ <[\C[NEXT LINE]]>/, 'Negative charclass named NEXT LINE nomatch');
...
ok(not "\c[LF]\c[NEXT LINE]" ~~ m/^ <-[\c[LF; NEXT LINE]]>/, 'Negative charclass LF; NEXT LINE');
ok(not "\c[LF]" ~~ m/^ \C[LF]/, 'Negative named LF nomatch');
ok("\c[NEXT LINE]" ~~ m/^ \C[LF]/, 'Negative named LF match');
ok(not "\c[LF]" ~~ m/^ <[\C[LF]]>/, 'Negative charclass named LF nomatch');
...
ok(not "\c[FF]\c[LF]" ~~ m/^ <-[\c[FF;LF]]>/, 'Negative charclass FF;LF');
ok(not "\c[FF]" ~~ m/^ \C[FF]/, 'Negative named FF nomatch');
ok("\c[LF]" ~~ m/^ \C[FF]/, 'Negative named FF match');
ok(not "\c[FF]" ~~ m/^ <[\C[FF]]>/, 'Negative charclass named FF nomatch');
...
ok(not "\c[CR]\c[FF]" ~~ m/^ <-[\c[CR;FF]]>/, 'Negative charclass CR;FF');
ok(not "\c[CR]" ~~ m/^ \C[CR]/, 'Negative named CR nomatch');
ok("\c[FF]" ~~ m/^ \C[CR]/, 'Negative named CR match');
ok(not "\c[CR]" ~~ m/^ <[\C[CR]]>/, 'Negative charclass named CR nomatch');
...
ok(not "\c[NEL]\c[CR]" ~~ m/^ <-[\c[NEL;CR]]>/, 'Negative charclass NEL;CR');
ok(not "\c[NEL]" ~~ m/^ \C[NEL]/, 'Negative named NEL nomatch');
ok("\c[CR]" ~~ m/^ \C[NEL]/, 'Negative named NEL match');
ok(not "\c[NEL]" ~~ m/^ <[\C[NEL]]>/, 'Negative charclass named NEL nomatch');
...
ok(not "\x[fd55]\c[NEL]" ~~ m/^ <-[\c[ARABIC LIGATURE TEH WITH MEEM WITH JEEM INITIAL FORM;NEL]]>/, 'Negative charclass ARABIC LIGATURE TEH WITH MEEM WITH JEEM INITIAL FORM;NEL');
ok(not "\x[fd55]" ~~ m/^ \C[ARABIC LIGATURE TEH WITH MEEM WITH JEEM INITIAL FORM]/, 'Negative named ARABIC LIGATURE TEH WITH MEEM WITH JEEM INITIAL FORM nomatch');
...
ok(not "\x[fd55]" ~~ m/^ <[\C[ARABIC LIGATURE TEH WITH MEEM WITH JEEM INITIAL FORM]]>/, 'Negative charclass named ARABIC LIGATURE TEH WITH MEEM WITH JEEM INITIAL FORM nomatch');
...
ok(not "\x[fd55]" ~~ m/^ \X[FD55]/, 'Negative hex \X[FD55] nomatch');
ok(not "\x[fd55]" ~~ m/^ <[\X[FD55]]>/, 'Negative charclass hex \X[FD55] nomatch');
...
ok(not "\x[5b4]\x[fd55]" ~~ m/^ <-[\c[HEBREW POINT HIRIQ;ARABIC LIGATURE TEH WITH MEEM WITH JEEM INITIAL FORM]]>/, 'Negative charclass HEBREW POINT HIRIQ;ARABIC LIGATURE TEH WITH MEEM WITH JEEM INITIAL FORM');
ok(not "\x[5b4]" ~~ m/^ \C[HEBREW POINT HIRIQ]/, 'Negative named HEBREW POINT HIRIQ nomatch');
ok("\x[fd55]" ~~ m/^ \C[HEBREW POINT HIRIQ]/, 'Negative named HEBREW POINT HIRIQ match');
ok(not "\x[5b4]" ~~ m/^ <[\C[HEBREW POINT HIRIQ]]>/, 'Negative charclass named HEBREW POINT HIRIQ nomatch');
ok("\x[fd55]" ~~ m/^ <[\C[HEBREW POINT HIRIQ]]>/, 'Negative charclass named HEBREW POINT HIRIQ match');
ok(not "\x[5b4]" ~~ m/^ \X[5B4]/, 'Negative hex \X[5B4] nomatch');
ok(not "\x[5b4]" ~~ m/^ <[\X[5B4]]>/, 'Negative charclass hex \X[5B4] nomatch');
...
ok(not "\x[1ea2]\x[5b4]" ~~ m/^ <-[\c[LATIN CAPITAL LETTER A WITH HOOK ABOVE;HEBREW POINT HIRIQ]]>/, 'Negative charclass LATIN CAPITAL LETTER A WITH HOOK ABOVE;HEBREW POINT HIRIQ');
ok(not "\x[1ea2]" ~~ m/^ \C[LATIN CAPITAL LETTER A WITH HOOK ABOVE]/, 'Negative named LATIN CAPITAL LETTER A WITH HOOK ABOVE nomatch');
ok("\x[5b4]" ~~ m/^ \C[LATIN CAPITAL LETTER A WITH HOOK ABOVE]/, 'Negative named LATIN CAPITAL LETTER A WITH HOOK ABOVE match');
ok(not "\x[1ea2]" ~~ m/^ <[\C[LATIN CAPITAL LETTER A WITH HOOK ABOVE]]>/, 'Negative charclass named LATIN CAPITAL LETTER A WITH HOOK ABOVE nomatch');
...
ok(not "\x[1ea2]" ~~ m/^ \X[1EA2]/, 'Negative hex \X[1EA2] nomatch');
ok(not "\x[1ea2]" ~~ m/^ <[\X[1EA2]]>/, 'Negative charclass hex \X[1EA2] nomatch');
...
ok(not "\x[565]\x[1ea2]" ~~ m/^ <-[\c[ARMENIAN SMALL LETTER ECH;LATIN CAPITAL LETTER A WITH HOOK ABOVE]]>/, 'Negative charclass ARMENIAN SMALL LETTER ECH;LATIN CAPITAL LETTER A WITH HOOK ABOVE');
ok(not "\x[565]" ~~ m/^ \C[ARMENIAN SMALL LETTER ECH]/, 'Negative named ARMENIAN SMALL LETTER ECH nomatch');
ok("\x[1ea2]" ~~ m/^ \C[ARMENIAN SMALL LETTER ECH]/, 'Negative named ARMENIAN SMALL LETTER ECH match');
ok(not "\x[565]" ~~ m/^ <[\C[ARMENIAN SMALL LETTER ECH]]>/, 'Negative charclass named ARMENIAN SMALL LETTER ECH nomatch');
ok("\x[1ea2]" ~~ m/^ <[\C[ARMENIAN SMALL LETTER ECH]]>/, 'Negative charclass named ARMENIAN SMALL LETTER ECH match');
ok(not "\x[565]" ~~ m/^ \X[565]/, 'Negative hex \X[565] nomatch');
ok(not "\x[565]" ~~ m/^ <[\X[565]]>/, 'Negative charclass hex \X[565] nomatch');
...
ok(not "\x[25db]\x[565]" ~~ m/^ <-[\c[LOWER HALF INVERSE WHITE CIRCLE;ARMENIAN SMALL LETTER ECH]]>/, 'Negative charclass LOWER HALF INVERSE WHITE CIRCLE;ARMENIAN SMALL LETTER ECH');
ok(not "\x[25db]" ~~ m/^ \C[LOWER HALF INVERSE WHITE CIRCLE]/, 'Negative named LOWER HALF INVERSE WHITE CIRCLE nomatch');
ok("\x[565]" ~~ m/^ \C[LOWER HALF INVERSE WHITE CIRCLE]/, 'Negative named LOWER HALF INVERSE WHITE CIRCLE match');
ok(not "\x[25db]" ~~ m/^ <[\C[LOWER HALF INVERSE WHITE CIRCLE]]>/, 'Negative charclass named LOWER HALF INVERSE WHITE CIRCLE nomatch');
ok("\x[565]" ~~ m/^ <[\C[LOWER HALF INVERSE WHITE CIRCLE]]>/, 'Negative charclass named LOWER HALF INVERSE WHITE CIRCLE match');
ok(not "\x[25db]" ~~ m/^ \X[25DB]/, 'Negative hex \X[25DB] nomatch');
ok(not "\x[25db]" ~~ m/^ <[\X[25DB]]>/, 'Negative charclass hex \X[25DB] nomatch');
...
ok(not "\x[fe7d]\x[25db]" ~~ m/^ <-[\c[ARABIC SHADDA MEDIAL FORM;LOWER HALF INVERSE WHITE CIRCLE]]>/, 'Negative charclass ARABIC SHADDA MEDIAL FORM;LOWER HALF INVERSE WHITE CIRCLE');
ok(not "\x[fe7d]" ~~ m/^ \C[ARABIC SHADDA MEDIAL FORM]/, 'Negative named ARABIC SHADDA MEDIAL FORM nomatch');
ok("\x[25db]" ~~ m/^ \C[ARABIC SHADDA MEDIAL FORM]/, 'Negative named ARABIC SHADDA MEDIAL FORM match');
ok(not "\x[fe7d]" ~~ m/^ <[\C[ARABIC SHADDA MEDIAL FORM]]>/, 'Negative charclass named ARABIC SHADDA MEDIAL FORM nomatch');
ok("\x[25db]" ~~ m/^ <[\C[ARABIC SHADDA MEDIAL FORM]]>/, 'Negative charclass named ARABIC SHADDA MEDIAL FORM match');
ok(not "\x[fe7d]" ~~ m/^ \X[FE7D]/, 'Negative hex \X[FE7D] nomatch');
ok(not "\x[fe7d]" ~~ m/^ <[\X[FE7D]]>/, 'Negative charclass hex \X[FE7D] nomatch');
...
ok(not "\x[a15d]\x[fe7d]" ~~ m/^ <-[\c[YI SYLLABLE NDO; ARABIC SHADDA MEDIAL FORM]]>/, 'Negative charclass YI SYLLABLE NDO; ARABIC SHADDA MEDIAL FORM');
ok(not "\x[a15d]" ~~ m/^ \C[YI SYLLABLE NDO]/, 'Negative named YI SYLLABLE NDO nomatch');
ok("\x[fe7d]" ~~ m/^ \C[YI SYLLABLE NDO]/, 'Negative named YI SYLLABLE NDO match');
ok(not "\x[a15d]" ~~ m/^ <[\C[YI SYLLABLE NDO]]>/, 'Negative charclass named YI SYLLABLE NDO nomatch');
ok("\x[fe7d]" ~~ m/^ <[\C[YI SYLLABLE NDO]]>/, 'Negative charclass named YI SYLLABLE NDO match');
ok(not "\x[a15d]" ~~ m/^ \X[A15D]/, 'Negative hex \X[A15D] nomatch');
ok(not "\x[a15d]" ~~ m/^ <[\X[A15D]]>/, 'Negative charclass hex \X[A15D] nomatch');
...
ok(not "\x[2964]\x[a15d]" ~~ m/^ <-[\c[RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN;YI SYLLABLE NDO]]>/, 'Negative charclass RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN;YI SYLLABLE NDO');
ok(not "\x[2964]" ~~ m/^ \C[RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN]/, 'Negative named RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN nomatch');
...
ok(not "\x[2964]" ~~ m/^ <[\C[RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN]]>/, 'Negative charclass named RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN nomatch');
...
ok(not "\x[2964]" ~~ m/^ \X[2964]/, 'Negative hex \X[2964] nomatch');
ok(not "\x[2964]" ~~ m/^ <[\X[2964]]>/, 'Negative charclass hex \X[2964] nomatch');
...
ok(not "\x[ff6d]\x[2964]" ~~ m/^ <-[\c[HALFWIDTH KATAKANA LETTER SMALL YU; RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN]]>/, 'Negative charclass HALFWIDTH KATAKANA LETTER SMALL YU; RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN');
ok(not "\x[ff6d]" ~~ m/^ \C[HALFWIDTH KATAKANA LETTER SMALL YU]/, 'Negative named HALFWIDTH KATAKANA LETTER SMALL YU nomatch');
ok("\x[2964]" ~~ m/^ \C[HALFWIDTH KATAKANA LETTER SMALL YU]/, 'Negative named HALFWIDTH KATAKANA LETTER SMALL YU match');
ok(not "\x[ff6d]" ~~ m/^ <[\C[HALFWIDTH KATAKANA LETTER SMALL YU]]>/, 'Negative charclass named HALFWIDTH KATAKANA LETTER SMALL YU nomatch');
ok("\x[2964]" ~~ m/^ <[\C[HALFWIDTH KATAKANA LETTER SMALL YU]]>/, 'Negative charclass named HALFWIDTH KATAKANA LETTER SMALL YU match');
ok(not "\x[ff6d]" ~~ m/^ \X[FF6D]/, 'Negative hex \X[FF6D] nomatch');
ok(not "\x[ff6d]" ~~ m/^ <[\X[FF6D]]>/, 'Negative charclass hex \X[FF6D] nomatch');
...
ok(not "\x[36]\x[ff6d]" ~~ m/^ <-[\c[DIGIT SIX;HALFWIDTH KATAKANA LETTER SMALL YU]]>/, 'Negative charclass DIGIT SIX;HALFWIDTH KATAKANA LETTER SMALL YU');
ok(not "\x[36]" ~~ m/^ \C[DIGIT SIX]/, 'Negative named DIGIT SIX nomatch');
ok("\x[ff6d]" ~~ m/^ \C[DIGIT SIX]/, 'Negative named DIGIT SIX match');
ok(not "\x[36]" ~~ m/^ <[\C[DIGIT SIX]]>/, 'Negative charclass named DIGIT SIX nomatch');
ok("\x[ff6d]" ~~ m/^ <[\C[DIGIT SIX]]>/, 'Negative charclass named DIGIT SIX match');
ok(not "\x[36]" ~~ m/^ \X[36]/, 'Negative hex \X[36] nomatch');
ok(not "\x[36]" ~~ m/^ <[\X[36]]>/, 'Negative charclass hex \X[36] nomatch');
...
ok(not "\x[1323]\x[36]" ~~ m/^ <-[\c[ETHIOPIC SYLLABLE THAA; DIGIT SIX]]>/, 'Negative charclass ETHIOPIC SYLLABLE THAA; DIGIT SIX');
ok(not "\x[1323]" ~~ m/^ \C[ETHIOPIC SYLLABLE THAA]/, 'Negative named ETHIOPIC SYLLABLE THAA nomatch');
ok("\x[36]" ~~ m/^ \C[ETHIOPIC SYLLABLE THAA]/, 'Negative named ETHIOPIC SYLLABLE THAA match');
ok(not "\x[1323]" ~~ m/^ <[\C[ETHIOPIC SYLLABLE THAA]]>/, 'Negative charclass named ETHIOPIC SYLLABLE THAA nomatch');
ok("\x[36]" ~~ m/^ <[\C[ETHIOPIC SYLLABLE THAA]]>/, 'Negative charclass named ETHIOPIC SYLLABLE THAA match');
ok(not "\x[1323]" ~~ m/^ \X[1323]/, 'Negative hex \X[1323] nomatch');
ok(not "\x[1323]" ~~ m/^ <[\X[1323]]>/, 'Negative charclass hex \X[1323] nomatch');
...
ok(not "\x[1697]\x[1323]" ~~ m/^ <-[\c[OGHAM LETTER UILLEANN;ETHIOPIC SYLLABLE THAA]]>/, 'Negative charclass OGHAM LETTER UILLEANN;ETHIOPIC SYLLABLE THAA');
ok(not "\x[1697]" ~~ m/^ \C[OGHAM LETTER UILLEANN]/, 'Negative named OGHAM LETTER UILLEANN nomatch');
ok("\x[1323]" ~~ m/^ \C[OGHAM LETTER UILLEANN]/, 'Negative named OGHAM LETTER UILLEANN match');
ok(not "\x[1697]" ~~ m/^ <[\C[OGHAM LETTER UILLEANN]]>/, 'Negative charclass named OGHAM LETTER UILLEANN nomatch');
ok("\x[1323]" ~~ m/^ <[\C[OGHAM LETTER UILLEANN]]>/, 'Negative charclass named OGHAM LETTER UILLEANN match');
ok(not "\x[1697]" ~~ m/^ \X[1697]/, 'Negative hex \X[1697] nomatch');
ok(not "\x[1697]" ~~ m/^ <[\X[1697]]>/, 'Negative charclass hex \X[1697] nomatch');
...
ok(not "\x[fe8b]\x[1697]" ~~ m/^ <-[\c[ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM;OGHAM LETTER UILLEANN]]>/, 'Negative charclass ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM;OGHAM LETTER UILLEANN');
ok(not "\x[fe8b]" ~~ m/^ \C[ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM]/, 'Negative named ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM nomatch');
...
ok(not "\x[fe8b]" ~~ m/^ <[\C[ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM]]>/, 'Negative charclass named ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM nomatch');
...
ok(not "\x[fe8b]" ~~ m/^ \X[FE8B]/, 'Negative hex \X[FE8B] nomatch');
ok(not "\x[fe8b]" ~~ m/^ <[\X[FE8B]]>/, 'Negative charclass hex \X[FE8B] nomatch');
...
ok(not "\x[16de]\x[fe8b]" ~~ m/^ <-[\c[RUNIC LETTER DAGAZ DAEG D;ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM]]>/, 'Negative charclass RUNIC LETTER DAGAZ DAEG D;ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM');
ok(not "\x[16de]" ~~ m/^ \C[RUNIC LETTER DAGAZ DAEG D]/, 'Negative named RUNIC LETTER DAGAZ DAEG D nomatch');
ok("\x[fe8b]" ~~ m/^ \C[RUNIC LETTER DAGAZ DAEG D]/, 'Negative named RUNIC LETTER DAGAZ DAEG D match');
ok(not "\x[16de]" ~~ m/^ <[\C[RUNIC LETTER DAGAZ DAEG D]]>/, 'Negative charclass named RUNIC LETTER DAGAZ DAEG D nomatch');
ok("\x[fe8b]" ~~ m/^ <[\C[RUNIC LETTER DAGAZ DAEG D]]>/, 'Negative charclass named RUNIC LETTER DAGAZ DAEG D match');
ok(not "\x[16de]" ~~ m/^ \X[16DE]/, 'Negative hex \X[16DE] nomatch');
ok(not "\x[16de]" ~~ m/^ <[\X[16DE]]>/, 'Negative charclass hex \X[16DE] nomatch');
...
ok(not "\x[64]\x[16de]" ~~ m/^ <-[\c[LATIN SMALL LETTER D;RUNIC LETTER DAGAZ DAEG D]]>/, 'Negative charclass LATIN SMALL LETTER D;RUNIC LETTER DAGAZ DAEG D');
ok(not "\x[64]" ~~ m/^ \C[LATIN SMALL LETTER D]/, 'Negative named LATIN SMALL LETTER D nomatch');
ok("\x[16de]" ~~ m/^ \C[LATIN SMALL LETTER D]/, 'Negative named LATIN SMALL LETTER D match');
ok(not "\x[64]" ~~ m/^ <[\C[LATIN SMALL LETTER D]]>/, 'Negative charclass named LATIN SMALL LETTER D nomatch');
ok("\x[16de]" ~~ m/^ <[\C[LATIN SMALL LETTER D]]>/, 'Negative charclass named LATIN SMALL LETTER D match');
ok(not "\x[64]" ~~ m/^ \X[64]/, 'Negative hex \X[64] nomatch');
ok(not "\x[64]" ~~ m/^ <[\X[64]]>/, 'Negative charclass hex \X[64] nomatch');
...
ok(not "\x[2724]\x[64]" ~~ m/^ <-[\c[HEAVY FOUR BALLOON-SPOKED ASTERISK;LATIN SMALL LETTER D]]>/, 'Negative charclass HEAVY FOUR BALLOON-SPOKED ASTERISK;LATIN SMALL LETTER D');
ok(not "\x[2724]" ~~ m/^ \C[HEAVY FOUR BALLOON-SPOKED ASTERISK]/, 'Negative named HEAVY FOUR BALLOON-SPOKED ASTERISK nomatch');
ok("\x[64]" ~~ m/^ \C[HEAVY FOUR BALLOON-SPOKED ASTERISK]/, 'Negative named HEAVY FOUR BALLOON-SPOKED ASTERISK match');
ok(not "\x[2724]" ~~ m/^ <[\C[HEAVY FOUR BALLOON-SPOKED ASTERISK]]>/, 'Negative charclass named HEAVY FOUR BALLOON-SPOKED ASTERISK nomatch');
ok("\x[64]" ~~ m/^ <[\C[HEAVY FOUR BALLOON-SPOKED ASTERISK]]>/, 'Negative charclass named HEAVY FOUR BALLOON-SPOKED ASTERISK match');
ok(not "\x[2724]" ~~ m/^ \X[2724]/, 'Negative hex \X[2724] nomatch');
ok(not "\x[2724]" ~~ m/^ <[\X[2724]]>/, 'Negative charclass hex \X[2724] nomatch');
...
ok(not "\x[2719]\x[2724]" ~~ m/^ <-[\c[OUTLINED GREEK CROSS;HEAVY FOUR BALLOON-SPOKED ASTERISK]]>/, 'Negative charclass OUTLINED GREEK CROSS;HEAVY FOUR BALLOON-SPOKED ASTERISK');
ok(not "\x[2719]" ~~ m/^ \C[OUTLINED GREEK CROSS]/, 'Negative named OUTLINED GREEK CROSS nomatch');
ok("\x[2724]" ~~ m/^ \C[OUTLINED GREEK CROSS]/, 'Negative named OUTLINED GREEK CROSS match');
ok(not "\x[2719]" ~~ m/^ <[\C[OUTLINED GREEK CROSS]]>/, 'Negative charclass named OUTLINED GREEK CROSS nomatch');
ok("\x[2724]" ~~ m/^ <[\C[OUTLINED GREEK CROSS]]>/, 'Negative charclass named OUTLINED GREEK CROSS match');
ok(not "\x[2719]" ~~ m/^ \X[2719]/, 'Negative hex \X[2719] nomatch');
ok(not "\x[2719]" ~~ m/^ <[\X[2719]]>/, 'Negative charclass hex \X[2719] nomatch');
...
ok(not "\x[e97]\x[2719]" ~~ m/^ <-[\c[LAO LETTER THO TAM; OUTLINED GREEK CROSS]]>/, 'Negative charclass LAO LETTER THO TAM; OUTLINED GREEK CROSS');
ok(not "\x[e97]" ~~ m/^ \C[LAO LETTER THO TAM]/, 'Negative named LAO LETTER THO TAM nomatch');
ok("\x[2719]" ~~ m/^ \C[LAO LETTER THO TAM]/, 'Negative named LAO LETTER THO TAM match');
ok(not "\x[e97]" ~~ m/^ <[\C[LAO LETTER THO TAM]]>/, 'Negative charclass named LAO LETTER THO TAM nomatch');
ok("\x[2719]" ~~ m/^ <[\C[LAO LETTER THO TAM]]>/, 'Negative charclass named LAO LETTER THO TAM match');
ok(not "\x[e97]" ~~ m/^ \X[E97]/, 'Negative hex \X[E97] nomatch');
ok(not "\x[e97]" ~~ m/^ <[\X[E97]]>/, 'Negative charclass hex \X[E97] nomatch');
...
ok(not "\x[a42d]\x[e97]" ~~ m/^ <-[\c[YI SYLLABLE JJYT;LAO LETTER THO TAM]]>/, 'Negative charclass YI SYLLABLE JJYT;LAO LETTER THO TAM');
ok(not "\x[a42d]" ~~ m/^ \C[YI SYLLABLE JJYT]/, 'Negative named YI SYLLABLE JJYT nomatch');
ok("\x[e97]" ~~ m/^ \C[YI SYLLABLE JJYT]/, 'Negative named YI SYLLABLE JJYT match');
ok(not "\x[a42d]" ~~ m/^ <[\C[YI SYLLABLE JJYT]]>/, 'Negative charclass named YI SYLLABLE JJYT nomatch');
ok("\x[e97]" ~~ m/^ <[\C[YI SYLLABLE JJYT]]>/, 'Negative charclass named YI SYLLABLE JJYT match');
ok(not "\x[a42d]" ~~ m/^ \X[A42D]/, 'Negative hex \X[A42D] nomatch');
ok(not "\x[a42d]" ~~ m/^ <[\X[A42D]]>/, 'Negative charclass hex \X[A42D] nomatch');
...
ok(not "\x[ff6e]\x[a42d]" ~~ m/^ <-[\c[HALFWIDTH KATAKANA LETTER SMALL YO;YI SYLLABLE JJYT]]>/, 'Negative charclass HALFWIDTH KATAKANA LETTER SMALL YO;YI SYLLABLE JJYT');
ok(not "\x[ff6e]" ~~ m/^ \C[HALFWIDTH KATAKANA LETTER SMALL YO]/, 'Negative named HALFWIDTH KATAKANA LETTER SMALL YO nomatch');
ok("\x[a42d]" ~~ m/^ \C[HALFWIDTH KATAKANA LETTER SMALL YO]/, 'Negative named HALFWIDTH KATAKANA LETTER SMALL YO match');
ok(not "\x[ff6e]" ~~ m/^ <[\C[HALFWIDTH KATAKANA LETTER SMALL YO]]>/, 'Negative charclass named HALFWIDTH KATAKANA LETTER SMALL YO nomatch');
ok("\x[a42d]" ~~ m/^ <[\C[HALFWIDTH KATAKANA LETTER SMALL YO]]>/, 'Negative charclass named HALFWIDTH KATAKANA LETTER SMALL YO match');
ok(not "\x[ff6e]" ~~ m/^ \X[FF6E]/, 'Negative hex \X[FF6E] nomatch');
ok(not "\x[ff6e]" ~~ m/^ <[\X[FF6E]]>/, 'Negative charclass hex \X[FF6E] nomatch');
