...
ok(not "7abc1_2" ~~ m/^ <?ident> $/, 'not <?ident>');

ok("\t \n\t" ~~ m/^ <?ws> $/, '<?ws>');
ok(!defined $/<ws>, 'Uncaptured <?ws>');
ok(not "7abc1_2" ~~ m/^ <?ws> $/, 'not <?ws>');

ok(" " ~~ m/^ <?sp> $/, '<?sp>');
ok(!defined $/<sp>, 'Uncaptured <?sp>');
ok(not "7abc1_2" ~~ m/<?sp>/, 'not <?sp>');
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<!alpha>.$/, q{Don't match negated alpha as subrule} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<-alpha>$/, q{Don't match inverted alpha as subrule} );
ok(not "\c[BELL]"  ~~ m/^<?alpha>$/, q{Don't match unrelated alpha as subrule} );
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<-<?alpha>>$/, q{Don't match externally inverted alpha as charset} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<[A]-<?alpha>>$/, q{Don't match compound inverted alpha as charset} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<+<-alpha>>$/, q{Don't match internally inverted alpha as charset} );
ok(not "\c[BELL]"  ~~ m/^<+<?alpha>>$/, q{Don't match unrelated alpha as charset} );
...
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<!space>.$/, q{Don't match negated space as subrule} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<-space>$/, q{Don't match inverted space as subrule} );
ok(not "\c[LEFT PARENTHESIS]"  ~~ m/^<?space>$/, q{Don't match unrelated space as subrule} );
...
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<-<?space>>$/, q{Don't match externally inverted space as charset} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<[A]-<?space>>$/, q{Don't match compound inverted space as charset} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<+<-space>>$/, q{Don't match internally inverted space as charset} );
ok(not "\c[LEFT PARENTHESIS]"  ~~ m/^<+<?space>>$/, q{Don't match unrelated space as charset} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<!digit>.$/, q{Don't match negated digit as subrule} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<-digit>$/, q{Don't match inverted digit as subrule} );
ok(not "\c[FORM FEED (FF)]"  ~~ m/^<?digit>$/, q{Don't match unrelated digit as subrule} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<-<?digit>>$/, q{Don't match externally inverted digit as charset} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<[A]-<?digit>>$/, q{Don't match compound inverted digit as charset} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<+<-digit>>$/, q{Don't match internally inverted digit as charset} );
ok(not "\c[FORM FEED (FF)]"  ~~ m/^<+<?digit>>$/, q{Don't match unrelated digit as charset} );
...
ok(not "\c[LATIN SMALL LETTER N]" ~~ m/^<!alnum>.$/, q{Don't match negated alnum as subrule} );
ok(not "\c[LATIN SMALL LETTER N]" ~~ m/^<-alnum>$/, q{Don't match inverted alnum as subrule} );
ok(not "\c[LEFT CURLY BRACKET]"  ~~ m/^<?alnum>$/, q{Don't match unrelated alnum as subrule} );
...
ok(not "\c[LATIN SMALL LETTER N]" ~~ m/^<-<?alnum>>$/, q{Don't match externally inverted alnum as charset} );
ok(not "\c[LATIN SMALL LETTER N]" ~~ m/^<[A]-<?alnum>>$/, q{Don't match compound inverted alnum as charset} );
ok(not "\c[LATIN SMALL LETTER N]" ~~ m/^<+<-alnum>>$/, q{Don't match internally inverted alnum as charset} );
ok(not "\c[LEFT CURLY BRACKET]"  ~~ m/^<+<?alnum>>$/, q{Don't match unrelated alnum as charset} );
...
ok(not "\c[PLUS SIGN]" ~~ m/^<!ascii>.$/, q{Don't match negated ascii as subrule} );
ok(not "\c[PLUS SIGN]" ~~ m/^<-ascii>$/, q{Don't match inverted ascii as subrule} );

ok("\c[PLUS SIGN]" ~~ m/^<+<?ascii>>$/, q{Match ascii as charset} );
ok("\c[PLUS SIGN]" ~~ m/^<[A]+<?ascii>>$/, q{Match compound ascii as charset} );
ok(not "\c[PLUS SIGN]" ~~ m/^<-<?ascii>>$/, q{Don't match externally inverted ascii as charset} );
ok(not "\c[PLUS SIGN]" ~~ m/^<[A]-<?ascii>>$/, q{Don't match compound inverted ascii as charset} );
ok(not "\c[PLUS SIGN]" ~~ m/^<+<-ascii>>$/, q{Don't match internally inverted ascii as charset} );
ok("\c[PLUS SIGN]" ~~ m/<+<?ascii>>/, q{Match unanchored ascii as charset} );

# blank

ok("\c[CHARACTER TABULATION]" ~~ m/^<?blank>$/, q{Match blank as subrule} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<!blank>.$/, q{Don't match negated blank as subrule} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<-blank>$/, q{Don't match inverted blank as subrule} );
ok(not "\c[AMPERSAND]"  ~~ m/^<?blank>$/, q{Don't match unrelated blank as subrule} );
...
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<-<?blank>>$/, q{Don't match externally inverted blank as charset} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<[A]-<?blank>>$/, q{Don't match compound inverted blank as charset} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<+<-blank>>$/, q{Don't match internally inverted blank as charset} );
ok(not "\c[AMPERSAND]"  ~~ m/^<+<?blank>>$/, q{Don't match unrelated blank as charset} );
...
ok(not "\c[DELETE]" ~~ m/^<!cntrl>.$/, q{Don't match negated cntrl as subrule} );
ok(not "\c[DELETE]" ~~ m/^<-cntrl>$/, q{Don't match inverted cntrl as subrule} );
ok(not "\c[EQUALS SIGN]"  ~~ m/^<?cntrl>$/, q{Don't match unrelated cntrl as subrule} );
...
ok(not "\c[DELETE]" ~~ m/^<-<?cntrl>>$/, q{Don't match externally inverted cntrl as charset} );
ok(not "\c[DELETE]" ~~ m/^<[A]-<?cntrl>>$/, q{Don't match compound inverted cntrl as charset} );
ok(not "\c[DELETE]" ~~ m/^<+<-cntrl>>$/, q{Don't match internally inverted cntrl as charset} );
ok(not "\c[EQUALS SIGN]"  ~~ m/^<+<?cntrl>>$/, q{Don't match unrelated cntrl as charset} );
...
ok(not "\c[LATIN CAPITAL LETTER V]" ~~ m/^<!graph>.$/, q{Don't match negated graph as subrule} );
ok(not "\c[LATIN CAPITAL LETTER V]" ~~ m/^<-graph>$/, q{Don't match inverted graph as subrule} );
ok(not "\c[DELETE]"  ~~ m/^<?graph>$/, q{Don't match unrelated graph as subrule} );
...
ok(not "\c[LATIN CAPITAL LETTER V]" ~~ m/^<-<?graph>>$/, q{Don't match externally inverted graph as charset} );
ok(not "\c[LATIN CAPITAL LETTER V]" ~~ m/^<[A]-<?graph>>$/, q{Don't match compound inverted graph as charset} );
ok(not "\c[LATIN CAPITAL LETTER V]" ~~ m/^<+<-graph>>$/, q{Don't match internally inverted graph as charset} );
ok(not "\c[DELETE]"  ~~ m/^<+<?graph>>$/, q{Don't match unrelated graph as charset} );
...
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<!lower>.$/, q{Don't match negated lower as subrule} );
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<-lower>$/, q{Don't match inverted lower as subrule} );
ok(not "\c[INFORMATION SEPARATOR TWO]"  ~~ m/^<?lower>$/, q{Don't match unrelated lower as subrule} );
...
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<-<?lower>>$/, q{Don't match externally inverted lower as charset} );
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<[A]-<?lower>>$/, q{Don't match compound inverted lower as charset} );
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<+<-lower>>$/, q{Don't match internally inverted lower as charset} );
ok(not "\c[INFORMATION SEPARATOR TWO]"  ~~ m/^<+<?lower>>$/, q{Don't match unrelated lower as charset} );
...
ok(not "\c[LATIN CAPITAL LETTER M]" ~~ m/^<!print>.$/, q{Don't match negated print as subrule} );
ok(not "\c[LATIN CAPITAL LETTER M]" ~~ m/^<-print>$/, q{Don't match inverted print as subrule} );
ok(not "\c[DELETE]"  ~~ m/^<?print>$/, q{Don't match unrelated print as subrule} );
...
ok(not "\c[LATIN CAPITAL LETTER M]" ~~ m/^<-<?print>>$/, q{Don't match externally inverted print as charset} );
ok(not "\c[LATIN CAPITAL LETTER M]" ~~ m/^<[A]-<?print>>$/, q{Don't match compound inverted print as charset} );
ok(not "\c[LATIN CAPITAL LETTER M]" ~~ m/^<+<-print>>$/, q{Don't match internally inverted print as charset} );
ok(not "\c[DELETE]"  ~~ m/^<+<?print>>$/, q{Don't match unrelated print as charset} );
...
ok(not "\c[LEFT SQUARE BRACKET]" ~~ m/^<!punct>.$/, q{Don't match negated punct as subrule} );
ok(not "\c[LEFT SQUARE BRACKET]" ~~ m/^<-punct>$/, q{Don't match inverted punct as subrule} );
ok(not "\c[LATIN CAPITAL LETTER F]"  ~~ m/^<?punct>$/, q{Don't match unrelated punct as subrule} );
...
ok(not "\c[LEFT SQUARE BRACKET]" ~~ m/^<-<?punct>>$/, q{Don't match externally inverted punct as charset} );
ok(not "\c[LEFT SQUARE BRACKET]" ~~ m/^<[A]-<?punct>>$/, q{Don't match compound inverted punct as charset} );
ok(not "\c[LEFT SQUARE BRACKET]" ~~ m/^<+<-punct>>$/, q{Don't match internally inverted punct as charset} );
ok(not "\c[LATIN CAPITAL LETTER F]"  ~~ m/^<+<?punct>>$/, q{Don't match unrelated punct as charset} );
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<!upper>.$/, q{Don't match negated upper as subrule} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<-upper>$/, q{Don't match inverted upper as subrule} );
ok(not "\c[LOW LINE]"  ~~ m/^<?upper>$/, q{Don't match unrelated upper as subrule} );
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<-<?upper>>$/, q{Don't match externally inverted upper as charset} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<[A]-<?upper>>$/, q{Don't match compound inverted upper as charset} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<+<-upper>>$/, q{Don't match internally inverted upper as charset} );
ok(not "\c[LOW LINE]"  ~~ m/^<+<?upper>>$/, q{Don't match unrelated upper as charset} );
...
ok(not "\c[LATIN SMALL LETTER B]" ~~ m/^<!word>.$/, q{Don't match negated word as subrule} );
ok(not "\c[LATIN SMALL LETTER B]" ~~ m/^<-word>$/, q{Don't match inverted word as subrule} );
ok(not "\c[LEFT CURLY BRACKET]"  ~~ m/^<?word>$/, q{Don't match unrelated word as subrule} );
...
ok(not "\c[LATIN SMALL LETTER B]" ~~ m/^<-<?word>>$/, q{Don't match externally inverted word as charset} );
ok(not "\c[LATIN SMALL LETTER B]" ~~ m/^<[A]-<?word>>$/, q{Don't match compound inverted word as charset} );
ok(not "\c[LATIN SMALL LETTER B]" ~~ m/^<+<-word>>$/, q{Don't match internally inverted word as charset} );
ok(not "\c[LEFT CURLY BRACKET]"  ~~ m/^<+<?word>>$/, q{Don't match unrelated word as charset} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<!xdigit>.$/, q{Don't match negated xdigit as subrule} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<-xdigit>$/, q{Don't match inverted xdigit as subrule} );
ok(not "\c[RIGHT CURLY BRACKET]"  ~~ m/^<?xdigit>$/, q{Don't match unrelated xdigit as subrule} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<-<?xdigit>>$/, q{Don't match externally inverted xdigit as charset} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<[A]-<?xdigit>>$/, q{Don't match compound inverted xdigit as charset} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<+<-xdigit>>$/, q{Don't match internally inverted xdigit as charset} );
ok(not "\c[RIGHT CURLY BRACKET]"  ~~ m/^<+<?xdigit>>$/, q{Don't match unrelated xdigit as charset} );
