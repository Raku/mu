...
ok(not "abcabcabcabcd" ~~ m/[abc]**{5}/, 'Fail fixed exact repetition');
ok("abcabcabcabcd"     ~~ m/[abc]**{2..4}/, 'Fixed range repetition');
ok(not "abc"           ~~ m/[abc]**{2..4}/, 'Fail fixed range repetition');
ok("abcabcabcabcd"     ~~ m/[abc]**{2..}/, 'Open range repetition');
ok(not "abcd"          ~~ m/[abc]**{2..}/, 'Fail open range repetition');
