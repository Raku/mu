...
ok(not "\x[45CD]" ~~ m/^<-<L>>$/, q{Don't match externally inverted <L> (Letter)} );
ok(not "\x[45CD]" ~~ m/^<[A]-<L>>$/, q{Don't match compound inverted <L> (Letter)} );
ok(not "\x[45CD]" ~~ m/^<+<-L>>$/, q{Don't match internally inverted <L> (Letter)} );
ok(not "\x[4DB6]"  ~~ m/^<+<L>>$/, q{Don't match unrelated <L> (Letter)} );
...
ok(not "\c[HANGUL LETTER SIOS-PIEUP]" ~~ m/^<-<?Letter>>$/, q{Don't match externally inverted <?Letter>} );
ok(not "\c[HANGUL LETTER SIOS-PIEUP]" ~~ m/^<[A]-<?Letter>>$/, q{Don't match compound inverted <?Letter>} );
ok(not "\c[HANGUL LETTER SIOS-PIEUP]" ~~ m/^<+<-Letter>>$/, q{Don't match internally inverted <?Letter>} );
ok(not "\x[318F]"  ~~ m/^<+<?Letter>>$/, q{Don't match unrelated <?Letter>} );
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<-<?Lu>>$/, q{Don't match externally inverted <?Lu> (UppercaseLetter)} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<[A]-<?Lu>>$/, q{Don't match compound inverted <?Lu> (UppercaseLetter)} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<+<-Lu>>$/, q{Don't match internally inverted <?Lu> (UppercaseLetter)} );
ok(not "\x[5E52]"  ~~ m/^<+<?Lu>>$/, q{Don't match unrelated <?Lu> (UppercaseLetter)} );
...
ok(not "\x[5E52]" ~~ m/^<+<?Lu>>$/, q{Don't match related <?Lu> (UppercaseLetter)} );
...
ok(not "\c[LATIN CAPITAL LETTER A WITH RING BELOW]" ~~ m/^<-<?UppercaseLetter>>$/, q{Don't match externally inverted <?UppercaseLetter>} );
ok(not "\c[LATIN CAPITAL LETTER A WITH RING BELOW]" ~~ m/^<[A]-<?UppercaseLetter>>$/, q{Don't match compound inverted <?UppercaseLetter>} );
ok(not "\c[LATIN CAPITAL LETTER A WITH RING BELOW]" ~~ m/^<+<-UppercaseLetter>>$/, q{Don't match internally inverted <?UppercaseLetter>} );
ok(not "\x[1DB9]"  ~~ m/^<+<?UppercaseLetter>>$/, q{Don't match unrelated <?UppercaseLetter>} );
...
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<-<?Ll>>$/, q{Don't match externally inverted <?Ll> (LowercaseLetter)} );
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<[A]-<?Ll>>$/, q{Don't match compound inverted <?Ll> (LowercaseLetter)} );
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<+<-Ll>>$/, q{Don't match internally inverted <?Ll> (LowercaseLetter)} );
ok(not "\x[83AD]"  ~~ m/^<+<?Ll>>$/, q{Don't match unrelated <?Ll> (LowercaseLetter)} );
...
ok(not "\x[83AD]" ~~ m/^<+<?Ll>>$/, q{Don't match related <?Ll> (LowercaseLetter)} );
...
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<-<?LowercaseLetter>>$/, q{Don't match externally inverted <?LowercaseLetter>} );
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<[A]-<?LowercaseLetter>>$/, q{Don't match compound inverted <?LowercaseLetter>} );
ok(not "\c[LATIN SMALL LETTER A]" ~~ m/^<+<-LowercaseLetter>>$/, q{Don't match internally inverted <?LowercaseLetter>} );
ok(not "\x[A9A8]"  ~~ m/^<+<?LowercaseLetter>>$/, q{Don't match unrelated <?LowercaseLetter>} );
...
ok(not "\x[AC00]" ~~ m/^<+<?LowercaseLetter>>$/, q{Don't match related <?LowercaseLetter>} );
...
ok(not "\c[LATIN CAPITAL LETTER D WITH SMALL LETTER Z WITH CARON]" ~~ m/^<-<?Lt>>$/, q{Don't match externally inverted <?Lt> (TitlecaseLetter)} );
ok(not "\c[LATIN CAPITAL LETTER D WITH SMALL LETTER Z WITH CARON]" ~~ m/^<[A]-<?Lt>>$/, q{Don't match compound inverted <?Lt> (TitlecaseLetter)} );
ok(not "\c[LATIN CAPITAL LETTER D WITH SMALL LETTER Z WITH CARON]" ~~ m/^<+<-Lt>>$/, q{Don't match internally inverted <?Lt> (TitlecaseLetter)} );
ok(not "\x[D187]"  ~~ m/^<+<?Lt>>$/, q{Don't match unrelated <?Lt> (TitlecaseLetter)} );
...
ok(not "\x[D187]" ~~ m/^<+<?Lt>>$/, q{Don't match related <?Lt> (TitlecaseLetter)} );
...
ok(not "\c[LATIN CAPITAL LETTER D WITH SMALL LETTER Z WITH CARON]" ~~ m/^<-<?TitlecaseLetter>>$/, q{Don't match externally inverted <?TitlecaseLetter>} );
ok(not "\c[LATIN CAPITAL LETTER D WITH SMALL LETTER Z WITH CARON]" ~~ m/^<[A]-<?TitlecaseLetter>>$/, q{Don't match compound inverted <?TitlecaseLetter>} );
ok(not "\c[LATIN CAPITAL LETTER D WITH SMALL LETTER Z WITH CARON]" ~~ m/^<+<-TitlecaseLetter>>$/, q{Don't match internally inverted <?TitlecaseLetter>} );
ok(not "\x[C2A9]"  ~~ m/^<+<?TitlecaseLetter>>$/, q{Don't match unrelated <?TitlecaseLetter>} );
...
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<-<?Lm>>$/, q{Don't match externally inverted <?Lm> (ModifierLetter)} );
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<[A]-<?Lm>>$/, q{Don't match compound inverted <?Lm> (ModifierLetter)} );
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<+<-Lm>>$/, q{Don't match internally inverted <?Lm> (ModifierLetter)} );
ok(not "\x[8C34]"  ~~ m/^<+<?Lm>>$/, q{Don't match unrelated <?Lm> (ModifierLetter)} );
...
ok(not "\x[8C34]" ~~ m/^<+<?Lm>>$/, q{Don't match related <?Lm> (ModifierLetter)} );
...
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<-<?ModifierLetter>>$/, q{Don't match externally inverted <?ModifierLetter>} );
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<[A]-<?ModifierLetter>>$/, q{Don't match compound inverted <?ModifierLetter>} );
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<+<-ModifierLetter>>$/, q{Don't match internally inverted <?ModifierLetter>} );
ok(not "\c[YI SYLLABLE NZAX]"  ~~ m/^<+<?ModifierLetter>>$/, q{Don't match unrelated <?ModifierLetter>} );
...
ok(not "\x[8CC9]" ~~ m/^<-<?Lo>>$/, q{Don't match externally inverted <?Lo> (OtherLetter)} );
ok(not "\x[8CC9]" ~~ m/^<[A]-<?Lo>>$/, q{Don't match compound inverted <?Lo> (OtherLetter)} );
ok(not "\x[8CC9]" ~~ m/^<+<-Lo>>$/, q{Don't match internally inverted <?Lo> (OtherLetter)} );
ok(not "\x[9FA6]"  ~~ m/^<+<?Lo>>$/, q{Don't match unrelated <?Lo> (OtherLetter)} );
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<+<?Lo>>$/, q{Don't match related <?Lo> (OtherLetter)} );
...
ok(not "\x[BC7D]" ~~ m/^<-<?OtherLetter>>$/, q{Don't match externally inverted <?OtherLetter>} );
ok(not "\x[BC7D]" ~~ m/^<[A]-<?OtherLetter>>$/, q{Don't match compound inverted <?OtherLetter>} );
ok(not "\x[BC7D]" ~~ m/^<+<-OtherLetter>>$/, q{Don't match internally inverted <?OtherLetter>} );
ok(not "\x[D7A4]"  ~~ m/^<+<?OtherLetter>>$/, q{Don't match unrelated <?OtherLetter>} );
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<-<?Lr>>$/, q{Don't match externally inverted (Alias for "Ll", "Lu", and "Lt".)} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<[A]-<?Lr>>$/, q{Don't match compound inverted (Alias for "Ll", "Lu", and "Lt".)} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<+<-Lr>>$/, q{Don't match internally inverted (Alias for "Ll", "Lu", and "Lt".)} );
ok(not "\x[CD29]"  ~~ m/^<+<?Lr>>$/, q{Don't match unrelated (Alias for "Ll", "Lu", and "Lt".)} );
...
ok(not "\x[CD29]" ~~ m/^<+<?Lr>>$/, q{Don't match related (Alias for "Ll", "Lu", and "Lt".)} );
...
ok(not "\c[TAGALOG VOWEL SIGN I]" ~~ m/^<-<M>>$/, q{Don't match externally inverted <M> (Mark)} );
ok(not "\c[TAGALOG VOWEL SIGN I]" ~~ m/^<[A]-<M>>$/, q{Don't match compound inverted <M> (Mark)} );
ok(not "\c[TAGALOG VOWEL SIGN I]" ~~ m/^<+<-M>>$/, q{Don't match internally inverted <M> (Mark)} );
ok(not "\c[CANADIAN SYLLABICS KAAI]"  ~~ m/^<+<M>>$/, q{Don't match unrelated <M> (Mark)} );
...
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<-<?Mark>>$/, q{Don't match externally inverted <?Mark>} );
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<[A]-<?Mark>>$/, q{Don't match compound inverted <?Mark>} );
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<+<-Mark>>$/, q{Don't match internally inverted <?Mark>} );
ok(not "\x[4BF0]"  ~~ m/^<+<?Mark>>$/, q{Don't match unrelated <?Mark>} );
...
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<-<?Mn>>$/, q{Don't match externally inverted <?Mn> (NonspacingMark)} );
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<[A]-<?Mn>>$/, q{Don't match compound inverted <?Mn> (NonspacingMark)} );
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<+<-Mn>>$/, q{Don't match internally inverted <?Mn> (NonspacingMark)} );
ok(not "\x[CF2C]"  ~~ m/^<+<?Mn>>$/, q{Don't match unrelated <?Mn> (NonspacingMark)} );
...
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<-<?NonspacingMark>>$/, q{Don't match externally inverted <?NonspacingMark>} );
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<[A]-<?NonspacingMark>>$/, q{Don't match compound inverted <?NonspacingMark>} );
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<+<-NonspacingMark>>$/, q{Don't match internally inverted <?NonspacingMark>} );
ok(not "\x[B617]"  ~~ m/^<+<?NonspacingMark>>$/, q{Don't match unrelated <?NonspacingMark>} );
...
ok(not "\c[DEVANAGARI SIGN VISARGA]" ~~ m/^<-<?Mc>>$/, q{Don't match externally inverted <?Mc> (SpacingMark)} );
ok(not "\c[DEVANAGARI SIGN VISARGA]" ~~ m/^<[A]-<?Mc>>$/, q{Don't match compound inverted <?Mc> (SpacingMark)} );
ok(not "\c[DEVANAGARI SIGN VISARGA]" ~~ m/^<+<-Mc>>$/, q{Don't match internally inverted <?Mc> (SpacingMark)} );
ok(not "\c[BALLOT BOX WITH CHECK]"  ~~ m/^<+<?Mc>>$/, q{Don't match unrelated <?Mc> (SpacingMark)} );
...
ok(not "\c[IDEOGRAPHIC LEVEL TONE MARK]" ~~ m/^<+<?Mc>>$/, q{Don't match related <?Mc> (SpacingMark)} );
...
ok(not "\c[MALAYALAM SIGN ANUSVARA]" ~~ m/^<-<?SpacingMark>>$/, q{Don't match externally inverted <?SpacingMark>} );
ok(not "\c[MALAYALAM SIGN ANUSVARA]" ~~ m/^<[A]-<?SpacingMark>>$/, q{Don't match compound inverted <?SpacingMark>} );
ok(not "\c[MALAYALAM SIGN ANUSVARA]" ~~ m/^<+<-SpacingMark>>$/, q{Don't match internally inverted <?SpacingMark>} );
ok(not "\c[KANNADA LETTER VOCALIC LL]"  ~~ m/^<+<?SpacingMark>>$/, q{Don't match unrelated <?SpacingMark>} );
...
ok(not "\c[COMBINING CYRILLIC HUNDRED THOUSANDS SIGN]" ~~ m/^<-<?Me>>$/, q{Don't match externally inverted <?Me> (EnclosingMark)} );
ok(not "\c[COMBINING CYRILLIC HUNDRED THOUSANDS SIGN]" ~~ m/^<[A]-<?Me>>$/, q{Don't match compound inverted <?Me> (EnclosingMark)} );
ok(not "\c[COMBINING CYRILLIC HUNDRED THOUSANDS SIGN]" ~~ m/^<+<-Me>>$/, q{Don't match internally inverted <?Me> (EnclosingMark)} );
ok(not "\x[C680]"  ~~ m/^<+<?Me>>$/, q{Don't match unrelated <?Me> (EnclosingMark)} );
...
ok(not "\c[COMBINING CYRILLIC HUNDRED THOUSANDS SIGN]" ~~ m/^<-<?EnclosingMark>>$/, q{Don't match externally inverted <?EnclosingMark>} );
ok(not "\c[COMBINING CYRILLIC HUNDRED THOUSANDS SIGN]" ~~ m/^<[A]-<?EnclosingMark>>$/, q{Don't match compound inverted <?EnclosingMark>} );
ok(not "\c[COMBINING CYRILLIC HUNDRED THOUSANDS SIGN]" ~~ m/^<+<-EnclosingMark>>$/, q{Don't match internally inverted <?EnclosingMark>} );
ok(not "\x[911E]"  ~~ m/^<+<?EnclosingMark>>$/, q{Don't match unrelated <?EnclosingMark>} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<-<N>>$/, q{Don't match externally inverted <N> (Number)} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<[A]-<N>>$/, q{Don't match compound inverted <N> (Number)} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<+<-N>>$/, q{Don't match internally inverted <N> (Number)} );
ok(not "\x[3BA3]"  ~~ m/^<+<N>>$/, q{Don't match unrelated <N> (Number)} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<-<?Number>>$/, q{Don't match externally inverted <?Number>} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<[A]-<?Number>>$/, q{Don't match compound inverted <?Number>} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<+<-Number>>$/, q{Don't match internally inverted <?Number>} );
ok(not "\x[37D0]"  ~~ m/^<+<?Number>>$/, q{Don't match unrelated <?Number>} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<-<?Nd>>$/, q{Don't match externally inverted <?Nd> (DecimalNumber)} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<[A]-<?Nd>>$/, q{Don't match compound inverted <?Nd> (DecimalNumber)} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<+<-Nd>>$/, q{Don't match internally inverted <?Nd> (DecimalNumber)} );
ok(not "\x[8536]"  ~~ m/^<+<?Nd>>$/, q{Don't match unrelated <?Nd> (DecimalNumber)} );
...
ok(not "\c[KHMER DIGIT ZERO]" ~~ m/^<-<?DecimalNumber>>$/, q{Don't match externally inverted <?DecimalNumber>} );
ok(not "\c[KHMER DIGIT ZERO]" ~~ m/^<[A]-<?DecimalNumber>>$/, q{Don't match compound inverted <?DecimalNumber>} );
ok(not "\c[KHMER DIGIT ZERO]" ~~ m/^<+<-DecimalNumber>>$/, q{Don't match internally inverted <?DecimalNumber>} );
ok(not "\c[CANADIAN SYLLABICS NWE]"  ~~ m/^<+<?DecimalNumber>>$/, q{Don't match unrelated <?DecimalNumber>} );
...
ok(not "\c[ROMAN NUMERAL ONE]" ~~ m/^<-<?Nl>>$/, q{Don't match externally inverted <?Nl> (LetterNumber)} );
ok(not "\c[ROMAN NUMERAL ONE]" ~~ m/^<[A]-<?Nl>>$/, q{Don't match compound inverted <?Nl> (LetterNumber)} );
ok(not "\c[ROMAN NUMERAL ONE]" ~~ m/^<+<-Nl>>$/, q{Don't match internally inverted <?Nl> (LetterNumber)} );
ok(not "\x[1B95]"  ~~ m/^<+<?Nl>>$/, q{Don't match unrelated <?Nl> (LetterNumber)} );
...
ok(not "\c[SUPERSCRIPT ZERO]" ~~ m/^<+<?Nl>>$/, q{Don't match related <?Nl> (LetterNumber)} );
...
ok(not "\c[RUNIC ARLAUG SYMBOL]" ~~ m/^<-<?LetterNumber>>$/, q{Don't match externally inverted <?LetterNumber>} );
ok(not "\c[RUNIC ARLAUG SYMBOL]" ~~ m/^<[A]-<?LetterNumber>>$/, q{Don't match compound inverted <?LetterNumber>} );
ok(not "\c[RUNIC ARLAUG SYMBOL]" ~~ m/^<+<-LetterNumber>>$/, q{Don't match internally inverted <?LetterNumber>} );
ok(not "\x[9B4F]"  ~~ m/^<+<?LetterNumber>>$/, q{Don't match unrelated <?LetterNumber>} );
...
ok(not "\x[9B4F]" ~~ m/^<+<?LetterNumber>>$/, q{Don't match related <?LetterNumber>} );
...
ok(not "\c[SUPERSCRIPT TWO]" ~~ m/^<-<?No>>$/, q{Don't match externally inverted <?No> (OtherNumber)} );
ok(not "\c[SUPERSCRIPT TWO]" ~~ m/^<[A]-<?No>>$/, q{Don't match compound inverted <?No> (OtherNumber)} );
ok(not "\c[SUPERSCRIPT TWO]" ~~ m/^<+<-No>>$/, q{Don't match internally inverted <?No> (OtherNumber)} );
ok(not "\x[8F9A]"  ~~ m/^<+<?No>>$/, q{Don't match unrelated <?No> (OtherNumber)} );
...
ok(not "\c[BENGALI CURRENCY NUMERATOR ONE]" ~~ m/^<-<?OtherNumber>>$/, q{Don't match externally inverted <?OtherNumber>} );
ok(not "\c[BENGALI CURRENCY NUMERATOR ONE]" ~~ m/^<[A]-<?OtherNumber>>$/, q{Don't match compound inverted <?OtherNumber>} );
ok(not "\c[BENGALI CURRENCY NUMERATOR ONE]" ~~ m/^<+<-OtherNumber>>$/, q{Don't match internally inverted <?OtherNumber>} );
ok(not "\x[0522]"  ~~ m/^<+<?OtherNumber>>$/, q{Don't match unrelated <?OtherNumber>} );
...
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<-<P>>$/, q{Don't match externally inverted <P> (Punctuation)} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<[A]-<P>>$/, q{Don't match compound inverted <P> (Punctuation)} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<+<-P>>$/, q{Don't match internally inverted <P> (Punctuation)} );
ok(not "\x[3753]"  ~~ m/^<+<P>>$/, q{Don't match unrelated <P> (Punctuation)} );
...
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<-<?Punctuation>>$/, q{Don't match externally inverted <?Punctuation>} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<[A]-<?Punctuation>>$/, q{Don't match compound inverted <?Punctuation>} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<+<-Punctuation>>$/, q{Don't match internally inverted <?Punctuation>} );
ok(not "\x[9C5E]"  ~~ m/^<+<?Punctuation>>$/, q{Don't match unrelated <?Punctuation>} );
...
ok(not "\c[LOW LINE]" ~~ m/^<-<?Pc>>$/, q{Don't match externally inverted <?Pc> (ConnectorPunctuation)} );
ok(not "\c[LOW LINE]" ~~ m/^<[A]-<?Pc>>$/, q{Don't match compound inverted <?Pc> (ConnectorPunctuation)} );
ok(not "\c[LOW LINE]" ~~ m/^<+<-Pc>>$/, q{Don't match internally inverted <?Pc> (ConnectorPunctuation)} );
ok(not "\x[B2C9]"  ~~ m/^<+<?Pc>>$/, q{Don't match unrelated <?Pc> (ConnectorPunctuation)} );
...
ok(not "\c[LOW LINE]" ~~ m/^<-<?ConnectorPunctuation>>$/, q{Don't match externally inverted <?ConnectorPunctuation>} );
ok(not "\c[LOW LINE]" ~~ m/^<[A]-<?ConnectorPunctuation>>$/, q{Don't match compound inverted <?ConnectorPunctuation>} );
ok(not "\c[LOW LINE]" ~~ m/^<+<-ConnectorPunctuation>>$/, q{Don't match internally inverted <?ConnectorPunctuation>} );
ok(not "\x[AEFC]"  ~~ m/^<+<?ConnectorPunctuation>>$/, q{Don't match unrelated <?ConnectorPunctuation>} );
...
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<-<?Pd>>$/, q{Don't match externally inverted <?Pd> (DashPunctuation)} );
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<[A]-<?Pd>>$/, q{Don't match compound inverted <?Pd> (DashPunctuation)} );
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<+<-Pd>>$/, q{Don't match internally inverted <?Pd> (DashPunctuation)} );
ok(not "\x[86C8]"  ~~ m/^<+<?Pd>>$/, q{Don't match unrelated <?Pd> (DashPunctuation)} );
...
ok(not "\c[KATAKANA-HIRAGANA DOUBLE HYPHEN]" ~~ m/^<-<?DashPunctuation>>$/, q{Don't match externally inverted <?DashPunctuation>} );
ok(not "\c[KATAKANA-HIRAGANA DOUBLE HYPHEN]" ~~ m/^<[A]-<?DashPunctuation>>$/, q{Don't match compound inverted <?DashPunctuation>} );
ok(not "\c[KATAKANA-HIRAGANA DOUBLE HYPHEN]" ~~ m/^<+<-DashPunctuation>>$/, q{Don't match internally inverted <?DashPunctuation>} );
ok(not "\c[HIRAGANA LETTER NI]"  ~~ m/^<+<?DashPunctuation>>$/, q{Don't match unrelated <?DashPunctuation>} );
...
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<-<?Ps>>$/, q{Don't match externally inverted <?Ps> (OpenPunctuation)} );
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<[A]-<?Ps>>$/, q{Don't match compound inverted <?Ps> (OpenPunctuation)} );
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<+<-Ps>>$/, q{Don't match internally inverted <?Ps> (OpenPunctuation)} );
ok(not "\x[B601]"  ~~ m/^<+<?Ps>>$/, q{Don't match unrelated <?Ps> (OpenPunctuation)} );
...
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<-<?OpenPunctuation>>$/, q{Don't match externally inverted <?OpenPunctuation>} );
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<[A]-<?OpenPunctuation>>$/, q{Don't match compound inverted <?OpenPunctuation>} );
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<+<-OpenPunctuation>>$/, q{Don't match internally inverted <?OpenPunctuation>} );
ok(not "\x[89C1]"  ~~ m/^<+<?OpenPunctuation>>$/, q{Don't match unrelated <?OpenPunctuation>} );
...
ok(not "\c[RIGHT PARENTHESIS]" ~~ m/^<-<?Pe>>$/, q{Don't match externally inverted <?Pe> (ClosePunctuation)} );
ok(not "\c[RIGHT PARENTHESIS]" ~~ m/^<[A]-<?Pe>>$/, q{Don't match compound inverted <?Pe> (ClosePunctuation)} );
ok(not "\c[RIGHT PARENTHESIS]" ~~ m/^<+<-Pe>>$/, q{Don't match internally inverted <?Pe> (ClosePunctuation)} );
ok(not "\x[5561]"  ~~ m/^<+<?Pe>>$/, q{Don't match unrelated <?Pe> (ClosePunctuation)} );
...
ok(not "\c[RIGHT PARENTHESIS]" ~~ m/^<-<?ClosePunctuation>>$/, q{Don't match externally inverted <?ClosePunctuation>} );
ok(not "\c[RIGHT PARENTHESIS]" ~~ m/^<[A]-<?ClosePunctuation>>$/, q{Don't match compound inverted <?ClosePunctuation>} );
ok(not "\c[RIGHT PARENTHESIS]" ~~ m/^<+<-ClosePunctuation>>$/, q{Don't match internally inverted <?ClosePunctuation>} );
ok(not "\x[98D0]"  ~~ m/^<+<?ClosePunctuation>>$/, q{Don't match unrelated <?ClosePunctuation>} );
...
ok(not "\c[LEFT-POINTING DOUBLE ANGLE QUOTATION MARK]" ~~ m/^<-<?Pi>>$/, q{Don't match externally inverted <?Pi> (InitialPunctuation)} );
ok(not "\c[LEFT-POINTING DOUBLE ANGLE QUOTATION MARK]" ~~ m/^<[A]-<?Pi>>$/, q{Don't match compound inverted <?Pi> (InitialPunctuation)} );
ok(not "\c[LEFT-POINTING DOUBLE ANGLE QUOTATION MARK]" ~~ m/^<+<-Pi>>$/, q{Don't match internally inverted <?Pi> (InitialPunctuation)} );
ok(not "\x[D76F]"  ~~ m/^<+<?Pi>>$/, q{Don't match unrelated <?Pi> (InitialPunctuation)} );
...
ok(not "\c[LEFT-POINTING DOUBLE ANGLE QUOTATION MARK]" ~~ m/^<-<?InitialPunctuation>>$/, q{Don't match externally inverted <?InitialPunctuation>} );
ok(not "\c[LEFT-POINTING DOUBLE ANGLE QUOTATION MARK]" ~~ m/^<[A]-<?InitialPunctuation>>$/, q{Don't match compound inverted <?InitialPunctuation>} );
ok(not "\c[LEFT-POINTING DOUBLE ANGLE QUOTATION MARK]" ~~ m/^<+<-InitialPunctuation>>$/, q{Don't match internally inverted <?InitialPunctuation>} );
ok(not "\x[C96E]"  ~~ m/^<+<?InitialPunctuation>>$/, q{Don't match unrelated <?InitialPunctuation>} );
...
ok(not "\c[RIGHT SINGLE QUOTATION MARK]" ~~ m/^<-<?Pf>>$/, q{Don't match externally inverted <?Pf> (FinalPunctuation)} );
ok(not "\c[RIGHT SINGLE QUOTATION MARK]" ~~ m/^<[A]-<?Pf>>$/, q{Don't match compound inverted <?Pf> (FinalPunctuation)} );
ok(not "\c[RIGHT SINGLE QUOTATION MARK]" ~~ m/^<+<-Pf>>$/, q{Don't match internally inverted <?Pf> (FinalPunctuation)} );
ok(not "\x[0515]"  ~~ m/^<+<?Pf>>$/, q{Don't match unrelated <?Pf> (FinalPunctuation)} );
...
ok(not "\c[ARMENIAN APOSTROPHE]" ~~ m/^<+<?Pf>>$/, q{Don't match related <?Pf> (FinalPunctuation)} );
...
ok(not "\c[RIGHT SINGLE QUOTATION MARK]" ~~ m/^<-<?FinalPunctuation>>$/, q{Don't match externally inverted <?FinalPunctuation>} );
ok(not "\c[RIGHT SINGLE QUOTATION MARK]" ~~ m/^<[A]-<?FinalPunctuation>>$/, q{Don't match compound inverted <?FinalPunctuation>} );
ok(not "\c[RIGHT SINGLE QUOTATION MARK]" ~~ m/^<+<-FinalPunctuation>>$/, q{Don't match internally inverted <?FinalPunctuation>} );
ok(not "\c[MODIFIER LETTER PRIME]"  ~~ m/^<+<?FinalPunctuation>>$/, q{Don't match unrelated <?FinalPunctuation>} );
...
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<-<?Po>>$/, q{Don't match externally inverted <?Po> (OtherPunctuation)} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<[A]-<?Po>>$/, q{Don't match compound inverted <?Po> (OtherPunctuation)} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<+<-Po>>$/, q{Don't match internally inverted <?Po> (OtherPunctuation)} );
ok(not "\x[A586]"  ~~ m/^<+<?Po>>$/, q{Don't match unrelated <?Po> (OtherPunctuation)} );
...
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<-<?OtherPunctuation>>$/, q{Don't match externally inverted <?OtherPunctuation>} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<[A]-<?OtherPunctuation>>$/, q{Don't match compound inverted <?OtherPunctuation>} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<+<-OtherPunctuation>>$/, q{Don't match internally inverted <?OtherPunctuation>} );
ok(not "\x[5FBD]"  ~~ m/^<+<?OtherPunctuation>>$/, q{Don't match unrelated <?OtherPunctuation>} );
...
ok(not "\c[GUJARATI RUPEE SIGN]" ~~ m/^<-<S>>$/, q{Don't match externally inverted <S> (Symbol)} );
ok(not "\c[GUJARATI RUPEE SIGN]" ~~ m/^<[A]-<S>>$/, q{Don't match compound inverted <S> (Symbol)} );
ok(not "\c[GUJARATI RUPEE SIGN]" ~~ m/^<+<-S>>$/, q{Don't match internally inverted <S> (Symbol)} );
ok(not "\c[GURMUKHI SIGN ADAK BINDI]"  ~~ m/^<+<S>>$/, q{Don't match unrelated <S> (Symbol)} );
...
ok(not "\c[LIMBU SIGN LOO]" ~~ m/^<-<?Symbol>>$/, q{Don't match externally inverted <?Symbol>} );
ok(not "\c[LIMBU SIGN LOO]" ~~ m/^<[A]-<?Symbol>>$/, q{Don't match compound inverted <?Symbol>} );
ok(not "\c[LIMBU SIGN LOO]" ~~ m/^<+<-Symbol>>$/, q{Don't match internally inverted <?Symbol>} );
ok(not "\x[192C]"  ~~ m/^<+<?Symbol>>$/, q{Don't match unrelated <?Symbol>} );
...
ok(not "\c[PLUS SIGN]" ~~ m/^<-<?Sm>>$/, q{Don't match externally inverted <?Sm> (MathSymbol)} );
ok(not "\c[PLUS SIGN]" ~~ m/^<[A]-<?Sm>>$/, q{Don't match compound inverted <?Sm> (MathSymbol)} );
ok(not "\c[PLUS SIGN]" ~~ m/^<+<-Sm>>$/, q{Don't match internally inverted <?Sm> (MathSymbol)} );
ok(not "\x[769B]"  ~~ m/^<+<?Sm>>$/, q{Don't match unrelated <?Sm> (MathSymbol)} );
...
ok(not "\c[YI RADICAL QOT]" ~~ m/^<+<?Sm>>$/, q{Don't match related <?Sm> (MathSymbol)} );
...
ok(not "\c[FRACTION SLASH]" ~~ m/^<-<?MathSymbol>>$/, q{Don't match externally inverted <?MathSymbol>} );
ok(not "\c[FRACTION SLASH]" ~~ m/^<[A]-<?MathSymbol>>$/, q{Don't match compound inverted <?MathSymbol>} );
ok(not "\c[FRACTION SLASH]" ~~ m/^<+<-MathSymbol>>$/, q{Don't match internally inverted <?MathSymbol>} );
ok(not "\c[GREEK SMALL LETTER ALPHA WITH PERISPOMENI AND YPOGEGRAMMENI]"  ~~ m/^<+<?MathSymbol>>$/, q{Don't match unrelated <?MathSymbol>} );
...
ok(not "\c[COMBINING LEFT HARPOON ABOVE]" ~~ m/^<+<?MathSymbol>>$/, q{Don't match related <?MathSymbol>} );
...
ok(not "\c[DOLLAR SIGN]" ~~ m/^<-<?Sc>>$/, q{Don't match externally inverted <?Sc> (CurrencySymbol)} );
ok(not "\c[DOLLAR SIGN]" ~~ m/^<[A]-<?Sc>>$/, q{Don't match compound inverted <?Sc> (CurrencySymbol)} );
ok(not "\c[DOLLAR SIGN]" ~~ m/^<+<-Sc>>$/, q{Don't match internally inverted <?Sc> (CurrencySymbol)} );
ok(not "\x[B6B4]"  ~~ m/^<+<?Sc>>$/, q{Don't match unrelated <?Sc> (CurrencySymbol)} );
...
ok(not "\c[PLUS SIGN]" ~~ m/^<+<?Sc>>$/, q{Don't match related <?Sc> (CurrencySymbol)} );
...
ok(not "\c[EURO-CURRENCY SIGN]" ~~ m/^<-<?CurrencySymbol>>$/, q{Don't match externally inverted <?CurrencySymbol>} );
ok(not "\c[EURO-CURRENCY SIGN]" ~~ m/^<[A]-<?CurrencySymbol>>$/, q{Don't match compound inverted <?CurrencySymbol>} );
ok(not "\c[EURO-CURRENCY SIGN]" ~~ m/^<+<-CurrencySymbol>>$/, q{Don't match internally inverted <?CurrencySymbol>} );
ok(not "\x[1CD3]"  ~~ m/^<+<?CurrencySymbol>>$/, q{Don't match unrelated <?CurrencySymbol>} );
...
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<-<?Sk>>$/, q{Don't match externally inverted <?Sk> (ModifierSymbol)} );
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<[A]-<?Sk>>$/, q{Don't match compound inverted <?Sk> (ModifierSymbol)} );
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<+<-Sk>>$/, q{Don't match internally inverted <?Sk> (ModifierSymbol)} );
ok(not "\x[68FA]"  ~~ m/^<+<?Sk>>$/, q{Don't match unrelated <?Sk> (ModifierSymbol)} );
...
ok(not "\c[YI RADICAL QOT]" ~~ m/^<+<?Sk>>$/, q{Don't match related <?Sk> (ModifierSymbol)} );
...
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<-<?ModifierSymbol>>$/, q{Don't match externally inverted <?ModifierSymbol>} );
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<[A]-<?ModifierSymbol>>$/, q{Don't match compound inverted <?ModifierSymbol>} );
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<+<-ModifierSymbol>>$/, q{Don't match internally inverted <?ModifierSymbol>} );
ok(not "\x[69E7]"  ~~ m/^<+<?ModifierSymbol>>$/, q{Don't match unrelated <?ModifierSymbol>} );
...
ok(not "\c[YI RADICAL QOT]" ~~ m/^<-<?So>>$/, q{Don't match externally inverted <?So> (OtherSymbol)} );
ok(not "\c[YI RADICAL QOT]" ~~ m/^<[A]-<?So>>$/, q{Don't match compound inverted <?So> (OtherSymbol)} );
ok(not "\c[YI RADICAL QOT]" ~~ m/^<+<-So>>$/, q{Don't match internally inverted <?So> (OtherSymbol)} );
ok(not "\x[8C90]"  ~~ m/^<+<?So>>$/, q{Don't match unrelated <?So> (OtherSymbol)} );
...
ok(not "\c[YI RADICAL QOT]" ~~ m/^<-<?OtherSymbol>>$/, q{Don't match externally inverted <?OtherSymbol>} );
ok(not "\c[YI RADICAL QOT]" ~~ m/^<[A]-<?OtherSymbol>>$/, q{Don't match compound inverted <?OtherSymbol>} );
ok(not "\c[YI RADICAL QOT]" ~~ m/^<+<-OtherSymbol>>$/, q{Don't match internally inverted <?OtherSymbol>} );
ok(not "\x[95A7]"  ~~ m/^<+<?OtherSymbol>>$/, q{Don't match unrelated <?OtherSymbol>} );
...
ok(not "\c[SPACE]" ~~ m/^<-<Z>>$/, q{Don't match externally inverted <Z> (Separator)} );
ok(not "\c[SPACE]" ~~ m/^<[A]-<Z>>$/, q{Don't match compound inverted <Z> (Separator)} );
ok(not "\c[SPACE]" ~~ m/^<+<-Z>>$/, q{Don't match internally inverted <Z> (Separator)} );
ok(not "\x[D222]"  ~~ m/^<+<Z>>$/, q{Don't match unrelated <Z> (Separator)} );
...
ok(not "\c[SPACE]" ~~ m/^<-<?Separator>>$/, q{Don't match externally inverted <?Separator>} );
ok(not "\c[SPACE]" ~~ m/^<[A]-<?Separator>>$/, q{Don't match compound inverted <?Separator>} );
ok(not "\c[SPACE]" ~~ m/^<+<-Separator>>$/, q{Don't match internally inverted <?Separator>} );
ok(not "\x[D7B7]"  ~~ m/^<+<?Separator>>$/, q{Don't match unrelated <?Separator>} );
...
ok(not "\c[DOLLAR SIGN]" ~~ m/^<+<?Separator>>$/, q{Don't match related <?Separator>} );
...
ok(not "\c[SPACE]" ~~ m/^<-<?Zs>>$/, q{Don't match externally inverted <?Zs> (SpaceSeparator)} );
ok(not "\c[SPACE]" ~~ m/^<[A]-<?Zs>>$/, q{Don't match compound inverted <?Zs> (SpaceSeparator)} );
ok(not "\c[SPACE]" ~~ m/^<+<-Zs>>$/, q{Don't match internally inverted <?Zs> (SpaceSeparator)} );
ok(not "\x[5918]"  ~~ m/^<+<?Zs>>$/, q{Don't match unrelated <?Zs> (SpaceSeparator)} );
...
ok(not "\c[SPACE]" ~~ m/^<-<?SpaceSeparator>>$/, q{Don't match externally inverted <?SpaceSeparator>} );
ok(not "\c[SPACE]" ~~ m/^<[A]-<?SpaceSeparator>>$/, q{Don't match compound inverted <?SpaceSeparator>} );
ok(not "\c[SPACE]" ~~ m/^<+<-SpaceSeparator>>$/, q{Don't match internally inverted <?SpaceSeparator>} );
ok(not "\x[3704]"  ~~ m/^<+<?SpaceSeparator>>$/, q{Don't match unrelated <?SpaceSeparator>} );
...
ok(not "\c[HEXAGRAM FOR THE CREATIVE HEAVEN]" ~~ m/^<+<?SpaceSeparator>>$/, q{Don't match related <?SpaceSeparator>} );
...
ok(not "\c[LINE SEPARATOR]" ~~ m/^<-<?Zl>>$/, q{Don't match externally inverted <?Zl> (LineSeparator)} );
ok(not "\c[LINE SEPARATOR]" ~~ m/^<[A]-<?Zl>>$/, q{Don't match compound inverted <?Zl> (LineSeparator)} );
ok(not "\c[LINE SEPARATOR]" ~~ m/^<+<-Zl>>$/, q{Don't match internally inverted <?Zl> (LineSeparator)} );
ok(not "\x[ADAD]"  ~~ m/^<+<?Zl>>$/, q{Don't match unrelated <?Zl> (LineSeparator)} );
...
ok(not "\c[LINE SEPARATOR]" ~~ m/^<-<?LineSeparator>>$/, q{Don't match externally inverted <?LineSeparator>} );
ok(not "\c[LINE SEPARATOR]" ~~ m/^<[A]-<?LineSeparator>>$/, q{Don't match compound inverted <?LineSeparator>} );
ok(not "\c[LINE SEPARATOR]" ~~ m/^<+<-LineSeparator>>$/, q{Don't match internally inverted <?LineSeparator>} );
ok(not "\x[C5E7]"  ~~ m/^<+<?LineSeparator>>$/, q{Don't match unrelated <?LineSeparator>} );
...
ok(not "\x[C5E7]" ~~ m/^<+<?LineSeparator>>$/, q{Don't match related <?LineSeparator>} );
...
ok(not "\c[PARAGRAPH SEPARATOR]" ~~ m/^<-<?Zp>>$/, q{Don't match externally inverted <?Zp> (ParagraphSeparator)} );
ok(not "\c[PARAGRAPH SEPARATOR]" ~~ m/^<[A]-<?Zp>>$/, q{Don't match compound inverted <?Zp> (ParagraphSeparator)} );
ok(not "\c[PARAGRAPH SEPARATOR]" ~~ m/^<+<-Zp>>$/, q{Don't match internally inverted <?Zp> (ParagraphSeparator)} );
ok(not "\c[KHMER SYMBOL LEK ATTAK PRAM-BUON]"  ~~ m/^<+<?Zp>>$/, q{Don't match unrelated <?Zp> (ParagraphSeparator)} );
...
ok(not "\c[MONGOLIAN VOWEL SEPARATOR]" ~~ m/^<+<?Zp>>$/, q{Don't match related <?Zp> (ParagraphSeparator)} );
...
ok(not "\c[PARAGRAPH SEPARATOR]" ~~ m/^<-<?ParagraphSeparator>>$/, q{Don't match externally inverted <?ParagraphSeparator>} );
ok(not "\c[PARAGRAPH SEPARATOR]" ~~ m/^<[A]-<?ParagraphSeparator>>$/, q{Don't match compound inverted <?ParagraphSeparator>} );
ok(not "\c[PARAGRAPH SEPARATOR]" ~~ m/^<+<-ParagraphSeparator>>$/, q{Don't match internally inverted <?ParagraphSeparator>} );
ok(not "\c[HIRAGANA LETTER KA]"  ~~ m/^<+<?ParagraphSeparator>>$/, q{Don't match unrelated <?ParagraphSeparator>} );
...
ok(not "\c[KATAKANA-HIRAGANA DOUBLE HYPHEN]" ~~ m/^<+<?ParagraphSeparator>>$/, q{Don't match related <?ParagraphSeparator>} );
...
ok(not "\x[9FA6]" ~~ m/^<-<C>>$/, q{Don't match externally inverted <C> (Other)} );
ok(not "\x[9FA6]" ~~ m/^<[A]-<C>>$/, q{Don't match compound inverted <C> (Other)} );
ok(not "\x[9FA6]" ~~ m/^<+<-C>>$/, q{Don't match internally inverted <C> (Other)} );
ok(not "\x[56E6]"  ~~ m/^<+<C>>$/, q{Don't match unrelated <C> (Other)} );
...
ok(not "\x[0EAC]" ~~ m/^<-<?Other>>$/, q{Don't match externally inverted <?Other>} );
ok(not "\x[0EAC]" ~~ m/^<[A]-<?Other>>$/, q{Don't match compound inverted <?Other>} );
ok(not "\x[0EAC]" ~~ m/^<+<-Other>>$/, q{Don't match internally inverted <?Other>} );
ok(not "\c[LAO LETTER HO SUNG]"  ~~ m/^<+<?Other>>$/, q{Don't match unrelated <?Other>} );
...
ok(not "\c[NULL]" ~~ m/^<-<?Cc>>$/, q{Don't match externally inverted <?Cc> (Control)} );
ok(not "\c[NULL]" ~~ m/^<[A]-<?Cc>>$/, q{Don't match compound inverted <?Cc> (Control)} );
ok(not "\c[NULL]" ~~ m/^<+<-Cc>>$/, q{Don't match internally inverted <?Cc> (Control)} );
ok(not "\c[OGONEK]"  ~~ m/^<+<?Cc>>$/, q{Don't match unrelated <?Cc> (Control)} );
...
ok(not "\x[0358]" ~~ m/^<+<?Cc>>$/, q{Don't match related <?Cc> (Control)} );
...
ok(not "\c[NULL]" ~~ m/^<-<?Control>>$/, q{Don't match externally inverted <?Control>} );
ok(not "\c[NULL]" ~~ m/^<[A]-<?Control>>$/, q{Don't match compound inverted <?Control>} );
ok(not "\c[NULL]" ~~ m/^<+<-Control>>$/, q{Don't match internally inverted <?Control>} );
ok(not "\x[4A20]"  ~~ m/^<+<?Control>>$/, q{Don't match unrelated <?Control>} );
...
ok(not "\c[SOFT HYPHEN]" ~~ m/^<-<?Cf>>$/, q{Don't match externally inverted <?Cf> (Format)} );
ok(not "\c[SOFT HYPHEN]" ~~ m/^<[A]-<?Cf>>$/, q{Don't match compound inverted <?Cf> (Format)} );
ok(not "\c[SOFT HYPHEN]" ~~ m/^<+<-Cf>>$/, q{Don't match internally inverted <?Cf> (Format)} );
ok(not "\x[AECE]"  ~~ m/^<+<?Cf>>$/, q{Don't match unrelated <?Cf> (Format)} );
...
ok(not "\x[D7A4]" ~~ m/^<+<?Cf>>$/, q{Don't match related <?Cf> (Format)} );
...
ok(not "\c[SOFT HYPHEN]" ~~ m/^<-<?Format>>$/, q{Don't match externally inverted <?Format>} );
ok(not "\c[SOFT HYPHEN]" ~~ m/^<[A]-<?Format>>$/, q{Don't match compound inverted <?Format>} );
ok(not "\c[SOFT HYPHEN]" ~~ m/^<+<-Format>>$/, q{Don't match internally inverted <?Format>} );
ok(not "\x[5382]"  ~~ m/^<+<?Format>>$/, q{Don't match unrelated <?Format>} );
...
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<-<?BidiL>>$/, q{Don't match externally inverted (Left-to-Right)} );
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<[A]-<?BidiL>>$/, q{Don't match compound inverted (Left-to-Right)} );
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<+<-BidiL>>$/, q{Don't match internally inverted (Left-to-Right)} );
ok(not "\x[5BF5]"  ~~ m/^<+<?BidiL>>$/, q{Don't match unrelated (Left-to-Right)} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<-<?BidiEN>>$/, q{Don't match externally inverted (European Number)} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<[A]-<?BidiEN>>$/, q{Don't match compound inverted (European Number)} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<+<-BidiEN>>$/, q{Don't match internally inverted (European Number)} );
ok(not "\x[5596]"  ~~ m/^<+<?BidiEN>>$/, q{Don't match unrelated (European Number)} );
...
ok(not "\c[SOLIDUS]" ~~ m/^<-<?BidiES>>$/, q{Don't match externally inverted (European Number Separator)} );
ok(not "\c[SOLIDUS]" ~~ m/^<[A]-<?BidiES>>$/, q{Don't match compound inverted (European Number Separator)} );
ok(not "\c[SOLIDUS]" ~~ m/^<+<-BidiES>>$/, q{Don't match internally inverted (European Number Separator)} );
ok(not "\x[85D3]"  ~~ m/^<+<?BidiES>>$/, q{Don't match unrelated (European Number Separator)} );
...
ok(not "\c[NUMBER SIGN]" ~~ m/^<-<?BidiET>>$/, q{Don't match externally inverted (European Number Terminator)} );
ok(not "\c[NUMBER SIGN]" ~~ m/^<[A]-<?BidiET>>$/, q{Don't match compound inverted (European Number Terminator)} );
ok(not "\c[NUMBER SIGN]" ~~ m/^<+<-BidiET>>$/, q{Don't match internally inverted (European Number Terminator)} );
ok(not "\x[9AFC]"  ~~ m/^<+<?BidiET>>$/, q{Don't match unrelated (European Number Terminator)} );
...
ok(not "\c[FORM FEED (FF)]" ~~ m/^<-<?BidiWS>>$/, q{Don't match externally inverted (Whitespace)} );
ok(not "\c[FORM FEED (FF)]" ~~ m/^<[A]-<?BidiWS>>$/, q{Don't match compound inverted (Whitespace)} );
ok(not "\c[FORM FEED (FF)]" ~~ m/^<+<-BidiWS>>$/, q{Don't match internally inverted (Whitespace)} );
ok(not "\x[4441]"  ~~ m/^<+<?BidiWS>>$/, q{Don't match unrelated (Whitespace)} );
...
ok(not "\c[ARABIC LETTER HAMZA]" ~~ m/^<-<?Arabic>>$/, q{Don't match externally inverted <?Arabic>} );
ok(not "\c[ARABIC LETTER HAMZA]" ~~ m/^<[A]-<?Arabic>>$/, q{Don't match compound inverted <?Arabic>} );
ok(not "\c[ARABIC LETTER HAMZA]" ~~ m/^<+<-Arabic>>$/, q{Don't match internally inverted <?Arabic>} );
ok(not "\c[YI SYLLABLE RYRX]"  ~~ m/^<+<?Arabic>>$/, q{Don't match unrelated <?Arabic>} );
...
ok(not "\c[ARMENIAN CAPITAL LETTER AYB]" ~~ m/^<-<?Armenian>>$/, q{Don't match externally inverted <?Armenian>} );
ok(not "\c[ARMENIAN CAPITAL LETTER AYB]" ~~ m/^<[A]-<?Armenian>>$/, q{Don't match compound inverted <?Armenian>} );
ok(not "\c[ARMENIAN CAPITAL LETTER AYB]" ~~ m/^<+<-Armenian>>$/, q{Don't match internally inverted <?Armenian>} );
ok(not "\x[B2ED]"  ~~ m/^<+<?Armenian>>$/, q{Don't match unrelated <?Armenian>} );
...
ok(not "\c[BENGALI SIGN CANDRABINDU]" ~~ m/^<-<?Bengali>>$/, q{Don't match externally inverted <?Bengali>} );
ok(not "\c[BENGALI SIGN CANDRABINDU]" ~~ m/^<[A]-<?Bengali>>$/, q{Don't match compound inverted <?Bengali>} );
ok(not "\c[BENGALI SIGN CANDRABINDU]" ~~ m/^<+<-Bengali>>$/, q{Don't match internally inverted <?Bengali>} );
ok(not "\x[4AFD]"  ~~ m/^<+<?Bengali>>$/, q{Don't match unrelated <?Bengali>} );
...
ok(not "\c[BOPOMOFO LETTER B]" ~~ m/^<-<?Bopomofo>>$/, q{Don't match externally inverted <?Bopomofo>} );
ok(not "\c[BOPOMOFO LETTER B]" ~~ m/^<[A]-<?Bopomofo>>$/, q{Don't match compound inverted <?Bopomofo>} );
ok(not "\c[BOPOMOFO LETTER B]" ~~ m/^<+<-Bopomofo>>$/, q{Don't match internally inverted <?Bopomofo>} );
ok(not "\x[8369]"  ~~ m/^<+<?Bopomofo>>$/, q{Don't match unrelated <?Bopomofo>} );
...
ok(not "\c[BUHID LETTER A]" ~~ m/^<-<?Buhid>>$/, q{Don't match externally inverted <?Buhid>} );
ok(not "\c[BUHID LETTER A]" ~~ m/^<[A]-<?Buhid>>$/, q{Don't match compound inverted <?Buhid>} );
ok(not "\c[BUHID LETTER A]" ~~ m/^<+<-Buhid>>$/, q{Don't match internally inverted <?Buhid>} );
ok(not "\x[877F]"  ~~ m/^<+<?Buhid>>$/, q{Don't match unrelated <?Buhid>} );
...
ok(not "\c[CANADIAN SYLLABICS E]" ~~ m/^<-<?CanadianAboriginal>>$/, q{Don't match externally inverted <?CanadianAboriginal>} );
ok(not "\c[CANADIAN SYLLABICS E]" ~~ m/^<[A]-<?CanadianAboriginal>>$/, q{Don't match compound inverted <?CanadianAboriginal>} );
ok(not "\c[CANADIAN SYLLABICS E]" ~~ m/^<+<-CanadianAboriginal>>$/, q{Don't match internally inverted <?CanadianAboriginal>} );
ok(not "\x[3A42]"  ~~ m/^<+<?CanadianAboriginal>>$/, q{Don't match unrelated <?CanadianAboriginal>} );
...
ok(not "\x[4DB6]" ~~ m/^<+<?CanadianAboriginal>>$/, q{Don't match related <?CanadianAboriginal>} );
...
ok(not "\c[CHEROKEE LETTER A]" ~~ m/^<-<?Cherokee>>$/, q{Don't match externally inverted <?Cherokee>} );
ok(not "\c[CHEROKEE LETTER A]" ~~ m/^<[A]-<?Cherokee>>$/, q{Don't match compound inverted <?Cherokee>} );
ok(not "\c[CHEROKEE LETTER A]" ~~ m/^<+<-Cherokee>>$/, q{Don't match internally inverted <?Cherokee>} );
ok(not "\x[A9EF]"  ~~ m/^<+<?Cherokee>>$/, q{Don't match unrelated <?Cherokee>} );
...
ok(not "\x[A9EF]" ~~ m/^<+<?Cherokee>>$/, q{Don't match related <?Cherokee>} );
...
ok(not "\c[CYRILLIC LETTER SMALL CAPITAL EL]" ~~ m/^<-<?Cyrillic>>$/, q{Don't match externally inverted <?Cyrillic>} );
ok(not "\c[CYRILLIC LETTER SMALL CAPITAL EL]" ~~ m/^<[A]-<?Cyrillic>>$/, q{Don't match compound inverted <?Cyrillic>} );
ok(not "\c[CYRILLIC LETTER SMALL CAPITAL EL]" ~~ m/^<+<-Cyrillic>>$/, q{Don't match internally inverted <?Cyrillic>} );
ok(not "\x[07EF]"  ~~ m/^<+<?Cyrillic>>$/, q{Don't match unrelated <?Cyrillic>} );
...
ok(not "\x[07EF]" ~~ m/^<+<?Cyrillic>>$/, q{Don't match related <?Cyrillic>} );
...
ok(not "\x[65BD]"  ~~ m/^<+<?Deseret>>$/, q{Don't match unrelated <?Deseret>} );
...
ok(not "\c[DEVANAGARI SIGN CANDRABINDU]" ~~ m/^<-<?Devanagari>>$/, q{Don't match externally inverted <?Devanagari>} );
ok(not "\c[DEVANAGARI SIGN CANDRABINDU]" ~~ m/^<[A]-<?Devanagari>>$/, q{Don't match compound inverted <?Devanagari>} );
ok(not "\c[DEVANAGARI SIGN CANDRABINDU]" ~~ m/^<+<-Devanagari>>$/, q{Don't match internally inverted <?Devanagari>} );
ok(not "\x[653B]"  ~~ m/^<+<?Devanagari>>$/, q{Don't match unrelated <?Devanagari>} );
...
ok(not "\c[ETHIOPIC SYLLABLE HA]" ~~ m/^<-<?Ethiopic>>$/, q{Don't match externally inverted <?Ethiopic>} );
ok(not "\c[ETHIOPIC SYLLABLE HA]" ~~ m/^<[A]-<?Ethiopic>>$/, q{Don't match compound inverted <?Ethiopic>} );
ok(not "\c[ETHIOPIC SYLLABLE HA]" ~~ m/^<+<-Ethiopic>>$/, q{Don't match internally inverted <?Ethiopic>} );
ok(not "\x[482C]"  ~~ m/^<+<?Ethiopic>>$/, q{Don't match unrelated <?Ethiopic>} );
...
ok(not "\c[GEORGIAN CAPITAL LETTER AN]" ~~ m/^<-<?Georgian>>$/, q{Don't match externally inverted <?Georgian>} );
ok(not "\c[GEORGIAN CAPITAL LETTER AN]" ~~ m/^<[A]-<?Georgian>>$/, q{Don't match compound inverted <?Georgian>} );
ok(not "\c[GEORGIAN CAPITAL LETTER AN]" ~~ m/^<+<-Georgian>>$/, q{Don't match internally inverted <?Georgian>} );
ok(not "\x[9BE5]"  ~~ m/^<+<?Georgian>>$/, q{Don't match unrelated <?Georgian>} );
...
ok(not "\x[4ED2]"  ~~ m/^<+<?Gothic>>$/, q{Don't match unrelated <?Gothic>} );
...
ok(not "\c[MICRO SIGN]" ~~ m/^<-<?Greek>>$/, q{Don't match externally inverted <?Greek>} );
ok(not "\c[MICRO SIGN]" ~~ m/^<[A]-<?Greek>>$/, q{Don't match compound inverted <?Greek>} );
ok(not "\c[MICRO SIGN]" ~~ m/^<+<-Greek>>$/, q{Don't match internally inverted <?Greek>} );
ok(not "\x[D486]"  ~~ m/^<+<?Greek>>$/, q{Don't match unrelated <?Greek>} );
...
ok(not "\c[GUJARATI SIGN CANDRABINDU]" ~~ m/^<-<?Gujarati>>$/, q{Don't match externally inverted <?Gujarati>} );
ok(not "\c[GUJARATI SIGN CANDRABINDU]" ~~ m/^<[A]-<?Gujarati>>$/, q{Don't match compound inverted <?Gujarati>} );
ok(not "\c[GUJARATI SIGN CANDRABINDU]" ~~ m/^<+<-Gujarati>>$/, q{Don't match internally inverted <?Gujarati>} );
ok(not "\x[B3F3]"  ~~ m/^<+<?Gujarati>>$/, q{Don't match unrelated <?Gujarati>} );
...
ok(not "\c[GURMUKHI SIGN BINDI]" ~~ m/^<-<?Gurmukhi>>$/, q{Don't match externally inverted <?Gurmukhi>} );
ok(not "\c[GURMUKHI SIGN BINDI]" ~~ m/^<[A]-<?Gurmukhi>>$/, q{Don't match compound inverted <?Gurmukhi>} );
ok(not "\c[GURMUKHI SIGN BINDI]" ~~ m/^<+<-Gurmukhi>>$/, q{Don't match internally inverted <?Gurmukhi>} );
ok(not "\x[6469]"  ~~ m/^<+<?Gurmukhi>>$/, q{Don't match unrelated <?Gurmukhi>} );
...
ok(not "\x[9DB5]" ~~ m/^<-<?Han>>$/, q{Don't match externally inverted <?Han>} );
ok(not "\x[9DB5]" ~~ m/^<[A]-<?Han>>$/, q{Don't match compound inverted <?Han>} );
ok(not "\x[9DB5]" ~~ m/^<+<-Han>>$/, q{Don't match internally inverted <?Han>} );
ok(not "\x[9FA6]"  ~~ m/^<+<?Han>>$/, q{Don't match unrelated <?Han>} );
...
ok(not "\x[AC00]" ~~ m/^<-<?Hangul>>$/, q{Don't match externally inverted <?Hangul>} );
ok(not "\x[AC00]" ~~ m/^<[A]-<?Hangul>>$/, q{Don't match compound inverted <?Hangul>} );
ok(not "\x[AC00]" ~~ m/^<+<-Hangul>>$/, q{Don't match internally inverted <?Hangul>} );
ok(not "\x[9E09]"  ~~ m/^<+<?Hangul>>$/, q{Don't match unrelated <?Hangul>} );
...
ok(not "\c[HANUNOO LETTER A]" ~~ m/^<-<?Hanunoo>>$/, q{Don't match externally inverted <?Hanunoo>} );
ok(not "\c[HANUNOO LETTER A]" ~~ m/^<[A]-<?Hanunoo>>$/, q{Don't match compound inverted <?Hanunoo>} );
ok(not "\c[HANUNOO LETTER A]" ~~ m/^<+<-Hanunoo>>$/, q{Don't match internally inverted <?Hanunoo>} );
ok(not "\x[580B]"  ~~ m/^<+<?Hanunoo>>$/, q{Don't match unrelated <?Hanunoo>} );
...
ok(not "\c[HEBREW LETTER ALEF]" ~~ m/^<-<?Hebrew>>$/, q{Don't match externally inverted <?Hebrew>} );
ok(not "\c[HEBREW LETTER ALEF]" ~~ m/^<[A]-<?Hebrew>>$/, q{Don't match compound inverted <?Hebrew>} );
ok(not "\c[HEBREW LETTER ALEF]" ~~ m/^<+<-Hebrew>>$/, q{Don't match internally inverted <?Hebrew>} );
ok(not "\x[62B4]"  ~~ m/^<+<?Hebrew>>$/, q{Don't match unrelated <?Hebrew>} );
...
ok(not "\c[HIRAGANA LETTER SMALL A]" ~~ m/^<-<?Hiragana>>$/, q{Don't match externally inverted <?Hiragana>} );
ok(not "\c[HIRAGANA LETTER SMALL A]" ~~ m/^<[A]-<?Hiragana>>$/, q{Don't match compound inverted <?Hiragana>} );
ok(not "\c[HIRAGANA LETTER SMALL A]" ~~ m/^<+<-Hiragana>>$/, q{Don't match internally inverted <?Hiragana>} );
ok(not "\x[9504]"  ~~ m/^<+<?Hiragana>>$/, q{Don't match unrelated <?Hiragana>} );
...
ok(not "\c[MONGOLIAN FREE VARIATION SELECTOR ONE]" ~~ m/^<-<?Inherited>>$/, q{Don't match externally inverted <?Inherited>} );
ok(not "\c[MONGOLIAN FREE VARIATION SELECTOR ONE]" ~~ m/^<[A]-<?Inherited>>$/, q{Don't match compound inverted <?Inherited>} );
ok(not "\c[MONGOLIAN FREE VARIATION SELECTOR ONE]" ~~ m/^<+<-Inherited>>$/, q{Don't match internally inverted <?Inherited>} );
ok(not "\c[TAMIL LETTER RRA]"  ~~ m/^<+<?Inherited>>$/, q{Don't match unrelated <?Inherited>} );
...
ok(not "\c[KANNADA SIGN ANUSVARA]" ~~ m/^<-<?Kannada>>$/, q{Don't match externally inverted <?Kannada>} );
ok(not "\c[KANNADA SIGN ANUSVARA]" ~~ m/^<[A]-<?Kannada>>$/, q{Don't match compound inverted <?Kannada>} );
ok(not "\c[KANNADA SIGN ANUSVARA]" ~~ m/^<+<-Kannada>>$/, q{Don't match internally inverted <?Kannada>} );
ok(not "\c[BLACK RIGHT-POINTING SMALL TRIANGLE]"  ~~ m/^<+<?Kannada>>$/, q{Don't match unrelated <?Kannada>} );
...
ok(not "\c[KATAKANA LETTER SMALL A]" ~~ m/^<-<?Katakana>>$/, q{Don't match externally inverted <?Katakana>} );
ok(not "\c[KATAKANA LETTER SMALL A]" ~~ m/^<[A]-<?Katakana>>$/, q{Don't match compound inverted <?Katakana>} );
ok(not "\c[KATAKANA LETTER SMALL A]" ~~ m/^<+<-Katakana>>$/, q{Don't match internally inverted <?Katakana>} );
ok(not "\x[40DB]"  ~~ m/^<+<?Katakana>>$/, q{Don't match unrelated <?Katakana>} );
...
ok(not "\c[KHMER LETTER KA]" ~~ m/^<-<?Khmer>>$/, q{Don't match externally inverted <?Khmer>} );
ok(not "\c[KHMER LETTER KA]" ~~ m/^<[A]-<?Khmer>>$/, q{Don't match compound inverted <?Khmer>} );
ok(not "\c[KHMER LETTER KA]" ~~ m/^<+<-Khmer>>$/, q{Don't match internally inverted <?Khmer>} );
ok(not "\x[AC3E]"  ~~ m/^<+<?Khmer>>$/, q{Don't match unrelated <?Khmer>} );
...
ok(not "\c[LAO LETTER KO]" ~~ m/^<-<?Lao>>$/, q{Don't match externally inverted <?Lao>} );
ok(not "\c[LAO LETTER KO]" ~~ m/^<[A]-<?Lao>>$/, q{Don't match compound inverted <?Lao>} );
ok(not "\c[LAO LETTER KO]" ~~ m/^<+<-Lao>>$/, q{Don't match internally inverted <?Lao>} );
ok(not "\c[MODIFIER LETTER UNASPIRATED]"  ~~ m/^<+<?Lao>>$/, q{Don't match unrelated <?Lao>} );
...
ok(not "\c[MODIFIER LETTER DOUBLE APOSTROPHE]" ~~ m/^<+<?Lao>>$/, q{Don't match related <?Lao>} );
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<-<?Latin>>$/, q{Don't match externally inverted <?Latin>} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<[A]-<?Latin>>$/, q{Don't match compound inverted <?Latin>} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<+<-Latin>>$/, q{Don't match internally inverted <?Latin>} );
ok(not "\x[6B4C]"  ~~ m/^<+<?Latin>>$/, q{Don't match unrelated <?Latin>} );
...
ok(not "\x[6B4C]" ~~ m/^<+<?Latin>>$/, q{Don't match related <?Latin>} );
...
ok(not "\c[MALAYALAM LETTER TA]" ~~ m/^<-<?Malayalam>>$/, q{Don't match externally inverted <?Malayalam>} );
ok(not "\c[MALAYALAM LETTER TA]" ~~ m/^<[A]-<?Malayalam>>$/, q{Don't match compound inverted <?Malayalam>} );
ok(not "\c[MALAYALAM LETTER TA]" ~~ m/^<+<-Malayalam>>$/, q{Don't match internally inverted <?Malayalam>} );
ok(not "\x[0D29]"  ~~ m/^<+<?Malayalam>>$/, q{Don't match unrelated <?Malayalam>} );
...
ok(not "\c[SINHALA SIGN ANUSVARAYA]" ~~ m/^<+<?Malayalam>>$/, q{Don't match related <?Malayalam>} );
...
ok(not "\c[MONGOLIAN DIGIT ZERO]" ~~ m/^<-<?Mongolian>>$/, q{Don't match externally inverted <?Mongolian>} );
ok(not "\c[MONGOLIAN DIGIT ZERO]" ~~ m/^<[A]-<?Mongolian>>$/, q{Don't match compound inverted <?Mongolian>} );
ok(not "\c[MONGOLIAN DIGIT ZERO]" ~~ m/^<+<-Mongolian>>$/, q{Don't match internally inverted <?Mongolian>} );
ok(not "\x[70C0]"  ~~ m/^<+<?Mongolian>>$/, q{Don't match unrelated <?Mongolian>} );
...
ok(not "\c[MYANMAR LETTER KA]" ~~ m/^<-<?Myanmar>>$/, q{Don't match externally inverted <?Myanmar>} );
ok(not "\c[MYANMAR LETTER KA]" ~~ m/^<[A]-<?Myanmar>>$/, q{Don't match compound inverted <?Myanmar>} );
ok(not "\c[MYANMAR LETTER KA]" ~~ m/^<+<-Myanmar>>$/, q{Don't match internally inverted <?Myanmar>} );
ok(not "\x[3CE3]"  ~~ m/^<+<?Myanmar>>$/, q{Don't match unrelated <?Myanmar>} );
...
ok(not "\c[OGHAM LETTER BEITH]" ~~ m/^<-<?Ogham>>$/, q{Don't match externally inverted <?Ogham>} );
ok(not "\c[OGHAM LETTER BEITH]" ~~ m/^<[A]-<?Ogham>>$/, q{Don't match compound inverted <?Ogham>} );
ok(not "\c[OGHAM LETTER BEITH]" ~~ m/^<+<-Ogham>>$/, q{Don't match internally inverted <?Ogham>} );
ok(not "\x[077B]"  ~~ m/^<+<?Ogham>>$/, q{Don't match unrelated <?Ogham>} );
...
ok(not "\x[562B]"  ~~ m/^<+<?OldItalic>>$/, q{Don't match unrelated <?OldItalic>} );
...
ok(not "\c[ORIYA SIGN CANDRABINDU]" ~~ m/^<-<?Oriya>>$/, q{Don't match externally inverted <?Oriya>} );
ok(not "\c[ORIYA SIGN CANDRABINDU]" ~~ m/^<[A]-<?Oriya>>$/, q{Don't match compound inverted <?Oriya>} );
ok(not "\c[ORIYA SIGN CANDRABINDU]" ~~ m/^<+<-Oriya>>$/, q{Don't match internally inverted <?Oriya>} );
ok(not "\x[3CE7]"  ~~ m/^<+<?Oriya>>$/, q{Don't match unrelated <?Oriya>} );
...
ok(not "\c[RUNIC LETTER FEHU FEOH FE F]" ~~ m/^<-<?Runic>>$/, q{Don't match externally inverted <?Runic>} );
ok(not "\c[RUNIC LETTER FEHU FEOH FE F]" ~~ m/^<[A]-<?Runic>>$/, q{Don't match compound inverted <?Runic>} );
ok(not "\c[RUNIC LETTER FEHU FEOH FE F]" ~~ m/^<+<-Runic>>$/, q{Don't match internally inverted <?Runic>} );
ok(not "\c[BLACK HEART SUIT]"  ~~ m/^<+<?Runic>>$/, q{Don't match unrelated <?Runic>} );
...
ok(not "\c[SINHALA SIGN ANUSVARAYA]" ~~ m/^<-<?Sinhala>>$/, q{Don't match externally inverted <?Sinhala>} );
ok(not "\c[SINHALA SIGN ANUSVARAYA]" ~~ m/^<[A]-<?Sinhala>>$/, q{Don't match compound inverted <?Sinhala>} );
ok(not "\c[SINHALA SIGN ANUSVARAYA]" ~~ m/^<+<-Sinhala>>$/, q{Don't match internally inverted <?Sinhala>} );
ok(not "\c[MYANMAR VOWEL SIGN II]"  ~~ m/^<+<?Sinhala>>$/, q{Don't match unrelated <?Sinhala>} );
...
ok(not "\c[KHMER CURRENCY SYMBOL RIEL]" ~~ m/^<+<?Sinhala>>$/, q{Don't match related <?Sinhala>} );
...
ok(not "\c[SYRIAC LETTER ALAPH]" ~~ m/^<-<?Syriac>>$/, q{Don't match externally inverted <?Syriac>} );
ok(not "\c[SYRIAC LETTER ALAPH]" ~~ m/^<[A]-<?Syriac>>$/, q{Don't match compound inverted <?Syriac>} );
ok(not "\c[SYRIAC LETTER ALAPH]" ~~ m/^<+<-Syriac>>$/, q{Don't match internally inverted <?Syriac>} );
ok(not "\x[7BAA]"  ~~ m/^<+<?Syriac>>$/, q{Don't match unrelated <?Syriac>} );
...
ok(not "\c[TAGALOG LETTER A]" ~~ m/^<-<?Tagalog>>$/, q{Don't match externally inverted <?Tagalog>} );
ok(not "\c[TAGALOG LETTER A]" ~~ m/^<[A]-<?Tagalog>>$/, q{Don't match compound inverted <?Tagalog>} );
ok(not "\c[TAGALOG LETTER A]" ~~ m/^<+<-Tagalog>>$/, q{Don't match internally inverted <?Tagalog>} );
ok(not "\x[50F2]"  ~~ m/^<+<?Tagalog>>$/, q{Don't match unrelated <?Tagalog>} );
...
ok(not "\c[TAGBANWA LETTER A]" ~~ m/^<-<?Tagbanwa>>$/, q{Don't match externally inverted <?Tagbanwa>} );
ok(not "\c[TAGBANWA LETTER A]" ~~ m/^<[A]-<?Tagbanwa>>$/, q{Don't match compound inverted <?Tagbanwa>} );
ok(not "\c[TAGBANWA LETTER A]" ~~ m/^<+<-Tagbanwa>>$/, q{Don't match internally inverted <?Tagbanwa>} );
ok(not "\x[8843]"  ~~ m/^<+<?Tagbanwa>>$/, q{Don't match unrelated <?Tagbanwa>} );
...
ok(not "\c[TAMIL SIGN ANUSVARA]" ~~ m/^<-<?Tamil>>$/, q{Don't match externally inverted <?Tamil>} );
ok(not "\c[TAMIL SIGN ANUSVARA]" ~~ m/^<[A]-<?Tamil>>$/, q{Don't match compound inverted <?Tamil>} );
ok(not "\c[TAMIL SIGN ANUSVARA]" ~~ m/^<+<-Tamil>>$/, q{Don't match internally inverted <?Tamil>} );
ok(not "\x[76C0]"  ~~ m/^<+<?Tamil>>$/, q{Don't match unrelated <?Tamil>} );
...
ok(not "\c[TELUGU SIGN CANDRABINDU]" ~~ m/^<-<?Telugu>>$/, q{Don't match externally inverted <?Telugu>} );
ok(not "\c[TELUGU SIGN CANDRABINDU]" ~~ m/^<[A]-<?Telugu>>$/, q{Don't match compound inverted <?Telugu>} );
ok(not "\c[TELUGU SIGN CANDRABINDU]" ~~ m/^<+<-Telugu>>$/, q{Don't match internally inverted <?Telugu>} );
ok(not "\x[60BD]"  ~~ m/^<+<?Telugu>>$/, q{Don't match unrelated <?Telugu>} );
...
ok(not "\c[THAANA LETTER HAA]" ~~ m/^<-<?Thaana>>$/, q{Don't match externally inverted <?Thaana>} );
ok(not "\c[THAANA LETTER HAA]" ~~ m/^<[A]-<?Thaana>>$/, q{Don't match compound inverted <?Thaana>} );
ok(not "\c[THAANA LETTER HAA]" ~~ m/^<+<-Thaana>>$/, q{Don't match internally inverted <?Thaana>} );
ok(not "\x[2E74]"  ~~ m/^<+<?Thaana>>$/, q{Don't match unrelated <?Thaana>} );
...
ok(not "\c[THAI CHARACTER KO KAI]" ~~ m/^<-<?Thai>>$/, q{Don't match externally inverted <?Thai>} );
ok(not "\c[THAI CHARACTER KO KAI]" ~~ m/^<[A]-<?Thai>>$/, q{Don't match compound inverted <?Thai>} );
ok(not "\c[THAI CHARACTER KO KAI]" ~~ m/^<+<-Thai>>$/, q{Don't match internally inverted <?Thai>} );
ok(not "\x[A929]"  ~~ m/^<+<?Thai>>$/, q{Don't match unrelated <?Thai>} );
...
ok(not "\c[TIBETAN SYLLABLE OM]" ~~ m/^<-<?Tibetan>>$/, q{Don't match externally inverted <?Tibetan>} );
ok(not "\c[TIBETAN SYLLABLE OM]" ~~ m/^<[A]-<?Tibetan>>$/, q{Don't match compound inverted <?Tibetan>} );
ok(not "\c[TIBETAN SYLLABLE OM]" ~~ m/^<+<-Tibetan>>$/, q{Don't match internally inverted <?Tibetan>} );
ok(not "\x[19C9]"  ~~ m/^<+<?Tibetan>>$/, q{Don't match unrelated <?Tibetan>} );
...
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<-<?Yi>>$/, q{Don't match externally inverted <?Yi>} );
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<[A]-<?Yi>>$/, q{Don't match compound inverted <?Yi>} );
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<+<-Yi>>$/, q{Don't match internally inverted <?Yi>} );
ok(not "\x[3A38]"  ~~ m/^<+<?Yi>>$/, q{Don't match unrelated <?Yi>} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<-<?ASCIIHexDigit>>$/, q{Don't match externally inverted <?ASCIIHexDigit>} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<[A]-<?ASCIIHexDigit>>$/, q{Don't match compound inverted <?ASCIIHexDigit>} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<+<-ASCIIHexDigit>>$/, q{Don't match internally inverted <?ASCIIHexDigit>} );
ok(not "\x[55D7]"  ~~ m/^<+<?ASCIIHexDigit>>$/, q{Don't match unrelated <?ASCIIHexDigit>} );
...
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<-<?Dash>>$/, q{Don't match externally inverted <?Dash>} );
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<[A]-<?Dash>>$/, q{Don't match compound inverted <?Dash>} );
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<+<-Dash>>$/, q{Don't match internally inverted <?Dash>} );
ok(not "\x[4C7F]"  ~~ m/^<+<?Dash>>$/, q{Don't match unrelated <?Dash>} );
...
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<-<?Diacritic>>$/, q{Don't match externally inverted <?Diacritic>} );
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<[A]-<?Diacritic>>$/, q{Don't match compound inverted <?Diacritic>} );
ok(not "\c[CIRCUMFLEX ACCENT]" ~~ m/^<+<-Diacritic>>$/, q{Don't match internally inverted <?Diacritic>} );
ok(not "\x[398E]"  ~~ m/^<+<?Diacritic>>$/, q{Don't match unrelated <?Diacritic>} );
...
ok(not "\c[MIDDLE DOT]" ~~ m/^<-<?Extender>>$/, q{Don't match externally inverted <?Extender>} );
ok(not "\c[MIDDLE DOT]" ~~ m/^<[A]-<?Extender>>$/, q{Don't match compound inverted <?Extender>} );
ok(not "\c[MIDDLE DOT]" ~~ m/^<+<-Extender>>$/, q{Don't match internally inverted <?Extender>} );
ok(not "\x[3F66]"  ~~ m/^<+<?Extender>>$/, q{Don't match unrelated <?Extender>} );
...
ok(not "\c[COMBINING GRAPHEME JOINER]" ~~ m/^<-<?GraphemeLink>>$/, q{Don't match externally inverted <?GraphemeLink>} );
ok(not "\c[COMBINING GRAPHEME JOINER]" ~~ m/^<[A]-<?GraphemeLink>>$/, q{Don't match compound inverted <?GraphemeLink>} );
ok(not "\c[COMBINING GRAPHEME JOINER]" ~~ m/^<+<-GraphemeLink>>$/, q{Don't match internally inverted <?GraphemeLink>} );
ok(not "\x[34DA]"  ~~ m/^<+<?GraphemeLink>>$/, q{Don't match unrelated <?GraphemeLink>} );
...
ok(not "\c[DIGIT ZERO]" ~~ m/^<-<?HexDigit>>$/, q{Don't match externally inverted <?HexDigit>} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<[A]-<?HexDigit>>$/, q{Don't match compound inverted <?HexDigit>} );
ok(not "\c[DIGIT ZERO]" ~~ m/^<+<-HexDigit>>$/, q{Don't match internally inverted <?HexDigit>} );
ok(not "\x[D446]"  ~~ m/^<+<?HexDigit>>$/, q{Don't match unrelated <?HexDigit>} );
...
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<-<?Hyphen>>$/, q{Don't match externally inverted <?Hyphen>} );
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<[A]-<?Hyphen>>$/, q{Don't match compound inverted <?Hyphen>} );
ok(not "\c[HYPHEN-MINUS]" ~~ m/^<+<-Hyphen>>$/, q{Don't match internally inverted <?Hyphen>} );
ok(not "\c[YI SYLLABLE WOX]"  ~~ m/^<+<?Hyphen>>$/, q{Don't match unrelated <?Hyphen>} );
...
ok(not "\c[IDEOGRAPHIC CLOSING MARK]" ~~ m/^<-<?Ideographic>>$/, q{Don't match externally inverted <?Ideographic>} );
ok(not "\c[IDEOGRAPHIC CLOSING MARK]" ~~ m/^<[A]-<?Ideographic>>$/, q{Don't match compound inverted <?Ideographic>} );
ok(not "\c[IDEOGRAPHIC CLOSING MARK]" ~~ m/^<+<-Ideographic>>$/, q{Don't match internally inverted <?Ideographic>} );
ok(not "\x[CB86]"  ~~ m/^<+<?Ideographic>>$/, q{Don't match unrelated <?Ideographic>} );
...
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO RIGHT]" ~~ m/^<-<?IDSBinaryOperator>>$/, q{Don't match externally inverted <?IDSBinaryOperator>} );
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO RIGHT]" ~~ m/^<[A]-<?IDSBinaryOperator>>$/, q{Don't match compound inverted <?IDSBinaryOperator>} );
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO RIGHT]" ~~ m/^<+<-IDSBinaryOperator>>$/, q{Don't match internally inverted <?IDSBinaryOperator>} );
ok(not "\x[54A0]"  ~~ m/^<+<?IDSBinaryOperator>>$/, q{Don't match unrelated <?IDSBinaryOperator>} );
...
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO MIDDLE AND RIGHT]" ~~ m/^<-<?IDSTrinaryOperator>>$/, q{Don't match externally inverted <?IDSTrinaryOperator>} );
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO MIDDLE AND RIGHT]" ~~ m/^<[A]-<?IDSTrinaryOperator>>$/, q{Don't match compound inverted <?IDSTrinaryOperator>} );
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO MIDDLE AND RIGHT]" ~~ m/^<+<-IDSTrinaryOperator>>$/, q{Don't match internally inverted <?IDSTrinaryOperator>} );
ok(not "\x[4900]"  ~~ m/^<+<?IDSTrinaryOperator>>$/, q{Don't match unrelated <?IDSTrinaryOperator>} );
...
ok(not "\c[ZERO WIDTH NON-JOINER]" ~~ m/^<-<?JoinControl>>$/, q{Don't match externally inverted <?JoinControl>} );
ok(not "\c[ZERO WIDTH NON-JOINER]" ~~ m/^<[A]-<?JoinControl>>$/, q{Don't match compound inverted <?JoinControl>} );
ok(not "\c[ZERO WIDTH NON-JOINER]" ~~ m/^<+<-JoinControl>>$/, q{Don't match internally inverted <?JoinControl>} );
ok(not "\c[CYRILLIC CAPITAL LETTER OT]"  ~~ m/^<+<?JoinControl>>$/, q{Don't match unrelated <?JoinControl>} );
...
ok(not "\c[THAI CHARACTER SARA E]" ~~ m/^<-<?LogicalOrderException>>$/, q{Don't match externally inverted <?LogicalOrderException>} );
ok(not "\c[THAI CHARACTER SARA E]" ~~ m/^<[A]-<?LogicalOrderException>>$/, q{Don't match compound inverted <?LogicalOrderException>} );
ok(not "\c[THAI CHARACTER SARA E]" ~~ m/^<+<-LogicalOrderException>>$/, q{Don't match internally inverted <?LogicalOrderException>} );
ok(not "\x[88D2]"  ~~ m/^<+<?LogicalOrderException>>$/, q{Don't match unrelated <?LogicalOrderException>} );
...
ok(not "\x[88D2]" ~~ m/^<+<?LogicalOrderException>>$/, q{Don't match related <?LogicalOrderException>} );
...
ok(not "\c[CIRCLED HANGUL NIEUN A]"  ~~ m/^<+<?NoncharacterCodePoint>>$/, q{Don't match unrelated <?NoncharacterCodePoint>} );
...
ok(not "\c[CIRCLED IDEOGRAPH ONE]" ~~ m/^<+<?NoncharacterCodePoint>>$/, q{Don't match related <?NoncharacterCodePoint>} );
...
ok(not "\c[COMBINING GREEK YPOGEGRAMMENI]" ~~ m/^<-<?OtherAlphabetic>>$/, q{Don't match externally inverted <?OtherAlphabetic>} );
ok(not "\c[COMBINING GREEK YPOGEGRAMMENI]" ~~ m/^<[A]-<?OtherAlphabetic>>$/, q{Don't match compound inverted <?OtherAlphabetic>} );
ok(not "\c[COMBINING GREEK YPOGEGRAMMENI]" ~~ m/^<+<-OtherAlphabetic>>$/, q{Don't match internally inverted <?OtherAlphabetic>} );
ok(not "\x[7B02]"  ~~ m/^<+<?OtherAlphabetic>>$/, q{Don't match unrelated <?OtherAlphabetic>} );
...
ok(not "\c[COMBINING GRAPHEME JOINER]" ~~ m/^<-<?OtherDefaultIgnorableCodePoint>>$/, q{Don't match externally inverted <?OtherDefaultIgnorableCodePoint>} );
ok(not "\c[COMBINING GRAPHEME JOINER]" ~~ m/^<[A]-<?OtherDefaultIgnorableCodePoint>>$/, q{Don't match compound inverted <?OtherDefaultIgnorableCodePoint>} );
ok(not "\c[COMBINING GRAPHEME JOINER]" ~~ m/^<+<-OtherDefaultIgnorableCodePoint>>$/, q{Don't match internally inverted <?OtherDefaultIgnorableCodePoint>} );
ok(not "\x[42DA]"  ~~ m/^<+<?OtherDefaultIgnorableCodePoint>>$/, q{Don't match unrelated <?OtherDefaultIgnorableCodePoint>} );
...
ok(not "\c[BENGALI VOWEL SIGN AA]" ~~ m/^<-<?OtherGraphemeExtend>>$/, q{Don't match externally inverted <?OtherGraphemeExtend>} );
ok(not "\c[BENGALI VOWEL SIGN AA]" ~~ m/^<[A]-<?OtherGraphemeExtend>>$/, q{Don't match compound inverted <?OtherGraphemeExtend>} );
ok(not "\c[BENGALI VOWEL SIGN AA]" ~~ m/^<+<-OtherGraphemeExtend>>$/, q{Don't match internally inverted <?OtherGraphemeExtend>} );
ok(not "\c[TAI LE LETTER KHA]"  ~~ m/^<+<?OtherGraphemeExtend>>$/, q{Don't match unrelated <?OtherGraphemeExtend>} );
...
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<-<?OtherLowercase>>$/, q{Don't match externally inverted <?OtherLowercase>} );
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<[A]-<?OtherLowercase>>$/, q{Don't match compound inverted <?OtherLowercase>} );
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<+<-OtherLowercase>>$/, q{Don't match internally inverted <?OtherLowercase>} );
ok(not "\x[8153]"  ~~ m/^<+<?OtherLowercase>>$/, q{Don't match unrelated <?OtherLowercase>} );
...
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<-<?OtherMath>>$/, q{Don't match externally inverted <?OtherMath>} );
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<[A]-<?OtherMath>>$/, q{Don't match compound inverted <?OtherMath>} );
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<+<-OtherMath>>$/, q{Don't match internally inverted <?OtherMath>} );
ok(not "\x[6D2F]"  ~~ m/^<+<?OtherMath>>$/, q{Don't match unrelated <?OtherMath>} );
...
ok(not "\c[ROMAN NUMERAL ONE]" ~~ m/^<-<?OtherUppercase>>$/, q{Don't match externally inverted <?OtherUppercase>} );
ok(not "\c[ROMAN NUMERAL ONE]" ~~ m/^<[A]-<?OtherUppercase>>$/, q{Don't match compound inverted <?OtherUppercase>} );
ok(not "\c[ROMAN NUMERAL ONE]" ~~ m/^<+<-OtherUppercase>>$/, q{Don't match internally inverted <?OtherUppercase>} );
ok(not "\x[A746]"  ~~ m/^<+<?OtherUppercase>>$/, q{Don't match unrelated <?OtherUppercase>} );
...
ok(not "\c[LEFT SINGLE QUOTATION MARK]" ~~ m/^<-<?QuotationMark>>$/, q{Don't match externally inverted <?QuotationMark>} );
ok(not "\c[LEFT SINGLE QUOTATION MARK]" ~~ m/^<[A]-<?QuotationMark>>$/, q{Don't match compound inverted <?QuotationMark>} );
ok(not "\c[LEFT SINGLE QUOTATION MARK]" ~~ m/^<+<-QuotationMark>>$/, q{Don't match internally inverted <?QuotationMark>} );
ok(not "\c[GURMUKHI VOWEL SIGN AI]"  ~~ m/^<+<?QuotationMark>>$/, q{Don't match unrelated <?QuotationMark>} );
...
ok(not "\c[CJK RADICAL REPEAT]" ~~ m/^<-<?Radical>>$/, q{Don't match externally inverted <?Radical>} );
ok(not "\c[CJK RADICAL REPEAT]" ~~ m/^<[A]-<?Radical>>$/, q{Don't match compound inverted <?Radical>} );
ok(not "\c[CJK RADICAL REPEAT]" ~~ m/^<+<-Radical>>$/, q{Don't match internally inverted <?Radical>} );
ok(not "\c[RUNIC LETTER ETH]"  ~~ m/^<+<?Radical>>$/, q{Don't match unrelated <?Radical>} );
...
ok(not "\c[LATIN SMALL LETTER I WITH TILDE BELOW]" ~~ m/^<-<?SoftDotted>>$/, q{Don't match externally inverted <?SoftDotted>} );
ok(not "\c[LATIN SMALL LETTER I WITH TILDE BELOW]" ~~ m/^<[A]-<?SoftDotted>>$/, q{Don't match compound inverted <?SoftDotted>} );
ok(not "\c[LATIN SMALL LETTER I WITH TILDE BELOW]" ~~ m/^<+<-SoftDotted>>$/, q{Don't match internally inverted <?SoftDotted>} );
ok(not "\c[LATIN CAPITAL LETTER B WITH DOT ABOVE]"  ~~ m/^<+<?SoftDotted>>$/, q{Don't match unrelated <?SoftDotted>} );
...
ok(not "\c[GREEK KORONIS]" ~~ m/^<+<?SoftDotted>>$/, q{Don't match related <?SoftDotted>} );
...
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<-<?TerminalPunctuation>>$/, q{Don't match externally inverted <?TerminalPunctuation>} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<[A]-<?TerminalPunctuation>>$/, q{Don't match compound inverted <?TerminalPunctuation>} );
ok(not "\c[EXCLAMATION MARK]" ~~ m/^<+<-TerminalPunctuation>>$/, q{Don't match internally inverted <?TerminalPunctuation>} );
ok(not "\x[B43A]"  ~~ m/^<+<?TerminalPunctuation>>$/, q{Don't match unrelated <?TerminalPunctuation>} );
...
ok(not "\x[88D8]" ~~ m/^<-<?UnifiedIdeograph>>$/, q{Don't match externally inverted <?UnifiedIdeograph>} );
ok(not "\x[88D8]" ~~ m/^<[A]-<?UnifiedIdeograph>>$/, q{Don't match compound inverted <?UnifiedIdeograph>} );
ok(not "\x[88D8]" ~~ m/^<+<-UnifiedIdeograph>>$/, q{Don't match internally inverted <?UnifiedIdeograph>} );
...
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<-<?WhiteSpace>>$/, q{Don't match externally inverted <?WhiteSpace>} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<[A]-<?WhiteSpace>>$/, q{Don't match compound inverted <?WhiteSpace>} );
ok(not "\c[CHARACTER TABULATION]" ~~ m/^<+<-WhiteSpace>>$/, q{Don't match internally inverted <?WhiteSpace>} );
ok(not "\x[4345]"  ~~ m/^<+<?WhiteSpace>>$/, q{Don't match unrelated <?WhiteSpace>} );
...
ok(not "\x[3816]" ~~ m/^<-<?Alphabetic>>$/, q{Don't match externally inverted (Lu + Ll + Lt + Lm + Lo + OtherAlphabetic)} );
ok(not "\x[3816]" ~~ m/^<[A]-<?Alphabetic>>$/, q{Don't match compound inverted (Lu + Ll + Lt + Lm + Lo + OtherAlphabetic)} );
ok(not "\x[3816]" ~~ m/^<+<-Alphabetic>>$/, q{Don't match internally inverted (Lu + Ll + Lt + Lm + Lo + OtherAlphabetic)} );
ok(not "\x[4DB6]"  ~~ m/^<+<?Alphabetic>>$/, q{Don't match unrelated (Lu + Ll + Lt + Lm + Lo + OtherAlphabetic)} );
...
ok(not "\c[LATIN LETTER SMALL CAPITAL A]" ~~ m/^<-<?Lowercase>>$/, q{Don't match externally inverted (Ll + OtherLowercase)} );
ok(not "\c[LATIN LETTER SMALL CAPITAL A]" ~~ m/^<[A]-<?Lowercase>>$/, q{Don't match compound inverted (Ll + OtherLowercase)} );
ok(not "\c[LATIN LETTER SMALL CAPITAL A]" ~~ m/^<+<-Lowercase>>$/, q{Don't match internally inverted (Ll + OtherLowercase)} );
ok(not "\x[0D3D]"  ~~ m/^<+<?Lowercase>>$/, q{Don't match unrelated (Ll + OtherLowercase)} );
...
ok(not "\c[MALAYALAM LETTER VOCALIC RR]" ~~ m/^<+<?Lowercase>>$/, q{Don't match related (Ll + OtherLowercase)} );
...
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<-<?Uppercase>>$/, q{Don't match externally inverted (Lu + OtherUppercase)} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<[A]-<?Uppercase>>$/, q{Don't match compound inverted (Lu + OtherUppercase)} );
ok(not "\c[LATIN CAPITAL LETTER A]" ~~ m/^<+<-Uppercase>>$/, q{Don't match internally inverted (Lu + OtherUppercase)} );
ok(not "\x[C107]"  ~~ m/^<+<?Uppercase>>$/, q{Don't match unrelated (Lu + OtherUppercase)} );
...
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<-<?Math>>$/, q{Don't match externally inverted (Sm + OtherMath)} );
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<[A]-<?Math>>$/, q{Don't match compound inverted (Sm + OtherMath)} );
ok(not "\c[LEFT PARENTHESIS]" ~~ m/^<+<-Math>>$/, q{Don't match internally inverted (Sm + OtherMath)} );
ok(not "\x[D73F]"  ~~ m/^<+<?Math>>$/, q{Don't match unrelated (Sm + OtherMath)} );
...
ok(not "\x[4E5B]" ~~ m/^<-<?ID_Start>>$/, q{Don't match externally inverted (Lu + Ll + Lt + Lm + Lo + Nl)} );
ok(not "\x[4E5B]" ~~ m/^<[A]-<?ID_Start>>$/, q{Don't match compound inverted (Lu + Ll + Lt + Lm + Lo + Nl)} );
ok(not "\x[4E5B]" ~~ m/^<+<-ID_Start>>$/, q{Don't match internally inverted (Lu + Ll + Lt + Lm + Lo + Nl)} );
ok(not "\x[9FA6]"  ~~ m/^<+<?ID_Start>>$/, q{Don't match unrelated (Lu + Ll + Lt + Lm + Lo + Nl)} );
...
ok(not "\c[IDEOGRAPHIC ITERATION MARK]" ~~ m/^<-<?ID_Continue>>$/, q{Don't match externally inverted (ID_Start + Mn + Mc + Nd + Pc)} );
ok(not "\c[IDEOGRAPHIC ITERATION MARK]" ~~ m/^<[A]-<?ID_Continue>>$/, q{Don't match compound inverted (ID_Start + Mn + Mc + Nd + Pc)} );
ok(not "\c[IDEOGRAPHIC ITERATION MARK]" ~~ m/^<+<-ID_Continue>>$/, q{Don't match internally inverted (ID_Start + Mn + Mc + Nd + Pc)} );
ok(not "\c[APL FUNCTIONAL SYMBOL UP TACK JOT]"  ~~ m/^<+<?ID_Continue>>$/, q{Don't match unrelated (ID_Start + Mn + Mc + Nd + Pc)} );
...
ok(not "\c[SYRIAC LETTER TAW]" ~~ m/^<-<?Any>>$/, q{Don't match externally inverted (Any character)} );
ok(not "\c[SYRIAC LETTER TAW]" ~~ m/^<[A]-<?Any>>$/, q{Don't match compound inverted (Any character)} );
ok(not "\c[SYRIAC LETTER TAW]" ~~ m/^<+<-Any>>$/, q{Don't match internally inverted (Any character)} );
...
ok(not "\x[AC00]" ~~ m/^<-<?Assigned>>$/, q{Don't match externally inverted (Any non-Cn character (i.e. synonym for \P{Cn}))} );
ok(not "\x[AC00]" ~~ m/^<[A]-<?Assigned>>$/, q{Don't match compound inverted (Any non-Cn character (i.e. synonym for \P{Cn}))} );
ok(not "\x[AC00]" ~~ m/^<+<-Assigned>>$/, q{Don't match internally inverted (Any non-Cn character (i.e. synonym for \P{Cn}))} );
ok(not "\x[AB08]"  ~~ m/^<+<?Assigned>>$/, q{Don't match unrelated (Any non-Cn character (i.e. synonym for \P{Cn}))} );
...
ok(not "\x[1738]" ~~ m/^<-<?Unassigned>>$/, q{Don't match externally inverted (Synonym for \p{Cn})} );
ok(not "\x[1738]" ~~ m/^<[A]-<?Unassigned>>$/, q{Don't match compound inverted (Synonym for \p{Cn})} );
ok(not "\x[1738]" ~~ m/^<+<-Unassigned>>$/, q{Don't match internally inverted (Synonym for \p{Cn})} );
ok(not "\c[BUHID LETTER A]"  ~~ m/^<+<?Unassigned>>$/, q{Don't match unrelated (Synonym for \p{Cn})} );
...
ok(not "\c[LEFT RIGHT DOUBLE ARROW WITH VERTICAL STROKE]" ~~ m/^<-<?Common>>$/, q{Don't match externally inverted (Codepoint not explicitly assigned to a script)} );
ok(not "\c[LEFT RIGHT DOUBLE ARROW WITH VERTICAL STROKE]" ~~ m/^<[A]-<?Common>>$/, q{Don't match compound inverted (Codepoint not explicitly assigned to a script)} );
ok(not "\c[LEFT RIGHT DOUBLE ARROW WITH VERTICAL STROKE]" ~~ m/^<+<-Common>>$/, q{Don't match internally inverted (Codepoint not explicitly assigned to a script)} );
ok(not "\c[CJK RADICAL REPEAT]"  ~~ m/^<+<?Common>>$/, q{Don't match unrelated (Codepoint not explicitly assigned to a script)} );
...
ok(not "\c[ARABIC END OF AYAH]" ~~ m/^<+<?Common>>$/, q{Don't match related (Codepoint not explicitly assigned to a script)} );
...
ok(not "\x[5A81]"  ~~ m/^<+<?InAlphabeticPresentationForms>>$/, q{Don't match unrelated <?InAlphabeticPresentationForms>} );
...
ok(not "\c[ARABIC NUMBER SIGN]" ~~ m/^<-<?InArabic>>$/, q{Don't match externally inverted <?InArabic>} );
ok(not "\c[ARABIC NUMBER SIGN]" ~~ m/^<[A]-<?InArabic>>$/, q{Don't match compound inverted <?InArabic>} );
ok(not "\c[ARABIC NUMBER SIGN]" ~~ m/^<+<-InArabic>>$/, q{Don't match internally inverted <?InArabic>} );
ok(not "\x[8D16]"  ~~ m/^<+<?InArabic>>$/, q{Don't match unrelated <?InArabic>} );
...
ok(not "\x[C775]"  ~~ m/^<+<?InArabicPresentationFormsA>>$/, q{Don't match unrelated <?InArabicPresentationFormsA>} );
...
ok(not "\x[B2EA]"  ~~ m/^<+<?InArabicPresentationFormsB>>$/, q{Don't match unrelated <?InArabicPresentationFormsB>} );
...
ok(not "\x[0530]" ~~ m/^<-<?InArmenian>>$/, q{Don't match externally inverted <?InArmenian>} );
ok(not "\x[0530]" ~~ m/^<[A]-<?InArmenian>>$/, q{Don't match compound inverted <?InArmenian>} );
ok(not "\x[0530]" ~~ m/^<+<-InArmenian>>$/, q{Don't match internally inverted <?InArmenian>} );
ok(not "\c[ETHIOPIC SYLLABLE QHWAA]"  ~~ m/^<+<?InArmenian>>$/, q{Don't match unrelated <?InArmenian>} );
...
ok(not "\c[LEFTWARDS ARROW]" ~~ m/^<-<?InArrows>>$/, q{Don't match externally inverted <?InArrows>} );
ok(not "\c[LEFTWARDS ARROW]" ~~ m/^<[A]-<?InArrows>>$/, q{Don't match compound inverted <?InArrows>} );
ok(not "\c[LEFTWARDS ARROW]" ~~ m/^<+<-InArrows>>$/, q{Don't match internally inverted <?InArrows>} );
ok(not "\x[74FA]"  ~~ m/^<+<?InArrows>>$/, q{Don't match unrelated <?InArrows>} );
...
ok(not "\c[NULL]" ~~ m/^<-<?InBasicLatin>>$/, q{Don't match externally inverted <?InBasicLatin>} );
ok(not "\c[NULL]" ~~ m/^<[A]-<?InBasicLatin>>$/, q{Don't match compound inverted <?InBasicLatin>} );
ok(not "\c[NULL]" ~~ m/^<+<-InBasicLatin>>$/, q{Don't match internally inverted <?InBasicLatin>} );
ok(not "\x[ADFF]"  ~~ m/^<+<?InBasicLatin>>$/, q{Don't match unrelated <?InBasicLatin>} );
...
ok(not "\x[0980]" ~~ m/^<-<?InBengali>>$/, q{Don't match externally inverted <?InBengali>} );
ok(not "\x[0980]" ~~ m/^<[A]-<?InBengali>>$/, q{Don't match compound inverted <?InBengali>} );
ok(not "\x[0980]" ~~ m/^<+<-InBengali>>$/, q{Don't match internally inverted <?InBengali>} );
ok(not "\x[3409]"  ~~ m/^<+<?InBengali>>$/, q{Don't match unrelated <?InBengali>} );
...
ok(not "\c[UPPER HALF BLOCK]" ~~ m/^<-<?InBlockElements>>$/, q{Don't match externally inverted <?InBlockElements>} );
ok(not "\c[UPPER HALF BLOCK]" ~~ m/^<[A]-<?InBlockElements>>$/, q{Don't match compound inverted <?InBlockElements>} );
ok(not "\c[UPPER HALF BLOCK]" ~~ m/^<+<-InBlockElements>>$/, q{Don't match internally inverted <?InBlockElements>} );
ok(not "\x[77B1]"  ~~ m/^<+<?InBlockElements>>$/, q{Don't match unrelated <?InBlockElements>} );
...
ok(not "\x[3100]" ~~ m/^<-<?InBopomofo>>$/, q{Don't match externally inverted <?InBopomofo>} );
ok(not "\x[3100]" ~~ m/^<[A]-<?InBopomofo>>$/, q{Don't match compound inverted <?InBopomofo>} );
ok(not "\x[3100]" ~~ m/^<+<-InBopomofo>>$/, q{Don't match internally inverted <?InBopomofo>} );
ok(not "\x[701E]"  ~~ m/^<+<?InBopomofo>>$/, q{Don't match unrelated <?InBopomofo>} );
...
ok(not "\c[BOPOMOFO LETTER BU]" ~~ m/^<-<?InBopomofoExtended>>$/, q{Don't match externally inverted <?InBopomofoExtended>} );
ok(not "\c[BOPOMOFO LETTER BU]" ~~ m/^<[A]-<?InBopomofoExtended>>$/, q{Don't match compound inverted <?InBopomofoExtended>} );
ok(not "\c[BOPOMOFO LETTER BU]" ~~ m/^<+<-InBopomofoExtended>>$/, q{Don't match internally inverted <?InBopomofoExtended>} );
ok(not "\c[YI SYLLABLE TIE]"  ~~ m/^<+<?InBopomofoExtended>>$/, q{Don't match unrelated <?InBopomofoExtended>} );
...
ok(not "\c[BOX DRAWINGS LIGHT HORIZONTAL]" ~~ m/^<-<?InBoxDrawing>>$/, q{Don't match externally inverted <?InBoxDrawing>} );
ok(not "\c[BOX DRAWINGS LIGHT HORIZONTAL]" ~~ m/^<[A]-<?InBoxDrawing>>$/, q{Don't match compound inverted <?InBoxDrawing>} );
ok(not "\c[BOX DRAWINGS LIGHT HORIZONTAL]" ~~ m/^<+<-InBoxDrawing>>$/, q{Don't match internally inverted <?InBoxDrawing>} );
ok(not "\x[D2FB]"  ~~ m/^<+<?InBoxDrawing>>$/, q{Don't match unrelated <?InBoxDrawing>} );
...
ok(not "\c[BRAILLE PATTERN BLANK]" ~~ m/^<-<?InBraillePatterns>>$/, q{Don't match externally inverted <?InBraillePatterns>} );
ok(not "\c[BRAILLE PATTERN BLANK]" ~~ m/^<[A]-<?InBraillePatterns>>$/, q{Don't match compound inverted <?InBraillePatterns>} );
ok(not "\c[BRAILLE PATTERN BLANK]" ~~ m/^<+<-InBraillePatterns>>$/, q{Don't match internally inverted <?InBraillePatterns>} );
ok(not "\x[4FE4]"  ~~ m/^<+<?InBraillePatterns>>$/, q{Don't match unrelated <?InBraillePatterns>} );
...
ok(not "\c[BUHID LETTER A]" ~~ m/^<-<?InBuhid>>$/, q{Don't match externally inverted <?InBuhid>} );
ok(not "\c[BUHID LETTER A]" ~~ m/^<[A]-<?InBuhid>>$/, q{Don't match compound inverted <?InBuhid>} );
ok(not "\c[BUHID LETTER A]" ~~ m/^<+<-InBuhid>>$/, q{Don't match internally inverted <?InBuhid>} );
ok(not "\x[996F]"  ~~ m/^<+<?InBuhid>>$/, q{Don't match unrelated <?InBuhid>} );
...
ok(not "\x[802A]"  ~~ m/^<+<?InByzantineMusicalSymbols>>$/, q{Don't match unrelated <?InByzantineMusicalSymbols>} );
...
ok(not "\c[SQUARE APAATO]" ~~ m/^<-<?InCJKCompatibility>>$/, q{Don't match externally inverted <?InCJKCompatibility>} );
ok(not "\c[SQUARE APAATO]" ~~ m/^<[A]-<?InCJKCompatibility>>$/, q{Don't match compound inverted <?InCJKCompatibility>} );
ok(not "\c[SQUARE APAATO]" ~~ m/^<+<-InCJKCompatibility>>$/, q{Don't match internally inverted <?InCJKCompatibility>} );
ok(not "\x[2B99]"  ~~ m/^<+<?InCJKCompatibility>>$/, q{Don't match unrelated <?InCJKCompatibility>} );
...
ok(not "\x[342B]"  ~~ m/^<+<?InCJKCompatibilityForms>>$/, q{Don't match unrelated <?InCJKCompatibilityForms>} );
...
ok(not "\c[BLACK SQUARE]"  ~~ m/^<+<?InCJKCompatibilityIdeographs>>$/, q{Don't match unrelated <?InCJKCompatibilityIdeographs>} );
...
ok(not "\x[A90E]"  ~~ m/^<+<?InCJKCompatibilityIdeographsSupplement>>$/, q{Don't match unrelated <?InCJKCompatibilityIdeographsSupplement>} );
...
ok(not "\c[CJK RADICAL REPEAT]" ~~ m/^<-<?InCJKRadicalsSupplement>>$/, q{Don't match externally inverted <?InCJKRadicalsSupplement>} );
ok(not "\c[CJK RADICAL REPEAT]" ~~ m/^<[A]-<?InCJKRadicalsSupplement>>$/, q{Don't match compound inverted <?InCJKRadicalsSupplement>} );
ok(not "\c[CJK RADICAL REPEAT]" ~~ m/^<+<-InCJKRadicalsSupplement>>$/, q{Don't match internally inverted <?InCJKRadicalsSupplement>} );
ok(not "\x[563B]"  ~~ m/^<+<?InCJKRadicalsSupplement>>$/, q{Don't match unrelated <?InCJKRadicalsSupplement>} );
...
ok(not "\c[IDEOGRAPHIC SPACE]" ~~ m/^<-<?InCJKSymbolsAndPunctuation>>$/, q{Don't match externally inverted <?InCJKSymbolsAndPunctuation>} );
ok(not "\c[IDEOGRAPHIC SPACE]" ~~ m/^<[A]-<?InCJKSymbolsAndPunctuation>>$/, q{Don't match compound inverted <?InCJKSymbolsAndPunctuation>} );
ok(not "\c[IDEOGRAPHIC SPACE]" ~~ m/^<+<-InCJKSymbolsAndPunctuation>>$/, q{Don't match internally inverted <?InCJKSymbolsAndPunctuation>} );
ok(not "\x[3BE6]"  ~~ m/^<+<?InCJKSymbolsAndPunctuation>>$/, q{Don't match unrelated <?InCJKSymbolsAndPunctuation>} );
...
ok(not "\x[4E00]" ~~ m/^<-<?InCJKUnifiedIdeographs>>$/, q{Don't match externally inverted <?InCJKUnifiedIdeographs>} );
ok(not "\x[4E00]" ~~ m/^<[A]-<?InCJKUnifiedIdeographs>>$/, q{Don't match compound inverted <?InCJKUnifiedIdeographs>} );
ok(not "\x[4E00]" ~~ m/^<+<-InCJKUnifiedIdeographs>>$/, q{Don't match internally inverted <?InCJKUnifiedIdeographs>} );
ok(not "\x[436E]"  ~~ m/^<+<?InCJKUnifiedIdeographs>>$/, q{Don't match unrelated <?InCJKUnifiedIdeographs>} );
...
ok(not "\x[4993]" ~~ m/^<-<?InCJKUnifiedIdeographsExtensionA>>$/, q{Don't match externally inverted <?InCJKUnifiedIdeographsExtensionA>} );
ok(not "\x[4993]" ~~ m/^<[A]-<?InCJKUnifiedIdeographsExtensionA>>$/, q{Don't match compound inverted <?InCJKUnifiedIdeographsExtensionA>} );
ok(not "\x[4993]" ~~ m/^<+<-InCJKUnifiedIdeographsExtensionA>>$/, q{Don't match internally inverted <?InCJKUnifiedIdeographsExtensionA>} );
ok(not "\c[HEXAGRAM FOR THE CREATIVE HEAVEN]"  ~~ m/^<+<?InCJKUnifiedIdeographsExtensionA>>$/, q{Don't match unrelated <?InCJKUnifiedIdeographsExtensionA>} );
...
ok(not "\x[3E5A]"  ~~ m/^<+<?InCJKUnifiedIdeographsExtensionB>>$/, q{Don't match unrelated <?InCJKUnifiedIdeographsExtensionB>} );
...
ok(not "\c[CHEROKEE LETTER A]" ~~ m/^<-<?InCherokee>>$/, q{Don't match externally inverted <?InCherokee>} );
ok(not "\c[CHEROKEE LETTER A]" ~~ m/^<[A]-<?InCherokee>>$/, q{Don't match compound inverted <?InCherokee>} );
ok(not "\c[CHEROKEE LETTER A]" ~~ m/^<+<-InCherokee>>$/, q{Don't match internally inverted <?InCherokee>} );
ok(not "\x[B311]"  ~~ m/^<+<?InCherokee>>$/, q{Don't match unrelated <?InCherokee>} );
...
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<-<?InCombiningDiacriticalMarks>>$/, q{Don't match externally inverted <?InCombiningDiacriticalMarks>} );
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<[A]-<?InCombiningDiacriticalMarks>>$/, q{Don't match compound inverted <?InCombiningDiacriticalMarks>} );
ok(not "\c[COMBINING GRAVE ACCENT]" ~~ m/^<+<-InCombiningDiacriticalMarks>>$/, q{Don't match internally inverted <?InCombiningDiacriticalMarks>} );
ok(not "\x[81B8]"  ~~ m/^<+<?InCombiningDiacriticalMarks>>$/, q{Don't match unrelated <?InCombiningDiacriticalMarks>} );
...
ok(not "\c[COMBINING LEFT HARPOON ABOVE]" ~~ m/^<-<?InCombiningDiacriticalMarksforSymbols>>$/, q{Don't match externally inverted <?InCombiningDiacriticalMarksforSymbols>} );
ok(not "\c[COMBINING LEFT HARPOON ABOVE]" ~~ m/^<[A]-<?InCombiningDiacriticalMarksforSymbols>>$/, q{Don't match compound inverted <?InCombiningDiacriticalMarksforSymbols>} );
ok(not "\c[COMBINING LEFT HARPOON ABOVE]" ~~ m/^<+<-InCombiningDiacriticalMarksforSymbols>>$/, q{Don't match internally inverted <?InCombiningDiacriticalMarksforSymbols>} );
ok(not "\c[YI SYLLABLE NZOX]"  ~~ m/^<+<?InCombiningDiacriticalMarksforSymbols>>$/, q{Don't match unrelated <?InCombiningDiacriticalMarksforSymbols>} );
...
ok(not "\x[7140]"  ~~ m/^<+<?InCombiningHalfMarks>>$/, q{Don't match unrelated <?InCombiningHalfMarks>} );
...
ok(not "\c[SYMBOL FOR NULL]" ~~ m/^<-<?InControlPictures>>$/, q{Don't match externally inverted <?InControlPictures>} );
ok(not "\c[SYMBOL FOR NULL]" ~~ m/^<[A]-<?InControlPictures>>$/, q{Don't match compound inverted <?InControlPictures>} );
ok(not "\c[SYMBOL FOR NULL]" ~~ m/^<+<-InControlPictures>>$/, q{Don't match internally inverted <?InControlPictures>} );
ok(not "\x[CBBF]"  ~~ m/^<+<?InControlPictures>>$/, q{Don't match unrelated <?InControlPictures>} );
...
ok(not "\c[EURO-CURRENCY SIGN]" ~~ m/^<-<?InCurrencySymbols>>$/, q{Don't match externally inverted <?InCurrencySymbols>} );
ok(not "\c[EURO-CURRENCY SIGN]" ~~ m/^<[A]-<?InCurrencySymbols>>$/, q{Don't match compound inverted <?InCurrencySymbols>} );
ok(not "\c[EURO-CURRENCY SIGN]" ~~ m/^<+<-InCurrencySymbols>>$/, q{Don't match internally inverted <?InCurrencySymbols>} );
ok(not "\x[D040]"  ~~ m/^<+<?InCurrencySymbols>>$/, q{Don't match unrelated <?InCurrencySymbols>} );
...
ok(not "\c[CYRILLIC CAPITAL LETTER IE WITH GRAVE]" ~~ m/^<-<?InCyrillic>>$/, q{Don't match externally inverted <?InCyrillic>} );
ok(not "\c[CYRILLIC CAPITAL LETTER IE WITH GRAVE]" ~~ m/^<[A]-<?InCyrillic>>$/, q{Don't match compound inverted <?InCyrillic>} );
ok(not "\c[CYRILLIC CAPITAL LETTER IE WITH GRAVE]" ~~ m/^<+<-InCyrillic>>$/, q{Don't match internally inverted <?InCyrillic>} );
ok(not "\x[9C58]"  ~~ m/^<+<?InCyrillic>>$/, q{Don't match unrelated <?InCyrillic>} );
...
ok(not "\c[CYRILLIC CAPITAL LETTER KOMI DE]" ~~ m/^<-<?InCyrillicSupplementary>>$/, q{Don't match externally inverted <?InCyrillicSupplementary>} );
ok(not "\c[CYRILLIC CAPITAL LETTER KOMI DE]" ~~ m/^<[A]-<?InCyrillicSupplementary>>$/, q{Don't match compound inverted <?InCyrillicSupplementary>} );
ok(not "\c[CYRILLIC CAPITAL LETTER KOMI DE]" ~~ m/^<+<-InCyrillicSupplementary>>$/, q{Don't match internally inverted <?InCyrillicSupplementary>} );
ok(not "\x[857A]"  ~~ m/^<+<?InCyrillicSupplementary>>$/, q{Don't match unrelated <?InCyrillicSupplementary>} );
...
ok(not "\c[LATIN SMALL LETTER I WITH DOUBLE GRAVE]"  ~~ m/^<+<?InDeseret>>$/, q{Don't match unrelated <?InDeseret>} );
...
ok(not "\x[0900]" ~~ m/^<-<?InDevanagari>>$/, q{Don't match externally inverted <?InDevanagari>} );
ok(not "\x[0900]" ~~ m/^<[A]-<?InDevanagari>>$/, q{Don't match compound inverted <?InDevanagari>} );
ok(not "\x[0900]" ~~ m/^<+<-InDevanagari>>$/, q{Don't match internally inverted <?InDevanagari>} );
ok(not "\x[3837]"  ~~ m/^<+<?InDevanagari>>$/, q{Don't match unrelated <?InDevanagari>} );
...
ok(not "\x[2700]" ~~ m/^<-<?InDingbats>>$/, q{Don't match externally inverted <?InDingbats>} );
ok(not "\x[2700]" ~~ m/^<[A]-<?InDingbats>>$/, q{Don't match compound inverted <?InDingbats>} );
ok(not "\x[2700]" ~~ m/^<+<-InDingbats>>$/, q{Don't match internally inverted <?InDingbats>} );
ok(not "\x[C9CC]"  ~~ m/^<+<?InDingbats>>$/, q{Don't match unrelated <?InDingbats>} );
...
ok(not "\c[CIRCLED DIGIT ONE]" ~~ m/^<-<?InEnclosedAlphanumerics>>$/, q{Don't match externally inverted <?InEnclosedAlphanumerics>} );
ok(not "\c[CIRCLED DIGIT ONE]" ~~ m/^<[A]-<?InEnclosedAlphanumerics>>$/, q{Don't match compound inverted <?InEnclosedAlphanumerics>} );
ok(not "\c[CIRCLED DIGIT ONE]" ~~ m/^<+<-InEnclosedAlphanumerics>>$/, q{Don't match internally inverted <?InEnclosedAlphanumerics>} );
ok(not "\x[CCB8]"  ~~ m/^<+<?InEnclosedAlphanumerics>>$/, q{Don't match unrelated <?InEnclosedAlphanumerics>} );
...
ok(not "\c[PARENTHESIZED HANGUL KIYEOK]" ~~ m/^<-<?InEnclosedCJKLettersAndMonths>>$/, q{Don't match externally inverted <?InEnclosedCJKLettersAndMonths>} );
ok(not "\c[PARENTHESIZED HANGUL KIYEOK]" ~~ m/^<[A]-<?InEnclosedCJKLettersAndMonths>>$/, q{Don't match compound inverted <?InEnclosedCJKLettersAndMonths>} );
ok(not "\c[PARENTHESIZED HANGUL KIYEOK]" ~~ m/^<+<-InEnclosedCJKLettersAndMonths>>$/, q{Don't match internally inverted <?InEnclosedCJKLettersAndMonths>} );
ok(not "\x[8883]"  ~~ m/^<+<?InEnclosedCJKLettersAndMonths>>$/, q{Don't match unrelated <?InEnclosedCJKLettersAndMonths>} );
...
ok(not "\c[ETHIOPIC SYLLABLE HA]" ~~ m/^<-<?InEthiopic>>$/, q{Don't match externally inverted <?InEthiopic>} );
ok(not "\c[ETHIOPIC SYLLABLE HA]" ~~ m/^<[A]-<?InEthiopic>>$/, q{Don't match compound inverted <?InEthiopic>} );
ok(not "\c[ETHIOPIC SYLLABLE HA]" ~~ m/^<+<-InEthiopic>>$/, q{Don't match internally inverted <?InEthiopic>} );
ok(not "\c[MALAYALAM DIGIT NINE]"  ~~ m/^<+<?InEthiopic>>$/, q{Don't match unrelated <?InEthiopic>} );
...
ok(not "\c[EN QUAD]" ~~ m/^<-<?InGeneralPunctuation>>$/, q{Don't match externally inverted <?InGeneralPunctuation>} );
ok(not "\c[EN QUAD]" ~~ m/^<[A]-<?InGeneralPunctuation>>$/, q{Don't match compound inverted <?InGeneralPunctuation>} );
ok(not "\c[EN QUAD]" ~~ m/^<+<-InGeneralPunctuation>>$/, q{Don't match internally inverted <?InGeneralPunctuation>} );
ok(not "\x[BBC9]"  ~~ m/^<+<?InGeneralPunctuation>>$/, q{Don't match unrelated <?InGeneralPunctuation>} );
...
ok(not "\c[BLACK SQUARE]" ~~ m/^<-<?InGeometricShapes>>$/, q{Don't match externally inverted <?InGeometricShapes>} );
ok(not "\c[BLACK SQUARE]" ~~ m/^<[A]-<?InGeometricShapes>>$/, q{Don't match compound inverted <?InGeometricShapes>} );
ok(not "\c[BLACK SQUARE]" ~~ m/^<+<-InGeometricShapes>>$/, q{Don't match internally inverted <?InGeometricShapes>} );
ok(not "\x[C58A]"  ~~ m/^<+<?InGeometricShapes>>$/, q{Don't match unrelated <?InGeometricShapes>} );
...
ok(not "\c[GEORGIAN CAPITAL LETTER AN]" ~~ m/^<-<?InGeorgian>>$/, q{Don't match externally inverted <?InGeorgian>} );
ok(not "\c[GEORGIAN CAPITAL LETTER AN]" ~~ m/^<[A]-<?InGeorgian>>$/, q{Don't match compound inverted <?InGeorgian>} );
ok(not "\c[GEORGIAN CAPITAL LETTER AN]" ~~ m/^<+<-InGeorgian>>$/, q{Don't match internally inverted <?InGeorgian>} );
ok(not "\c[ARMENIAN CAPITAL LETTER BEN]"  ~~ m/^<+<?InGeorgian>>$/, q{Don't match unrelated <?InGeorgian>} );
...
ok(not "\x[1A5A]"  ~~ m/^<+<?InGothic>>$/, q{Don't match unrelated <?InGothic>} );
...
ok(not "\c[GREEK SMALL LETTER ALPHA WITH PSILI]" ~~ m/^<-<?InGreekExtended>>$/, q{Don't match externally inverted <?InGreekExtended>} );
ok(not "\c[GREEK SMALL LETTER ALPHA WITH PSILI]" ~~ m/^<[A]-<?InGreekExtended>>$/, q{Don't match compound inverted <?InGreekExtended>} );
ok(not "\c[GREEK SMALL LETTER ALPHA WITH PSILI]" ~~ m/^<+<-InGreekExtended>>$/, q{Don't match internally inverted <?InGreekExtended>} );
ok(not "\x[39F3]"  ~~ m/^<+<?InGreekExtended>>$/, q{Don't match unrelated <?InGreekExtended>} );
...
ok(not "\x[0370]" ~~ m/^<-<?InGreekAndCoptic>>$/, q{Don't match externally inverted <?InGreekAndCoptic>} );
ok(not "\x[0370]" ~~ m/^<[A]-<?InGreekAndCoptic>>$/, q{Don't match compound inverted <?InGreekAndCoptic>} );
ok(not "\x[0370]" ~~ m/^<+<-InGreekAndCoptic>>$/, q{Don't match internally inverted <?InGreekAndCoptic>} );
ok(not "\x[8CFE]"  ~~ m/^<+<?InGreekAndCoptic>>$/, q{Don't match unrelated <?InGreekAndCoptic>} );
...
ok(not "\x[0A80]" ~~ m/^<-<?InGujarati>>$/, q{Don't match externally inverted <?InGujarati>} );
ok(not "\x[0A80]" ~~ m/^<[A]-<?InGujarati>>$/, q{Don't match compound inverted <?InGujarati>} );
ok(not "\x[0A80]" ~~ m/^<+<-InGujarati>>$/, q{Don't match internally inverted <?InGujarati>} );
ok(not "\x[B022]"  ~~ m/^<+<?InGujarati>>$/, q{Don't match unrelated <?InGujarati>} );
...
ok(not "\x[0A00]" ~~ m/^<-<?InGurmukhi>>$/, q{Don't match externally inverted <?InGurmukhi>} );
ok(not "\x[0A00]" ~~ m/^<[A]-<?InGurmukhi>>$/, q{Don't match compound inverted <?InGurmukhi>} );
ok(not "\x[0A00]" ~~ m/^<+<-InGurmukhi>>$/, q{Don't match internally inverted <?InGurmukhi>} );
ok(not "\x[8FC3]"  ~~ m/^<+<?InGurmukhi>>$/, q{Don't match unrelated <?InGurmukhi>} );
...
ok(not "\x[36A3]"  ~~ m/^<+<?InHalfwidthAndFullwidthForms>>$/, q{Don't match unrelated <?InHalfwidthAndFullwidthForms>} );
...
ok(not "\x[3130]" ~~ m/^<-<?InHangulCompatibilityJamo>>$/, q{Don't match externally inverted <?InHangulCompatibilityJamo>} );
ok(not "\x[3130]" ~~ m/^<[A]-<?InHangulCompatibilityJamo>>$/, q{Don't match compound inverted <?InHangulCompatibilityJamo>} );
ok(not "\x[3130]" ~~ m/^<+<-InHangulCompatibilityJamo>>$/, q{Don't match internally inverted <?InHangulCompatibilityJamo>} );
ok(not "\x[BAF0]"  ~~ m/^<+<?InHangulCompatibilityJamo>>$/, q{Don't match unrelated <?InHangulCompatibilityJamo>} );
...
ok(not "\c[HANGUL CHOSEONG KIYEOK]" ~~ m/^<-<?InHangulJamo>>$/, q{Don't match externally inverted <?InHangulJamo>} );
ok(not "\c[HANGUL CHOSEONG KIYEOK]" ~~ m/^<[A]-<?InHangulJamo>>$/, q{Don't match compound inverted <?InHangulJamo>} );
ok(not "\c[HANGUL CHOSEONG KIYEOK]" ~~ m/^<+<-InHangulJamo>>$/, q{Don't match internally inverted <?InHangulJamo>} );
ok(not "\x[4EB3]"  ~~ m/^<+<?InHangulJamo>>$/, q{Don't match unrelated <?InHangulJamo>} );
...
ok(not "\x[AC00]" ~~ m/^<-<?InHangulSyllables>>$/, q{Don't match externally inverted <?InHangulSyllables>} );
ok(not "\x[AC00]" ~~ m/^<[A]-<?InHangulSyllables>>$/, q{Don't match compound inverted <?InHangulSyllables>} );
ok(not "\x[AC00]" ~~ m/^<+<-InHangulSyllables>>$/, q{Don't match internally inverted <?InHangulSyllables>} );
ok(not "\x[7D7E]"  ~~ m/^<+<?InHangulSyllables>>$/, q{Don't match unrelated <?InHangulSyllables>} );
...
ok(not "\c[HANUNOO LETTER A]" ~~ m/^<-<?InHanunoo>>$/, q{Don't match externally inverted <?InHanunoo>} );
ok(not "\c[HANUNOO LETTER A]" ~~ m/^<[A]-<?InHanunoo>>$/, q{Don't match compound inverted <?InHanunoo>} );
ok(not "\c[HANUNOO LETTER A]" ~~ m/^<+<-InHanunoo>>$/, q{Don't match internally inverted <?InHanunoo>} );
ok(not "\x[BD8A]"  ~~ m/^<+<?InHanunoo>>$/, q{Don't match unrelated <?InHanunoo>} );
...
ok(not "\x[0590]" ~~ m/^<-<?InHebrew>>$/, q{Don't match externally inverted <?InHebrew>} );
ok(not "\x[0590]" ~~ m/^<[A]-<?InHebrew>>$/, q{Don't match compound inverted <?InHebrew>} );
ok(not "\x[0590]" ~~ m/^<+<-InHebrew>>$/, q{Don't match internally inverted <?InHebrew>} );
ok(not "\x[7EB3]"  ~~ m/^<+<?InHebrew>>$/, q{Don't match unrelated <?InHebrew>} );
...
ok(not "\x[9EC6]"  ~~ m/^<+<?InHighPrivateUseSurrogates>>$/, q{Don't match unrelated <?InHighPrivateUseSurrogates>} );
...
ok(not "\x[BC8F]"  ~~ m/^<+<?InHighSurrogates>>$/, q{Don't match unrelated <?InHighSurrogates>} );
...
ok(not "\x[3040]" ~~ m/^<-<?InHiragana>>$/, q{Don't match externally inverted <?InHiragana>} );
ok(not "\x[3040]" ~~ m/^<[A]-<?InHiragana>>$/, q{Don't match compound inverted <?InHiragana>} );
ok(not "\x[3040]" ~~ m/^<+<-InHiragana>>$/, q{Don't match internally inverted <?InHiragana>} );
ok(not "\c[ARABIC SIGN ALAYHE ASSALLAM]"  ~~ m/^<+<?InHiragana>>$/, q{Don't match unrelated <?InHiragana>} );
...
ok(not "\c[LATIN SMALL LETTER TURNED A]" ~~ m/^<-<?InIPAExtensions>>$/, q{Don't match externally inverted <?InIPAExtensions>} );
ok(not "\c[LATIN SMALL LETTER TURNED A]" ~~ m/^<[A]-<?InIPAExtensions>>$/, q{Don't match compound inverted <?InIPAExtensions>} );
ok(not "\c[LATIN SMALL LETTER TURNED A]" ~~ m/^<+<-InIPAExtensions>>$/, q{Don't match internally inverted <?InIPAExtensions>} );
ok(not "\x[0DFC]"  ~~ m/^<+<?InIPAExtensions>>$/, q{Don't match unrelated <?InIPAExtensions>} );
...
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO RIGHT]" ~~ m/^<-<?InIdeographicDescriptionCharacters>>$/, q{Don't match externally inverted <?InIdeographicDescriptionCharacters>} );
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO RIGHT]" ~~ m/^<[A]-<?InIdeographicDescriptionCharacters>>$/, q{Don't match compound inverted <?InIdeographicDescriptionCharacters>} );
ok(not "\c[IDEOGRAPHIC DESCRIPTION CHARACTER LEFT TO RIGHT]" ~~ m/^<+<-InIdeographicDescriptionCharacters>>$/, q{Don't match internally inverted <?InIdeographicDescriptionCharacters>} );
ok(not "\c[LATIN CAPITAL LETTER AE]"  ~~ m/^<+<?InIdeographicDescriptionCharacters>>$/, q{Don't match unrelated <?InIdeographicDescriptionCharacters>} );
...
ok(not "\c[IDEOGRAPHIC ANNOTATION LINKING MARK]" ~~ m/^<-<?InKanbun>>$/, q{Don't match externally inverted <?InKanbun>} );
ok(not "\c[IDEOGRAPHIC ANNOTATION LINKING MARK]" ~~ m/^<[A]-<?InKanbun>>$/, q{Don't match compound inverted <?InKanbun>} );
ok(not "\c[IDEOGRAPHIC ANNOTATION LINKING MARK]" ~~ m/^<+<-InKanbun>>$/, q{Don't match internally inverted <?InKanbun>} );
ok(not "\x[93AB]"  ~~ m/^<+<?InKanbun>>$/, q{Don't match unrelated <?InKanbun>} );
...
ok(not "\c[KANGXI RADICAL ONE]" ~~ m/^<-<?InKangxiRadicals>>$/, q{Don't match externally inverted <?InKangxiRadicals>} );
ok(not "\c[KANGXI RADICAL ONE]" ~~ m/^<[A]-<?InKangxiRadicals>>$/, q{Don't match compound inverted <?InKangxiRadicals>} );
ok(not "\c[KANGXI RADICAL ONE]" ~~ m/^<+<-InKangxiRadicals>>$/, q{Don't match internally inverted <?InKangxiRadicals>} );
ok(not "\x[363D]"  ~~ m/^<+<?InKangxiRadicals>>$/, q{Don't match unrelated <?InKangxiRadicals>} );
...
ok(not "\x[0C80]" ~~ m/^<-<?InKannada>>$/, q{Don't match externally inverted <?InKannada>} );
ok(not "\x[0C80]" ~~ m/^<[A]-<?InKannada>>$/, q{Don't match compound inverted <?InKannada>} );
ok(not "\x[0C80]" ~~ m/^<+<-InKannada>>$/, q{Don't match internally inverted <?InKannada>} );
ok(not "\x[9093]"  ~~ m/^<+<?InKannada>>$/, q{Don't match unrelated <?InKannada>} );
...
ok(not "\c[KATAKANA-HIRAGANA DOUBLE HYPHEN]" ~~ m/^<-<?InKatakana>>$/, q{Don't match externally inverted <?InKatakana>} );
ok(not "\c[KATAKANA-HIRAGANA DOUBLE HYPHEN]" ~~ m/^<[A]-<?InKatakana>>$/, q{Don't match compound inverted <?InKatakana>} );
ok(not "\c[KATAKANA-HIRAGANA DOUBLE HYPHEN]" ~~ m/^<+<-InKatakana>>$/, q{Don't match internally inverted <?InKatakana>} );
ok(not "\x[75DA]"  ~~ m/^<+<?InKatakana>>$/, q{Don't match unrelated <?InKatakana>} );
...
ok(not "\c[KATAKANA LETTER SMALL KU]" ~~ m/^<-<?InKatakanaPhoneticExtensions>>$/, q{Don't match externally inverted <?InKatakanaPhoneticExtensions>} );
ok(not "\c[KATAKANA LETTER SMALL KU]" ~~ m/^<[A]-<?InKatakanaPhoneticExtensions>>$/, q{Don't match compound inverted <?InKatakanaPhoneticExtensions>} );
ok(not "\c[KATAKANA LETTER SMALL KU]" ~~ m/^<+<-InKatakanaPhoneticExtensions>>$/, q{Don't match internally inverted <?InKatakanaPhoneticExtensions>} );
ok(not "\c[GREEK SMALL LETTER EPSILON WITH DASIA AND VARIA]"  ~~ m/^<+<?InKatakanaPhoneticExtensions>>$/, q{Don't match unrelated <?InKatakanaPhoneticExtensions>} );
...
ok(not "\c[KHMER LETTER KA]" ~~ m/^<-<?InKhmer>>$/, q{Don't match externally inverted <?InKhmer>} );
ok(not "\c[KHMER LETTER KA]" ~~ m/^<[A]-<?InKhmer>>$/, q{Don't match compound inverted <?InKhmer>} );
ok(not "\c[KHMER LETTER KA]" ~~ m/^<+<-InKhmer>>$/, q{Don't match internally inverted <?InKhmer>} );
ok(not "\x[508C]"  ~~ m/^<+<?InKhmer>>$/, q{Don't match unrelated <?InKhmer>} );
...
ok(not "\x[0E80]" ~~ m/^<-<?InLao>>$/, q{Don't match externally inverted <?InLao>} );
ok(not "\x[0E80]" ~~ m/^<[A]-<?InLao>>$/, q{Don't match compound inverted <?InLao>} );
ok(not "\x[0E80]" ~~ m/^<+<-InLao>>$/, q{Don't match internally inverted <?InLao>} );
ok(not "\c[PARENTHESIZED IDEOGRAPH CONGRATULATION]"  ~~ m/^<+<?InLao>>$/, q{Don't match unrelated <?InLao>} );
...
ok(not "\x[0080]" ~~ m/^<-<?InLatin1Supplement>>$/, q{Don't match externally inverted <?InLatin1Supplement>} );
ok(not "\x[0080]" ~~ m/^<[A]-<?InLatin1Supplement>>$/, q{Don't match compound inverted <?InLatin1Supplement>} );
ok(not "\x[0080]" ~~ m/^<+<-InLatin1Supplement>>$/, q{Don't match internally inverted <?InLatin1Supplement>} );
ok(not "\x[3A43]"  ~~ m/^<+<?InLatin1Supplement>>$/, q{Don't match unrelated <?InLatin1Supplement>} );
...
ok(not "\c[LATIN CAPITAL LETTER A WITH MACRON]" ~~ m/^<-<?InLatinExtendedA>>$/, q{Don't match externally inverted <?InLatinExtendedA>} );
ok(not "\c[LATIN CAPITAL LETTER A WITH MACRON]" ~~ m/^<[A]-<?InLatinExtendedA>>$/, q{Don't match compound inverted <?InLatinExtendedA>} );
ok(not "\c[LATIN CAPITAL LETTER A WITH MACRON]" ~~ m/^<+<-InLatinExtendedA>>$/, q{Don't match internally inverted <?InLatinExtendedA>} );
ok(not "\c[ARROW POINTING RIGHTWARDS THEN CURVING UPWARDS]"  ~~ m/^<+<?InLatinExtendedA>>$/, q{Don't match unrelated <?InLatinExtendedA>} );
...
ok(not "\c[LATIN CAPITAL LETTER A WITH RING BELOW]" ~~ m/^<-<?InLatinExtendedAdditional>>$/, q{Don't match externally inverted <?InLatinExtendedAdditional>} );
ok(not "\c[LATIN CAPITAL LETTER A WITH RING BELOW]" ~~ m/^<[A]-<?InLatinExtendedAdditional>>$/, q{Don't match compound inverted <?InLatinExtendedAdditional>} );
ok(not "\c[LATIN CAPITAL LETTER A WITH RING BELOW]" ~~ m/^<+<-InLatinExtendedAdditional>>$/, q{Don't match internally inverted <?InLatinExtendedAdditional>} );
ok(not "\x[36E7]"  ~~ m/^<+<?InLatinExtendedAdditional>>$/, q{Don't match unrelated <?InLatinExtendedAdditional>} );
...
ok(not "\c[LATIN SMALL LETTER B WITH STROKE]" ~~ m/^<-<?InLatinExtendedB>>$/, q{Don't match externally inverted <?InLatinExtendedB>} );
ok(not "\c[LATIN SMALL LETTER B WITH STROKE]" ~~ m/^<[A]-<?InLatinExtendedB>>$/, q{Don't match compound inverted <?InLatinExtendedB>} );
ok(not "\c[LATIN SMALL LETTER B WITH STROKE]" ~~ m/^<+<-InLatinExtendedB>>$/, q{Don't match internally inverted <?InLatinExtendedB>} );
ok(not "\x[877E]"  ~~ m/^<+<?InLatinExtendedB>>$/, q{Don't match unrelated <?InLatinExtendedB>} );
...
ok(not "\c[ACCOUNT OF]" ~~ m/^<-<?InLetterlikeSymbols>>$/, q{Don't match externally inverted <?InLetterlikeSymbols>} );
ok(not "\c[ACCOUNT OF]" ~~ m/^<[A]-<?InLetterlikeSymbols>>$/, q{Don't match compound inverted <?InLetterlikeSymbols>} );
ok(not "\c[ACCOUNT OF]" ~~ m/^<+<-InLetterlikeSymbols>>$/, q{Don't match internally inverted <?InLetterlikeSymbols>} );
ok(not "\c[CIRCLED IDEOGRAPH TWO]"  ~~ m/^<+<?InLetterlikeSymbols>>$/, q{Don't match unrelated <?InLetterlikeSymbols>} );
...
ok(not "\x[B611]"  ~~ m/^<+<?InLowSurrogates>>$/, q{Don't match unrelated <?InLowSurrogates>} );
...
ok(not "\x[0D00]" ~~ m/^<-<?InMalayalam>>$/, q{Don't match externally inverted <?InMalayalam>} );
ok(not "\x[0D00]" ~~ m/^<[A]-<?InMalayalam>>$/, q{Don't match compound inverted <?InMalayalam>} );
ok(not "\x[0D00]" ~~ m/^<+<-InMalayalam>>$/, q{Don't match internally inverted <?InMalayalam>} );
ok(not "\x[C011]"  ~~ m/^<+<?InMalayalam>>$/, q{Don't match unrelated <?InMalayalam>} );
...
ok(not "\x[73FA]"  ~~ m/^<+<?InMathematicalAlphanumericSymbols>>$/, q{Don't match unrelated <?InMathematicalAlphanumericSymbols>} );
...
ok(not "\c[FOR ALL]" ~~ m/^<-<?InMathematicalOperators>>$/, q{Don't match externally inverted <?InMathematicalOperators>} );
ok(not "\c[FOR ALL]" ~~ m/^<[A]-<?InMathematicalOperators>>$/, q{Don't match compound inverted <?InMathematicalOperators>} );
ok(not "\c[FOR ALL]" ~~ m/^<+<-InMathematicalOperators>>$/, q{Don't match internally inverted <?InMathematicalOperators>} );
ok(not "\x[B389]"  ~~ m/^<+<?InMathematicalOperators>>$/, q{Don't match unrelated <?InMathematicalOperators>} );
...
ok(not "\x[27C0]" ~~ m/^<-<?InMiscellaneousMathematicalSymbolsA>>$/, q{Don't match externally inverted <?InMiscellaneousMathematicalSymbolsA>} );
ok(not "\x[27C0]" ~~ m/^<[A]-<?InMiscellaneousMathematicalSymbolsA>>$/, q{Don't match compound inverted <?InMiscellaneousMathematicalSymbolsA>} );
ok(not "\x[27C0]" ~~ m/^<+<-InMiscellaneousMathematicalSymbolsA>>$/, q{Don't match internally inverted <?InMiscellaneousMathematicalSymbolsA>} );
ok(not "\x[AAB2]"  ~~ m/^<+<?InMiscellaneousMathematicalSymbolsA>>$/, q{Don't match unrelated <?InMiscellaneousMathematicalSymbolsA>} );
...
ok(not "\c[TRIPLE VERTICAL BAR DELIMITER]" ~~ m/^<-<?InMiscellaneousMathematicalSymbolsB>>$/, q{Don't match externally inverted <?InMiscellaneousMathematicalSymbolsB>} );
ok(not "\c[TRIPLE VERTICAL BAR DELIMITER]" ~~ m/^<[A]-<?InMiscellaneousMathematicalSymbolsB>>$/, q{Don't match compound inverted <?InMiscellaneousMathematicalSymbolsB>} );
ok(not "\c[TRIPLE VERTICAL BAR DELIMITER]" ~~ m/^<+<-InMiscellaneousMathematicalSymbolsB>>$/, q{Don't match internally inverted <?InMiscellaneousMathematicalSymbolsB>} );
ok(not "\x[5793]"  ~~ m/^<+<?InMiscellaneousMathematicalSymbolsB>>$/, q{Don't match unrelated <?InMiscellaneousMathematicalSymbolsB>} );
...
ok(not "\c[BLACK SUN WITH RAYS]" ~~ m/^<-<?InMiscellaneousSymbols>>$/, q{Don't match externally inverted <?InMiscellaneousSymbols>} );
ok(not "\c[BLACK SUN WITH RAYS]" ~~ m/^<[A]-<?InMiscellaneousSymbols>>$/, q{Don't match compound inverted <?InMiscellaneousSymbols>} );
ok(not "\c[BLACK SUN WITH RAYS]" ~~ m/^<+<-InMiscellaneousSymbols>>$/, q{Don't match internally inverted <?InMiscellaneousSymbols>} );
ok(not "\x[39D9]"  ~~ m/^<+<?InMiscellaneousSymbols>>$/, q{Don't match unrelated <?InMiscellaneousSymbols>} );
...
ok(not "\c[DIAMETER SIGN]" ~~ m/^<-<?InMiscellaneousTechnical>>$/, q{Don't match externally inverted <?InMiscellaneousTechnical>} );
ok(not "\c[DIAMETER SIGN]" ~~ m/^<[A]-<?InMiscellaneousTechnical>>$/, q{Don't match compound inverted <?InMiscellaneousTechnical>} );
ok(not "\c[DIAMETER SIGN]" ~~ m/^<+<-InMiscellaneousTechnical>>$/, q{Don't match internally inverted <?InMiscellaneousTechnical>} );
ok(not "\x[528A]"  ~~ m/^<+<?InMiscellaneousTechnical>>$/, q{Don't match unrelated <?InMiscellaneousTechnical>} );
...
ok(not "\c[MONGOLIAN BIRGA]" ~~ m/^<-<?InMongolian>>$/, q{Don't match externally inverted <?InMongolian>} );
ok(not "\c[MONGOLIAN BIRGA]" ~~ m/^<[A]-<?InMongolian>>$/, q{Don't match compound inverted <?InMongolian>} );
ok(not "\c[MONGOLIAN BIRGA]" ~~ m/^<+<-InMongolian>>$/, q{Don't match internally inverted <?InMongolian>} );
ok(not "\x[3985]"  ~~ m/^<+<?InMongolian>>$/, q{Don't match unrelated <?InMongolian>} );
...
ok(not "\x[7A59]"  ~~ m/^<+<?InMusicalSymbols>>$/, q{Don't match unrelated <?InMusicalSymbols>} );
...
ok(not "\c[MYANMAR LETTER KA]" ~~ m/^<-<?InMyanmar>>$/, q{Don't match externally inverted <?InMyanmar>} );
ok(not "\c[MYANMAR LETTER KA]" ~~ m/^<[A]-<?InMyanmar>>$/, q{Don't match compound inverted <?InMyanmar>} );
ok(not "\c[MYANMAR LETTER KA]" ~~ m/^<+<-InMyanmar>>$/, q{Don't match internally inverted <?InMyanmar>} );
ok(not "\x[5698]"  ~~ m/^<+<?InMyanmar>>$/, q{Don't match unrelated <?InMyanmar>} );
...
ok(not "\x[2150]" ~~ m/^<-<?InNumberForms>>$/, q{Don't match externally inverted <?InNumberForms>} );
ok(not "\x[2150]" ~~ m/^<[A]-<?InNumberForms>>$/, q{Don't match compound inverted <?InNumberForms>} );
ok(not "\x[2150]" ~~ m/^<+<-InNumberForms>>$/, q{Don't match internally inverted <?InNumberForms>} );
ok(not "\x[C41B]"  ~~ m/^<+<?InNumberForms>>$/, q{Don't match unrelated <?InNumberForms>} );
...
ok(not "\c[OGHAM SPACE MARK]" ~~ m/^<-<?InOgham>>$/, q{Don't match externally inverted <?InOgham>} );
ok(not "\c[OGHAM SPACE MARK]" ~~ m/^<[A]-<?InOgham>>$/, q{Don't match compound inverted <?InOgham>} );
ok(not "\c[OGHAM SPACE MARK]" ~~ m/^<+<-InOgham>>$/, q{Don't match internally inverted <?InOgham>} );
ok(not "\x[2C8C]"  ~~ m/^<+<?InOgham>>$/, q{Don't match unrelated <?InOgham>} );
...
ok(not "\c[YI SYLLABLE MGAT]"  ~~ m/^<+<?InOldItalic>>$/, q{Don't match unrelated <?InOldItalic>} );
...
ok(not "\c[OCR HOOK]" ~~ m/^<-<?InOpticalCharacterRecognition>>$/, q{Don't match externally inverted <?InOpticalCharacterRecognition>} );
ok(not "\c[OCR HOOK]" ~~ m/^<[A]-<?InOpticalCharacterRecognition>>$/, q{Don't match compound inverted <?InOpticalCharacterRecognition>} );
ok(not "\c[OCR HOOK]" ~~ m/^<+<-InOpticalCharacterRecognition>>$/, q{Don't match internally inverted <?InOpticalCharacterRecognition>} );
ok(not "\x[CB83]"  ~~ m/^<+<?InOpticalCharacterRecognition>>$/, q{Don't match unrelated <?InOpticalCharacterRecognition>} );
...
ok(not "\x[0B00]" ~~ m/^<-<?InOriya>>$/, q{Don't match externally inverted <?InOriya>} );
ok(not "\x[0B00]" ~~ m/^<[A]-<?InOriya>>$/, q{Don't match compound inverted <?InOriya>} );
ok(not "\x[0B00]" ~~ m/^<+<-InOriya>>$/, q{Don't match internally inverted <?InOriya>} );
ok(not "\x[6CE7]"  ~~ m/^<+<?InOriya>>$/, q{Don't match unrelated <?InOriya>} );
...
ok(not "\x[7662]"  ~~ m/^<+<?InPrivateUseArea>>$/, q{Don't match unrelated <?InPrivateUseArea>} );
...
ok(not "\c[RUNIC LETTER FEHU FEOH FE F]" ~~ m/^<-<?InRunic>>$/, q{Don't match externally inverted <?InRunic>} );
ok(not "\c[RUNIC LETTER FEHU FEOH FE F]" ~~ m/^<[A]-<?InRunic>>$/, q{Don't match compound inverted <?InRunic>} );
ok(not "\c[RUNIC LETTER FEHU FEOH FE F]" ~~ m/^<+<-InRunic>>$/, q{Don't match internally inverted <?InRunic>} );
ok(not "\x[47A1]"  ~~ m/^<+<?InRunic>>$/, q{Don't match unrelated <?InRunic>} );
...
ok(not "\x[0D80]" ~~ m/^<-<?InSinhala>>$/, q{Don't match externally inverted <?InSinhala>} );
ok(not "\x[0D80]" ~~ m/^<[A]-<?InSinhala>>$/, q{Don't match compound inverted <?InSinhala>} );
ok(not "\x[0D80]" ~~ m/^<+<-InSinhala>>$/, q{Don't match internally inverted <?InSinhala>} );
ok(not "\x[1C39]"  ~~ m/^<+<?InSinhala>>$/, q{Don't match unrelated <?InSinhala>} );
...
ok(not "\c[YI SYLLABLE FAP]"  ~~ m/^<+<?InSmallFormVariants>>$/, q{Don't match unrelated <?InSmallFormVariants>} );
...
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<-<?InSpacingModifierLetters>>$/, q{Don't match externally inverted <?InSpacingModifierLetters>} );
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<[A]-<?InSpacingModifierLetters>>$/, q{Don't match compound inverted <?InSpacingModifierLetters>} );
ok(not "\c[MODIFIER LETTER SMALL H]" ~~ m/^<+<-InSpacingModifierLetters>>$/, q{Don't match internally inverted <?InSpacingModifierLetters>} );
ok(not "\x[08E8]"  ~~ m/^<+<?InSpacingModifierLetters>>$/, q{Don't match unrelated <?InSpacingModifierLetters>} );
...
ok(not "\x[0C7E]"  ~~ m/^<+<?InSpecials>>$/, q{Don't match unrelated <?InSpecials>} );
...
ok(not "\c[SUPERSCRIPT ZERO]" ~~ m/^<-<?InSuperscriptsAndSubscripts>>$/, q{Don't match externally inverted <?InSuperscriptsAndSubscripts>} );
ok(not "\c[SUPERSCRIPT ZERO]" ~~ m/^<[A]-<?InSuperscriptsAndSubscripts>>$/, q{Don't match compound inverted <?InSuperscriptsAndSubscripts>} );
ok(not "\c[SUPERSCRIPT ZERO]" ~~ m/^<+<-InSuperscriptsAndSubscripts>>$/, q{Don't match internally inverted <?InSuperscriptsAndSubscripts>} );
ok(not "\x[D378]"  ~~ m/^<+<?InSuperscriptsAndSubscripts>>$/, q{Don't match unrelated <?InSuperscriptsAndSubscripts>} );
...
ok(not "\c[UPWARDS QUADRUPLE ARROW]" ~~ m/^<-<?InSupplementalArrowsA>>$/, q{Don't match externally inverted <?InSupplementalArrowsA>} );
ok(not "\c[UPWARDS QUADRUPLE ARROW]" ~~ m/^<[A]-<?InSupplementalArrowsA>>$/, q{Don't match compound inverted <?InSupplementalArrowsA>} );
ok(not "\c[UPWARDS QUADRUPLE ARROW]" ~~ m/^<+<-InSupplementalArrowsA>>$/, q{Don't match internally inverted <?InSupplementalArrowsA>} );
ok(not "\c[LIMBU DIGIT SEVEN]"  ~~ m/^<+<?InSupplementalArrowsA>>$/, q{Don't match unrelated <?InSupplementalArrowsA>} );
...
ok(not "\c[RIGHTWARDS TWO-HEADED ARROW WITH VERTICAL STROKE]" ~~ m/^<-<?InSupplementalArrowsB>>$/, q{Don't match externally inverted <?InSupplementalArrowsB>} );
ok(not "\c[RIGHTWARDS TWO-HEADED ARROW WITH VERTICAL STROKE]" ~~ m/^<[A]-<?InSupplementalArrowsB>>$/, q{Don't match compound inverted <?InSupplementalArrowsB>} );
ok(not "\c[RIGHTWARDS TWO-HEADED ARROW WITH VERTICAL STROKE]" ~~ m/^<+<-InSupplementalArrowsB>>$/, q{Don't match internally inverted <?InSupplementalArrowsB>} );
ok(not "\x[1D7D]"  ~~ m/^<+<?InSupplementalArrowsB>>$/, q{Don't match unrelated <?InSupplementalArrowsB>} );
...
ok(not "\c[N-ARY CIRCLED DOT OPERATOR]" ~~ m/^<-<?InSupplementalMathematicalOperators>>$/, q{Don't match externally inverted <?InSupplementalMathematicalOperators>} );
ok(not "\c[N-ARY CIRCLED DOT OPERATOR]" ~~ m/^<[A]-<?InSupplementalMathematicalOperators>>$/, q{Don't match compound inverted <?InSupplementalMathematicalOperators>} );
ok(not "\c[N-ARY CIRCLED DOT OPERATOR]" ~~ m/^<+<-InSupplementalMathematicalOperators>>$/, q{Don't match internally inverted <?InSupplementalMathematicalOperators>} );
ok(not "\c[YI SYLLABLE TAX]"  ~~ m/^<+<?InSupplementalMathematicalOperators>>$/, q{Don't match unrelated <?InSupplementalMathematicalOperators>} );
...
ok(not "\c[TIBETAN LETTER PHA]"  ~~ m/^<+<?InSupplementaryPrivateUseAreaA>>$/, q{Don't match unrelated <?InSupplementaryPrivateUseAreaA>} );
...
ok(not "\x[7E65]"  ~~ m/^<+<?InSupplementaryPrivateUseAreaB>>$/, q{Don't match unrelated <?InSupplementaryPrivateUseAreaB>} );
...
ok(not "\c[SYRIAC END OF PARAGRAPH]" ~~ m/^<-<?InSyriac>>$/, q{Don't match externally inverted <?InSyriac>} );
ok(not "\c[SYRIAC END OF PARAGRAPH]" ~~ m/^<[A]-<?InSyriac>>$/, q{Don't match compound inverted <?InSyriac>} );
ok(not "\c[SYRIAC END OF PARAGRAPH]" ~~ m/^<+<-InSyriac>>$/, q{Don't match internally inverted <?InSyriac>} );
ok(not "\x[CA1C]"  ~~ m/^<+<?InSyriac>>$/, q{Don't match unrelated <?InSyriac>} );
...
ok(not "\c[TAGALOG LETTER A]" ~~ m/^<-<?InTagalog>>$/, q{Don't match externally inverted <?InTagalog>} );
ok(not "\c[TAGALOG LETTER A]" ~~ m/^<[A]-<?InTagalog>>$/, q{Don't match compound inverted <?InTagalog>} );
ok(not "\c[TAGALOG LETTER A]" ~~ m/^<+<-InTagalog>>$/, q{Don't match internally inverted <?InTagalog>} );
ok(not "\x[D49E]"  ~~ m/^<+<?InTagalog>>$/, q{Don't match unrelated <?InTagalog>} );
...
ok(not "\c[TAGBANWA LETTER A]" ~~ m/^<-<?InTagbanwa>>$/, q{Don't match externally inverted <?InTagbanwa>} );
ok(not "\c[TAGBANWA LETTER A]" ~~ m/^<[A]-<?InTagbanwa>>$/, q{Don't match compound inverted <?InTagbanwa>} );
ok(not "\c[TAGBANWA LETTER A]" ~~ m/^<+<-InTagbanwa>>$/, q{Don't match internally inverted <?InTagbanwa>} );
ok(not "\x[AFAA]"  ~~ m/^<+<?InTagbanwa>>$/, q{Don't match unrelated <?InTagbanwa>} );
...
ok(not "\x[CA38]"  ~~ m/^<+<?InTags>>$/, q{Don't match unrelated <?InTags>} );
...
ok(not "\x[0B80]" ~~ m/^<-<?InTamil>>$/, q{Don't match externally inverted <?InTamil>} );
ok(not "\x[0B80]" ~~ m/^<[A]-<?InTamil>>$/, q{Don't match compound inverted <?InTamil>} );
ok(not "\x[0B80]" ~~ m/^<+<-InTamil>>$/, q{Don't match internally inverted <?InTamil>} );
ok(not "\x[D44B]"  ~~ m/^<+<?InTamil>>$/, q{Don't match unrelated <?InTamil>} );
...
ok(not "\x[0C00]" ~~ m/^<-<?InTelugu>>$/, q{Don't match externally inverted <?InTelugu>} );
ok(not "\x[0C00]" ~~ m/^<[A]-<?InTelugu>>$/, q{Don't match compound inverted <?InTelugu>} );
ok(not "\x[0C00]" ~~ m/^<+<-InTelugu>>$/, q{Don't match internally inverted <?InTelugu>} );
ok(not "\x[D3E7]"  ~~ m/^<+<?InTelugu>>$/, q{Don't match unrelated <?InTelugu>} );
...
ok(not "\c[THAANA LETTER HAA]" ~~ m/^<-<?InThaana>>$/, q{Don't match externally inverted <?InThaana>} );
ok(not "\c[THAANA LETTER HAA]" ~~ m/^<[A]-<?InThaana>>$/, q{Don't match compound inverted <?InThaana>} );
ok(not "\c[THAANA LETTER HAA]" ~~ m/^<+<-InThaana>>$/, q{Don't match internally inverted <?InThaana>} );
ok(not "\c[YI SYLLABLE QIT]"  ~~ m/^<+<?InThaana>>$/, q{Don't match unrelated <?InThaana>} );
...
ok(not "\x[0E00]" ~~ m/^<-<?InThai>>$/, q{Don't match externally inverted <?InThai>} );
ok(not "\x[0E00]" ~~ m/^<[A]-<?InThai>>$/, q{Don't match compound inverted <?InThai>} );
ok(not "\x[0E00]" ~~ m/^<+<-InThai>>$/, q{Don't match internally inverted <?InThai>} );
ok(not "\x[BCED]"  ~~ m/^<+<?InThai>>$/, q{Don't match unrelated <?InThai>} );
...
ok(not "\c[TIBETAN SYLLABLE OM]" ~~ m/^<-<?InTibetan>>$/, q{Don't match externally inverted <?InTibetan>} );
ok(not "\c[TIBETAN SYLLABLE OM]" ~~ m/^<[A]-<?InTibetan>>$/, q{Don't match compound inverted <?InTibetan>} );
ok(not "\c[TIBETAN SYLLABLE OM]" ~~ m/^<+<-InTibetan>>$/, q{Don't match internally inverted <?InTibetan>} );
ok(not "\c[ARABIC SIGN SINDHI AMPERSAND]"  ~~ m/^<+<?InTibetan>>$/, q{Don't match unrelated <?InTibetan>} );
...
ok(not "\x[1400]" ~~ m/^<-<?InUnifiedCanadianAboriginalSyllabics>>$/, q{Don't match externally inverted <?InUnifiedCanadianAboriginalSyllabics>} );
ok(not "\x[1400]" ~~ m/^<[A]-<?InUnifiedCanadianAboriginalSyllabics>>$/, q{Don't match compound inverted <?InUnifiedCanadianAboriginalSyllabics>} );
ok(not "\x[1400]" ~~ m/^<+<-InUnifiedCanadianAboriginalSyllabics>>$/, q{Don't match internally inverted <?InUnifiedCanadianAboriginalSyllabics>} );
ok(not "\x[49D8]"  ~~ m/^<+<?InUnifiedCanadianAboriginalSyllabics>>$/, q{Don't match unrelated <?InUnifiedCanadianAboriginalSyllabics>} );
...
ok(not "\x[5307]"  ~~ m/^<+<?InVariationSelectors>>$/, q{Don't match unrelated <?InVariationSelectors>} );
...
ok(not "\c[YI RADICAL QOT]" ~~ m/^<-<?InYiRadicals>>$/, q{Don't match externally inverted <?InYiRadicals>} );
ok(not "\c[YI RADICAL QOT]" ~~ m/^<[A]-<?InYiRadicals>>$/, q{Don't match compound inverted <?InYiRadicals>} );
ok(not "\c[YI RADICAL QOT]" ~~ m/^<+<-InYiRadicals>>$/, q{Don't match internally inverted <?InYiRadicals>} );
ok(not "\x[7CAD]"  ~~ m/^<+<?InYiRadicals>>$/, q{Don't match unrelated <?InYiRadicals>} );
...
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<-<?InYiSyllables>>$/, q{Don't match externally inverted <?InYiSyllables>} );
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<[A]-<?InYiSyllables>>$/, q{Don't match compound inverted <?InYiSyllables>} );
ok(not "\c[YI SYLLABLE IT]" ~~ m/^<+<-InYiSyllables>>$/, q{Don't match internally inverted <?InYiSyllables>} );
ok(not "\c[BRAILLE PATTERN DOTS-1578]"  ~~ m/^<+<?InYiSyllables>>$/, q{Don't match unrelated <?InYiSyllables>} );
