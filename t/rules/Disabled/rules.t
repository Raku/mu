...
is(("abc" ~~ /abc/ && $0), "abc", 're_tests 2/0 (#3)');
...
is(("abbbbc" ~~ /ab**{1..3}bc/ && $0), "abbbbc", 're_tests 40/0 (#67)');
...
is(("abbbbc" ~~ /ab**{3..4}bc/ && $0), "abbbbc", 're_tests 42/0 (#71)');
...
is(("abbc" ~~ /ab?bc/ && $0), "abbc", 're_tests 46/0 (#76)');
# 54: ab?bc	abc	y	$&	abc
is(("abc" ~~ /ab?bc/ && $0), "abc", 're_tests 48/0 (#78)');
# 55: ab{0,1}bc	abc	y	$&	abc
is(("abc" ~~ /ab**{0..1}bc/ && $0), "abc", 're_tests 50/0 (#80)');
# 56: ab?bc	abbbbc	n	-	-
ok((not ("abbbbc" ~~ /ab?bc/)), 're_tests 52  (#82)');
# 57: ab?c	abc	y	$&	abc
is(("abc" ~~ /ab?c/ && $0), "abc", 're_tests 54/0 (#84)');
# 58: ab{0,1}c	abc	y	$&	abc
is(("abc" ~~ /ab**{0..1}c/ && $0), "abc", 're_tests 56/0 (#86)');
# 59: ^abc$	abc	y	$&	abc
is(("abc" ~~ /^abc$/ && $0), "abc", 're_tests 58/0 (#88)');
# 60: ^abc$	abcc	n	-	-
ok((not ("abcc" ~~ /^abc$/)), 're_tests 60  (#90)');
# 61: ^abc	abcc	y	$&	abc
is(("abcc" ~~ /^abc/ && $0), "abc", 're_tests 62/0 (#92)');
# 62: ^abc$	aabc	n	-	-
ok((not ("aabc" ~~ /^abc$/)), 're_tests 64  (#94)');
# 63: abc$	aabc	y	$&	abc
is(("aabc" ~~ /abc$/ && $0), "abc", 're_tests 66/0 (#96)');
# 64: abc$	aabcd	n	-	-
ok((not ("aabcd" ~~ /abc$/)), 're_tests 68  (#98)');
# 65: ^	abc	y	$&	
is(("abc" ~~ /^/ && $0), "", 're_tests 70/0 (#100)');
# 66: $	abc	y	$&	
is(("abc" ~~ /$/ && $0), "", 're_tests 72/0 (#102)');
# 67: a.c	abc	y	$&	abc
is(("abc" ~~ /a\Nc/ && $0), "abc", 're_tests 74/0 (#104)');
# 68: a.c	axc	y	$&	axc
is(("axc" ~~ /a\Nc/ && $0), "axc", 're_tests 76/0 (#106)');
# 69: a.*c	axyzc	y	$&	axyzc
is(("axyzc" ~~ /a\N*c/ && $0), "axyzc", 're_tests 78/0 (#108)');
# 70: a.*c	axyzd	n	-	-
ok((not ("axyzd" ~~ /a\N*c/)), 're_tests 80  (#110)');
# 71: a[bc]d	abc	n	-	-
ok((not ("abc" ~~ /a<[bc]>d/)), 're_tests 82  (#112)');
# 72: a[bc]d	abd	y	$&	abd
is(("abd" ~~ /a<[bc]>d/ && $0), "abd", 're_tests 84/0 (#114)');
# 73: a[b-d]e	abd	n	-	-
ok((not ("abd" ~~ /a<[b-d]>e/)), 're_tests 86  (#116)');
# 74: a[b-d]e	ace	y	$&	ace
is(("ace" ~~ /a<[b-d]>e/ && $0), "ace", 're_tests 88/0 (#118)');
# 75: a[b-d]	aac	y	$&	ac
is(("aac" ~~ /a<[b-d]>/ && $0), "ac", 're_tests 90/0 (#120)');
# 76: a[-b]	a-	y	$&	a-
is(("a-" ~~ /a<[-b]>/ && $0), "a-", 're_tests 92/0 (#122)');
# 77: a[b-]	a-	y	$&	a-
is(("a-" ~~ /a<[b-]>/ && $0), "a-", 're_tests 94/0 (#124)');
...
# -- SKIPPED - TESTS ERROR MESSAGE
# 81: a]	a]	y	$&	a]
is(("a]" ~~ /a]/ && $0), "a]", 're_tests 96/0 (#126)');
# 82: a[]]b	a]b	y	$&	a]b
is(("a]b" ~~ /a<[]>]b/ && $0), "a]b", 're_tests 98/0 (#128)');
# 83: a[^bc]d	aed	y	$&	aed
is(("aed" ~~ /a<[^bc]>d/ && $0), "aed", 're_tests 100/0 (#130)');
# 84: a[^bc]d	abd	n	-	-
ok((not ("abd" ~~ /a<[^bc]>d/)), 're_tests 102  (#132)');
# 85: a[^-b]c	adc	y	$&	adc
is(("adc" ~~ /a<[^-b]>c/ && $0), "adc", 're_tests 104/0 (#134)');
# 86: a[^-b]c	a-c	n	-	-
ok((not ("a-c" ~~ /a<[^-b]>c/)), 're_tests 106  (#136)');
# 87: a[^]b]c	a]c	n	-	-
ok((not ("a]c" ~~ /a<[^]>b]c/)), 're_tests 108  (#138)');
# 88: a[^]b]c	adc	y	$&	adc
is(("adc" ~~ /a<[^]>b]c/ && $0), "adc", 're_tests 110/0 (#140)');
# 89: \ba\b	a-	y	-	-
...
# 128: ab|cd	abc	y	$&	ab
is(("abc" ~~ /ab|cd/ && $0), "ab", 're_tests 188/0 (#218)');
# 129: ab|cd	abcd	y	$&	ab
is(("abcd" ~~ /ab|cd/ && $0), "ab", 're_tests 190/0 (#220)');
# 130: ()ef	def	y	$&-$1	ef-
is(("def" ~~ /(<?null>)ef/ && $0), "ef", 're_tests 192/0 (#223)');
is(("def" ~~ /(<?null>)ef/ && $1), "", 're_tests 192/1 (#224)');
# 131: ()ef	def	y	$-[0]	1
...
# -- SKIPPED - TESTS ERROR MESSAGE
# 139: a\(b	a(b	y	$&-$1	a(b-
is(("a(b" ~~ /a\(b/ && $0), "a(b", 're_tests 200/0 (#233)');
is(("a(b" ~~ /a\(b/ && $1), "", 're_tests 200/1 (#234)');
# 140: a\(*b	ab	y	$&	ab
is(("ab" ~~ /a\(*b/ && $0), "ab", 're_tests 202/0 (#236)');
# 141: a\(*b	a((b	y	$&	a((b
is(("a((b" ~~ /a\(*b/ && $0), "a((b", 're_tests 204/0 (#238)');
# 142: a\\b	a\b	y	$&	a\b
is(("a\b" ~~ /a\\b/ && $0), "a\b", 're_tests 206/0 (#240)');
# 143: abc)	-	c	-	Unmatched )
# -- SKIPPED - TESTS ERROR MESSAGE
# 144: (abc	-	c	-	Unmatched (
# -- SKIPPED - TESTS ERROR MESSAGE
# 145: ((a))	abc	y	$&-$1-$2	a-a-a
is(("abc" ~~ /((a))/ && $0), "a", 're_tests 208/0 (#244)');
is(("abc" ~~ /((a))/ && $1), "a", 're_tests 208/1 (#245)');
is(("abc" ~~ /((a))/ && $2), "a", 're_tests 208/2 (#246)');
...
is(("abc" ~~ /(a)b(c)/ && $0), "abc", 're_tests 210/0 (#250)');
is(("abc" ~~ /(a)b(c)/ && $1), "a", 're_tests 210/1 (#251)');
is(("abc" ~~ /(a)b(c)/ && $2), "c", 're_tests 210/2 (#252)');
# 151: (a)b(c)	abc	y	$-[0]-$-[1]-$-[2]	0-0-2
# 152: (a)b(c)	abc	y	$+[0]-$+[1]-$+[2]	3-1-3 # SKIP
# SKIPPED: script doesn't understand `$-[0]-$-[1]-$-[2]' yet
# SKIPPED: script doesn't understand `$-[0]-$-[1]-$-[2]' yet
# 153: a+b+c	aabbabc	y	$&	abc
is(("aabbabc" ~~ /a+b+c/ && $0), "abc", 're_tests 212/0 (#254)');
# 154: a{1,}b{1,}c	aabbabc	y	$&	abc
is(("aabbabc" ~~ /a**{1...}b**{1...}c/ && $0), "abc", 're_tests 214/0 (#256)');
# 155: a**	-	c	-	Nested quantifiers
# -- SKIPPED - TESTS ERROR MESSAGE
# 156: a.+?c	abcabc	y	$&	abc
is(("abcabc" ~~ /a\N+?c/ && $0), "abc", 're_tests 216/0 (#258)');
# 157: (a+|b)*	ab	y	$&-$1	ab-b
is(("ab" ~~ /(a+|b)*/ && $0), "ab", 're_tests 218/0 (#261)');
is(("ab" ~~ /(a+|b)*/ && $1), "b", 're_tests 218/1 (#262)');
# 158: (a+|b)*	ab	y	$-[0]	0
...
is(("ab" ~~ /(a+|b)**{0...}/ && $0), "ab", 're_tests 224/0 (#269)');
is(("ab" ~~ /(a+|b)**{0...}/ && $1), "b", 're_tests 224/1 (#270)');
# 163: (a+|b)+	ab	y	$&-$1	ab-b
is(("ab" ~~ /(a+|b)+/ && $0), "ab", 're_tests 226/0 (#273)');
is(("ab" ~~ /(a+|b)+/ && $1), "b", 're_tests 226/1 (#274)');
# 164: (a+|b){1,}	ab	y	$&-$1	ab-b
is(("ab" ~~ /(a+|b)**{1...}/ && $0), "ab", 're_tests 228/0 (#277)');
is(("ab" ~~ /(a+|b)**{1...}/ && $1), "b", 're_tests 228/1 (#278)');
# 165: (a+|b)?	ab	y	$&-$1	a-a
is(("ab" ~~ /(a+|b)?/ && $0), "a", 're_tests 230/0 (#281)');
is(("ab" ~~ /(a+|b)?/ && $1), "a", 're_tests 230/1 (#282)');
# 166: (a+|b){0,1}	ab	y	$&-$1	a-a
is(("ab" ~~ /(a+|b)**{0..1}/ && $0), "a", 're_tests 232/0 (#285)');
is(("ab" ~~ /(a+|b)**{0..1}/ && $1), "a", 're_tests 232/1 (#286)');
# 167: )(	-	c	-	Unmatched )
# -- SKIPPED - TESTS ERROR MESSAGE
# 168: [^ab]*	cde	y	$&	cde
is(("cde" ~~ /<[^ab]>*/ && $0), "cde", 're_tests 234/0 (#288)');
# 169: abc		n	-	-
ok((not ("" ~~ /abc/)), 're_tests 236  (#290)');
# 170: a*		y	$&	
is(("" ~~ /a*/ && $0), "", 're_tests 238/0 (#292)');
# 171: ([abc])*d	abbbcd	y	$&-$1	abbbcd-c
is(("abbbcd" ~~ /(<[abc]>)*d/ && $0), "abbbcd", 're_tests 240/0 (#295)');
is(("abbbcd" ~~ /(<[abc]>)*d/ && $1), "c", 're_tests 240/1 (#296)');
# 172: ([abc])*bcd	abcd	y	$&-$1	abcd-a
is(("abcd" ~~ /(<[abc]>)*bcd/ && $0), "abcd", 're_tests 242/0 (#299)');
is(("abcd" ~~ /(<[abc]>)*bcd/ && $1), "a", 're_tests 242/1 (#300)');
# 173: a|b|c|d|e	e	y	$&	e
is(("e" ~~ /a|b|c|d|e/ && $0), "e", 're_tests 244/0 (#302)');
# 174: (a|b|c|d|e)f	ef	y	$&-$1	ef-e
is(("ef" ~~ /(a|b|c|d|e)f/ && $0), "ef", 're_tests 246/0 (#305)');
is(("ef" ~~ /(a|b|c|d|e)f/ && $1), "e", 're_tests 246/1 (#306)');
...
is(("abcdefg" ~~ /abcd*efg/ && $0), "abcdefg", 're_tests 252/0 (#312)');
# 180: ab*	xabyabbbz	y	$&	ab
is(("xabyabbbz" ~~ /ab*/ && $0), "ab", 're_tests 254/0 (#314)');
# 181: ab*	xayabbbz	y	$&	a
is(("xayabbbz" ~~ /ab*/ && $0), "a", 're_tests 256/0 (#316)');
# 182: (ab|cd)e	abcde	y	$&-$1	cde-cd
is(("abcde" ~~ /(ab|cd)e/ && $0), "cde", 're_tests 258/0 (#319)');
is(("abcde" ~~ /(ab|cd)e/ && $1), "cd", 're_tests 258/1 (#320)');
# 183: [abhgefdc]ij	hij	y	$&	hij
is(("hij" ~~ /<[abhgefdc]>ij/ && $0), "hij", 're_tests 260/0 (#322)');
# 184: ^(ab|cd)e	abcde	n	x$1y	xy
# SKIPPED: script doesn't understand `x$1y' yet
# SKIPPED: script doesn't understand `x$1y' yet
# 185: (abc|)ef	abcdef	y	$&-$1	ef-
is(("abcdef" ~~ /(abc|<?null>)ef/ && $0), "ef", 're_tests 262/0 (#325)');
is(("abcdef" ~~ /(abc|<?null>)ef/ && $1), "", 're_tests 262/1 (#326)');
# 186: (a|b)c*d	abcd	y	$&-$1	bcd-b
is(("abcd" ~~ /(a|b)c*d/ && $0), "bcd", 're_tests 264/0 (#329)');
is(("abcd" ~~ /(a|b)c*d/ && $1), "b", 're_tests 264/1 (#330)');
# 187: (ab|ab*)bc	abc	y	$&-$1	abc-a
is(("abc" ~~ /(ab|ab*)bc/ && $0), "abc", 're_tests 266/0 (#333)');
is(("abc" ~~ /(ab|ab*)bc/ && $1), "a", 're_tests 266/1 (#334)');
# 188: a([bc]*)c*	abc	y	$&-$1	abc-bc
is(("abc" ~~ /a(<[bc]>*)c*/ && $0), "abc", 're_tests 268/0 (#337)');
is(("abc" ~~ /a(<[bc]>*)c*/ && $1), "bc", 're_tests 268/1 (#338)');
# 189: a([bc]*)(c*d)	abcd	y	$&-$1-$2	abcd-bc-d
is(("abcd" ~~ /a(<[bc]>*)(c*d)/ && $0), "abcd", 're_tests 270/0 (#342)');
is(("abcd" ~~ /a(<[bc]>*)(c*d)/ && $1), "bc", 're_tests 270/1 (#343)');
is(("abcd" ~~ /a(<[bc]>*)(c*d)/ && $2), "d", 're_tests 270/2 (#344)');
...
is(("abcd" ~~ /a(<[bc]>+)(c*d)/ && $0), "abcd", 're_tests 278/0 (#354)');
is(("abcd" ~~ /a(<[bc]>+)(c*d)/ && $1), "bc", 're_tests 278/1 (#355)');
is(("abcd" ~~ /a(<[bc]>+)(c*d)/ && $2), "d", 're_tests 278/2 (#356)');
# 197: a([bc]*)(c+d)	abcd	y	$&-$1-$2	abcd-b-cd
is(("abcd" ~~ /a(<[bc]>*)(c+d)/ && $0), "abcd", 're_tests 280/0 (#360)');
is(("abcd" ~~ /a(<[bc]>*)(c+d)/ && $1), "b", 're_tests 280/1 (#361)');
is(("abcd" ~~ /a(<[bc]>*)(c+d)/ && $2), "cd", 're_tests 280/2 (#362)');
...
is(("adcdcde" ~~ /a<[bcd]>*dcdcde/ && $0), "adcdcde", 're_tests 288/0 (#370)');
# 205: a[bcd]+dcdcde	adcdcde	n	-	-
ok((not ("adcdcde" ~~ /a<[bcd]>+dcdcde/)), 're_tests 290  (#372)');
# 206: (ab|a)b*c	abc	y	$&-$1	abc-ab
is(("abc" ~~ /(ab|a)b*c/ && $0), "abc", 're_tests 292/0 (#375)');
is(("abc" ~~ /(ab|a)b*c/ && $1), "ab", 're_tests 292/1 (#376)');
...
is(("alpha" ~~ /<[a-zA-Z_]><[a-zA-Z0-9_]>*/ && $0), "alpha", 're_tests 308/0 (#392)');
# 223: ^a(bc+|b[eh])g|.h$	abh	y	$&-$1	bh-
is(("abh" ~~ /^a(bc+|b<[eh]>)g|\Nh$/ && $0), "bh", 're_tests 310/0 (#395)');
is(("abh" ~~ /^a(bc+|b<[eh]>)g|\Nh$/ && $1), "", 're_tests 310/1 (#396)');
# 224: (bc+d$|ef*g.|h?i(j|k))	effgz	y	$&-$1-$2	effgz-effgz-
is(("effgz" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $0), "effgz", 're_tests 312/0 (#400)');
is(("effgz" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $1), "effgz", 're_tests 312/1 (#401)');
is(("effgz" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $2), "", 're_tests 312/2 (#402)');
# 225: (bc+d$|ef*g.|h?i(j|k))	ij	y	$&-$1-$2	ij-ij-j
is(("ij" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $0), "ij", 're_tests 314/0 (#406)');
is(("ij" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $1), "ij", 're_tests 314/1 (#407)');
is(("ij" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $2), "j", 're_tests 314/2 (#408)');
...
is(("reffgz" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $0), "effgz", 're_tests 320/0 (#416)');
is(("reffgz" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $1), "effgz", 're_tests 320/1 (#417)');
is(("reffgz" ~~ /(bc+d$|ef*g\N|h?i(j|k))/ && $2), "", 're_tests 320/2 (#418)');
# 229: ((((((((((a))))))))))	a	y	$10	a
is(("a" ~~ /((((((((((a))))))))))/ && $10), "a", 're_tests 322/10 (#420)');
# 230: ((((((((((a))))))))))	a	y	$-[0]	0
# 231: ((((((((((a))))))))))	a	y	$+[0]	1 # SKIP
...
# 234: ((((((((((a))))))))))\10	aa	y	$&	aa
is(("aa" ~~ /((((((((((a))))))))))$10/ && $0), "aa", 're_tests 328/0 (#426)');
# 235: ((((((((((a))))))))))${bang}	aa	n	-	-
# -- SKIPPED - p5re_to_p6rule doesn't support this yet
# 236: ((((((((((a))))))))))${bang}	a!	y	$&	a!
# -- SKIPPED - p5re_to_p6rule doesn't support this yet
# 237: (((((((((a)))))))))	a	y	$&	a
is(("a" ~~ /(((((((((a)))))))))/ && $0), "a", 're_tests 332/0 (#430)');
...
is(("multiple words, yeah" ~~ /multiple<sp>words/ && $0), "multiple words", 're_tests 336/0 (#434)');
# 240: (.*)c(.*)	abcde	y	$&-$1-$2	abcde-ab-de
is(("abcde" ~~ /(\N*)c(\N*)/ && $0), "abcde", 're_tests 338/0 (#438)');
is(("abcde" ~~ /(\N*)c(\N*)/ && $1), "ab", 're_tests 338/1 (#439)');
is(("abcde" ~~ /(\N*)c(\N*)/ && $2), "de", 're_tests 338/2 (#440)');
# 241: \((.*), (.*)\)	(a, b)	y	($2, $1)	(b, a)
...
# SKIPPED: script doesn't understand `$1-\$1-\\$1' yet
# 245: a[-]?c	ac	y	$&	ac
is(("ac" ~~ /a<[-]>?c/ && $0), "ac", 're_tests 342/0 (#444)');
# 246: (abc)\1	abcabc	y	$1	abc
is(("abcabc" ~~ /(abc)$1/ && $1), "abc", 're_tests 344/1 (#446)');
# 247: ([a-c]*)\1	abcabc	y	$1	abc
is(("abcabc" ~~ /(<[a-c]>*)$1/ && $1), "abc", 're_tests 346/1 (#448)');
# 248: \1	-	c	-	Reference to nonexistent group
# -- SKIPPED - TESTS ERROR MESSAGE
# 249: \2	-	c	-	Reference to nonexistent group
# -- SKIPPED - TESTS ERROR MESSAGE
# 250: (a)|\1	a	y	-	-
#ok(("a" ~~ /(a)|$1/), 're_tests 348  (#450)');
# 251: (a)|\1	x	n	-	-
#ok((not ("x" ~~ /(a)|$1/)), 're_tests 350  (#452)');
# 252: (a)|\2	-	c	-	Reference to nonexistent group
# -- SKIPPED - TESTS ERROR MESSAGE
# 253: (([a-c])b*?\2)*	ababbbcbc	y	$&-$1-$2	ababb-bb-b
is(("ababbbcbc" ~~ /((<[a-c]>)b*?$2)*/ && $0), "ababb", 're_tests 352/0 (#456)');
is(("ababbbcbc" ~~ /((<[a-c]>)b*?$2)*/ && $1), "bb", 're_tests 352/1 (#457)');
is(("ababbbcbc" ~~ /((<[a-c]>)b*?$2)*/ && $2), "b", 're_tests 352/2 (#458)');
# 254: (([a-c])b*?\2){3}	ababbbcbc	y	$&-$1-$2	ababbbcbc-cbc-c
is(("ababbbcbc" ~~ /((<[a-c]>)b*?$2)**{3}/ && $0), "ababbbcbc", 're_tests 354/0 (#462)');
is(("ababbbcbc" ~~ /((<[a-c]>)b*?$2)**{3}/ && $1), "cbc", 're_tests 354/1 (#463)');
is(("ababbbcbc" ~~ /((<[a-c]>)b*?$2)**{3}/ && $2), "c", 're_tests 354/2 (#464)');
# 255: ((\3|b)\2(a)x)+	aaxabxbaxbbx	n	-	-
#ok((not ("aaxabxbaxbbx" ~~ /(($3|b)$2(a)x)+/)), 're_tests 356  (#466)');
...
# 264: 'abc'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/abc/ && $0), "ABC", 're_tests 362/0 (#472)');
# 265: 'abc'i	XBC	n	-	-
...
is(("XABCY" ~~ rx:i/abc/ && $0), "ABC", 're_tests 370/0 (#480)');
# 269: 'abc'i	ABABC	y	$&	ABC
is(("ABABC" ~~ rx:i/abc/ && $0), "ABC", 're_tests 372/0 (#482)');
# 270: 'ab*c'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/ab*c/ && $0), "ABC", 're_tests 374/0 (#484)');
# 271: 'ab*bc'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/ab*bc/ && $0), "ABC", 're_tests 376/0 (#486)');
# 272: 'ab*bc'i	ABBC	y	$&	ABBC
is(("ABBC" ~~ rx:i/ab*bc/ && $0), "ABBC", 're_tests 378/0 (#488)');
# 273: 'ab*?bc'i	ABBBBC	y	$&	ABBBBC
is(("ABBBBC" ~~ rx:i/ab*?bc/ && $0), "ABBBBC", 're_tests 380/0 (#490)');
# 274: 'ab{0,}?bc'i	ABBBBC	y	$&	ABBBBC
is(("ABBBBC" ~~ rx:i/ab**{0...}?bc/ && $0), "ABBBBC", 're_tests 382/0 (#492)');
# 275: 'ab+?bc'i	ABBC	y	$&	ABBC
is(("ABBC" ~~ rx:i/ab+?bc/ && $0), "ABBC", 're_tests 384/0 (#494)');
# 276: 'ab+bc'i	ABC	n	-	-
...
is(("ABBBBC" ~~ rx:i/ab+bc/ && $0), "ABBBBC", 're_tests 392/0 (#502)');
# 280: 'ab{1,}?bc'i	ABBBBC	y	$&	ABBBBC
is(("ABBBBC" ~~ rx:i/ab**{1...}?bc/ && $0), "ABBBBC", 're_tests 394/0 (#504)');
# 281: 'ab{1,3}?bc'i	ABBBBC	y	$&	ABBBBC
is(("ABBBBC" ~~ rx:i/ab**{1..3}?bc/ && $0), "ABBBBC", 're_tests 396/0 (#506)');
# 282: 'ab{3,4}?bc'i	ABBBBC	y	$&	ABBBBC
is(("ABBBBC" ~~ rx:i/ab**{3..4}?bc/ && $0), "ABBBBC", 're_tests 398/0 (#508)');
# 283: 'ab{4,5}?bc'i	ABBBBC	n	-	-
ok((not ("ABBBBC" ~~ rx:i/ab**{4..5}?bc/)), 're_tests 400  (#510)');
# 284: 'ab??bc'i	ABBC	y	$&	ABBC
is(("ABBC" ~~ rx:i/ab??bc/ && $0), "ABBC", 're_tests 402/0 (#512)');
# 285: 'ab??bc'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/ab??bc/ && $0), "ABC", 're_tests 404/0 (#514)');
# 286: 'ab{0,1}?bc'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/ab**{0..1}?bc/ && $0), "ABC", 're_tests 406/0 (#516)');
# 287: 'ab??bc'i	ABBBBC	n	-	-
ok((not ("ABBBBC" ~~ rx:i/ab??bc/)), 're_tests 408  (#518)');
# 288: 'ab??c'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/ab??c/ && $0), "ABC", 're_tests 410/0 (#520)');
# 289: 'ab{0,1}?c'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/ab**{0..1}?c/ && $0), "ABC", 're_tests 412/0 (#522)');
# 290: '^abc$'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/^abc$/ && $0), "ABC", 're_tests 414/0 (#524)');
# 291: '^abc$'i	ABCC	n	-	-
ok((not ("ABCC" ~~ rx:i/^abc$/)), 're_tests 416  (#526)');
# 292: '^abc'i	ABCC	y	$&	ABC
is(("ABCC" ~~ rx:i/^abc/ && $0), "ABC", 're_tests 418/0 (#528)');
# 293: '^abc$'i	AABC	n	-	-
ok((not ("AABC" ~~ rx:i/^abc$/)), 're_tests 420  (#530)');
# 294: 'abc$'i	AABC	y	$&	ABC
is(("AABC" ~~ rx:i/abc$/ && $0), "ABC", 're_tests 422/0 (#532)');
# 295: '^'i	ABC	y	$&	
is(("ABC" ~~ rx:i/^/ && $0), "", 're_tests 424/0 (#534)');
# 296: '$'i	ABC	y	$&	
is(("ABC" ~~ rx:i/$/ && $0), "", 're_tests 426/0 (#536)');
# 297: 'a.c'i	ABC	y	$&	ABC
is(("ABC" ~~ rx:i/a\Nc/ && $0), "ABC", 're_tests 428/0 (#538)');
# 298: 'a.c'i	AXC	y	$&	AXC
is(("AXC" ~~ rx:i/a\Nc/ && $0), "AXC", 're_tests 430/0 (#540)');
# 299: 'a.*?c'i	AXYZC	y	$&	AXYZC
is(("AXYZC" ~~ rx:i/a\N*?c/ && $0), "AXYZC", 're_tests 432/0 (#542)');
# 300: 'a.*c'i	AXYZD	n	-	-
ok((not ("AXYZD" ~~ rx:i/a\N*c/)), 're_tests 434  (#544)');
# 301: 'a[bc]d'i	ABC	n	-	-
ok((not ("ABC" ~~ rx:i/a<[bc]>d/)), 're_tests 436  (#546)');
# 302: 'a[bc]d'i	ABD	y	$&	ABD
is(("ABD" ~~ rx:i/a<[bc]>d/ && $0), "ABD", 're_tests 438/0 (#548)');
# 303: 'a[b-d]e'i	ABD	n	-	-
ok((not ("ABD" ~~ rx:i/a<[b-d]>e/)), 're_tests 440  (#550)');
# 304: 'a[b-d]e'i	ACE	y	$&	ACE
is(("ACE" ~~ rx:i/a<[b-d]>e/ && $0), "ACE", 're_tests 442/0 (#552)');
# 305: 'a[b-d]'i	AAC	y	$&	AC
is(("AAC" ~~ rx:i/a<[b-d]>/ && $0), "AC", 're_tests 444/0 (#554)');
# 306: 'a[-b]'i	A-	y	$&	A-
is(("A-" ~~ rx:i/a<[-b]>/ && $0), "A-", 're_tests 446/0 (#556)');
# 307: 'a[b-]'i	A-	y	$&	A-
is(("A-" ~~ rx:i/a<[b-]>/ && $0), "A-", 're_tests 448/0 (#558)');
...
# -- SKIPPED - TESTS ERROR MESSAGE
# 311: 'a]'i	A]	y	$&	A]
is(("A]" ~~ rx:i/a]/ && $0), "A]", 're_tests 450/0 (#560)');
# 312: 'a[]]b'i	A]B	y	$&	A]B
is(("A]B" ~~ rx:i/a<[]>]b/ && $0), "A]B", 're_tests 452/0 (#562)');
# 313: 'a[^bc]d'i	AED	y	$&	AED
is(("AED" ~~ rx:i/a<[^bc]>d/ && $0), "AED", 're_tests 454/0 (#564)');
# 314: 'a[^bc]d'i	ABD	n	-	-
ok((not ("ABD" ~~ rx:i/a<[^bc]>d/)), 're_tests 456  (#566)');
# 315: 'a[^-b]c'i	ADC	y	$&	ADC
is(("ADC" ~~ rx:i/a<[^-b]>c/ && $0), "ADC", 're_tests 458/0 (#568)');
# 316: 'a[^-b]c'i	A-C	n	-	-
ok((not ("A-C" ~~ rx:i/a<[^-b]>c/)), 're_tests 460  (#570)');
# 317: 'a[^]b]c'i	A]C	n	-	-
ok((not ("A]C" ~~ rx:i/a<[^]>b]c/)), 're_tests 462  (#572)');
# 318: 'a[^]b]c'i	ADC	y	$&	ADC
is(("ADC" ~~ rx:i/a<[^]>b]c/ && $0), "ADC", 're_tests 464/0 (#574)');
# 319: 'ab|cd'i	ABC	y	$&	AB
is(("ABC" ~~ rx:i/ab|cd/ && $0), "AB", 're_tests 466/0 (#576)');
# 320: 'ab|cd'i	ABCD	y	$&	AB
is(("ABCD" ~~ rx:i/ab|cd/ && $0), "AB", 're_tests 468/0 (#578)');
# 321: '()ef'i	DEF	y	$&-$1	EF-
is(("DEF" ~~ rx:i/(<?null>)ef/ && $0), "EF", 're_tests 470/0 (#581)');
is(("DEF" ~~ rx:i/(<?null>)ef/ && $1), "", 're_tests 470/1 (#582)');
...
is(("A(B" ~~ rx:i/a\(b/ && $0), "A(B", 're_tests 474/0 (#587)');
is(("A(B" ~~ rx:i/a\(b/ && $1), "", 're_tests 474/1 (#588)');
# 327: 'a\(*b'i	AB	y	$&	AB
is(("AB" ~~ rx:i/a\(*b/ && $0), "AB", 're_tests 476/0 (#590)');
# 328: 'a\(*b'i	A((B	y	$&	A((B
is(("A((B" ~~ rx:i/a\(*b/ && $0), "A((B", 're_tests 478/0 (#592)');
# 329: 'a\\b'i	A\B	y	$&	A\B
is(("A\B" ~~ rx:i/a\\b/ && $0), "A\B", 're_tests 480/0 (#594)');
# 330: 'abc)'i	-	c	-	Unmatched )
# -- SKIPPED - TESTS ERROR MESSAGE
# 331: '(abc'i	-	c	-	Unmatched (
# -- SKIPPED - TESTS ERROR MESSAGE
# 332: '((a))'i	ABC	y	$&-$1-$2	A-A-A
is(("ABC" ~~ rx:i/((a))/ && $0), "A", 're_tests 482/0 (#598)');
is(("ABC" ~~ rx:i/((a))/ && $1), "A", 're_tests 482/1 (#599)');
is(("ABC" ~~ rx:i/((a))/ && $2), "A", 're_tests 482/2 (#600)');
# 333: '(a)b(c)'i	ABC	y	$&-$1-$2	ABC-A-C
is(("ABC" ~~ rx:i/(a)b(c)/ && $0), "ABC", 're_tests 484/0 (#604)');
is(("ABC" ~~ rx:i/(a)b(c)/ && $1), "A", 're_tests 484/1 (#605)');
is(("ABC" ~~ rx:i/(a)b(c)/ && $2), "C", 're_tests 484/2 (#606)');
# 334: 'a+b+c'i	AABBABC	y	$&	ABC
is(("AABBABC" ~~ rx:i/a+b+c/ && $0), "ABC", 're_tests 486/0 (#608)');
# 335: 'a{1,}b{1,}c'i	AABBABC	y	$&	ABC
is(("AABBABC" ~~ rx:i/a**{1...}b**{1...}c/ && $0), "ABC", 're_tests 488/0 (#610)');
# 336: 'a**'i	-	c	-	Nested quantifiers
# -- SKIPPED - TESTS ERROR MESSAGE
# 337: 'a.+?c'i	ABCABC	y	$&	ABC
is(("ABCABC" ~~ rx:i/a\N+?c/ && $0), "ABC", 're_tests 490/0 (#612)');
# 338: 'a.*?c'i	ABCABC	y	$&	ABC
is(("ABCABC" ~~ rx:i/a\N*?c/ && $0), "ABC", 're_tests 492/0 (#614)');
# 339: 'a.{0,5}?c'i	ABCABC	y	$&	ABC
is(("ABCABC" ~~ rx:i/a\N**{0..5}?c/ && $0), "ABC", 're_tests 494/0 (#616)');
# 340: '(a+|b)*'i	AB	y	$&-$1	AB-B
is(("AB" ~~ rx:i/(a+|b)*/ && $0), "AB", 're_tests 496/0 (#619)');
is(("AB" ~~ rx:i/(a+|b)*/ && $1), "B", 're_tests 496/1 (#620)');
# 341: '(a+|b){0,}'i	AB	y	$&-$1	AB-B
is(("AB" ~~ rx:i/(a+|b)**{0...}/ && $0), "AB", 're_tests 498/0 (#623)');
is(("AB" ~~ rx:i/(a+|b)**{0...}/ && $1), "B", 're_tests 498/1 (#624)');
# 342: '(a+|b)+'i	AB	y	$&-$1	AB-B
is(("AB" ~~ rx:i/(a+|b)+/ && $0), "AB", 're_tests 500/0 (#627)');
is(("AB" ~~ rx:i/(a+|b)+/ && $1), "B", 're_tests 500/1 (#628)');
# 343: '(a+|b){1,}'i	AB	y	$&-$1	AB-B
is(("AB" ~~ rx:i/(a+|b)**{1...}/ && $0), "AB", 're_tests 502/0 (#631)');
is(("AB" ~~ rx:i/(a+|b)**{1...}/ && $1), "B", 're_tests 502/1 (#632)');
# 344: '(a+|b)?'i	AB	y	$&-$1	A-A
is(("AB" ~~ rx:i/(a+|b)?/ && $0), "A", 're_tests 504/0 (#635)');
is(("AB" ~~ rx:i/(a+|b)?/ && $1), "A", 're_tests 504/1 (#636)');
# 345: '(a+|b){0,1}'i	AB	y	$&-$1	A-A
is(("AB" ~~ rx:i/(a+|b)**{0..1}/ && $0), "A", 're_tests 506/0 (#639)');
is(("AB" ~~ rx:i/(a+|b)**{0..1}/ && $1), "A", 're_tests 506/1 (#640)');
# 346: '(a+|b){0,1}?'i	AB	y	$&-$1	-
is(("AB" ~~ rx:i/(a+|b)**{0..1}?/ && $0), "", 're_tests 508/0 (#643)');
is(("AB" ~~ rx:i/(a+|b)**{0..1}?/ && $1), "", 're_tests 508/1 (#644)');
# 347: ')('i	-	c	-	Unmatched )
# -- SKIPPED - TESTS ERROR MESSAGE
# 348: '[^ab]*'i	CDE	y	$&	CDE
is(("CDE" ~~ rx:i/<[^ab]>*/ && $0), "CDE", 're_tests 510/0 (#646)');
# 349: 'abc'i		n	-	-
ok((not ("" ~~ rx:i/abc/)), 're_tests 512  (#648)');
# 350: 'a*'i		y	$&	
is(("" ~~ rx:i/a*/ && $0), "", 're_tests 514/0 (#650)');
# 351: '([abc])*d'i	ABBBCD	y	$&-$1	ABBBCD-C
is(("ABBBCD" ~~ rx:i/(<[abc]>)*d/ && $0), "ABBBCD", 're_tests 516/0 (#653)');
is(("ABBBCD" ~~ rx:i/(<[abc]>)*d/ && $1), "C", 're_tests 516/1 (#654)');
# 352: '([abc])*bcd'i	ABCD	y	$&-$1	ABCD-A
is(("ABCD" ~~ rx:i/(<[abc]>)*bcd/ && $0), "ABCD", 're_tests 518/0 (#657)');
is(("ABCD" ~~ rx:i/(<[abc]>)*bcd/ && $1), "A", 're_tests 518/1 (#658)');
# 353: 'a|b|c|d|e'i	E	y	$&	E
is(("E" ~~ rx:i/a|b|c|d|e/ && $0), "E", 're_tests 520/0 (#660)');
# 354: '(a|b|c|d|e)f'i	EF	y	$&-$1	EF-E
is(("EF" ~~ rx:i/(a|b|c|d|e)f/ && $0), "EF", 're_tests 522/0 (#663)');
is(("EF" ~~ rx:i/(a|b|c|d|e)f/ && $1), "E", 're_tests 522/1 (#664)');
# 355: 'abcd*efg'i	ABCDEFG	y	$&	ABCDEFG
is(("ABCDEFG" ~~ rx:i/abcd*efg/ && $0), "ABCDEFG", 're_tests 524/0 (#666)');
# 356: 'ab*'i	XABYABBBZ	y	$&	AB
is(("XABYABBBZ" ~~ rx:i/ab*/ && $0), "AB", 're_tests 526/0 (#668)');
# 357: 'ab*'i	XAYABBBZ	y	$&	A
is(("XAYABBBZ" ~~ rx:i/ab*/ && $0), "A", 're_tests 528/0 (#670)');
# 358: '(ab|cd)e'i	ABCDE	y	$&-$1	CDE-CD
is(("ABCDE" ~~ rx:i/(ab|cd)e/ && $0), "CDE", 're_tests 530/0 (#673)');
is(("ABCDE" ~~ rx:i/(ab|cd)e/ && $1), "CD", 're_tests 530/1 (#674)');
# 359: '[abhgefdc]ij'i	HIJ	y	$&	HIJ
is(("HIJ" ~~ rx:i/<[abhgefdc]>ij/ && $0), "HIJ", 're_tests 532/0 (#676)');
# 360: '^(ab|cd)e'i	ABCDE	n	x$1y	XY
# SKIPPED: script doesn't understand `x$1y' yet
# SKIPPED: script doesn't understand `x$1y' yet
# 361: '(abc|)ef'i	ABCDEF	y	$&-$1	EF-
is(("ABCDEF" ~~ rx:i/(abc|<?null>)ef/ && $0), "EF", 're_tests 534/0 (#679)');
is(("ABCDEF" ~~ rx:i/(abc|<?null>)ef/ && $1), "", 're_tests 534/1 (#680)');
# 362: '(a|b)c*d'i	ABCD	y	$&-$1	BCD-B
is(("ABCD" ~~ rx:i/(a|b)c*d/ && $0), "BCD", 're_tests 536/0 (#683)');
is(("ABCD" ~~ rx:i/(a|b)c*d/ && $1), "B", 're_tests 536/1 (#684)');
# 363: '(ab|ab*)bc'i	ABC	y	$&-$1	ABC-A
is(("ABC" ~~ rx:i/(ab|ab*)bc/ && $0), "ABC", 're_tests 538/0 (#687)');
is(("ABC" ~~ rx:i/(ab|ab*)bc/ && $1), "A", 're_tests 538/1 (#688)');
# 364: 'a([bc]*)c*'i	ABC	y	$&-$1	ABC-BC
is(("ABC" ~~ rx:i/a(<[bc]>*)c*/ && $0), "ABC", 're_tests 540/0 (#691)');
is(("ABC" ~~ rx:i/a(<[bc]>*)c*/ && $1), "BC", 're_tests 540/1 (#692)');
# 365: 'a([bc]*)(c*d)'i	ABCD	y	$&-$1-$2	ABCD-BC-D
is(("ABCD" ~~ rx:i/a(<[bc]>*)(c*d)/ && $0), "ABCD", 're_tests 542/0 (#696)');
is(("ABCD" ~~ rx:i/a(<[bc]>*)(c*d)/ && $1), "BC", 're_tests 542/1 (#697)');
is(("ABCD" ~~ rx:i/a(<[bc]>*)(c*d)/ && $2), "D", 're_tests 542/2 (#698)');
# 366: 'a([bc]+)(c*d)'i	ABCD	y	$&-$1-$2	ABCD-BC-D
is(("ABCD" ~~ rx:i/a(<[bc]>+)(c*d)/ && $0), "ABCD", 're_tests 544/0 (#702)');
is(("ABCD" ~~ rx:i/a(<[bc]>+)(c*d)/ && $1), "BC", 're_tests 544/1 (#703)');
is(("ABCD" ~~ rx:i/a(<[bc]>+)(c*d)/ && $2), "D", 're_tests 544/2 (#704)');
# 367: 'a([bc]*)(c+d)'i	ABCD	y	$&-$1-$2	ABCD-B-CD
is(("ABCD" ~~ rx:i/a(<[bc]>*)(c+d)/ && $0), "ABCD", 're_tests 546/0 (#708)');
is(("ABCD" ~~ rx:i/a(<[bc]>*)(c+d)/ && $1), "B", 're_tests 546/1 (#709)');
is(("ABCD" ~~ rx:i/a(<[bc]>*)(c+d)/ && $2), "CD", 're_tests 546/2 (#710)');
# 368: 'a[bcd]*dcdcde'i	ADCDCDE	y	$&	ADCDCDE
is(("ADCDCDE" ~~ rx:i/a<[bcd]>*dcdcde/ && $0), "ADCDCDE", 're_tests 548/0 (#712)');
# 369: 'a[bcd]+dcdcde'i	ADCDCDE	n	-	-
ok((not ("ADCDCDE" ~~ rx:i/a<[bcd]>+dcdcde/)), 're_tests 550  (#714)');
# 370: '(ab|a)b*c'i	ABC	y	$&-$1	ABC-AB
is(("ABC" ~~ rx:i/(ab|a)b*c/ && $0), "ABC", 're_tests 552/0 (#717)');
is(("ABC" ~~ rx:i/(ab|a)b*c/ && $1), "AB", 're_tests 552/1 (#718)');
# 371: '((a)(b)c)(d)'i	ABCD	y	$1-$2-$3-$4	ABC-A-B-D
# SKIPPED: script doesn't understand `$1-$2-$3-$4' yet
# SKIPPED: script doesn't understand `$1-$2-$3-$4' yet
# 372: '[a-zA-Z_][a-zA-Z0-9_]*'i	ALPHA	y	$&	ALPHA
is(("ALPHA" ~~ rx:i/<[a-zA-Z_]><[a-zA-Z0-9_]>*/ && $0), "ALPHA", 're_tests 554/0 (#720)');
# 373: '^a(bc+|b[eh])g|.h$'i	ABH	y	$&-$1	BH-
is(("ABH" ~~ rx:i/^a(bc+|b<[eh]>)g|\Nh$/ && $0), "BH", 're_tests 556/0 (#723)');
is(("ABH" ~~ rx:i/^a(bc+|b<[eh]>)g|\Nh$/ && $1), "", 're_tests 556/1 (#724)');
# 374: '(bc+d$|ef*g.|h?i(j|k))'i	EFFGZ	y	$&-$1-$2	EFFGZ-EFFGZ-
is(("EFFGZ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $0), "EFFGZ", 're_tests 558/0 (#728)');
is(("EFFGZ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $1), "EFFGZ", 're_tests 558/1 (#729)');
is(("EFFGZ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $2), "", 're_tests 558/2 (#730)');
# 375: '(bc+d$|ef*g.|h?i(j|k))'i	IJ	y	$&-$1-$2	IJ-IJ-J
is(("IJ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $0), "IJ", 're_tests 560/0 (#734)');
is(("IJ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $1), "IJ", 're_tests 560/1 (#735)');
is(("IJ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $2), "J", 're_tests 560/2 (#736)');
...
is(("REFFGZ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $0), "EFFGZ", 're_tests 566/0 (#744)');
is(("REFFGZ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $1), "EFFGZ", 're_tests 566/1 (#745)');
is(("REFFGZ" ~~ rx:i/(bc+d$|ef*g\N|h?i(j|k))/ && $2), "", 're_tests 566/2 (#746)');
# 379: '((((((((((a))))))))))'i	A	y	$10	A
#is(("A" ~~ rx:i/((((((((((a))))))))))/ && $10), "A", 're_tests 568/10 (#748)');
# 380: '((((((((((a))))))))))\10'i	AA	y	$&	AA
#is(("AA" ~~ rx:i/((((((((((a))))))))))$10/ && $0), "AA", 're_tests 570/0 (#750)');
# 381: '((((((((((a))))))))))${bang}'i	AA	n	-	-
# -- SKIPPED - p5re_to_p6rule doesn't support this yet
# 382: '((((((((((a))))))))))${bang}'i	A!	y	$&	A!
# -- SKIPPED - p5re_to_p6rule doesn't support this yet
# 383: '(((((((((a)))))))))'i	A	y	$&	A
is(("A" ~~ rx:i/(((((((((a)))))))))/ && $0), "A", 're_tests 574/0 (#754)');
# 384: '(?:(?:(?:(?:(?:(?:(?:(?:(?:(a))))))))))'i	A	y	$1	A
is(("A" ~~ rx:i/[[[[[[[[[(a)]]]]]]]]]/ && $1), "A", 're_tests 576/1 (#756)');
# 385: '(?:(?:(?:(?:(?:(?:(?:(?:(?:(a|b|c))))))))))'i	C	y	$1	C
is(("C" ~~ rx:i/[[[[[[[[[(a|b|c)]]]]]]]]]/ && $1), "C", 're_tests 578/1 (#758)');
...
is(("MULTIPLE WORDS, YEAH" ~~ rx:i/multiple<sp>words/ && $0), "MULTIPLE WORDS", 're_tests 582/0 (#762)');
# 388: '(.*)c(.*)'i	ABCDE	y	$&-$1-$2	ABCDE-AB-DE
is(("ABCDE" ~~ rx:i/(\N*)c(\N*)/ && $0), "ABCDE", 're_tests 584/0 (#766)');
is(("ABCDE" ~~ rx:i/(\N*)c(\N*)/ && $1), "AB", 're_tests 584/1 (#767)');
is(("ABCDE" ~~ rx:i/(\N*)c(\N*)/ && $2), "DE", 're_tests 584/2 (#768)');
# 389: '\((.*), (.*)\)'i	(A, B)	y	($2, $1)	(B, A)
# SKIPPED: script doesn't understand `($2, $1)' yet
# SKIPPED: script doesn't understand `($2, $1)' yet
# 390: '[k]'i	AB	n	-	-
...
# SKIPPED: script doesn't understand `$1-\$1-\\$1' yet
# 393: 'a[-]?c'i	AC	y	$&	AC
is(("AC" ~~ rx:i/a<[-]>?c/ && $0), "AC", 're_tests 588/0 (#772)');
# 394: '(abc)\1'i	ABCABC	y	$1	ABC
is(("ABCABC" ~~ rx:i/(abc)$1/ && $1), "ABC", 're_tests 590/1 (#774)');
# 395: '([a-c]*)\1'i	ABCABC	y	$1	ABC
is(("ABCABC" ~~ rx:i/(<[a-c]>*)$1/ && $1), "ABC", 're_tests 592/1 (#776)');
# 396: a(?!b).	abad	y	$&	ad
is(("abad" ~~ /a<!before b>\N/ && $0), "ad", 're_tests 594/0 (#778)');
# 397: a(?=d).	abad	y	$&	ad
is(("abad" ~~ /a<before d>\N/ && $0), "ad", 're_tests 596/0 (#780)');
# 398: a(?=c|d).	abad	y	$&	ad
is(("abad" ~~ /a<before c|d>\N/ && $0), "ad", 're_tests 598/0 (#782)');
# 399: a(?:b|c|d)(.)	ace	y	$1	e
is(("ace" ~~ /a[b|c|d](\N)/ && $1), "e", 're_tests 600/1 (#784)');
# 400: a(?:b|c|d)*(.)	ace	y	$1	e
is(("ace" ~~ /a[b|c|d]*(\N)/ && $1), "e", 're_tests 602/1 (#786)');
# 401: a(?:b|c|d)+?(.)	ace	y	$1	e
is(("ace" ~~ /a[b|c|d]+?(\N)/ && $1), "e", 're_tests 604/1 (#788)');
# 402: a(?:b|c|d)+?(.)	acdbcdbe	y	$1	d
is(("acdbcdbe" ~~ /a[b|c|d]+?(\N)/ && $1), "d", 're_tests 606/1 (#790)');
# 403: a(?:b|c|d)+(.)	acdbcdbe	y	$1	e
is(("acdbcdbe" ~~ /a[b|c|d]+(\N)/ && $1), "e", 're_tests 608/1 (#792)');
# 404: a(?:b|c|d){2}(.)	acdbcdbe	y	$1	b
is(("acdbcdbe" ~~ /a[b|c|d]**{2}(\N)/ && $1), "b", 're_tests 610/1 (#794)');
# 405: a(?:b|c|d){4,5}(.)	acdbcdbe	y	$1	b
is(("acdbcdbe" ~~ /a[b|c|d]**{4..5}(\N)/ && $1), "b", 're_tests 612/1 (#796)');
# 406: a(?:b|c|d){4,5}?(.)	acdbcdbe	y	$1	d
is(("acdbcdbe" ~~ /a[b|c|d]**{4..5}?(\N)/ && $1), "d", 're_tests 614/1 (#798)');
...
is(("acdbcdbe" ~~ /a[b|c|d]**{6..7}(\N)/ && $1), "e", 're_tests 616/1 (#800)');
# 410: a(?:b|c|d){6,7}?(.)	acdbcdbe	y	$1	e
is(("acdbcdbe" ~~ /a[b|c|d]**{6..7}?(\N)/ && $1), "e", 're_tests 618/1 (#802)');
# 411: a(?:b|c|d){5,6}(.)	acdbcdbe	y	$1	e
is(("acdbcdbe" ~~ /a[b|c|d]**{5..6}(\N)/ && $1), "e", 're_tests 620/1 (#804)');
# 412: a(?:b|c|d){5,6}?(.)	acdbcdbe	y	$1	b
is(("acdbcdbe" ~~ /a[b|c|d]**{5..6}?(\N)/ && $1), "b", 're_tests 622/1 (#806)');
# 413: a(?:b|c|d){5,7}(.)	acdbcdbe	y	$1	e
is(("acdbcdbe" ~~ /a[b|c|d]**{5..7}(\N)/ && $1), "e", 're_tests 624/1 (#808)');
# 414: a(?:b|c|d){5,7}?(.)	acdbcdbe	y	$1	b
is(("acdbcdbe" ~~ /a[b|c|d]**{5..7}?(\N)/ && $1), "b", 're_tests 626/1 (#810)');
# 415: a(?:b|(c|e){1,2}?|d)+?(.)	ace	y	$1$2	ce
# SKIPPED: script doesn't understand `$1$2' yet
# SKIPPED: script doesn't understand `$1$2' yet
# 416: ^(.+)?B	AB	y	$1	A
is(("AB" ~~ /^(\N+)?B/ && $1), "A", 're_tests 628/1 (#812)');
# 417: ^([^a-z])|(\^)$	.	y	$1	.
is(("." ~~ /^(<[^a-z]>)|(\^)$/ && $1), ".", 're_tests 630/1 (#814)');
# 418: ^[<>]&	<&OUT	y	$&	<&
is(("<&OUT" ~~ /^<[<>]>\&/ && $0), "<&", 're_tests 632/0 (#816)');
# 419: ^(a\1?){4}$	aaaaaaaaaa	y	$1	aaaa
is(("aaaaaaaaaa" ~~ /^(a$1?)**{4}$/ && $1), "aaaa", 're_tests 634/1 (#818)');
# 420: ^(a\1?){4}$	aaaaaaaaa	n	-	-
ok((not ("aaaaaaaaa" ~~ /^(a$1?)**{4}$/)), 're_tests 636  (#820)');
# 421: ^(a\1?){4}$	aaaaaaaaaaa	n	-	-
ok((not ("aaaaaaaaaaa" ~~ /^(a$1?)**{4}$/)), 're_tests 638  (#822)');
# 422: ^(a(?(1)\1)){4}$	aaaaaaaaaa	y	$1	aaaa
is(("aaaaaaaaaa" ~~ /^(a[ <(defined $1)> :: $1 ])**{4}$/ && $1), "aaaa", 're_tests 640/1 (#824)');
# 423: ^(a(?(1)\1)){4}$	aaaaaaaaa	n	-	-
ok((not ("aaaaaaaaa" ~~ /^(a[ <(defined $1)> :: $1 ])**{4}$/)), 're_tests 642  (#826)');
# 424: ^(a(?(1)\1)){4}$	aaaaaaaaaaa	n	-	-
ok((not ("aaaaaaaaaaa" ~~ /^(a[ <(defined $1)> :: $1 ])**{4}$/)), 're_tests 644  (#828)');
# 425: ((a{4})+)	aaaaaaaaa	y	$1	aaaaaaaa
is(("aaaaaaaaa" ~~ /((a**{4})+)/ && $1), "aaaaaaaa", 're_tests 646/1 (#830)');
# 426: (((aa){2})+)	aaaaaaaaaa	y	$1	aaaaaaaa
is(("aaaaaaaaaa" ~~ /(((aa)**{2})+)/ && $1), "aaaaaaaa", 're_tests 648/1 (#832)');
# 427: (((a{2}){2})+)	aaaaaaaaaa	y	$1	aaaaaaaa
is(("aaaaaaaaaa" ~~ /(((a**{2})**{2})+)/ && $1), "aaaaaaaa", 're_tests 650/1 (#834)');
# 428: (?:(f)(o)(o)|(b)(a)(r))*	foobar	y	$1:$2:$3:$4:$5:$6	f:o:o:b:a:r
# SKIPPED: script doesn't understand `$1:$2:$3:$4:$5:$6' yet
# SKIPPED: script doesn't understand `$1:$2:$3:$4:$5:$6' yet
# 429: (?<=a)b	ab	y	$&	b
is(("ab" ~~ /<after a>b/ && $0), "b", 're_tests 652/0 (#836)');
# 430: (?<=a)b	cb	n	-	-
ok((not ("cb" ~~ /<after a>b/)), 're_tests 654  (#838)');
# 431: (?<=a)b	b	n	-	-
ok((not ("b" ~~ /<after a>b/)), 're_tests 656  (#840)');
# 432: (?<!c)b	ab	y	$&	b
is(("ab" ~~ /<!after c>b/ && $0), "b", 're_tests 658/0 (#842)');
# 433: (?<!c)b	cb	n	-	-
ok((not ("cb" ~~ /<!after c>b/)), 're_tests 660  (#844)');
# 434: (?<!c)b	b	y	-	-
ok(("b" ~~ /<!after c>b/), 're_tests 662  (#846)');
# 435: (?<!c)b	b	y	$&	b
is(("b" ~~ /<!after c>b/ && $0), "b", 're_tests 664/0 (#848)');
# 436: (?<%)b	-	c	-	Sequence (?<%...) not recognized
# -- SKIPPED - TESTS ERROR MESSAGE
# 437: (?:..)*a	aba	y	$&	aba
is(("aba" ~~ /[\N\N]*a/ && $0), "aba", 're_tests 666/0 (#850)');
# 438: (?:..)*?a	aba	y	$&	a
is(("aba" ~~ /[\N\N]*?a/ && $0), "a", 're_tests 668/0 (#852)');
# 439: ^(?:b|a(?=(.)))*\1	abc	y	$&	ab
is(("abc" ~~ /^[b|a<before (\N)>]*$1/ && $0), "ab", 're_tests 670/0 (#854)');
# 440: ^(){3,5}	abc	y	a$1	a
# SKIPPED: script doesn't understand `a$1' yet
# SKIPPED: script doesn't understand `a$1' yet
# 441: ^(a+)*ax	aax	y	$1	a
is(("aax" ~~ /^(a+)*ax/ && $1), "a", 're_tests 672/1 (#856)');
# 442: ^((a|b)+)*ax	aax	y	$1	a
is(("aax" ~~ /^((a|b)+)*ax/ && $1), "a", 're_tests 674/1 (#858)');
# 443: ^((a|bc)+)*ax	aax	y	$1	a
is(("aax" ~~ /^((a|bc)+)*ax/ && $1), "a", 're_tests 676/1 (#860)');
...
# SKIPPED: script doesn't understand `y$1' yet
# 446: (?:(?i)a)b	ab	y	$&	ab
is(("ab" ~~ /[:i a]b/ && $0), "ab", 're_tests 678/0 (#862)');
# 447: ((?i)a)b	ab	y	$&:$1	ab:a
is(("ab" ~~ /(:i a)b/ && $0), "ab", 're_tests 680/0 (#865)');
is(("ab" ~~ /(:i a)b/ && $1), "a", 're_tests 680/1 (#866)');
# 448: (?:(?i)a)b	Ab	y	$&	Ab
is(("Ab" ~~ /[:i a]b/ && $0), "Ab", 're_tests 682/0 (#868)');
# 449: ((?i)a)b	Ab	y	$&:$1	Ab:A
is(("Ab" ~~ /(:i a)b/ && $0), "Ab", 're_tests 684/0 (#871)');
is(("Ab" ~~ /(:i a)b/ && $1), "A", 're_tests 684/1 (#872)');
# 450: (?:(?i)a)b	aB	n	-	-
ok((not ("aB" ~~ /[:i a]b/)), 're_tests 686  (#874)');
# 451: ((?i)a)b	aB	n	-	-
ok((not ("aB" ~~ /(:i a)b/)), 're_tests 688  (#876)');
# 452: (?i:a)b	ab	y	$&	ab
is(("ab" ~~ /[:i a]b/ && $0), "ab", 're_tests 690/0 (#878)');
# 453: ((?i:a))b	ab	y	$&:$1	ab:a
is(("ab" ~~ /([:i a])b/ && $0), "ab", 're_tests 692/0 (#881)');
is(("ab" ~~ /([:i a])b/ && $1), "a", 're_tests 692/1 (#882)');
# 454: (?i:a)b	Ab	y	$&	Ab
is(("Ab" ~~ /[:i a]b/ && $0), "Ab", 're_tests 694/0 (#884)');
# 455: ((?i:a))b	Ab	y	$&:$1	Ab:A
is(("Ab" ~~ /([:i a])b/ && $0), "Ab", 're_tests 696/0 (#887)');
is(("Ab" ~~ /([:i a])b/ && $1), "A", 're_tests 696/1 (#888)');
# 456: (?i:a)b	aB	n	-	-
...
is(("cabbbb" ~~ /[c|d][][a[][b][b[]][b[][b]]]/ && $0), "cabbbb", 're_tests 725/0 (#921)');
...
is(("caaaaaaaabbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb" ~~ /[c|d][][aaaaaaaa[][bbbbbbbb][bbbbbbbb[]][bbbbbbbb[][bbbbbbbb]]]/ && $0), "caaaaaaaabbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", 're_tests 727/0 (#923)');
# 483: '(ab)\d\1'i	Ab4ab	y	$1	Ab
is(("Ab4ab" ~~ rx:i/(ab)\d$1/ && $1), "Ab", 're_tests 729/1 (#925)');
# 484: '(ab)\d\1'i	ab4Ab	y	$1	ab
is(("ab4Ab" ~~ rx:i/(ab)\d$1/ && $1), "ab", 're_tests 731/1 (#927)');
# 485: foo\w*\d{4}baz	foobar1234baz	y	$&	foobar1234baz
is(("foobar1234baz" ~~ /foo\w*\d**{4}baz/ && $0), "foobar1234baz", 're_tests 733/0 (#929)');
# 486: a(?{})b	cabd	y	$&	ab
# -- SKIPPED - p5re_to_p6rule doesn't support `(?{...' yet
...
is(("dbaacb" ~~ /<!after <[cd]>><[ab]>/ && $0), "a", 're_tests 743/0 (#939)');
# 499: (?<!(c|d))b	dbcb	n	-	-
ok((not ("dbcb" ~~ /<!after (c|d)>b/)), 're_tests 745  (#941)');
# 500: (?<!(c|d))[ab]	dbaacb	y	$&	a
is(("dbaacb" ~~ /<!after (c|d)><[ab]>/ && $0), "a", 're_tests 747/0 (#943)');
# 501: (?<!cd)[ab]	cdaccb	y	$&	b
is(("cdaccb" ~~ /<!after cd><[ab]>/ && $0), "b", 're_tests 749/0 (#945)');
# 502: ^(?:a?b?)*$	a--	n	-	-
...
# -- SKIPPED - p5re_to_p6rule doesn't support `(?m)' yet
# 516: (?(1)a|b)	a	n	-	-
ok((not ("a" ~~ /[ <(defined $1)> :: a|b ]/)), 're_tests 765  (#961)');
# 517: (?(1)b|a)	a	y	$&	a
is(("a" ~~ /[ <(defined $1)> :: b|a ]/ && $0), "a", 're_tests 767/0 (#963)');
# 518: (x)?(?(1)a|b)	a	n	-	-
ok((not ("a" ~~ /(x)?[ <(defined $1)> :: a|b ]/)), 're_tests 769  (#965)');
# 519: (x)?(?(1)b|a)	a	y	$&	a
is(("a" ~~ /(x)?[ <(defined $1)> :: b|a ]/ && $0), "a", 're_tests 771/0 (#967)');
# 520: ()?(?(1)b|a)	a	y	$&	a
is(("a" ~~ /(<?null>)?[ <(defined $1)> :: b|a ]/ && $0), "a", 're_tests 773/0 (#969)');
# 521: ()(?(1)b|a)	a	n	-	-
ok((not ("a" ~~ /(<?null>)[ <(defined $1)> :: b|a ]/)), 're_tests 775  (#971)');
# 522: ()?(?(1)a|b)	a	y	$&	a
is(("a" ~~ /(<?null>)?[ <(defined $1)> :: a|b ]/ && $0), "a", 're_tests 777/0 (#973)');
# 523: ^(\()?blah(?(1)(\)))$	(blah)	y	$2	)
is(("(blah)" ~~ /^(\()?blah[ <(defined $1)> :: (\)) ]$/ && $2), ")", 're_tests 779/2 (#975)');
# 524: ^(\()?blah(?(1)(\)))$	blah	y	($2)	()
# SKIPPED: script doesn't understand `($2)' yet
# SKIPPED: script doesn't understand `($2)' yet
# 525: ^(\()?blah(?(1)(\)))$	blah)	n	-	-
ok((not ("blah)" ~~ /^(\()?blah[ <(defined $1)> :: (\)) ]$/)), 're_tests 781  (#977)');
# 526: ^(\()?blah(?(1)(\)))$	(blah	n	-	-
ok((not ("(blah" ~~ /^(\()?blah[ <(defined $1)> :: (\)) ]$/)), 're_tests 783  (#979)');
# 527: ^(\(+)?blah(?(1)(\)))$	(blah)	y	$2	)
is(("(blah)" ~~ /^(\(+)?blah[ <(defined $1)> :: (\)) ]$/ && $2), ")", 're_tests 785/2 (#981)');
# 528: ^(\(+)?blah(?(1)(\)))$	blah	y	($2)	()
# SKIPPED: script doesn't understand `($2)' yet
# SKIPPED: script doesn't understand `($2)' yet
# 529: ^(\(+)?blah(?(1)(\)))$	blah)	n	-	-
ok((not ("blah)" ~~ /^(\(+)?blah[ <(defined $1)> :: (\)) ]$/)), 're_tests 787  (#983)');
# 530: ^(\(+)?blah(?(1)(\)))$	(blah	n	-	-
ok((not ("(blah" ~~ /^(\(+)?blah[ <(defined $1)> :: (\)) ]$/)), 're_tests 789  (#985)');
...
is(("aaab" ~~ /<before (a+?)>($1ab)/ && $2), "aab", 're_tests 799/2 (#995)');
# 542: ^(?=(a+?))\1ab	aaab	n	-	-
ok((not ("aaab" ~~ /^<before (a+?)>$1ab/)), 're_tests 801  (#997)');
# 543: (\w+:)+	one:	y	$1	one:
is(("one:" ~~ /(\w+\:)+/ && $1), "one:", 're_tests 803/1 (#999)');
# 544: $(?<=^(a))	a	y	$1	a
is(("a" ~~ /$<after ^(a)>/ && $1), "a", 're_tests 805/1 (#1001)');
# 545: (?=(a+?))(\1ab)	aaab	y	$2	aab
is(("aaab" ~~ /<before (a+?)>($1ab)/ && $2), "aab", 're_tests 807/2 (#1003)');
# 546: ^(?=(a+?))\1ab	aaab	n	-	-
ok((not ("aaab" ~~ /^<before (a+?)>$1ab/)), 're_tests 809  (#1005)');
# 547: ([\w:]+::)?(\w+)$	abcd:	n	-	-
ok((not ("abcd:" ~~ /(<[\w:]>+\:\:)?(\w+)$/)), 're_tests 811  (#1007)');
# 548: ([\w:]+::)?(\w+)$	abcd	y	$1-$2	-abcd
is(("abcd" ~~ /(<[\w:]>+\:\:)?(\w+)$/ && $1), "", 're_tests 813/1 (#1010)');
is(("abcd" ~~ /(<[\w:]>+\:\:)?(\w+)$/ && $2), "abcd", 're_tests 813/2 (#1011)');
# 549: ([\w:]+::)?(\w+)$	xy:z:::abcd	y	$1-$2	xy:z:::-abcd
is(("xy:z:::abcd" ~~ /(<[\w:]>+\:\:)?(\w+)$/ && $1), "xy:z:::", 're_tests 815/1 (#1014)');
is(("xy:z:::abcd" ~~ /(<[\w:]>+\:\:)?(\w+)$/ && $2), "abcd", 're_tests 815/2 (#1015)');
# 550: ^[^bcd]*(c+)	aexycd	y	$1	c
is(("aexycd" ~~ /^<[^bcd]>*(c+)/ && $1), "c", 're_tests 817/1 (#1017)');
# 551: (a*)b+	caab	y	$1	aa
is(("caab" ~~ /(a*)b+/ && $1), "aa", 're_tests 819/1 (#1019)');
# 552: ([\w:]+::)?(\w+)$	abcd:	n	-	-
ok((not ("abcd:" ~~ /(<[\w:]>+\:\:)?(\w+)$/)), 're_tests 821  (#1021)');
# 553: ([\w:]+::)?(\w+)$	abcd	y	$1-$2	-abcd
is(("abcd" ~~ /(<[\w:]>+\:\:)?(\w+)$/ && $1), "", 're_tests 823/1 (#1024)');
is(("abcd" ~~ /(<[\w:]>+\:\:)?(\w+)$/ && $2), "abcd", 're_tests 823/2 (#1025)');
# 554: ([\w:]+::)?(\w+)$	xy:z:::abcd	y	$1-$2	xy:z:::-abcd
is(("xy:z:::abcd" ~~ /(<[\w:]>+\:\:)?(\w+)$/ && $1), "xy:z:::", 're_tests 825/1 (#1028)');
is(("xy:z:::abcd" ~~ /(<[\w:]>+\:\:)?(\w+)$/ && $2), "abcd", 're_tests 825/2 (#1029)');
# 555: ^[^bcd]*(c+)	aexycd	y	$1	c
is(("aexycd" ~~ /^<[^bcd]>*(c+)/ && $1), "c", 're_tests 827/1 (#1031)');
...
is(("aaab" ~~ /([a+]:b)/ && $1), "aaab", 're_tests 837/1 (#1041)');
# 596: (?>(a+))b	aaab	y	$1	aaa
is(("aaab" ~~ /[(a+)]:b/ && $1), "aaa", 're_tests 839/1 (#1043)');
# 597: ((?>[^()]+)|\([^()]*\))+	((abc(ade)ufh()()x	y	$&	abc(ade)ufh()()x
is(("((abc(ade)ufh()()x" ~~ /([<[^()]>+]:|\(<[^()]>*\))+/ && $0), "abc(ade)ufh()()x", 're_tests 841/0 (#1045)');
...
# -- SKIPPED - p5re_to_p6rule doesn't support `$ with \n in str' yet
# 798: (^|x)(c)	ca	y	$2	c
is(("ca" ~~ /(^|x)(c)/ && $2), "c", 're_tests 1107/2 (#1311)');
...
is(("_I(round(xs * sz),1)" ~~ /round\(([<[^()]>+]:)\)/ && $1), "xs * sz", 're_tests 1111/1 (#1315)');
# 802: '((?x:.) )'	x 	y	$1-	x -
# SKIPPED: script doesn't understand `$1-' yet
# -- SKIPPED - p5re_to_p6rule doesn't support this yet
# 803: '((?-x:.) )'x	x 	y	$1-	x-
...
is(("za-9z" ~~ /(<[a-\d]>+)/ && $1), "a-9", 're_tests 1154/1 (#1358)');
# 826: ([\d-z]+)	a0-za	y	$1	0-z
is(("a0-za" ~~ /(<[\d-z]>+)/ && $1), "0-z", 're_tests 1156/1 (#1360)');
# 827: ([\d-\s]+)	a0- z	y	$1	0- 
is(("a0- z" ~~ /(<[\d-\s]>+)/ && $1), "0- ", 're_tests 1158/1 (#1362)');
...
is(("3.1415926" ~~ /(\d+\.\d+)/ && $1), "3.1415926", 're_tests 1164/1 (#1368)');
# 833: (\ba.{0,10}br)	have a web browser	y	$1	a web br
is(("have a web browser" ~~ /(\ba\N**{0..10}br)/ && $1), "a web br", 're_tests 1166/1 (#1370)');
...
is(("IO.c" ~~ rx:i/(\.c(pp|xx|c)?$)/ && $1), ".c", 're_tests 1172/1 (#1376)');
# 837: ^([a-z]:)	C:/	n	-	-
...
ok((not ("abcab" ~~ /(\w)?(abc)$1b/)), 're_tests 1179  (#1383)');
# 842: ^(?:.,){2}c	a,b,c	y	-	-
ok(("a,b,c" ~~ /^[\N,]**{2}c/), 're_tests 1181  (#1385)');
# 843: ^(.,){2}c	a,b,c	y	$1	b,
is(("a,b,c" ~~ /^(\N,)**{2}c/ && $1), "b,", 're_tests 1183/1 (#1387)');
# 844: ^(?:[^,]*,){2}c	a,b,c	y	-	-
ok(("a,b,c" ~~ /^[<[^,]>*,]**{2}c/), 're_tests 1185  (#1389)');
# 845: ^([^,]*,){2}c	a,b,c	y	$1	b,
is(("a,b,c" ~~ /^(<[^,]>*,)**{2}c/ && $1), "b,", 're_tests 1187/1 (#1391)');
# 846: ^([^,]*,){3}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>*,)**{3}d/ && $1), "c,", 're_tests 1189/1 (#1393)');
# 847: ^([^,]*,){3,}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>*,)**{3...}d/ && $1), "c,", 're_tests 1191/1 (#1395)');
# 848: ^([^,]*,){0,3}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>*,)**{0..3}d/ && $1), "c,", 're_tests 1193/1 (#1397)');
# 849: ^([^,]{1,3},){3}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{1..3},)**{3}d/ && $1), "c,", 're_tests 1195/1 (#1399)');
# 850: ^([^,]{1,3},){3,}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{1..3},)**{3...}d/ && $1), "c,", 're_tests 1197/1 (#1401)');
# 851: ^([^,]{1,3},){0,3}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{1..3},)**{0..3}d/ && $1), "c,", 're_tests 1199/1 (#1403)');
# 852: ^([^,]{1,},){3}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{1...},)**{3}d/ && $1), "c,", 're_tests 1201/1 (#1405)');
# 853: ^([^,]{1,},){3,}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{1...},)**{3...}d/ && $1), "c,", 're_tests 1203/1 (#1407)');
# 854: ^([^,]{1,},){0,3}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{1...},)**{0..3}d/ && $1), "c,", 're_tests 1205/1 (#1409)');
# 855: ^([^,]{0,3},){3}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{0..3},)**{3}d/ && $1), "c,", 're_tests 1207/1 (#1411)');
# 856: ^([^,]{0,3},){3,}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{0..3},)**{3...}d/ && $1), "c,", 're_tests 1209/1 (#1413)');
# 857: ^([^,]{0,3},){0,3}d	aaa,b,c,d	y	$1	c,
is(("aaa,b,c,d" ~~ /^(<[^,]>**{0..3},)**{0..3}d/ && $1), "c,", 're_tests 1211/1 (#1415)');
# 858: (?i)		y	-	-
...
# SKIPPED: script doesn't understand `-$1-' yet
# 864: ^(a)?(?(1)a|b)+$	a	n	-	-
ok((not ("a" ~~ /^(a)?[ <(defined $1)> :: a|b ]+$/)), 're_tests 1217  (#1421)');
# 865: ^(a\1?)(a\1?)(a\2?)(a\3?)$	aaaaaa	y	$1,$2,$3,$4	a,aa,a,aa
# SKIPPED: script doesn't understand `$1,$2,$3,$4' yet
# SKIPPED: script doesn't understand `$1,$2,$3,$4' yet
# 866: ^(a\1?){4}$	aaaaaa	y	$1	aa
is(("aaaaaa" ~~ /^(a$1?)**{4}$/ && $1), "aa", 're_tests 1219/1 (#1423)');
# 867: ^(0+)?(?:x(1))?	x1	y	-	-
...
is(("bbbac" ~~ /^(b+?|a)**{1..2}c/ && $1), "a", 're_tests 1225/1 (#1429)');
# 870: ^(b+?|a){1,2}c	bbbbac	y	$1	a
is(("bbbbac" ~~ /^(b+?|a)**{1..2}c/ && $1), "a", 're_tests 1227/1 (#1431)');
...
# 874: (a)?(a)+	a	y	$1:$2	:a	-
is(("a" ~~ /(a)?(a)+/ && $1), "", 're_tests 1233/1 (#1438)');
is(("a" ~~ /(a)?(a)+/ && $2), "a", 're_tests 1233/2 (#1439)');
# 875: (ab)?(ab)+	ab	y	$1:$2	:ab	-
is(("ab" ~~ /(ab)?(ab)+/ && $1), "", 're_tests 1235/1 (#1442)');
is(("ab" ~~ /(ab)?(ab)+/ && $2), "ab", 're_tests 1235/2 (#1443)');
# 876: (abc)?(abc)+	abc	y	$1:$2	:abc	-
is(("abc" ~~ /(abc)?(abc)+/ && $1), "", 're_tests 1237/1 (#1446)');
is(("abc" ~~ /(abc)?(abc)+/ && $2), "abc", 're_tests 1237/2 (#1447)');
# 877: 'b\s^'m	a\nb\n	n	-	-
# -- SKIPPED - p5re_to_p6rule doesn't support `'...'m' yet
# 878: \ba	a	y	-	-
...
# 881: ab(?i)cd	abCd	y	-	-
ok(("abCd" ~~ /ab:i cd/), 're_tests 1245  (#1455)');
# 882: (A|B)*(?(1)(CD)|(CD))	CD	y	$2-$3	-CD
is(("CD" ~~ /(A|B)*[ <(defined $1)> :: (CD)|(CD) ]/ && $2), "", 're_tests 1247/2 (#1458)');
is(("CD" ~~ /(A|B)*[ <(defined $1)> :: (CD)|(CD) ]/ && $3), "CD", 're_tests 1247/3 (#1459)');
# 883: (A|B)*(?(1)(CD)|(CD))	ABCD	y	$2-$3	CD-
is(("ABCD" ~~ /(A|B)*[ <(defined $1)> :: (CD)|(CD) ]/ && $2), "CD", 're_tests 1249/2 (#1462)');
is(("ABCD" ~~ /(A|B)*[ <(defined $1)> :: (CD)|(CD) ]/ && $3), "", 're_tests 1249/3 (#1463)');
# 884: (A|B)*?(?(1)(CD)|(CD))	CD	y	$2-$3	-CD	# [ID 20010803.016]
is(("CD" ~~ /(A|B)*?[ <(defined $1)> :: (CD)|(CD) ]/ && $2), "", 're_tests 1251/2 (#1466)');
is(("CD" ~~ /(A|B)*?[ <(defined $1)> :: (CD)|(CD) ]/ && $3), "CD", 're_tests 1251/3 (#1467)');
# 885: (A|B)*?(?(1)(CD)|(CD))	ABCD	y	$2-$3	CD-
is(("ABCD" ~~ /(A|B)*?[ <(defined $1)> :: (CD)|(CD) ]/ && $2), "CD", 're_tests 1253/2 (#1470)');
is(("ABCD" ~~ /(A|B)*?[ <(defined $1)> :: (CD)|(CD) ]/ && $3), "", 're_tests 1253/3 (#1471)');
# 886: '^(o)(?!.*\1)'i	Oo	n	-	-
ok((not ("Oo" ~~ rx:i/^(o)<!before \N*$1>/)), 're_tests 1255  (#1473)');
# 887: (.*)\d+\1	abc12bc	y	$1	bc
is(("abc12bc" ~~ /(\N*)\d+$1/ && $1), "bc", 're_tests 1257/1 (#1475)');
# 888: (?m:(foo\s*$))	foo\n bar	y	$1	foo
# -- SKIPPED - p5re_to_p6rule doesn't support `$ with \n in str' yet
# 889: (.*)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)c/ && $1), "ab", 're_tests 1260/1 (#1478)');
# 890: (.*)(?=c)	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<before c>/ && $1), "ab", 're_tests 1262/1 (#1480)');
# 891: (.*)(?=c)c	abcd	yB	$1	ab
is(("abcd" ~~ /(\N*)<before c>c/ && $1), "ab", 're_tests 1264/1 (#1482)');
# 892: (.*)(?=b|c)	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<before b|c>/ && $1), "ab", 're_tests 1266/1 (#1484)');
# 893: (.*)(?=b|c)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<before b|c>c/ && $1), "ab", 're_tests 1268/1 (#1486)');
# 894: (.*)(?=c|b)	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<before c|b>/ && $1), "ab", 're_tests 1270/1 (#1488)');
# 895: (.*)(?=c|b)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<before c|b>c/ && $1), "ab", 're_tests 1272/1 (#1490)');
# 896: (.*)(?=[bc])	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<before <[bc]>>/ && $1), "ab", 're_tests 1274/1 (#1492)');
# 897: (.*)(?=[bc])c	abcd	yB	$1	ab
is(("abcd" ~~ /(\N*)<before <[bc]>>c/ && $1), "ab", 're_tests 1276/1 (#1494)');
# 898: (.*)(?<=b)	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<after b>/ && $1), "ab", 're_tests 1278/1 (#1496)');
# 899: (.*)(?<=b)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<after b>c/ && $1), "ab", 're_tests 1280/1 (#1498)');
# 900: (.*)(?<=b|c)	abcd	y	$1	abc
is(("abcd" ~~ /(\N*)<after b|c>/ && $1), "abc", 're_tests 1282/1 (#1500)');
# 901: (.*)(?<=b|c)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<after b|c>c/ && $1), "ab", 're_tests 1284/1 (#1502)');
# 902: (.*)(?<=c|b)	abcd	y	$1	abc
is(("abcd" ~~ /(\N*)<after c|b>/ && $1), "abc", 're_tests 1286/1 (#1504)');
# 903: (.*)(?<=c|b)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<after c|b>c/ && $1), "ab", 're_tests 1288/1 (#1506)');
# 904: (.*)(?<=[bc])	abcd	y	$1	abc
is(("abcd" ~~ /(\N*)<after <[bc]>>/ && $1), "abc", 're_tests 1290/1 (#1508)');
# 905: (.*)(?<=[bc])c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*)<after <[bc]>>c/ && $1), "ab", 're_tests 1292/1 (#1510)');
# 906: (.*?)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)c/ && $1), "ab", 're_tests 1294/1 (#1512)');
# 907: (.*?)(?=c)	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<before c>/ && $1), "ab", 're_tests 1296/1 (#1514)');
# 908: (.*?)(?=c)c	abcd	yB	$1	ab
is(("abcd" ~~ /(\N*?)<before c>c/ && $1), "ab", 're_tests 1298/1 (#1516)');
# 909: (.*?)(?=b|c)	abcd	y	$1	a
is(("abcd" ~~ /(\N*?)<before b|c>/ && $1), "a", 're_tests 1300/1 (#1518)');
# 910: (.*?)(?=b|c)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<before b|c>c/ && $1), "ab", 're_tests 1302/1 (#1520)');
# 911: (.*?)(?=c|b)	abcd	y	$1	a
is(("abcd" ~~ /(\N*?)<before c|b>/ && $1), "a", 're_tests 1304/1 (#1522)');
# 912: (.*?)(?=c|b)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<before c|b>c/ && $1), "ab", 're_tests 1306/1 (#1524)');
# 913: (.*?)(?=[bc])	abcd	y	$1	a
is(("abcd" ~~ /(\N*?)<before <[bc]>>/ && $1), "a", 're_tests 1308/1 (#1526)');
# 914: (.*?)(?=[bc])c	abcd	yB	$1	ab
is(("abcd" ~~ /(\N*?)<before <[bc]>>c/ && $1), "ab", 're_tests 1310/1 (#1528)');
# 915: (.*?)(?<=b)	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<after b>/ && $1), "ab", 're_tests 1312/1 (#1530)');
# 916: (.*?)(?<=b)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<after b>c/ && $1), "ab", 're_tests 1314/1 (#1532)');
# 917: (.*?)(?<=b|c)	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<after b|c>/ && $1), "ab", 're_tests 1316/1 (#1534)');
# 918: (.*?)(?<=b|c)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<after b|c>c/ && $1), "ab", 're_tests 1318/1 (#1536)');
# 919: (.*?)(?<=c|b)	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<after c|b>/ && $1), "ab", 're_tests 1320/1 (#1538)');
# 920: (.*?)(?<=c|b)c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<after c|b>c/ && $1), "ab", 're_tests 1322/1 (#1540)');
# 921: (.*?)(?<=[bc])	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<after <[bc]>>/ && $1), "ab", 're_tests 1324/1 (#1542)');
# 922: (.*?)(?<=[bc])c	abcd	y	$1	ab
is(("abcd" ~~ /(\N*?)<after <[bc]>>c/ && $1), "ab", 're_tests 1326/1 (#1544)');
# 923: 2(]*)?$\1	2	y	$&	2
is(("2" ~~ /2(]*)?$$1/ && $0), "2", 're_tests 1328/0 (#1546)');
# 924: (??{})	x	y	-	-
# -- SKIPPED - p5re_to_p6rule doesn't support `(??{...' yet
...
is(("foobarbar" ~~ /^\N**{3..4}(\N+)$1$/ && $1), "bar", 're_tests 1331/1 (#1549)');
# 928: ^(?:f|o|b){3,4}(.+)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^[f|o|b]**{3..4}(\N+)$1$/ && $1), "bar", 're_tests 1333/1 (#1551)');
# 929: ^.{3,4}((?:b|a|r)+)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^\N**{3..4}([b|a|r]+)$1$/ && $1), "bar", 're_tests 1335/1 (#1553)');
# 930: ^(?:f|o|b){3,4}((?:b|a|r)+)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^[f|o|b]**{3..4}([b|a|r]+)$1$/ && $1), "bar", 're_tests 1337/1 (#1555)');
# 931: ^.{3,4}(.+?)\1\z	foobarbar	y	$1	bar
#is(("foobarbar" ~~ /^\N**{3..4}(\N+?)$1$/ && $1), "bar", 're_tests 1339/1 (#1557)'); ## XXX PGE BUG
# 932: ^(?:f|o|b){3,4}(.+?)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^[f|o|b]**{3..4}(\N+?)$1$/ && $1), "bar", 're_tests 1341/1 (#1559)');
# 933: ^.{3,4}((?:b|a|r)+?)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^\N**{3..4}([b|a|r]+?)$1$/ && $1), "bar", 're_tests 1343/1 (#1561)');
# 934: ^(?:f|o|b){3,4}((?:b|a|r)+?)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^[f|o|b]**{3..4}([b|a|r]+?)$1$/ && $1), "bar", 're_tests 1345/1 (#1563)');
# 935: ^.{2,3}?(.+)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^\N**{2..3}?(\N+)$1$/ && $1), "bar", 're_tests 1347/1 (#1565)');
# 936: ^(?:f|o|b){2,3}?(.+)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^[f|o|b]**{2..3}?(\N+)$1$/ && $1), "bar", 're_tests 1349/1 (#1567)');
# 937: ^.{2,3}?((?:b|a|r)+)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^\N**{2..3}?([b|a|r]+)$1$/ && $1), "bar", 're_tests 1351/1 (#1569)');
# 938: ^(?:f|o|b){2,3}?((?:b|a|r)+)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^[f|o|b]**{2..3}?([b|a|r]+)$1$/ && $1), "bar", 're_tests 1353/1 (#1571)');
# 939: ^.{2,3}?(.+?)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^\N**{2..3}?(\N+?)$1$/ && $1), "bar", 're_tests 1355/1 (#1573)');
# 940: ^(?:f|o|b){2,3}?(.+?)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^[f|o|b]**{2..3}?(\N+?)$1$/ && $1), "bar", 're_tests 1357/1 (#1575)');
# 941: ^.{2,3}?((?:b|a|r)+?)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^\N**{2..3}?([b|a|r]+?)$1$/ && $1), "bar", 're_tests 1359/1 (#1577)');
# 942: ^(?:f|o|b){2,3}?((?:b|a|r)+?)\1\z	foobarbar	y	$1	bar
is(("foobarbar" ~~ /^[f|o|b]**{2..3}?([b|a|r]+?)$1$/ && $1), "bar", 're_tests 1361/1 (#1579)');
