...
ok(!eval(' "A" ~~ m/<?prior>/ '), 'No prior successful match', :todo<feature> );
ok($!, 'Error', :todo<feature> );

ok("A" ~~ m/<[A-Z]>/, 'Successful match', :todo<feature> );

ok("B" ~~ m/<?prior>/, 'Prior successful match', :todo<feature> );
ok(!( "!" ~~ m/<?prior>/ ), 'Prior successful non-match', :todo<feature> );

ok(!( "A" ~~ m/B/ ), 'Unsuccessful match', :todo<feature> );
...
ok(!( "A" ~~ m/A <?prior>/ ), 'Nested prior successful non-match', :todo<feature> );
ok("B" ~~ m/<?prior>/, 'And even now prior successful match', :todo<feature> );

ok("!" ~~ m/<-[A-Z]>/, 'New successful match', :todo<feature> );

ok(!( "B" ~~ m/<?prior>/ ), 'New prior successful non-match', :todo<feature> );
ok("!" ~~ m/<?prior>/, 'New prior successful match', :todo<feature> );

ok(!( "A" ~~ m/B/ ), 'New unsuccessful match', :todo<feature> );
...
ok(!( "A" ~~ m/A <?prior>/ ), 'New nested prior successful non-match', :todo<feature> );
...
is($/<prior>[0], 'A', 'Capture 0', :todo<feature> );
is($/<prior>[1], 'A', 'Capture 1', :todo<feature> );
is($/<prior>[2], 'A', 'Capture 2', :todo<feature> );
is($/<prior>[3], 'A', 'Capture 3', :todo<feature> );
ok(! defined $/<prior>[4], 'Capture 4', :todo<feature> );
