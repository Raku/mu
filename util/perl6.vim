...
"
" XXX: This file is now maintained at https://github.com/vim-perl/vim-perl
"                
...
syn region p6RegexBlock
    ...
    \ end="}"
    \ contained
    \ contains=@p6Regexen,@p6Variables,p6RxColonCode
...
syn region p6RxAssertion
    ...
    \ end=">"
    \ contained
    \ contains=@p6Regexen,@p6Variables,p6RxCharClass
...
" deprecation notice
redraw | echo "perl6.vim development has moved to https://github.com/vim-perl/vim-perl"
