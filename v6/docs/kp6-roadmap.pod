...
=item * Add support for optionally use Pugs::Compiler::Rule in the Perl 5 backend

=item * Add support for optionally use Parrot Grammar Engine in the Parrot backend
