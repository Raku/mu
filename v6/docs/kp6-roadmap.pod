...
For example, PGE in the Parrot backend, and Moose in the Perl 5 backend, and native-perl5 in the MiniPerl6-on-Perl5 backend.
...
The Sub and Method classes will be refactored from ...
...
=item * this requires a working type system; finishing the Code, Signature, Capture classes and also Array and Hash, which are barely started
