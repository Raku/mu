...
Returns the ResponderInterface of a SMOP Object, it's important to
realize that if a value has no RI defined, it is considered itself its
own responder interface, and should therefore comply to the Responder
Interface struct.
