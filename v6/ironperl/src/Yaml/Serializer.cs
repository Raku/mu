...
namespace IronPerl.Yaml {
    ...
    public class Serializer : ISerializer, IDisposable {
        public readonly IEmitter _emitter;
        public readonly bool _useExplicitStart;
        public readonly bool _useExplicitEnd;
        public readonly bool _explicitTypes;
        public readonly Version _useVersion;
        public readonly bool _useTags;
        public readonly string _anchorTemplate;

        public readonly Dictionary<Node, object> _serializedNodes = new Dictionary<Node, object>(ReferenceEqualityComparer<Node>.Instance);
        public readonly Dictionary<Node, string> _anchors = new Dictionary<Node, string>(ReferenceEqualityComparer<Node>.Instance);
        public int _lastAnchorId;
        public bool _closed;
        ...
        public void SerializeNode(Node node, Node parent, object index) {
            while (node is LinkNode) {
                node = ((LinkNode)node).Linked;
            }
