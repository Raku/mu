...
namespace IronPerl.Yaml {
    public class Parser : IEnumerable<YamlEvent> {
        ...
        public readonly LinkedList<string> _tags = new LinkedList<string>();
        public readonly LinkedList<string> _anchors = new LinkedList<string>();
        public readonly Dictionary<string, string> _tagHandles = new Dictionary<string, string>();
        public readonly Scanner _scanner;
        public readonly Version _defaultYamlVersion;

        public Version _yamlVersion;
        public bool _done;
        public YamlEvent _currentEvent;
        public string _familyTypePrefix;
        ...
        public YamlEvent ParseStreamNext() {
            if (_done) {
                return null;
            }
        ...
        public static Regex ONLY_WORD = new Regex("^\\w+$", RegexOptions.Compiled);

        public string GetTag(TagToken tagToken) {
        ...
        public void ProcessDirectives(out Version version, out Dictionary<string, string> tagHandles) {
