...
->{_value}{_array} } ) { do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_infix_58__60_eq_62_, 'APPLY', ::DISPATCH( $GLOBAL::trait, 'INDEX', ::DISPATCH( $::Int, 'new', 0 )
 )
, ::DISPATCH( $::Str, 'new', 'meta' )
 )
,"true"),"p5landish") ) { do {::MODIFIED($metaclass);
$metaclass = ::DISPATCH( $GLOBAL::trait, 'INDEX', ::DISPATCH( $::Int, 'new', 1 )
 )
} }  }
 } }
...
,::DISPATCH( $::Str, 'new', 'arguments' )
 => ::DISPATCH( $::Array, "new", { _array => [::DISPATCH( $::Val::Buf, 'new', ::DISPATCH( $::Str, 'new', 'buf' )
 => ::DISPATCH( $GLOBAL::trait, 'INDEX', ::DISPATCH( $::Int, 'new', 1 )
 )
, )
] } )
,::DISPATCH( $::Str, 'new', 'method' )
...
, )
 ...
 }  else { do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_infix_58__60_eq_62_, 'APPLY', ::DISPATCH( $GLOBAL::trait, 'INDEX', ::DISPATCH( $::Int, 'new', 0 )
 )
, ::DISPATCH( $::Str, 'new', 'is' )
 )
,"true"),"p5landish") ) { ::DISPATCH( $GLOBAL::Code_push, 'APPLY', ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', $module )
...
, ::DISPATCH( $GLOBAL::trait, 'INDEX', ::DISPATCH( $::Int, 'new', 0 )
 )
 )
 } }
 } }
...
->{_value}{_array} } ) { do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::item, 'isa', ::DISPATCH( $::Str, 'new', 'Method' )
 )
,"true"),"p5landish") ) { ::DISPATCH( $GLOBAL::Code_push, 'APPLY', ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', $module )
, ::DISPATCH( $::Call, 'new', ::DISPATCH( $::Str, 'new', 'hyper' )
 => ::DISPATCH( $::Str, 'new', '' )
...
; do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_infix_58__60__38__38__62_, 'APPLY', ::DISPATCH( $GLOBAL::item, 'isa', ::DISPATCH( $::Str, 'new', 'Decl' )
 )
...
,::DISPATCH( $::Str, 'new', 'arguments' )
 => ::DISPATCH( $::Array, "new", { _array => [::DISPATCH( $::Val::Buf, 'new', ::DISPATCH( $::Str, 'new', 'buf' )
 => ::DISPATCH( ::DISPATCH( $GLOBAL::item, 'var',  )
, 'name',  )
, )
] } )
,::DISPATCH( $::Str, 'new', 'method' )
...
->{_value}{_array} } ) { do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_infix_58__60__124__124__62_, 'APPLY', ::DISPATCH( $GLOBAL::item, 'isa', ::DISPATCH( $::Str, 'new', 'Method' )
 )
, ::DISPATCH( $GLOBAL::Code_infix_58__60__38__38__62_, 'APPLY', ::DISPATCH( $GLOBAL::item, 'isa', ::DISPATCH( $::Str, 'new', 'Decl' )
 )
, ::DISPATCH( $GLOBAL::Code_infix_58__60_eq_62_, 'APPLY', ::DISPATCH( $GLOBAL::item, 'decl',  )
, ::DISPATCH( $::Str, 'new', 'has' )
 )
