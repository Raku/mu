...
, 'add_method', ::DISPATCH( $::Str, 'new', 'double_quoted' )
...
; ::DISPATCH_VAR( ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'double_quoted' )
 )
, 'STORE', $m2 )
; ::DISPATCH( $::Int, 'new', 1 )
...
; ::DISPATCH( ::DISPATCH( $::KindaPerl6::Grammar, 'HOW',  )
, 'add_method', ::DISPATCH( $::Str, 'new', 'single_quoted' )
, ::DISPATCH( $::Method, 'new', sub  { my $MATCH; $MATCH = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$MATCH' } )  unless defined $MATCH; BEGIN { $MATCH = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$MATCH' } ) }
;
my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
...
; ::DISPATCH_VAR( ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'single_quoted' )
 )
, 'STORE', $m2 )
; ::DISPATCH( $::Int, 'new', 1 )
 }  else { ::DISPATCH( $::Int, 'new', 0 )
...
; ::DISPATCH( ::DISPATCH( $::KindaPerl6::Grammar, 'HOW',  )
, 'add_method', ::DISPATCH( $::Str, 'new', 'val_buf' )
, ::DISPATCH( $::Method, 'new', sub  { my $MATCH; $MATCH = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$MATCH' } )  unless defined $MATCH; BEGIN { $MATCH = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$MATCH' } ) }
;
my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
...
;
::DISPATCH_VAR( $ret, 'STORE', ::DISPATCH( $self, '__rule_block121cbd617e9f357f277064fe9202dc7ab',  )
 )
...
, do { my $ret; $ret = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$ret' } )  unless defined $ret; BEGIN { $ret = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$ret' } ) }
;
::DISPATCH_VAR( $ret, 'STORE', ::DISPATCH( $self, '__rule_block221cbd617e9f357f277064fe9202dc7ab',  )
 )
; do { if (::DISPATCH(::DISPATCH($ret,"true"),"p5landish") ) { ::DISPATCH_VAR( ::DISPATCH( $MATCH, 'result',  )
, 'STORE', $ret )
; return($MATCH)
...
; ::DISPATCH( ::DISPATCH( $::KindaPerl6::Grammar, 'HOW',  )
, 'add_method', ::DISPATCH( $::Str, 'new', '__rule_block121cbd617e9f357f277064fe9202dc7ab' )
...
$List__ = ::DISPATCH( $CAPTURE, 'array',  )
 ...
 => ::DISPATCH( $GLOBAL::Code_prefix_58__60__126__62_, 'APPLY', ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'double_quoted' )
 )
 )
, )
)
...
; ::DISPATCH( ::DISPATCH( $::KindaPerl6::Grammar, 'HOW',  )
, 'add_method', ::DISPATCH( $::Str, 'new', '__rule_block221cbd617e9f357f277064fe9202dc7ab' )
, ::DISPATCH( $::Method, 'new', sub  { $self = shift; my $CAPTURE; $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } )  unless defined $CAPTURE; BEGIN { $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } ) }
::DISPATCH_VAR($CAPTURE,"STORE",::CAPTURIZE(\@_));do {::MODIFIED($List__);
$List__ = ::DISPATCH( $CAPTURE, 'array',  )
};return(::DISPATCH( $::Val::Buf, 'new', ::DISPATCH( $::Str, 'new', 'buf' )
 => ::DISPATCH( $GLOBAL::Code_prefix_58__60__126__62_, 'APPLY', ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'single_quoted' )
 )
 )
, )
)
