...
do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::Junction )
,"true"),"p5landish") ) { }  else { do {::MODIFIED($::Junction);
...
, ::DISPATCH( $::Method, 'new', sub  { my  $Hash_sep = ::DISPATCH( $::Hash, 'new', { modified => $_MODIFIED, name => '$Hash_sep' } ) ; 
;
...
; ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $GLOBAL::Code_ternary_58__60__63__63__32__33__33__62_, 'APPLY', ::DISPATCH( $GLOBAL::Code_infix_58__60_eq_62_, 'APPLY', ::DISPATCH( $self, "type" )
, ::DISPATCH( $::Str, 'new', '!' )
 )
, ::DISPATCH( $::Str, 'new', 'none' )
, ::DISPATCH( $::Str, 'new', '' )
...
, ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', ::DISPATCH( $self, "things" )
 )
...
, ::DISPATCH( $::Method, 'new', sub  { my $thing; $thing = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$thing' } )  unless defined $thing; BEGIN { $thing = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$thing' } ) }
;
my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
my $self; $self = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$self' } )  unless defined $self; BEGIN { $self = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$self' } ) }
...
,"true"),"p5landish") ) { my $counter; $counter = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$counter' } )  unless defined $counter; BEGIN { $counter = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$counter' } ) }
;
