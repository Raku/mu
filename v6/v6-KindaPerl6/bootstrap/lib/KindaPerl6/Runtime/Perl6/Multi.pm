...
do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::Multi )
,"true"),"p5landish") ) { }  else { do {::MODIFIED($::Multi);
$::Multi = ::DISPATCH( ::DISPATCH( $::Class, 'new', ::DISPATCH( $::Str, 'new', 'Multi' )
 )
, 'PROTOTYPE',  )
} } }
; ::DISPATCH( ::DISPATCH( $::Multi, 'HOW',  )
, 'add_parent', ::DISPATCH( $::Str, 'new', 'Code' )
 )
; ::DISPATCH( ::DISPATCH( $::Multi, 'HOW',  )
...
, ::DISPATCH( $::Method, 'new', sub  { my  $List_candidates = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List_candidates' } ) ; 
;
...
};$List_candidates; $sub; do { if (::DISPATCH(::DISPATCH(::DISPATCH( ::DISPATCH( $List__, 'INDEX', ::DISPATCH( $::Int, 'new', 0 )
 )
, 'isa', ::DISPATCH( $::Str, 'new', 'Capture' )
 )
,"true"),"p5landish") ) { }  else { ::DISPATCH( $GLOBAL::Code_die, 'APPLY', ::DISPATCH( $::Str, 'new', 'the parameter to Multi.select must be a Capture' )
 )
 } }
...
,"true"),"p5landish") ) { ::DISPATCH( $List_candidates, 'push', $sub )
 }  }
 } }
; do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_infix_58__60__61__61__62_, 'APPLY', ::DISPATCH( $List_candidates, 'elems',  )
, ::DISPATCH( $::Int, 'new', 1 )
 )
,"true"),"p5landish") ) { return(::DISPATCH( $List_candidates, 'INDEX', ::DISPATCH( $::Int, 'new', 0 )
 )
)
 }  }
; ::DISPATCH( $GLOBAL::Code_die, 'APPLY', ::DISPATCH( $::Str, 'new', 'can\'t resolve Multi dispatch' )
 )
 }
 )
 )
