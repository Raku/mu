...
;
package CompUnit; sub new { shift; bless { @_ }, "CompUnit" } sub emit_perl5 { my $self = shift; my $List__ = \@_; do { [] }; ('{ package ' . ($self->{name} . ('; ' . (Main::newline() . ('# Do not edit this file - Perl 5 generated by ' . ($Main::_V6_COMPILER_NAME . (Main::newline() . ('use v5; ' . ('use strict; ' . ('no strict \'vars\'; ' . ('use KindaPerl6::Runtime::Perl5::Runtime; ' . ('use KindaPerl6::Runtime::Perl6::Hash; ' . ('my $_MODIFIED; BEGIN { $_MODIFIED = {} } ' . ('BEGIN { ' . ('$_ = ::DISPATCH($::Scalar, "new", { modified => $_MODIFIED, name => "$_" } ); ' . ('} ' . ($self->{body}->emit_perl5() . ('; 1 }' . Main::newline())))))))))))))))))) }
;
