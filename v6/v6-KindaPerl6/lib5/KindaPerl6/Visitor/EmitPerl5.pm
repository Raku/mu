...
;
package Bind; sub new { shift; bless { @_ }, "Bind" } sub emit_perl5 { my $self = shift; my $List__ = \@_; do { [] }; do { if (Main::isa($self->{parameters}, 'Proto')) { return(($self->{parameters}->emit_perl5() . (' = ' . $self->{arguments}->emit_perl5()))) } else {  } }; return(('::DISPATCH_VAR( ' . ($self->{parameters}->emit_perl5() . (', \'BIND\', ' . ($self->{arguments}->emit_perl5() . ' )'))))) }
;
