    ...
    do {
        my $List_visitors =
          ::DISPATCH( $::ArrayContainer, 'new',
            { modified => $_MODIFIED, name => '$List_visitors' } );
        my $emit_p5;
        $emit_p5 =
          ::DISPATCH( $::Scalar, 'new',
            { modified => $_MODIFIED, name => '$emit_p5' } )
          unless defined $emit_p5;
        INIT {
            $emit_p5 =
              ::DISPATCH( $::Scalar, 'new',
                { modified => $_MODIFIED, name => '$emit_p5' } );
        ...
        $List_visitors;
        ::DISPATCH( $List_visitors, 'push',
            ::DISPATCH( $::KindaPerl6::Visitor::ExtractRuleBlock, 'new', ) );
        ::DISPATCH( $List_visitors, 'push',
        ...
        ::DISPATCH_VAR( $emit_p5, 'STORE',
            ::DISPATCH( $::KindaPerl6::Visitor::Emit::Perl5, 'new', ) );
        ::DISPATCH_VAR(
            ::DISPATCH( $emit_p5, 'visitor_args', ),
            'STORE',
            do {
                my $List_visitors =
                  ::DISPATCH( $::ArrayContainer, 'new',
        ...
        ::DISPATCH_VAR(
            ...
            ::DISPATCH(
                (
                    $GLOBAL::Code_slurp = $GLOBAL::Code_slurp
                      || ::DISPATCH( $::Routine, "new", )
                ),
                'APPLY',
            )
        ...
        ::DISPATCH(
            (
                $COMPILER::Code_env_init = $COMPILER::Code_env_init
                  || ::DISPATCH( $::Routine, "new", )
            ),
            'APPLY',
        );
        ::DISPATCH_VAR(
            ::DISPATCH(
                ...
                do {
                    ::MODIFIED(
                        (
                            $COMPILER::source_md5 = $COMPILER::source_md5
                              || ::DISPATCH( $::Scalar, "new", )
                        )
                    );
                    ( $COMPILER::source_md5 = $COMPILER::source_md5
        ...
        ::DISPATCH_VAR(
            ...
            ::DISPATCH(
                (
                    $GLOBAL::Code_chars = $GLOBAL::Code_chars
                      || ::DISPATCH( $::Routine, "new", )
                ),
                'APPLY', $code
            )
              ...
              )
            {
                do {
                    ...
                    ::DISPATCH_VAR( $match, 'STORE',
                        ::DISPATCH( $::KindaPerl6::Grammar, 'comp_unit', $pos )
                    );
                    ...
                    ::DISPATCH(
                        ...
                        ::DISPATCH(
                            $ast, 'emit',
                            ::DISPATCH(
                                $::KindaPerl6::Visitor::Emit::AstPerl, 'new',
                            )
                        )
                    );
                    ::DISPATCH(
                        (
                            $GLOBAL::Code_exit = $GLOBAL::Code_exit
                              || ::DISPATCH( $::Routine, "new", )
                        ),
                        'APPLY',
                    );
                    ...
                    ::DISPATCH(
                        (
                            $GLOBAL::Code_print = $GLOBAL::Code_print
                              || ::DISPATCH( $::Routine, "new", )
                        ),
                        'APPLY', $res
                    );
