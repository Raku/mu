...
package GLOBAL;
    ...
    { bless \( do{ my $v = ${$_[0]->FETCH} eq ${$_[1]->FETCH}  } ), 'Type_Constant_Bit' }  # infix:<eq>
    sub infix_58__60_ne_62_         
    { bless \( do{ my $v = ${$_[0]->FETCH} ne ${$_[1]->FETCH}  } ), 'Type_Constant_Bit' }  # infix:<ne>
    sub infix_58__60__61__61__62_   
    { bless \( do{ my $v = ${$_[0]->FETCH} == ${$_[1]->FETCH}  } ), 'Type_Constant_Bit' }  # infix:<==>
    sub infix_58__60__33__61__62_   
    { bless \( do{ my $v = ${$_[0]->FETCH} != ${$_[1]->FETCH}  } ), 'Type_Constant_Bit' }  # infix:<!=>
    sub infix_58__60__126__62_      
    { bless \( do{ my $v = ${$_[0]->FETCH} .  ${$_[1]->FETCH}  } ), 'Type_Constant_Buf' }  # infix:<~>
    sub infix_58__60__43__62_       
    { bless \( do{ my $v = ${$_[0]->FETCH} +  ${$_[1]->FETCH}  } ), 'Type_Constant_Num' }  # infix:<+>
