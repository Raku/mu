...
, 'APPLY', $::KindaPerl6::Visitor::Namespace )
,"true"),"p5landish") ) { do {} }  else { do {do {::MODIFIED($::KindaPerl6::Visitor::Namespace);
...
,"true"),"p5landish") ) { do {do { if (::DISPATCH(::DISPATCH(::DISPATCH(  ( $GLOBAL::Code_prefix_58__60__64__62_ = $GLOBAL::Code_prefix_58__60__64__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', ::DISPATCH( $node, 'namespace',  )
 )
,"true"),"p5landish") ) { do {return(::DISPATCH( $::Call, 'new', ::DISPATCH( $::Pair, 'new', { key => ::DISPATCH( $::Str, 'new', 'invocant' )
