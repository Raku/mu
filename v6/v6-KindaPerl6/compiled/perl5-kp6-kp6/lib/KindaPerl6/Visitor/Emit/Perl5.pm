...
, ::DISPATCH( $::Code, 'new', { code => sub { my $source; $source = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$source' } )  unless defined $source; BEGIN { $source = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$source' } ) }
;
...
, 'for', ::DISPATCH( $::Code, 'new', { code => sub { my $bind_named; $bind_named = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$bind_named' } )  unless defined $bind_named; BEGIN { $bind_named = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$bind_named' } ) }
;
my $bind_default; $bind_default = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$bind_default' } )  unless defined $bind_default; BEGIN { $bind_default = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$bind_default' } ) }
;
my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
my $field; $field = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$field' } )  unless defined $field; BEGIN { $field = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$field' } ) }
...
my $name; $name = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$name' } )  unless defined $name; BEGIN { $name = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$name' } ) }
;
my $create; $create = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$create' } )  unless defined $create; BEGIN { $create = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$create' } ) }
;
my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
my $self; $self = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$self' } )  unless defined $self; BEGIN { $self = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$self' } ) }
...
,"true"),"p5landish") ) { do { my $s; $s = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$s' } )  unless defined $s; BEGIN { $s = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$s' } ) }
;
$s; do {::MODIFIED($s);
...
, 'add_method', ::DISPATCH( $::Str, 'new', 'emit_perl5' )
, ::DISPATCH( $::Code, 'new', { code => sub { my $inv; $inv = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$inv' } )  unless defined $inv; BEGIN { $inv = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$inv' } ) }
;
...
;
my $named; $named = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$named' } )  unless defined $named; BEGIN { $named = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$named' } ) }
;
my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
my $self; $self = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$self' } )  unless defined $self; BEGIN { $self = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$self' } ) }
