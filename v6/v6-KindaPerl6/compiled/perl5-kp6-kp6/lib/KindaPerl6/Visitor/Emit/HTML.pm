...
; return(::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', $s, ::DISPATCH( ::DISPATCH( $::Array, "new", { _array => [ map { ::DISPATCH( $_, "emit_html", ) } @{ ::DISPATCH( ::DISPATCH( $self, "body" )
, "array" )->{_value}{_array} } ] } )
...
, ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $::Str, 'new', ', ' )
, ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( ::DISPATCH( $::Array, "new", { _array => [ map { ::DISPATCH( $_, "emit_html", ) } @{ ::DISPATCH( ::DISPATCH( $self, "arguments" )
, "array" )->{_value}{_array} } ] } )
, 'join', ::DISPATCH( $::Str, 'new', ', ' )
 )
, ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $::Str, 'new', ')' )
