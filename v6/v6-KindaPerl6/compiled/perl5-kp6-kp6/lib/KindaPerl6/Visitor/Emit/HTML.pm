              ...
              )
            {
                ...
                do {
                    do {
                        ...
                        $::KindaPerl6::Visitor::Emit::HTML = ::DISPATCH(
                            ::DISPATCH(
                                $::Class, 'new',
                                ::DISPATCH(
                                    $::Str, 'new',
                ...
                $::Code, 'new',
                {
                    code => sub {
                        ...
                        do {
                            ...
                            $nl = ::DISPATCH(
                                (
                                    $Main::Code_newline = $Main::Code_newline
                                      || ::DISPATCH( $::Routine, "new", )
                                ),
                                'APPLY',
                            );
