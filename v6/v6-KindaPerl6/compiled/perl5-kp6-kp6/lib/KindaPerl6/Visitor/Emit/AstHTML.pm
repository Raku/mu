{
    ...
    do {
        do {
            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::KindaPerl6::Visitor::Emit::AstHTML ), "true" ), "p5landish" ) ) {
            }
            else {
                do {
                    do {
                        ::MODIFIED($::KindaPerl6::Visitor::Emit::AstHTML);
                        $::KindaPerl6::Visitor::Emit::AstHTML = ::DISPATCH( ::DISPATCH( $::Class, 'new', ::DISPATCH( $::Str, 'new', 'KindaPerl6::Visitor::Emit::AstHTML' ) ), 'PROTOTYPE', );
                        }
                    }
            }
        };
        ::DISPATCH(
            ::DISPATCH( $::KindaPerl6::Visitor::Emit::AstHTML, 'HOW', ),
            'add_method',
                                        ...
                                        do {
                                            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( ::DISPATCH( $data, 'LOOKUP', $item ), 'isa', ::DISPATCH( $::Str, 'new', 'Array' ) ), "true" ), "p5landish" ) ) {
                                                do {
                                                    ...
                                                    ::DISPATCH(
                                                        ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', ::DISPATCH( $data, 'LOOKUP', $item ) ),
                                                        'for',
                                                        ::DISPATCH(
                                                            $::Code, 'new',
                                                            {   code => sub {
