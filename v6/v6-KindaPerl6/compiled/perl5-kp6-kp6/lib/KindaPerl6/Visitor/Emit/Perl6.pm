...
,"true"),"p5landish") ) { do {} }  else { do {do {::MODIFIED($::KindaPerl6::Visitor::Emit::Perl6);
...
, 'APPLY', ::DISPATCH( $::Str, 'new', '(' )
, ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', ::DISPATCH( ::DISPATCH( $::List, "new", { _array => [ map { ::DISPATCH( $_, "emit_perl6", ) } @{ ::DISPATCH( ::DISPATCH( $self, "seq" )
, "array" )->{_value}{_array} } ] } )
...
, 'APPLY', ::DISPATCH( $::Str, 'new', '[' )
, ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', ::DISPATCH( ::DISPATCH( $::List, "new", { _array => [ map { ::DISPATCH( $_, "emit_perl6", ) } @{ ::DISPATCH( ::DISPATCH( $self, "array" )
, "array" )->{_value}{_array} } ] } )
, 'join', ::DISPATCH( $::Str, 'new', ', ' )
 )
, ::DISPATCH( $::Str, 'new', ']' )
...
, 'APPLY', $s, ::DISPATCH( ::DISPATCH( $::List, "new", { _array => [ map { ::DISPATCH( $_, "emit_perl6", ) } @{ ::DISPATCH( ::DISPATCH( $self, "body" )
, "array" )->{_value}{_array} } ] } )
...
, 'APPLY', ::DISPATCH( $::Str, 'new', ', ' )
, ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', ::DISPATCH( ::DISPATCH( $::List, "new", { _array => [ map { ::DISPATCH( $_, "emit_perl6", ) } @{ ::DISPATCH( ::DISPATCH( $self, "arguments" )
, "array" )->{_value}{_array} } ] } )
, 'join', ::DISPATCH( $::Str, 'new', ', ' )
 )
, ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
...
; do {::MODIFIED($call);
$call = ::DISPATCH( ::DISPATCH( $::List, "new", { _array => [ map { ::DISPATCH( $_, "emit_perl6", ) } @{ ::DISPATCH( ::DISPATCH( $self, "arguments" )
, "array" )->{_value}{_array} } ] } )
, 'join', ::DISPATCH( $::Str, 'new', ', ' )
 )
...
# emit_body
::DISPATCH( ::DISPATCH( $::List, "new", { _array => [ map { ::DISPATCH( $_, "emit_perl6", ) } @{ ::DISPATCH( ::DISPATCH( $self, "positional" )
, "array" )->{_value}{_array} } ] } )
, 'join', ::DISPATCH( $::Str, 'new', ', ' )
 )
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => bless( {
