...
# emit_body
::DISPATCH( ::DISPATCH( $::Array, "new", { _array => [ map { ::DISPATCH( $_, "emit_parrot", ) } @{ ::DISPATCH( ::DISPATCH( $self, "body" )
, "array" )->{_value}{_array} } ] } )
...
, ::DISPATCH( $::Code, 'new', { code => sub { 
# emit_declarations
my $id; $id = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$id' } )  unless defined $id; INIT { $id = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$id' } ) }
;
my  $List__ = ::DISPATCH( $::ArrayContainer, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
my $self; $self = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$self' } )  unless defined $self; INIT { $self = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$self' } ) }
...
# emit_body
::DISPATCH( ::DISPATCH( $::Array, "new", { _array => [ map { ::DISPATCH( $_, "emit_parrot", ) } @{ ::DISPATCH( ::DISPATCH( $self, "block" )
, "array" )->{_value}{_array} } ] } )
, 'join', ::DISPATCH( $::Str, 'new', '' )
 )
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => bless( {
...
# emit_body
::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $::Str, 'new', '  .include ' )
, ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $Main::Code_quote, 'APPLY',  )
