{
    ...
    do {
        do {
            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::KindaPerl6::Visitor::Emit::AstPerl ), "true" ), "p5landish" ) ) {
            }
            else {
                do {
                    do {
                        ::MODIFIED($::KindaPerl6::Visitor::Emit::AstPerl);
                        $::KindaPerl6::Visitor::Emit::AstPerl = ::DISPATCH( ::DISPATCH( $::Class, 'new', ::DISPATCH( $::Str, 'new', 'KindaPerl6::Visitor::Emit::AstPerl' ) ), 'PROTOTYPE', );
                        }
                    }
            }
        };
                ...
                {   code => sub {
                        ...
                        do {
                            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $node, 'isa', ::DISPATCH( $::Str, 'new', 'Str' ) ), "true" ), "p5landish" ) ) {
                                do {
                                    return (
                                        ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $::Str, 'new', chr(39) ), ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', $node, ::DISPATCH( $::Str, 'new', chr(39) ) ) ) );
                                    }
                            }
                            else { ::DISPATCH( $::Bit, "new", 0 ) }
                        };
                                                                                    ...
                                                                                    do {
                                                                                        do {
                                                                                            ...
                                                                                            $result = ::DISPATCH(
                                                                                                ...
                                                                                                ::DISPATCH(
                                                                                                    $GLOBAL::Code_infix_58__60__126__62_, 'APPLY',
                                                                                                    ::DISPATCH( ::DISPATCH( $data, 'LOOKUP', $item ), 'emit', $self ), ::DISPATCH( $::Str, 'new', ', ' )
                                                                                                )
                                                                                            );
                                                                                            }
                                                                                        }
