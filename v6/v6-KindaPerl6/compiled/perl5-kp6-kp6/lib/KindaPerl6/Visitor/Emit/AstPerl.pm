...
, 'APPLY', $::KindaPerl6::Visitor::Emit::AstPerl )
...
# emit_body
do { if (::DISPATCH(::DISPATCH(do { my $_tmp1 = ::DISPATCH( $node, 'isa', ::DISPATCH( $::Str, 'new', 'Array' )
 )
; ::DISPATCH( $_tmp1, "true" )->{_value} ? $_tmp1: ::DISPATCH( $node, 'isa', ::DISPATCH( $::Str, 'new', 'List' )
 )
 }
...
} }  elsif ( ::DISPATCH( $GLOBAL::Code_exists,  'APPLY',  ::DISPATCH(  $List__, 'INDEX',  ::DISPATCH( $::Int, 'new', $_param_index )  ) )->{_value}  )  { $subitem = ::DISPATCH(  $List__, 'INDEX',  ::DISPATCH( $::Int, 'new', $_param_index++ )  );  } } do { if (::DISPATCH(::DISPATCH(do { my $_tmp1 = ::DISPATCH( $subitem, 'isa', ::DISPATCH( $::Str, 'new', 'Array' )
 )
; ::DISPATCH( $_tmp1, "true" )->{_value} ? $_tmp1: ::DISPATCH( $subitem, 'isa', ::DISPATCH( $::Str, 'new', 'List' )
 )
 }
...
, 'APPLY', ::DISPATCH( $self, 'visit', $subitem, ::DISPATCH( $::Str, 'new', 'Array' )
 )
, ::DISPATCH( $::Str, 'new', ', ' )
 )
 )
...
, 'APPLY', ::DISPATCH( $::Str, 'new', chr( 39 ) )
, ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', $node, ::DISPATCH( $::Str, 'new', chr( 39 ) )
 )
 )
)
} }  else { ::DISPATCH($::Bit, "new", 0) } }
...
$result = ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', $result, ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', ::DISPATCH( $self, 'visit', ::DISPATCH( $data, 'LOOKUP', $item )
