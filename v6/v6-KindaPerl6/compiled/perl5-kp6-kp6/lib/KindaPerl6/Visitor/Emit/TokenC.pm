...
, ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', ::DISPATCH( ::DISPATCH( $::Array, "new", { _array => [ map { ::DISPATCH( $_, "emit_c", ) } @{ ::DISPATCH( ::DISPATCH( $self, "or" )
, "array" )->{_value}{_array} } ] } )
...
, 'APPLY', ::DISPATCH( $::Str, 'new', '(' )
, ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
, 'APPLY', ::DISPATCH( ::DISPATCH( $::Array, "new", { _array => [ map { ::DISPATCH( $_, "emit_c", ) } @{ ::DISPATCH( ::DISPATCH( $self, "concat" )
, "array" )->{_value}{_array} } ] } )
, 'join', ::DISPATCH( $::Str, 'new', '&&' )
 )
, ::DISPATCH( $::Str, 'new', ')' )
