{
    ...
    do {
        our $Code_new_pad = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_new_pad' } );
        our $Code_thunk   = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_thunk' } );
        do {
            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::KindaPerl6::Visitor::ShortCircuit ), "true" ), "p5landish" ) ) {
            }
            else {
                do {
                    our $Code_new_pad = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_new_pad' } );
                    our $Code_thunk   = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_thunk' } );
                    do {
                        ::MODIFIED($::KindaPerl6::Visitor::ShortCircuit);
                        $::KindaPerl6::Visitor::ShortCircuit = ::DISPATCH( ::DISPATCH( $::Class, 'new', ::DISPATCH( $::Str, 'new', 'KindaPerl6::Visitor::ShortCircuit' ) ), 'PROTOTYPE', );
                        }
                    }
            }
        };
        ::DISPATCH(
            ::DISPATCH( $::KindaPerl6::Visitor::ShortCircuit, 'HOW', ),
            'add_method',
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        my $pass_thunks;
                        $pass_thunks = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$pass_thunks' } )
                            unless defined $pass_thunks;

                        BEGIN {
                            $pass_thunks = ::DISPATCH(
                                $::Scalar,
                                'new',
                                {   modified => $_MODIFIED,
                                    name     => '$pass_thunks'
                        ...
                        do {
                            ::MODIFIED($pass_thunks);
                            $pass_thunks = ::DISPATCH(
                                $::Hash, 'new',
                                {   _hash => {
                                        ::DISPATCH( $::Str, 'new', 'infix:<&&>' )->{_value} => ::DISPATCH( $::Int, 'new', 1 ),
                                        ::DISPATCH( $::Str, 'new', 'infix:<||>' )->{_value} => ::DISPATCH( $::Int, 'new', 1 ),
                                        ::DISPATCH( $::Str, 'new', 'infix:<//>' )->{_value} => ::DISPATCH( $::Int, 'new', 1 ),
                                    }
                                }
                        ...
                        do {
                                        ...
                                        ::DISPATCH(
                                            ...
                                            ::DISPATCH(
                                                ...
                                                {   code => sub {
                                                        ...
                                                        ::DISPATCH( $GLOBAL::Code_infix_58__60_eq_62_, 'APPLY', $GLOBAL::node_name, ::DISPATCH( $::Str, 'new', 'Apply' ) );
                                                    },
                                                    signature => ::DISPATCH(
                                                        $::Signature,
                                                        "new",
                                            ...
                                            ::DISPATCH(
                                                ...
                                                {   code => sub {
                                                        ...
                                                        ::DISPATCH( $GLOBAL::pass_thunks, 'LOOKUP', ::DISPATCH( ::DISPATCH( $GLOBAL::node, 'code', ), 'name', ) );
                                                    },
                                                    signature => ::DISPATCH(
                                                        $::Signature,
                                                        "new",
                                ...
                                )
                            {
                                do {
                                    ...
                                    do {
                                        ::MODIFIED($left);
                                        $left = ::DISPATCH( ::DISPATCH( ::DISPATCH( $node, 'arguments', ), 'INDEX', ::DISPATCH( $::Int, 'new', 0 ) ), 'emit', $self );
                                    };
                                    do {
                                        ::MODIFIED($right);
                                        $right = ::DISPATCH( ::DISPATCH( ::DISPATCH( $node, 'arguments', ), 'INDEX', ::DISPATCH( $::Int, 'new', 1 ) ), 'emit', $self );
                                    };
                                    return (
                                        ::DISPATCH(
                                            $::Apply, 'new',
                                            ...
                                            ::DISPATCH(
                                                ...
                                                {   _argument_name_ => ::DISPATCH( $::Str, 'new', 'arguments' ),
                                                    value => ::DISPATCH( $::Array, 'new', { _array => [ ::DISPATCH( $Code_thunk, 'APPLY', $left ), ::DISPATCH( $Code_thunk, 'APPLY', $right ) ] } ),
                                                }
                                            ),
                                        )
                                    );
        ...
        do {
            ::MODIFIED($Code_new_pad);
            $Code_new_pad = ::DISPATCH(
                $::Code, 'new',
                {   code => sub {
                        my $pad;
                        $pad = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$pad' } )
                            unless defined $pad;
