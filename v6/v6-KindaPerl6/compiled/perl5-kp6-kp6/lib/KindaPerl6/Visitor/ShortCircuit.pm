    ...
    do {
        our $Code_thunk =
          ::DISPATCH( $::Routine, 'new',
            { modified => $_MODIFIED, name => '$Code_thunk' } );
        do {
            if (
                ::DISPATCH(
                    ::DISPATCH(
                        ::DISPATCH(
                            ...
                            'APPLY',
                            $::KindaPerl6::Visitor::ShortCircuit
                        ),
                        "true"
                    ),
                    "p5landish"
              ...
              )
            {
                ...
                do {
                    ...
                    do {
                        ...
                        $::KindaPerl6::Visitor::ShortCircuit = ::DISPATCH(
                            ::DISPATCH(
                                $::Class, 'new',
                                ::DISPATCH(
                                    $::Str, 'new',
            ...
            ::DISPATCH(
                $::Code, 'new',
                {
                    code => sub {
                        ...
                        # emit_declarations
                        my $pass_thunks;
                        $pass_thunks = ::DISPATCH( $::Scalar, 'new',
                            { modified => $_MODIFIED, name => '$pass_thunks' } )
                              ...
                              )
                            {
                                do {
                                    do {
                                        ::MODIFIED(
                                            (
                                                $KindaPerl6::Visitor::ShortCircuit::last_pad
                                                  = $KindaPerl6::Visitor::ShortCircuit::last_pad
                                                  || ::DISPATCH( $::Scalar,
                                                    "new", )
                                            )
