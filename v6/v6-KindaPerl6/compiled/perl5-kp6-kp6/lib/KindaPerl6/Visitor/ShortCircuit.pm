...
, ::DISPATCH( $::Code, 'new', { code => sub { my $pass_thunks; $pass_thunks = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$pass_thunks' } )  unless defined $pass_thunks; BEGIN { $pass_thunks = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$pass_thunks' } ) }
;
...
,"true"),"p5landish") ) { do { my $left; $left = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$left' } )  unless defined $left; BEGIN { $left = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$left' } ) }
;
my $right; $right = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$right' } )  unless defined $right; BEGIN { $right = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$right' } ) }
;
do {::MODIFIED($left);
...
$Code_new_pad = ::DISPATCH( $::Code, 'new', { code => sub { my $pad; $pad = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$pad' } )  unless defined $pad; BEGIN { $pad = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$pad' } ) }
;
my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
...
$Code_thunk = ::DISPATCH( $::Code, 'new', { code => sub { my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
