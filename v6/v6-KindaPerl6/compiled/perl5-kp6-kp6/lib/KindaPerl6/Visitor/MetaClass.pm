...
,"true"),"p5landish") ) { do {} }  else { do {do {::MODIFIED($::KindaPerl6::Visitor::MetaClass);
...
, 'APPLY', $module )
, ::DISPATCH( $::Call, 'new', ::DISPATCH( $::Pair, 'new', { key => ::DISPATCH( $::Str, 'new', 'hyper' )
...
$metaobject = ::DISPATCH( $::Call, 'new', ::DISPATCH( $::Pair, 'new', { key => ::DISPATCH( $::Str, 'new', 'hyper' )
, value => ::DISPATCH( $::Str, 'new', '' )
 } )
, ::DISPATCH( $::Pair, 'new', { key => ::DISPATCH( $::Str, 'new', 'arguments' )
, value => ::DISPATCH( $::Array, 'new', { _array => [::DISPATCH( $::Val::Buf, 'new', ::DISPATCH( $::NamedArgument, 'new', { _argument_name_ => ::DISPATCH( $::Str, 'new', 'buf' )
...
, value => ::DISPATCH( $::Lit::Code, 'new', ::DISPATCH( $::NamedArgument, 'new', { _argument_name_ => ::DISPATCH( $::Str, 'new', 'body' )
, value => ::DISPATCH( $::Array, 'new', { _array => [::DISPATCH( $::Bind, 'new', ::DISPATCH( $::Pair, 'new', { key => ::DISPATCH( $::Str, 'new', 'parameters' )
, value => ::DISPATCH( $::Proto, 'new', ::DISPATCH( $::NamedArgument, 'new', { _argument_name_ => ::DISPATCH( $::Str, 'new', 'name' )
, value => ::DISPATCH( $node, 'name',  )
 } )
 )
...
, ::DISPATCH( $::Pair, 'new', { key => ::DISPATCH( $::Str, 'new', 'arguments' )
, value => ::DISPATCH( $::Array, 'new', { _array => [::DISPATCH( $::Call, 'new', ::DISPATCH( $::Pair, 'new', { key => ::DISPATCH( $::Str, 'new', 'hyper' )
, value => ::DISPATCH( $::Str, 'new', '' )
 } )
, ::DISPATCH( $::Pair, 'new', { key => ::DISPATCH( $::Str, 'new', 'arguments' )
, value => ::DISPATCH( $::Array, 'new', { _array => [] }
