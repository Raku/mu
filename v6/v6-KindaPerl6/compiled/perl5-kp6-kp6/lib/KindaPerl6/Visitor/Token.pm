...
'APPLY',
                                                                                                ::DISPATCH(
                                                                                                    $::Str,
'new',
' returned true to ("~$MATCH.to~")"; } else {say "<<< token '
                                                                                                  )
                                                                                                ,
                                                                                                ::DISPATCH(
                                                                                                    (
                        ...
                        ::DISPATCH(
                            ...
                            ::DISPATCH(
                                ...
                                ::DISPATCH(
                                    $::Str,
                                    'new',
'",$str,($pos+0)); if ($m2) { $MATCH.to = $m2.to + 0; 1 } else { 0 } }'
                                )
                            )
                        );
                    },
            ...
            ::DISPATCH(
                $::Code, 'new',
                {
                    code => sub {
                        ...
                        ::DISPATCH(
                            (
                                $Rule::Code_constant = $Rule::Code_constant
                                  || ::DISPATCH( $::Routine, "new", )
                            ),
                            'APPLY', $str
                        );
