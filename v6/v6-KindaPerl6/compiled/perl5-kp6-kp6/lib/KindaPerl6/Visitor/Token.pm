...
# emit_body
::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $::Str, 'new', 'do { my $m2 = match_p5rx("' )
...
# emit_body
::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $::Str, 'new', 'do { if (\\\'\\\' ne substr( $str, $MATCH.to, 1 )) {' )
