    ...
    do {
        ...
        do {
            ...
            $Code_constant = ::DISPATCH(
                ...
                {   code => sub {
                        my $len;
                        $len = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$len' } )
                            unless defined $len;
                            ...
                            if ( ::DISPATCH( ::DISPATCH( $len, "true" ), "p5landish" ) ) {
                                do {
                                    ::DISPATCH(
                                        $GLOBAL::Code_infix_58__60__126__62_,
                                        'APPLY',
                                        ::DISPATCH( $::Str, 'new', 'do {if (chars($str) <  ' ),
                                        ::DISPATCH(
                                            $GLOBAL::Code_infix_58__60__126__62_,
                                            'APPLY', $len,
                                            ::DISPATCH(
    ...
    do {
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        my $char;
                        $char = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$char' } )
                            unless defined $char;
                                        ...
                                        ::DISPATCH(
                                            ...
                                            ::DISPATCH(
                                                ...
                                                ::DISPATCH(
                                                    $GLOBAL::Code_infix_58__60__126__62_,
                                                    'APPLY',
                                                    ::DISPATCH( $::Str, 'new', 'if (%*ENV{"KP6_TOKEN_DEBUGGER"}) { say "<<< some closure returning... " }; ' ),
                                                    ::DISPATCH(
                                                        $GLOBAL::Code_infix_58__60__126__62_,
                                                        'APPLY',
