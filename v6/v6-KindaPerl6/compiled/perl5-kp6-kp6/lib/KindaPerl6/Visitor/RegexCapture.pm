...
do { do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::KindaPerl6::Visitor::RegexCapture )
,"true"),"p5landish") ) { }  else { do { do {::MODIFIED($::KindaPerl6::Visitor::RegexCapture);
$::KindaPerl6::Visitor::RegexCapture = ::DISPATCH( ::DISPATCH( $::Class, 'new', ::DISPATCH( $::Str, 'new', 'KindaPerl6::Visitor::RegexCapture' )
 )
, 'PROTOTYPE',  )
} } } }
; ::DISPATCH( ::DISPATCH( $::KindaPerl6::Visitor::RegexCapture, 'HOW',  )
...
,"true"),"p5landish") ) { do { ::DISPATCH( ::DISPATCH( $node, 'regex',  )
...
, 'add_method', ::DISPATCH( $::Str, 'new', 'capture_count' )
, ::DISPATCH( $::Code, 'new', { code => sub { my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
my $count; $count = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$count' } )  unless defined $count; BEGIN { $count = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$count' } ) }
;
my $quantified; $quantified = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$quantified' } )  unless defined $quantified; BEGIN { $quantified = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$quantified' } ) }
;
my $seen; $seen = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$seen' } )  unless defined $seen; BEGIN { $seen = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$seen' } ) }
;
$self = shift; my $CAPTURE; $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } )  unless defined $CAPTURE; BEGIN { $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } ) }
::DISPATCH_VAR($CAPTURE,"STORE",::CAPTURIZE(\@_));do {::MODIFIED($List__);
$List__ = ::DISPATCH( $CAPTURE, 'array',  )
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0;  if ( exists $Hash__->{_value}{_hash}{'count'} )  { do {::MODIFIED($count);
$count = ::DISPATCH( $Hash__, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'count' )
 )
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $count = $List__->{_value}{_array}[ $_param_index++ ];  }  if ( exists $Hash__->{_value}{_hash}{'quantified'} )  { do {::MODIFIED($quantified);
$quantified = ::DISPATCH( $Hash__, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'quantified' )
 )
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $quantified = $List__->{_value}{_array}[ $_param_index++ ];  }  if ( exists $Hash__->{_value}{_hash}{'seen'} )  { do {::MODIFIED($seen);
$seen = ::DISPATCH( $Hash__, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'seen' )
 )
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $seen = $List__->{_value}{_array}[ $_param_index++ ];  } } $count }, signature => ::DISPATCH( $::Signature, "new", { invocant => $::Undef, array    => ::DISPATCH( $::Array, "new", { _array => [ ::DISPATCH( $::Signature::Item, 'new', { sigil  => '$', twigil => '', name   => 'count', value  => $::Undef, has_default    => ::DISPATCH( $::Bit, 'new', 0 )
, is_named_only  => ::DISPATCH( $::Bit, 'new', 0 )
, is_optional    => ::DISPATCH( $::Bit, 'new', 0 )
, is_slurpy      => ::DISPATCH( $::Bit, 'new', 0 )
, is_multidimensional  => ::DISPATCH( $::Bit, 'new', 0 )
...
, is_copy        => ::DISPATCH( $::Bit, 'new', 0 )
,  } )
, ::DISPATCH( $::Signature::Item, 'new', { sigil  => '$', twigil => '', name   => 'quantified', value  => $::Undef, has_default    => ::DISPATCH( $::Bit, 'new', 0 )
, is_named_only  => ::DISPATCH( $::Bit, 'new', 0 )
, is_optional    => ::DISPATCH( $::Bit, 'new', 0 )
, is_slurpy      => ::DISPATCH( $::Bit, 'new', 0 )
, is_multidimensional  => ::DISPATCH( $::Bit, 'new', 0 )
...
, is_copy        => ::DISPATCH( $::Bit, 'new', 0 )
,  } )
, ::DISPATCH( $::Signature::Item, 'new', { sigil  => '$', twigil => '', name   => 'seen', value  => $::Undef, has_default    => ::DISPATCH( $::Bit, 'new', 0 )
, is_named_only  => ::DISPATCH( $::Bit, 'new', 0 )
, is_optional    => ::DISPATCH( $::Bit, 'new', 0 )
, is_slurpy      => ::DISPATCH( $::Bit, 'new', 0 )
, is_multidimensional  => ::DISPATCH( $::Bit, 'new', 0 )
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $seen = $List__->{_value}{_array}[ $_param_index++ ];  } } ::DISPATCH( ::DISPATCH( $self, "term" )
, 'capture_count', $count, ::DISPATCH( $::Int, 'new', 1 )
, $seen )
; $count }, signature => ::DISPATCH( $::Signature, "new", { invocant => $::Undef, array    => ::DISPATCH( $::Array, "new", { _array => [ ::DISPATCH( $::Signature::Item, 'new', { sigil  => '$', twigil => '', name   => 'count', value  => $::Undef, has_default    => ::DISPATCH( $::Bit, 'new', 0 )
, is_named_only  => ::DISPATCH( $::Bit, 'new', 0 )
, is_optional    => ::DISPATCH( $::Bit, 'new', 0 )
, is_slurpy      => ::DISPATCH( $::Bit, 'new', 0 )
, is_multidimensional  => ::DISPATCH( $::Bit, 'new', 0 )
...
, 'add_method', ::DISPATCH( $::Str, 'new', 'capture_count' )
, ::DISPATCH( $::Code, 'new', { code => sub { my $max; $max = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$max' } )  unless defined $max; BEGIN { $max = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$max' } ) }
;
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $seen = $List__->{_value}{_array}[ $_param_index++ ];  } } do {::MODIFIED($max);
$max = $count}; ::DISPATCH( ::DISPATCH( $self, "or" )
, 'for', ::DISPATCH( $::Code, 'new', { code => sub { my $last; $last = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$last' } )  unless defined $last; BEGIN { $last = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$last' } ) }
;
my  $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } ) ; 
;
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $regex = $List__->{_value}{_array}[ $_param_index++ ];  } } do {::MODIFIED($last);
...
,"true"),"p5landish") ) { do { do {::MODIFIED($max);
$max = $last} } }  else { ::DISPATCH($::Bit, "new", 0) } }
...
; $max }, signature => ::DISPATCH( $::Signature, "new", { invocant => $::Undef, array    => ::DISPATCH( $::Array, "new", { _array => [ ::DISPATCH( $::Signature::Item, 'new', { sigil  => '$', twigil => '', name   => 'count', value  => $::Undef, has_default    => ::DISPATCH( $::Bit, 'new', 0 )
, is_named_only  => ::DISPATCH( $::Bit, 'new', 0 )
, is_optional    => ::DISPATCH( $::Bit, 'new', 0 )
, is_slurpy      => ::DISPATCH( $::Bit, 'new', 0 )
, is_multidimensional  => ::DISPATCH( $::Bit, 'new', 0 )
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $seen = $List__->{_value}{_array}[ $_param_index++ ];  } } ::DISPATCH( ::DISPATCH( $self, "concat" )
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $regex = $List__->{_value}{_array}[ $_param_index++ ];  } } do {::MODIFIED($count);
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $seen = $List__->{_value}{_array}[ $_param_index++ ];  } } do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_infix_58__60_ne_62_, 'APPLY', ::DISPATCH( $self, "assertion_modifier" )
, ::DISPATCH( $::Str, 'new', '' )
 )
,"true"),"p5landish") ) { do { return($count)
 } }  else { ::DISPATCH($::Bit, "new", 0) } }
; do {::MODIFIED(::DISPATCH( $self, "capture_to_array" )
);
::DISPATCH( $self, "capture_to_array" )
 = ::DISPATCH( $GLOBAL::Code_infix_58__60__124__124__62_, 'APPLY', ::DISPATCH( $::Code, 'new', { code => sub { my $CAPTURE; $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } )  unless defined $CAPTURE; BEGIN { $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } ) }
::DISPATCH_VAR($CAPTURE,"STORE",::CAPTURIZE(\@_));do {::MODIFIED($List__);
$List__ = ::DISPATCH( $CAPTURE, 'array',  )
};do {::MODIFIED($Hash__);
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } $GLOBAL::quantified }, signature => ::DISPATCH( $::Signature, "new", { invocant => $::Undef, array    => ::DISPATCH( $::Array, "new", { _array => [  ] } ), return   => $::Undef, } )
,  } )
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } ::DISPATCH( $GLOBAL::seen, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'before' )
 )
...
}; do { if (::DISPATCH(::DISPATCH(::DISPATCH( $seen, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'before' )
 )
,"true"),"p5landish") ) { do { ::DISPATCH( ::DISPATCH( $seen, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'before' )
 )
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } ::DISPATCH( $GLOBAL::seen, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'after' )
 )
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => $::Undef, array    => ::DISPATCH( $::Array, "new", { _array => [  ] } ), return   => $::Undef, } )
,  } )
, ::DISPATCH( $::Code, 'new', { code => sub { my $CAPTURE; $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } )  unless defined $CAPTURE; BEGIN { $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } ) }
...
}; do { if (::DISPATCH(::DISPATCH(::DISPATCH( $seen, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'after' )
 )
,"true"),"p5landish") ) { do { ::DISPATCH( ::DISPATCH( $seen, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'after' )
 )
, 'capture_to_array', ::DISPATCH( $::Int, 'new', 1 )
 )
 } }  else { ::DISPATCH($::Bit, "new", 0) } }
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $seen = $List__->{_value}{_array}[ $_param_index++ ];  } } do {::MODIFIED($meth);
...
, ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $::Str, 'new', '\\\'$\\\'.$GLOBAL::_Class.\\\'::_regex_' )
, ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( $self, "metasyntax" )
, ::DISPATCH( $::Str, 'new', '\\\'' )
 )
 )
 )
}; do {::MODIFIED(::DISPATCH( $self, "ident" )
);
::DISPATCH( $self, "ident" )
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } ::DISPATCH( $GLOBAL::seen, 'LOOKUP', ::DISPATCH( $self, "ident" )
 )
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => $::Undef, array    => ::DISPATCH( $::Array, "new", { _array => [  ] } ), return   => $::Undef, } )
,  } )
, ::DISPATCH( $::Code, 'new', { code => sub { my $CAPTURE; $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } )  unless defined $CAPTURE; BEGIN { $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } ) }
...
}; do { if (::DISPATCH(::DISPATCH(::DISPATCH( $seen, 'LOOKUP', ::DISPATCH( $self, "ident" )
 )
,"true"),"p5landish") ) { do { ::DISPATCH( ::DISPATCH( $seen, 'LOOKUP', ::DISPATCH( $self, "ident" )
 )
, 'capture_to_array', ::DISPATCH( $::Int, 'new', 1 )
 )
 } }  else { ::DISPATCH($::Bit, "new", 0) } }
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $seen = $List__->{_value}{_array}[ $_param_index++ ];  } } do {::MODIFIED(::DISPATCH( $self, "capture_to_array" )
);
::DISPATCH( $self, "capture_to_array" )
 = ::DISPATCH( $GLOBAL::Code_infix_58__60__124__124__62_, 'APPLY', ::DISPATCH( $::Code, 'new', { code => sub { my $CAPTURE; $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } )  unless defined $CAPTURE; BEGIN { $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } ) }
::DISPATCH_VAR($CAPTURE,"STORE",::CAPTURIZE(\@_));do {::MODIFIED($List__);
...
} }  elsif ( exists $List__->{_value}{_array}[ $_param_index ] )  { $seen = $List__->{_value}{_array}[ $_param_index++ ];  } } do {::MODIFIED(::DISPATCH( $self, "position" )
);
::DISPATCH( $self, "position" )
 = $count}; do {::MODIFIED(::DISPATCH( $self, "capture_to_array" )
);
::DISPATCH( $self, "capture_to_array" )
 = ::DISPATCH( $GLOBAL::Code_infix_58__60__124__124__62_, 'APPLY', ::DISPATCH( $::Code, 'new', { code => sub { my $CAPTURE; $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } )  unless defined $CAPTURE; BEGIN { $CAPTURE = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$CAPTURE' } ) }
::DISPATCH_VAR($CAPTURE,"STORE",::CAPTURIZE(\@_));do {::MODIFIED($List__);
...
; ::DISPATCH( $GLOBAL::Code_infix_58__60__43__62_, 'APPLY', $count, ::DISPATCH( $::Int, 'new', 1 )
 ...
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => $::Undef, array    => ::DISPATCH( $::Array, "new", { _array => [ ::DISPATCH( $::Signature::Item, 'new', { sigil  => '$', twigil => '', name   => 'count', value  => $::Undef, has_default    => ::DISPATCH( $::Bit, 'new', 0 )
, is_named_only  => ::DISPATCH( $::Bit, 'new', 0 )
, is_optional    => ::DISPATCH( $::Bit, 'new', 0 )
, is_slurpy      => ::DISPATCH( $::Bit, 'new', 0 )
, is_multidimensional  => ::DISPATCH( $::Bit, 'new', 0 )
