...
,"true"),"p5landish") ) { do {} }  else { do {do {::MODIFIED($::KindaPerl6::Visitor::Global);
...
, 'APPLY',  )
, 'declaration', $node )
,"true"),"p5landish") ) { do {} }  else { do {do { if (::DISPATCH(::DISPATCH(do { my $_tmp1 = ::DISPATCH(  ( $GLOBAL::Code_infix_58__60_eq_62_ = $GLOBAL::Code_infix_58__60_eq_62_ || ::DISPATCH( $::Routine, "new", )  ) 
