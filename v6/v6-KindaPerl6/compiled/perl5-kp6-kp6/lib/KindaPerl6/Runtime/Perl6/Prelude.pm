    ...
    do {
        ...
        do {
            ...
            $Code_say = ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        { my $_param_index = 0; }
                        ::DISPATCH( $GLOBAL::Code_print, 'APPLY', $List__, ::DISPATCH( $::Str, 'new', chr(10) ) );
                    },
                    signature => ::DISPATCH(
                        $::Signature,
                        "new",
        ...
        do {
            ...
            $Code_infix_58__60__124__62_ = ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $b;
                        $b = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$b' } )
                            unless defined $b;
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'a'} ) {
                                ...
                                $a = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                            if ( exists $Hash__->{_value}{_hash}{'b'} ) {
                                ...
                                $b = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
        ...
        do {
            ...
            $Code_infix_58__60__46__46__62_ = ::DISPATCH(
                ...
                {   code => sub {
                        my $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $from;
                        $from = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$from' } )
                            unless defined $from;
                        ...
                        my $to;
                        $to = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$to' } )
                            unless defined $to;
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'from'} ) {
                                ...
                                $from = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                            if ( exists $Hash__->{_value}{_hash}{'to'} ) {
                                ...
                                $to = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        ::DISPATCH(
                            $::Range, 'new',
        ...
        do {
            ...
            $Code_infix_58__60__38__38__62_ = ::DISPATCH(
                ...
                {   code => sub {
                        my $left;
                        $left = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$left' } )
                            unless defined $left;
                        ...
                        my $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $left_thunk;
                        $left_thunk = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$left_thunk' } )
                        ...
                        my $right_thunk;
                        $right_thunk = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$right_thunk' } )
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'left_thunk'} ) {
                                ...
                                $left_thunk = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                            if ( exists $Hash__->{_value}{_hash}{'right_thunk'} ) {
                                ...
                                $right_thunk = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
        ...
        do {
            ...
            $Code_p5token = ::DISPATCH(
                ...
                {   code => sub {
                        my $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $regex;
                        $regex = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$regex' } )
                            ...
                            {   code => sub {
                                    ...
                                    };
                                    {
                                        ...
                                        if ( exists $Hash__->{_value}{_hash}{'self'} ) {
                                            ...
                                            $self = $List__->{_value}{_array}[ $_param_index++ ];
                                        }
                                        if ( exists $Hash__->{_value}{_hash}{'str'} ) {
                                            ...
                                            $str = $List__->{_value}{_array}[ $_param_index++ ];
                                        }
                                        if ( exists $Hash__->{_value}{_hash}{'pos'} ) {
                                            ...
                                            $pos = $List__->{_value}{_array}[ $_param_index++ ];
                                        }
                                    }
                                    do {
