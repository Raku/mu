...
};{ my $_param_index = 0; } do { if (::DISPATCH(::DISPATCH(::DISPATCH( $self, "result" )
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } return(::DISPATCH( ::DISPATCH( $self, "bool" )
, 'true',  )
)
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => bless( {
                 'namespace' => [],
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } ::DISPATCH_VAR( ::DISPATCH( $self, "from" )
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } ::DISPATCH_VAR( ::DISPATCH( $self, "to" )
, 'STORE', ::DISPATCH( $_, 'INDEX', ::DISPATCH( $::Int, 'new', 0 )
 )
 )
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => bless( {
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } ::DISPATCH_VAR( ::DISPATCH( $self, "bool" )
, 'STORE', ::DISPATCH( $_, 'INDEX', ::DISPATCH( $::Int, 'new', 0 )
 )
 )
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => bless( {
...
$Hash__ = ::DISPATCH( $CAPTURE, 'hash',  )
};{ my $_param_index = 0; } ::DISPATCH_VAR( ::DISPATCH( $self, "match_str" )
, 'STORE', ::DISPATCH( $_, 'INDEX', ::DISPATCH( $::Int, 'new', 0 )
 )
 )
 }, signature => ::DISPATCH( $::Signature, "new", { invocant => bless( {
