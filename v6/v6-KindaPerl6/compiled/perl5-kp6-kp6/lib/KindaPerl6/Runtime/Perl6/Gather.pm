    ...
    do {
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        my $obj;
                        $obj = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$obj' } )
                            unless defined $obj;
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'i'} ) {
                                ...
                                $i = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        ...
                        do {
                            while ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_prefix_58__60__33__62_, 'APPLY', ::DISPATCH( $obj, 'finished', ) ), "true" ), "p5landish" ) ) {
                                do {
                                    do {
                                        if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60__60__62_, 'APPLY', $i, ::DISPATCH( ::DISPATCH( $obj, 'buf', ), 'elems', ) ), "true" ), "p5landish" ) ) {
                                            do {
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $Code_code;
                        $Code_code = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_code' } )
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'code'} ) {
                                ...
                                $Code_code = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        ::DISPATCH_VAR( $obj, 'STORE', $self );
                        ::DISPATCH(
                            ...
                            ::DISPATCH(
                                ...
                                {   code => sub {
                                        ...
                                        do {
                                            while ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_prefix_58__60__33__62_, 'APPLY', ::DISPATCH( $obj, 'finished', ) ), "true" ), "p5landish" ) ) {
                                                do {
                                                    ::DISPATCH( $GLOBAL::Code_take, 'APPLY', ::DISPATCH( $Code_code, 'APPLY', ::DISPATCH( $obj, 'INDEX', $i ) ) );
