            ...
            $Code_env_init = ::DISPATCH(
                $::Code, 'new',
                {
                    code => sub {
                        ...
                        ::DISPATCH(
                            (
                                $COMPILER::List_PAD = $COMPILER::List_PAD
                                  || ::DISPATCH( $::ArrayContainer, "new", )
                            ),
                            'unshift',
                            $pad
                        ...
                        ::DISPATCH_VAR(
                            ::DISPATCH(
                                ...
                                do {
                                    ...
                                    ( $List_COMPILER::PAD = $List_COMPILER::PAD
                                          || ::DISPATCH( $::Scalar, "new", ) ) =
                                      ::DISPATCH( $::Scalar, 'new', );
                                  }
                            ),
            ...
            $Code_begin_block = ::DISPATCH(
                $::Code, 'new',
                {
                    code => sub {
                        ...
                        ::DISPATCH(
                            (
                                $Pad::Code_begin_block = $Pad::Code_begin_block
                                  || ::DISPATCH( $::Routine, "new", )
                            ),
                            'APPLY', $ast
                        );
            ...
            $Code_check_block = ::DISPATCH(
                $::Code, 'new',
                {
                    code => sub {
                        ...
                        ::DISPATCH(
                            (
                                $GLOBAL::Code_push = $GLOBAL::Code_push
                                  || ::DISPATCH( $::Routine, "new", )
                            ),
                            'APPLY',
                            (
