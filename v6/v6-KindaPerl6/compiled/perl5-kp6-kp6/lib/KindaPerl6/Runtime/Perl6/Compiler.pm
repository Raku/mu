    ...
    do {
        ...
        do {
            ...
            $Code_emit_perl6 = ::DISPATCH(
                ...
                {   code => sub {
                        my $perl6;
                        $perl6 = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$perl6' } )
        ...
        do {
            ...
            $Code_add_pad = ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $namespace;
                        $namespace = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$namespace' } )
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'namespace'} ) {
                                ...
                                $namespace = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        ::DISPATCH_VAR( $pad, 'STORE', ::DISPATCH( $::Pad, 'new', ) );
                ...
                {   code => sub {
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'pad'} ) {
                                ...
                                $pad = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        ::DISPATCH( $COMPILER::List_PAD, 'unshift', $pad );
                    },
        ...
        do {
            ...
            $Code_begin_block = ::DISPATCH(
                ...
                {   code => sub {
                        my $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $ast;
                        $ast = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$ast' } )
                            unless defined $ast;
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'ast'} ) {
                                ...
                                $ast = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
        ...
        do {
            ...
            $Code_get_var = ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $sigil;
                        $sigil = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$sigil' } )
                        ...
                        my $twigil;
                        $twigil = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$twigil' } )
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'sigil'} ) {
                                ...
                                $sigil = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                            if ( exists $Hash__->{_value}{_hash}{'twigil'} ) {
                                ...
                                $twigil = $List__->{_value}{_array}[ $_param_index++ ];
                            }
