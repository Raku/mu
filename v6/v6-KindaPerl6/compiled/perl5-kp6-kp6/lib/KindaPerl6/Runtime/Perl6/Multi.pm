                ...
                {   code => sub {
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'code'} ) {
                                ...
                                $code = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        do {
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        {
                            my $_param_index = 0;
                            if ( exists $Hash__->{_value}{_hash}{'capture'} ) {
                                do {
                                    ::MODIFIED($capture);
                                ...
                                $capture = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        do {
                            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_prefix_58__60__33__62_, 'APPLY', ::DISPATCH( $GLOBAL::Code_defined, 'APPLY', ::DISPATCH( $self, 'long_names', ) ) ), "true" ), "p5landish" ) ) {
                        ...
                        ::DISPATCH(
                            ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', ::DISPATCH( $self, 'long_names', ) ),
                            'for',
                            ::DISPATCH(
                                $::Code, 'new',
                                {   code => sub {
                                        ...
                                        {
                                            my $_param_index = 0;
                                            if ( exists $Hash__->{_value}{_hash}{'sub'} ) {
                                                do {
                                                    ::MODIFIED($sub);
                                                ...
                                                $sub = $List__->{_value}{_array}[ $_param_index++ ];
                                            }
                                        }
                                        do {
                                            if (::DISPATCH(
                                                    ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60__61__61__62_, 'APPLY', ::DISPATCH( ::DISPATCH( $sub, 'signature', ), 'arity', ), ::DISPATCH( $capture, 'arity', ) ), "true" ), "p5landish"
                                                )
                                                )
                                            {
                                                do {
...
}
{
    ...
    do {
        do {
            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::MultiToken ), "true" ), "p5landish" ) ) {
            }
            else {
                do {
                    do {
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $sym;
                        $sym = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$sym' } )
                            unless defined $sym;
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'sym'} ) {
                                do {
                                    ::MODIFIED($sym);
                                ...
                                $sym = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                                        ...
                                        ::DISPATCH(
                                            ...
                                            ::DISPATCH(
                                                ...
                                                {   code => sub {
                                                        ...
                                                        ::DISPATCH( $GLOBAL::Code_defined, 'APPLY', ::DISPATCH( $self, 'token_length', ) );
                                                    },
                                                    signature => ::DISPATCH(
                                                        $::Signature,
                                                        "new",
                                    ...
                                    ::DISPATCH(
                                        ...
                                        ::DISPATCH(
                                            ...
                                            {   code => sub {
                                                    ...
                                                    {
                                                        my $_param_index = 0;
                                                        if ( exists $Hash__->{_value}{_hash}{'len'} ) {
                                                            do {
                                                                ::MODIFIED($len);
                                                            ...
                                                            $len = $List__->{_value}{_array}[ $_param_index++ ];
                                                        }
                                                    }
                                                    do {
