...
, 'APPLY', $::Capture )
,"true"),"p5landish") ) { do {} }  else { do {do {::MODIFIED($::Capture);
...
, 'APPLY', ::DISPATCH( ::DISPATCH( $self, "array" )
, 'elems',  )
...
# emit_body
$v; ::DISPATCH_VAR( $s, 'STORE', ::DISPATCH(  ( $GLOBAL::Code_infix_58__60__126__62_ = $GLOBAL::Code_infix_58__60__126__62_ || ::DISPATCH( $::Routine, "new", )  ) 
