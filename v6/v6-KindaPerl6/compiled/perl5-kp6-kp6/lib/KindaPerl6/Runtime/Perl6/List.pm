        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $List__      = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $Code_test;
                        $Code_test = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_test' } )
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'test'} ) {
                                ...
                                $Code_test = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        $List_result;
                        ::DISPATCH(
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $List__      = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $Code_proc;
                        $Code_proc = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_proc' } )
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'proc'} ) {
                                ...
                                $Code_proc = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        $List_result;
                        ::DISPATCH(
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $List__ = ::DISPATCH( $::Array, 'new', { modified => $_MODIFIED, name => '$List__' } );
                        my $sep;
                        $sep = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$sep' } )
                            unless defined $sep;
                        ...
                        };
                        {
                            ...
                            if ( exists $Hash__->{_value}{_hash}{'sep'} ) {
                                ...
                                $sep = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
