              ...
              )
            {
                ...
                do {
                    do {
                        ...
                        $::Lit::SigArgument = ::DISPATCH(
                            ::DISPATCH(
                                $::Class,
                                'new',
                                ::DISPATCH( $::Str, 'new', 'Lit::SigArgument' )
                            ),
                            'PROTOTYPE',
                        );
                      }
    ...
    do {
        do {
              ...
              )
            {
                ...
                do {
                    do {
                        ::MODIFIED($::Lit::Capture);
                        $::Lit::Capture = ::DISPATCH(
                            ::DISPATCH(
                                $::Class, 'new',
                                ::DISPATCH( $::Str, 'new', 'Lit::Capture' )
                            ),
                            'PROTOTYPE',
                        );
                      }
