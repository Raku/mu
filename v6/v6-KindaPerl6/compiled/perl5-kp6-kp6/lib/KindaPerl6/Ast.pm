        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $visitor;
                        $visitor = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$visitor' } )
                        ...
                        my $path;
                        $path = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$path' } )
                            unless defined $path;
                        ...
                        {
                            my $_param_index = 0;
                            if ( exists $Hash__->{_value}{_hash}{'visitor'} ) {
                                do {
                                    ::MODIFIED($visitor);
                                ...
                                $visitor = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                            if ( exists $Hash__->{_value}{_hash}{'path'} ) {
                                do {
                                    ::MODIFIED($path);
                                ...
                                $path = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
...
}
{
    ...
    do {
        ...
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'key' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'value' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'type' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'has_default' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'is_named_only' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'is_optional' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'is_slurpy' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'is_multidimensional' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'is_rw' ) );
        ::DISPATCH( ::DISPATCH( $::Lit::SigArgument, 'HOW', ), 'add_attribute', ::DISPATCH( $::Str, 'new', 'is_copy' ) );
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        ::DISPATCH( $KindaPerl6::Traverse::Code_visit, 'APPLY', $visitor, $self, ::DISPATCH( $::Str, 'new', 'Lit::SigArgument' ), $path );
                    },
                    signature => ::DISPATCH(
                        $::Signature,
                        "new",
                ...
                {   code => sub {
                        ...
                        ::DISPATCH(
                            ...
                            {   _hash => {
                                    ...
                                    ::DISPATCH( $::Str, 'new', 'has_default' )->{_value}         => ::DISPATCH( $self, "has_default" ),
                                    ::DISPATCH( $::Str, 'new', 'is_named_only' )->{_value}       => ::DISPATCH( $self, "is_named_only" ),
                                    ::DISPATCH( $::Str, 'new', 'is_optional' )->{_value}         => ::DISPATCH( $self, "is_optional" ),
                                    ::DISPATCH( $::Str, 'new', 'is_slurpy' )->{_value}           => ::DISPATCH( $self, "is_slurpy" ),
                                    ::DISPATCH( $::Str, 'new', 'is_multidimensional' )->{_value} => ::DISPATCH( $self, "is_multidimensional" ),
                                    ::DISPATCH( $::Str, 'new', 'is_rw' )->{_value}               => ::DISPATCH( $self, "is_rw" ),
                                    ::DISPATCH( $::Str, 'new', 'is_copy' )->{_value}             => ::DISPATCH( $self, "is_copy" ),
                                }
                            }
                        );
                    },
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        ::DISPATCH(
                            $::Pair, 'new',
                            {   key   => ::DISPATCH( $::Str, 'new', 'metasyntax' ),
