    ...
    do {
        ...
        do {
            ...
            $Code_declare_parameters = ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        my $var;
                        $var = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$var' } )
                            unless defined $var;
                        ...
                        my $env;
                        $env = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$env' } )
                            unless defined $env;
                        ...
                        my $vars;
                        $vars = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$vars' } )
                            unless defined $vars;
                        ...
                        {
                            my $_param_index = 0;
                            if ( exists $Hash__->{_value}{_hash}{'env'} ) {
                                do {
                                    ::MODIFIED($env);
                                ...
                                $env = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                            if ( exists $Hash__->{_value}{_hash}{'vars'} ) {
                                do {
                                    ::MODIFIED($vars);
                                ...
                                $vars = $List__->{_value}{_array}[ $_param_index++ ];
                            }
                        }
                        $decl;
                        $var;
                        ::DISPATCH(
                            ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', $vars ),
                            'for',
                            ::DISPATCH(
                                $::Code, 'new',
                                {   code => sub {
        ...
        do {
            ...
            $_rule_exp_parameter_named
                = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?:(?:(??{ eval '$_rule_ident' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture_to_array", "ident" ]; }))(?:(??{ eval '$_rule_opt_ws' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "discard_capture" ]; }))=>(?:(??{ eval '$_rule_opt_ws' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "discard_capture" ]; }))(?:(??{ eval '$_rule_exp' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture_to_array", "exp" ]; }))(?{ local $GLOBAL::_M = $GLOBAL::_M; Match::from_global_data( $GLOBAL::_M ); $MATCH = $GLOBAL::MATCH = pop @Match::Matches; @Match::Matches = (); my $ret = ( sub {do { return(::DISPATCH( $::Array, 'new', { _array => [::DISPATCH( $::Val::Buf, 'new', ::DISPATCH( $::NamedArgument, "new", { _argument_name_ => ::DISPATCH( $::Str, 'new', 'buf' )
...
,  } ),  )
        ...
        do {
            ...
            $_rule_exp_parameter_item
                = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?:(?:(??{ eval '$_rule_exp_parameter_named' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "exp_parameter_named" ]; }))(?{ local $GLOBAL::_M = $GLOBAL::_M; Match::from_global_data( $GLOBAL::_M ); $MATCH = $GLOBAL::MATCH = pop @Match::Matches; @Match::Matches = (); my $ret = ( sub {do { return(::DISPATCH( $::Lit::NamedArgument, 'new', ::DISPATCH( $::NamedArgument, "new", { _argument_name_ => ::DISPATCH( $::Str, 'new', 'key' )
