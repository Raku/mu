{
    ...
    do {
        ...
        do {
            use vars qw($_rule_double_quoted);
            $_rule_double_quoted
        ...
        do {
            use vars qw($_rule_quoted_any);
            $_rule_quoted_any = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?:(?:\n\r?|\r\n?|\X)))(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'to', pos() ]; $GLOBAL::_M2 = $GLOBAL::_M; })/x;
            ::DISPATCH(
                ::DISPATCH( $::KindaPerl6::Grammar, "HOW" ),
                "add_method",
        ...
        do {
            use vars qw($_rule_quoted_array);
            $_rule_quoted_array
...
,  } ),  )
        ...
        do {
            use vars qw($_rule_quoted_scalar);
            $_rule_quoted_scalar
                = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?:(?=(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; })(?:(?:\$))(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'to', pos() ]; local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "before" ]; }))(?:(??{ eval '$_rule_var' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "var" ]; }))(?{ local $GLOBAL::_M = $GLOBAL::_M; Match::from_global_data( $GLOBAL::_M ); $MATCH = $GLOBAL::MATCH = pop @Match::Matches; @Match::Matches = (); my $ret = ( sub {do { return(::DISPATCH( $::Apply, 'new', ::DISPATCH( $::NamedArgument, "new", { _argument_name_ => ::DISPATCH( $::Str, 'new', 'code' )
, value           => ::DISPATCH( $::Var, 'new', ::DISPATCH( $::NamedArgument, "new", { _argument_name_ => ::DISPATCH( $::Str, 'new', 'sigil' )
, value           => ::DISPATCH( $::Str, 'new', '&' )
,  } ), ::DISPATCH( $::NamedArgument, "new", { _argument_name_ => ::DISPATCH( $::Str, 'new', 'twigil' )
, value           => ::DISPATCH( $::Str, 'new', '' )
...
,  } ),  )
        ...
        do {
            use vars qw($_rule_quoted_exp);
            $_rule_quoted_exp
                = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?:(?:(??{ eval '$_rule_quoted_array' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "quoted_array" ]; }))(?{ local $GLOBAL::_M = $GLOBAL::_M; Match::from_global_data( $GLOBAL::_M ); $MATCH = $GLOBAL::MATCH = pop @Match::Matches; @Match::Matches = (); my $ret = ( sub {do { return(::DISPATCH( $GLOBAL::Code_prefix_58__60__36__62_, 'APPLY', ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'quoted_array' )
 )
 )
)
...
,  } ),  )
        ...
        do {
            use vars qw($_rule_quoted_exp_seq);
            $_rule_quoted_exp_seq
                = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?:(?:(??{ eval '$_rule_quoted_exp' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "quoted_exp" ]; }))(?:(?:(?=(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; })(?:(?:\"))(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'to', pos() ]; local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "before" ]; }))(?{ local $GLOBAL::_M = $GLOBAL::_M; Match::from_global_data( $GLOBAL::_M ); $MATCH = $GLOBAL::MATCH = pop @Match::Matches; @Match::Matches = (); my $ret = ( sub {do { return(::DISPATCH( $GLOBAL::Code_prefix_58__60__36__62_, 'APPLY', ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'quoted_exp' )
 )
 )
)
...
,  } ),  )
        ...
        do {
            use vars qw($_rule_single_quoted);
            $_rule_single_quoted
        ...
        do {
            use vars qw($_rule_angle_quoted);
            $_rule_angle_quoted
        ...
        do {
            use vars qw($_rule_french_quoted);
            $_rule_french_quoted
        ...
        do {
            use vars qw($_rule_val_buf);
            $_rule_val_buf
                = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?:\"(?:(??{ eval '$_rule_quoted_exp_seq' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "quoted_exp_seq" ]; }))\"(?{ local $GLOBAL::_M = $GLOBAL::_M; Match::from_global_data( $GLOBAL::_M ); $MATCH = $GLOBAL::MATCH = pop @Match::Matches; @Match::Matches = (); my $ret = ( sub {do { return(::DISPATCH( $GLOBAL::Code_prefix_58__60__36__62_, 'APPLY', ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'quoted_exp_seq' )
 )
 )
)
