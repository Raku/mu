{
    ...
    do {
        ...
        do {
            use vars qw($_rule_token_p5_modifier);
            $_rule_token_p5_modifier = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?::P5)|(?::Perl5))(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'to', pos() ]; $GLOBAL::_M2 = $GLOBAL::_M; })/x;
            ::DISPATCH(
        ...
        do {
            use vars qw($_rule_token_p5_body);
            $_rule_token_p5_body
        ...
        do {
            use vars qw($_rule_token_P5);
            $_rule_token_P5
                = qr/(?{ local $GLOBAL::_M = [ $GLOBAL::_M, 'create', pos(), \$_ ]; $GLOBAL::_M2 = $GLOBAL::_M; })(?:(?:token(?:(??{ eval '$_rule_ws' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "discard_capture" ]; }))(?:(??{ eval '$_rule_opt_name' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "opt_name" ]; }))(?:(??{ eval '$_rule_opt_ws' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "discard_capture" ]; }))(?:(??{ eval '$_rule_token_p5_modifier' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "token_p5_modifier" ]; }))(?:(??{ eval '$_rule_opt_ws' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "discard_capture" ]; }))\{(?:(??{ eval '$_rule_token_p5_body' })(?{ local $GLOBAL::_M = [ $GLOBAL::_M, "named_capture", "token_p5_body" ]; }))\}(?{ local $GLOBAL::_M = $GLOBAL::_M; Match::from_global_data( $GLOBAL::_M ); $MATCH = $GLOBAL::MATCH = pop @Match::Matches; @Match::Matches = (); my $ret = ( sub {do { return(::DISPATCH( $::Token, 'new', ::DISPATCH( $::NamedArgument, "new", { _argument_name_ => ::DISPATCH( $::Str, 'new', 'name' )
