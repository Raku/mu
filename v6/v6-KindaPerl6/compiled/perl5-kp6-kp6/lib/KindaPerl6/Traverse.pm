...
; do { if (::DISPATCH(::DISPATCH(do { my $_tmp1 = ::DISPATCH( $subnode, 'isa', ::DISPATCH( $::Str, 'new', 'Array' )
 )
; ::DISPATCH( $_tmp1, "true" )->{_value} ? $_tmp1: do { my $_tmp1 = ::DISPATCH( $subnode, 'isa', ::DISPATCH( $::Str, 'new', 'List' )
 )
; ::DISPATCH( $_tmp1, "true" )->{_value} ? $_tmp1: do { my $_tmp1 = ::DISPATCH( $subnode, 'isa', ::DISPATCH( $::Str, 'new', 'Hash' )
 )
; ::DISPATCH( $_tmp1, "true" )->{_value} ? $_tmp1: do { my $_tmp1 = ::DISPATCH( $subnode, 'isa', ::DISPATCH( $::Str, 'new', 'Str' )
 )
; ::DISPATCH( $_tmp1, "true" )->{_value} ? $_tmp1: ::DISPATCH( $subnode, 'isa', ::DISPATCH( $::Str, 'new', 'Pad' )
 )
 }
 }
 }
