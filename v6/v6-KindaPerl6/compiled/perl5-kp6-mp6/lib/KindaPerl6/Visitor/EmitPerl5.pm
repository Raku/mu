...
sub emit_perl5 {
    ...
    do {
        if ( ( $decl eq 'our' ) ) {
                                    ...
                                    ' = ::DISPATCH( $::Scalar'
                                        ...
                                        $create
                                            ...
                                            ' unless defined '
                                                ...
                                                $self->{var}->emit_perl5()
                                                    . (
                                                    '; ' . ( 'BEGIN { ' . ( $self->{var}->emit_perl5() . ( ' = ::DISPATCH( $::Scalar' . ( $create . ( ' unless defined ' . ( $self->{var}->emit_perl5() . ( '; ' . ( '}' . Main::newline() ) ) ) ) ) ) ) )
                                                    )
                                                )
                                            )
                                        )
            ...
            do {
                if ( ( $self->{var}->sigil() eq '@' ) ) { return ( ( $s . ( $self->{var}->emit_perl5() . ( ' = ::DISPATCH( $::Array' . ( $create . ( ';' . Main::newline() ) ) ) ) ) ) }
                else                                    { }
            };
                            ...
                            $self->{var}->emit_perl5()
                                ...
                                '; '
                                    ...
                                    $self->{var}->emit_perl5()
                                        ...
                                        ' = ::DISPATCH( $::Scalar'
                                            . (
                                            $create . ( ' unless defined ' . ( $self->{var}->emit_perl5() . ( '; ' . ( 'BEGIN { ' . ( $self->{var}->emit_perl5() . ( ' = ::DISPATCH( $::Scalar' . ( $create . ( '}' . Main::newline() ) ) ) ) ) ) ) ) )
                                        )
                                    )
                                )
                            )
                            ...
                            $self->{var}->emit_perl5()
                                ...
                                '; '
                                    ...
                                    $self->{var}->emit_perl5()
                                        ...
                                        ' = ::DISPATCH( $::Routine'
                                            . (
                                            $create . ( ' unless defined ' . ( $self->{var}->emit_perl5() . ( '; ' . ( 'BEGIN { ' . ( $self->{var}->emit_perl5() . ( ' = ::DISPATCH( $::Routine' . ( $create . ( '}' . Main::newline() ) ) ) ) ) ) ) )
                                            )
                                        )
                                    )
                                )
    ...
    do {
        if ( ( $self->{var}->sigil() eq '@' ) ) { return ( ( $self->{decl} . ( ' ' . ( ' ' . ( $self->{var}->emit_perl5() . ( ' = ::DISPATCH( $::Array' . ( $create . ( '; ' . Main::newline() ) ) ) ) ) ) ) ) }
        else                                    { }
    };
