...
sub emit {
    ...
    KindaPerl6::Traverse::visit( $visitor, $self, 'CompUnit', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Val::Int', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Val::Bit', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Val::Num', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Val::Buf', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Val::Char', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Val::Undef', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Val::Object', $path );
}
...
sub attribs {
    ...
    my $List__ = \@_;
    do { [] };
    { 'class' => $self->{class}, 'fields' => $self->{fields}, };
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Lit::Seq', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Lit::Array', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Lit::Hash', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Lit::Pair', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Lit::Code', $path );
}
...
sub attribs {
    ...
    my $List__ = \@_;
    do { [] };
    { 'pad' => $self->{pad}, 'state' => $self->{state}, 'sig' => $self->{sig}, 'body' => $self->{body}, };
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Lit::Object', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Var', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Bind', $path );
}
...
sub attribs {
    ...
    my $List__ = \@_;
    do { [] };
    { 'parameters' => $self->{parameters}, 'arguments' => $self->{arguments}, };
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Assign', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Proto', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Call', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Apply', $path );
}
...
sub attribs {
    ...
    my $List__ = \@_;
    do { [] };
    { 'code' => $self->{code}, 'arguments' => $self->{arguments}, };
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Return', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'If', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'While', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Decl', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Sig', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Method', $path );
}
...
sub attribs {
    ...
    my $List__ = \@_;
    do { [] };
    { 'name' => $self->{name}, 'block' => $self->{block}, };
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Macro', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Coro', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'P5Token', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Token', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Do', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'BEGIN', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Use', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Quantifier', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Or', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Concat', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Subrule', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Var', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Constant', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Dot', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::SpecialChar', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Block', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::NamedCapture', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Before', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::After', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::CharClass', $path );
}
...
sub emit {
    ...
    my $path;
    do { $visitor = $List__->[0]; $path = $List__->[1]; [ $visitor, $path ] };
    KindaPerl6::Traverse::visit( $visitor, $self, 'Rule::Capture', $path );
}
