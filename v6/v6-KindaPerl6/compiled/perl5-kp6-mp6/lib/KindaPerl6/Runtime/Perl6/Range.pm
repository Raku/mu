{
    ...
    do {
        do {
            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::Range ), "true" ), "p5landish" ) ) { }
            else {
                do {
                    do {
                        ::MODIFIED($::Range);
                        ...
                        ::DISPATCH(
                            ...
                            ::DISPATCH(
                                ...
                                ::DISPATCH(
                                    ...
                                    ::DISPATCH( $::Str, 'new', '..' ), ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( ::DISPATCH( $self, "end" ), 'perl', ), ::DISPATCH( $::Str, 'new', ' )' ) )
                                )
                            )
                        );
                    },
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        do {
                            while ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60__60__61__62_, 'APPLY', $v, ::DISPATCH( $self, "end" ) ), "true" ), "p5landish" ) ) {
                                do {
                                    my $List_param = ::DISPATCH( $::ArrayContainer, 'new', { modified => $_MODIFIED, name => '$List_param' } );
                                    $List_param;
                                    do {
                                        while ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60__60__62_, 'APPLY', ::DISPATCH( $List_param, 'elems', ), $arity ), "true" ), "p5landish" ) ) {
                                            do {
                                                ::DISPATCH( $List_param, 'push',
                                                    ::DISPATCH( $GLOBAL::Code_ternary_58__60__63__63__32__33__33__62_, 'APPLY', ::DISPATCH( $GLOBAL::Code_infix_58__60__60__61__62_, 'APPLY', $v, ::DISPATCH( $self, "end" ) ), $v, $::Undef ) );
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        # emit_body
                        ::DISPATCH_VAR( $v, 'STORE', ::DISPATCH( $GLOBAL::Code_infix_58__60__43__62_, 'APPLY', $i, ::DISPATCH( $GLOBAL::Code_infix_58__60__45__62_, 'APPLY', ::DISPATCH( $self, "start" ), ::DISPATCH( $::Int, 'new', 1 ) ) ) );
                        ::DISPATCH( $GLOBAL::Code_ternary_58__60__63__63__32__33__33__62_, 'APPLY', ::DISPATCH( $GLOBAL::Code_infix_58__60__126__126__62_, 'APPLY', $v, $self ), $v, $::Undef );
                    },
                    signature => ::DISPATCH(
                        $::Signature,
                        "new",
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                {   code => sub {
                        ...
                        # emit_body
                        do {
                            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60__60__62_, 'APPLY', $v, ::DISPATCH( $self, "start" ) ), "true" ), "p5landish" ) ) {
                                do {
                        ...
                        do {
                            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60__62__62_, 'APPLY', $v, ::DISPATCH( $self, "end" ) ), "true" ), "p5landish" ) ) {
                                do {
                                    return ( ::DISPATCH( $::Bit, 'new', 0 ) );
                                    }
                            }
