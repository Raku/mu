                            ...
                            ::DISPATCH(
                                ...
                                {   code => sub {
                                        ...
                                        };
                                        {
                                            ...
                                            elsif ( exists $List__->{_value}{_array}[$_param_index] ) { $sub = $List__->{_value}{_array}[ $_param_index++ ]; }
                                        }
                                        do {
                                            if (::DISPATCH(
                                        ...
                                        ::DISPATCH(
                                            ...
                                            {   code => sub {
                                                    ...
                                                    };
                                                    {
                                                        ...
                                                        elsif ( exists $List__->{_value}{_array}[$_param_index] ) { $len = $List__->{_value}{_array}[ $_param_index++ ]; }
                                                    }
                                                    do {
