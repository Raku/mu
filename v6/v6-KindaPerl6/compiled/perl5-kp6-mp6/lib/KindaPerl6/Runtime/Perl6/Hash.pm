{
    ...
    # Do not edit this file - Perl 5 generated by HASH(0x2300080)
    ...
    do {
        do {
            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( ( $GLOBAL::Code_VAR_defined = $GLOBAL::Code_VAR_defined || ::DISPATCH( $::Routine, "new", ) ), 'APPLY', $::Hash ), "true" ), "p5landish" ) ) {
                do { }
            }
            else {
                do {
