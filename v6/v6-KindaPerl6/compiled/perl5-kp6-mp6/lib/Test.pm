{
    ...
    # Do not edit this file - Perl 5 generated by HASH(0x9245274)
    ...
    do {
        ...
        do {
            if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( ( $GLOBAL::Code_VAR_defined = $GLOBAL::Code_VAR_defined || ::DISPATCH( $::Routine, "new", ) ), 'APPLY', $::Test ), "true" ), "p5landish" ) ) {
                do {
                    our $Code_ok   = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_ok' } );
                    our $Code_plan = ::DISPATCH( $::Routine, 'new', { modified => $_MODIFIED, name => '$Code_plan' } );
                    }
