                                    ...
                                    if ( ::DISPATCH( ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60_eq_62_, 'APPLY', ::DISPATCH( $node, 'unit_type', ), ::DISPATCH( $::Str, 'new', 'role' ) ), "true" ), "p5landish" ) ) {
                                        {
                                            ::DISPATCH(
                                                ...
                                                ::DISPATCH(
                                                    ...
                                                    ::DISPATCH( $::Str, 'new', 'arguments' ) => ::DISPATCH( $::Array, "new", { _array => [ ::DISPATCH( $::Val::Buf, 'new', ::DISPATCH( $::Str, 'new', 'buf' ) => ::DISPATCH( $node, 'name', ), ) ] } ),
                                                    ::DISPATCH( $::Str, 'new', 'method' )    => ::DISPATCH( $::Str,   'new', 'new' ),
                                                    ::DISPATCH( $::Str, 'new', 'invocant' ) => ::DISPATCH( $::Proto, 'new', ::DISPATCH( $::Str, 'new', 'name' ) => ::DISPATCH( $::Str, 'new', 'KindaPerl6::Role' ), ),
                                                )
                                                )
                                        }
                                    }
                                                ...
                                                for $trait ( @{ ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', ::DISPATCH( $node, 'traits', ) ) )->{_value}{_array} } ) {
                                                    {
                                                        do {
                                                            if (::DISPATCH(
                                                                    ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60_eq_62_, 'APPLY', ::DISPATCH( $trait, 'INDEX', ::DISPATCH( $::Int, 'new', 0 ) ), ::DISPATCH( $::Str, 'new', 'meta' ) ), "true" ),
                                                                    "p5landish"
                                                                )
                                                                )
                                                            {
                                            ...
                                            ::DISPATCH(
                                                ...
                                                ::DISPATCH(
                                                    ...
                                                    ::DISPATCH( $::Str, 'new', 'cond' ) => ::DISPATCH(
                                                        $::Apply, 'new',
                                                        ::DISPATCH( $::Str, 'new', 'arguments' ) => ::DISPATCH( $::Array, "new", { _array => [ ::DISPATCH( $::Proto, 'new', ::DISPATCH( $::Str, 'new', 'name' ) => ::DISPATCH( $node, 'name', ), ) ] } ),
                                                    ...
                                                    ::DISPATCH( $::Str, 'new', 'body' )      => ::DISPATCH( $::Str, 'new', '' ),
                                                    ::DISPATCH( $::Str, 'new', 'otherwise' ) => ::DISPATCH(
                                                        ...
                                                        ::DISPATCH( $::Str, 'new', 'body' ) => ::DISPATCH(
                                                            ...
                                                            {   _array => [
                                                                    ::DISPATCH(
                                                                        $::Bind, 'new',
                                                                        ::DISPATCH( $::Str, 'new', 'parameters' ) => ::DISPATCH( $::Proto, 'new', ::DISPATCH( $::Str, 'new', 'name' ) => ::DISPATCH( $node, 'name', ), ),
                                                                        ::DISPATCH( $::Str, 'new', 'arguments' )  => ::DISPATCH(
                                                                            $::Call, 'new', ::DISPATCH( $::Str, 'new', 'invocant' ) => $metaobject,
                                                                            ::DISPATCH( $::Str, 'new', 'method' ) => ::DISPATCH( $::Str, 'new', 'PROTOTYPE' ),
                                                        ...
                                                        ::DISPATCH( $::Str, 'new', 'sig' ) => ::DISPATCH(
                                                            $::Sig, 'new', ::DISPATCH( $::Str, 'new', 'named' ) => ::DISPATCH( $::Hash, "new", { _hash => {} } ),
                                    ...
                                    for $trait ( @{ ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', ::DISPATCH( $GLOBAL::Code_prefix_58__60__64__62_, 'APPLY', ::DISPATCH( $node, 'traits', ) ) )->{_value}{_array} } ) {
                                        {
                                            do {
                                                if (::DISPATCH(
                                                        ::DISPATCH( ::DISPATCH( $GLOBAL::Code_infix_58__60_eq_62_, 'APPLY', ::DISPATCH( $trait, 'INDEX', ::DISPATCH( $::Int, 'new', 0 ) ), ::DISPATCH( $::Str, 'new', 'does' ) ), "true" ), "p5landish"
                                                    )
                                                    )
                                                {
                                                    {
                                                        ...
                                                        ::DISPATCH(
                                                            ...
                                                            ::DISPATCH(
                                                                ...
                                                                ::DISPATCH( $::Str, 'new', 'arguments' ) => ::DISPATCH(
                                                                    $::Array, "new",
                                                                    {   _array => [
                                                                            ::DISPATCH( $::Val::Buf, 'new', ::DISPATCH( $::Str, 'new', 'buf' ) => ::DISPATCH( $item, 'name', ), ),
                                                                            ::DISPATCH(
                                                                                $::Call, 'new',
                                                                                ::DISPATCH( $::Str, 'new', 'hyper' )     => ::DISPATCH( $::Str, 'new', '' ),
                                                                                ::DISPATCH( $::Str, 'new', 'arguments' ) => ::DISPATCH(
                                                                                    ...
                                                                                    {   _array => [
                                                                                            ::DISPATCH(
                                                                                                $::Method, 'new', ::DISPATCH( $::Str, 'new', 'name' ) => ::DISPATCH( $::Str, 'new', '' ),
                                                                                                ::DISPATCH( $::Str, 'new', 'block' ) => ::DISPATCH( $item, 'block', ),
                                                                                            )
                                                                                        ]
                                                                                    }
                                                                                ),
                                                                                ::DISPATCH( $::Str, 'new', 'method' ) => ::DISPATCH( $::Str, 'new', 'new' ),
                                                                                ::DISPATCH( $::Str, 'new', 'invocant' ) => ::DISPATCH( $::Proto, 'new', ::DISPATCH( $::Str, 'new', 'name' ) => ::DISPATCH( $::Str, 'new', 'Method' ), ),
                                                                            )
                                                                        ]
                                                                    }
                                                                ),
                                                ...
                                                if (::DISPATCH(
                                                        ::DISPATCH(
                                                            ::DISPATCH(
                                                                ...
                                                                'APPLY',
                                                                ::DISPATCH( $item, 'isa', ::DISPATCH( $::Str, 'new', 'Decl' ) ),
                                                ...
                                                if (::DISPATCH(
                                                        ::DISPATCH(
                                                            ::DISPATCH(
                                                                ...
                                                                'APPLY',
                                                                ::DISPATCH( $item, 'isa', ::DISPATCH( $::Str, 'new', 'Method' ) ),
                                                                ::DISPATCH(
                                                                    $GLOBAL::Code_infix_58__60__38__38__62_,
                                                                    'APPLY',
                                                                    ::DISPATCH( $item, 'isa', ::DISPATCH( $::Str, 'new', 'Decl' ) ),
