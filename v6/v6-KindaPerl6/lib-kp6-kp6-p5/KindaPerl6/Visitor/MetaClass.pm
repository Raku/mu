            ...
            do {
                ...
                $::KindaPerl6::Visitor::MetaClass = ::DISPATCH(
                    ::DISPATCH(
                        $::Class, 'new',
                        ::DISPATCH(
                            $::Str, 'new', 'KindaPerl6::Visitor::MetaClass'
                        )
                    ),
                    'PROTOTYPE',
                );
            ...
            sub {
                ...
                do {
                      ...
                      )
                    {
                        ...
                        $module =
                          ::DISPATCH( $::Scalar, 'new',
                            { modified => $_MODIFIED, name => '$module' } )
