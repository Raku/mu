            ...
            do {
                ...
                $::KindaPerl6::Visitor::CreateEnv = ::DISPATCH(
                    ::DISPATCH(
                        $::Class, 'new',
                        ::DISPATCH(
                            $::Str, 'new', 'KindaPerl6::Visitor::CreateEnv'
                        )
                    ),
                    'PROTOTYPE',
                );
            ...
            sub {
                ...
                do {
                      ...
                      )
                    {
                        ...
                        $temp_env =
                          ::DISPATCH( $::Scalar, 'new',
                            { modified => $_MODIFIED, name => '$temp_env' } )
                          unless defined $temp_env;

                        BEGIN {
                            $temp_env = ::DISPATCH( $::Scalar, 'new',
                                { modified => $_MODIFIED, name => '$temp_env' }
                            );
                        }
                        my $temp_lexicals;
