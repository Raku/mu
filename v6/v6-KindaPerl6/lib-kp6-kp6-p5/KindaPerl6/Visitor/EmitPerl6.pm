    ...
    do {
          ...
          )
        {
            ...
            do {
                ...
                $::KindaPerl6::Visitor::EmitPerl6 = ::DISPATCH(
                    ::DISPATCH(
                        $::Class, 'new',
                        ::DISPATCH(
                            $::Str, 'new', 'KindaPerl6::Visitor::EmitPerl6'
                        )
                    ),
                    'PROTOTYPE',
                );
                ...
                ::DISPATCH(
                    ...
                    ::DISPATCH(
                        ...
                        ::DISPATCH(
                            ...
                            'APPLY',
                            ::DISPATCH(
                                ::DISPATCH( $self, "index" ), 'emit_perl6',
                            ),
                            ::DISPATCH( $::Str, 'new', ']' )
                        )
                    )
        ...
        ::DISPATCH(
            ...
            sub {
                ...
                ::DISPATCH(
                    ...
                    'APPLY',
                    ::DISPATCH(
                        ::DISPATCH( $self, "parameters" ), 'emit_perl6',
                    ),
                    ::DISPATCH(
                        $GLOBAL::Code_infix_58__60__126__62_,
                        'APPLY',
                        ...
                        ::DISPATCH(
                            ...
                            'APPLY',
                            ::DISPATCH(
                                ::DISPATCH( $self, "arguments" ), 'emit_perl6',
                            ),
                            ::DISPATCH( $::Str, 'new', '' )
                        )
                    )
                ...
                return (
                    ::DISPATCH(
                        ...
                        ::DISPATCH(
                            ...
                            'APPLY',
                            ::DISPATCH(
                                ::DISPATCH( $self, "result" ), 'emit_perl6',
                            ),
                            ::DISPATCH( $::Str, 'new', ')' )
                        )
                    )
                    ...
                    $code = ::DISPATCH(
                        ...
                        ::DISPATCH(
                            ...
                            ::DISPATCH(
                                ...
                                'APPLY',
                                ::DISPATCH(
                                    ::DISPATCH( $self, "block" ), 'emit_perl6',
                                ),
                                ::DISPATCH( $::Str, 'new', ' }' )
                            )
                        )
            ...
            sub {
                ...
                ::DISPATCH(
                    ...
                    ::DISPATCH(
                        $GLOBAL::Code_infix_58__60__126__62_,
                        'APPLY',
                        ::DISPATCH( ::DISPATCH( $self, "block" ), 'emit_perl6',
                        ),
                        ::DISPATCH( $::Str, 'new', ' }' )
                    )
                );
