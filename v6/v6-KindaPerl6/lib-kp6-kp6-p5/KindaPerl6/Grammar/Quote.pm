{
    ...
    BEGIN { $_ = ::DISPATCH( $::Scalar, "new", { modified => $_MODIFIED, name => "$_" } ); }
    {
                                                            ...
                                                            do {
                                                                {
                                                                    ...
                                                                    ::DISPATCH_VAR( $ret, 'STORE', ::DISPATCH( $self, '__rule_block74131581017a09016423677528f813f0', ) );
                                                                    do {
                                                                                                                            ...
                                                                                                                            do {
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    $m2 = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$m2' } ) unless defined $m2;
                                                                                                                                    BEGIN { $m2 = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$m2' } ) }
                                                                                                                                    ::DISPATCH_VAR( $m2, 'STORE', ::DISPATCH( $self, 'quoted_any', $str, ::DISPATCH( $MATCH, 'to', ) ) );
                                                                                                                                    do {
                                                                                                                                        if ( ::DISPATCH( ::DISPATCH( $m2, "true" ), "p5landish" ) ) {
                                                                                                                                            {
                                                                                                                                                ::DISPATCH_VAR( ::DISPATCH( $MATCH, 'to', ), 'STORE', ::DISPATCH( $m2, 'to', ) );
                                                                                                                                                ::DISPATCH_VAR( ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'quoted_any' ) ), 'STORE', $m2 );
                                                                                                                                                ::DISPATCH( $::Int, 'new', 1 )
                                                                                                                                            }
                                                                                                                                        }
                                                                                                                                        else {
        ...
        ::DISPATCH(
            ::DISPATCH( $::KindaPerl6::Grammar, 'HOW', ),
            'add_method',
            ::DISPATCH( $::Str, 'new', '__rule_block74131581017a09016423677528f813f0' ),
            ::DISPATCH(
                $::Method,
                'new',
                sub {
