{
    ...
    BEGIN { $_ = ::DISPATCH( $::Scalar, "new", { modified => $_MODIFIED, name => "$_" } ); }
    {
        ...
        ::DISPATCH(
            ::DISPATCH( $::KindaPerl6::Grammar, 'HOW', ),
            'add_method',
            ::DISPATCH( $::Str, 'new', '__rule_blockb63fa364902f724d1bdf451386a75002' ),
            ::DISPATCH(
                $::Method,
                'new',
                sub {
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                sub {
                    ...
                    return (
                        ::DISPATCH(
                            $::Sig, 'new', ::DISPATCH( $::Str, 'new', 'invocant' ) => ::DISPATCH( $::Val::Undef, 'new', ),
                            ::DISPATCH( $::Str, 'new', 'positional' ) =>
                                ::DISPATCH( $::Array, "new", { _array  => [ ::DISPATCH( $GLOBAL::Code_prefix_58__60__36__62_, 'APPLY', ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'undeclared_var' ) ) ) ] } ),
                            ::DISPATCH( $::Str,       'new', 'named' ) => ::DISPATCH( $::Hash,                                "new",   { _hash             => {} } ),
                        )
                    );
                }
        ...
        ::DISPATCH(
            ...
            ::DISPATCH(
                ...
                sub {
                    ...
                    ::DISPATCH( $KindaPerl6::Grammar::Code_declare_parameters, 'APPLY', $env, $block, ::DISPATCH( $GLOBAL::Code_prefix_58__60__36__62_, 'APPLY', ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'arrow_sub_sig' ) ) ) );
                    return (
                        ::DISPATCH(
                            $::Sub, 'new',
                            ...
                            ::DISPATCH( $::Str, 'new', 'block' ) => ::DISPATCH(
                                $::Lit::Code, 'new', ::DISPATCH( $::Str, 'new', 'pad' ) => $env,
                                ::DISPATCH( $::Str, 'new', 'state' ) => ::DISPATCH( $::Hash, "new", { _hash => {} } ),
                                ::DISPATCH( $::Str, 'new', 'sig' )  => ::DISPATCH( $GLOBAL::Code_prefix_58__60__36__62_, 'APPLY', ::DISPATCH( $MATCH, 'LOOKUP', ::DISPATCH( $::Str, 'new', 'arrow_sub_sig' ) ) ),
                                ::DISPATCH( $::Str, 'new', 'body' ) => $block,
                            ),
                        )
                    );
                    ...
                    do {
                        ...
                        $bind = ::DISPATCH(
                            ...
                            ::DISPATCH( $::Str, 'new', 'arguments' ) => ::DISPATCH(
                                ...
                                ::DISPATCH( $::Str, 'new', 'invocant' ) => ::DISPATCH( $::Proto, 'new', ::DISPATCH( $::Str, 'new', 'name' ) => ::DISPATCH( $::Str, 'new', 'Multi' ), ),
                            ),
                        );
                    };
