          ...
          )
        {
            ...
            do {
                ...
                $::KindaPerl6::Traverse = ::DISPATCH(
                    ::DISPATCH(
                        $::Class, 'new',
                        ::DISPATCH( $::Str, 'new', 'KindaPerl6::Traverse' )
                    ),
                    'PROTOTYPE',
                );
              }
                ...
                code => sub {
                    ...
                    do {
                          ...
                          )
                        {
                            ...
                            my $subitem;
                            $subitem = ::DISPATCH( $::Scalar, 'new',
                                { modified => $_MODIFIED, name => '$subitem' } )
                    ...
                    return (
                        ::DISPATCH(
                            $node, 'new',
                            ::DISPATCH(
                                $GLOBAL::Code_prefix_58__60__37__62_, 'APPLY',
                                $result
                            )
                        )
                    );
                ...
                code => sub {
                    ...
                    do {
                          ...
                          )
                        {
                            ...
                            return (
                                ::DISPATCH( $subnode, 'emit', $visitor, $path )
                            );
                        }
                      }
                },
