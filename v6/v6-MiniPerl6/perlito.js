...
(function () {
  ...
  MiniPerl6$Match.f_scalar = function () {
    var v_self = this;
    if ( f_bool(this.v_bool) ) { if ( f_bool((this.v_capture != null)) ) { return(this.v_capture) } else {  };return((this.v_str).substr(this.v_from, (this.v_to - this.v_from))) } else { return("") }
  }
...
(function () {
  ...
  Pair.f_perl = function () {
    var v_self = this;
    return(( f_string(this.v_key) + f_string(( f_string(" => ") + f_string(f_perl(this.v_value)) )) ))
  }
...
(function () {
  ...
  Main.f_to_lisp_identifier = function (v_ident) {
    return(( f_string("sv-") + f_string(v_ident) ))
  }
  // sub lisp_dump_object
  Main.f_lisp_dump_object = function (v_class_name, v_data) {
    return(( f_string(v_class_name) + f_string(( f_string("( ") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( f_perl(a_[i]) ) } return out; })(v_data).join(", ")) + f_string(" )") )) )) ))
  }
})();
...
(function () {
  ...
  Lit$Seq.f_emit = function () {
    var v_self = this;
    return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_seq).join(", ")) + f_string(")") )) ))
  }
...
(function () {
  ...
  Lit$Array.f_emit = function () {
    var v_self = this;
    var v_needs_interpolation;(v_needs_interpolation = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_item) { if ( f_bool(( f_bool(( f_bool(f_isa(v_item, "Var")) && f_bool((v_item.f_sigil() == "@")) )) || f_bool(( f_bool(f_isa(v_item, "Apply")) && f_bool((v_item.f_code() == "prefix:<@>")) )) )) ) { (v_needs_interpolation = 1) } else {  } })(a_[i_]) } })(this.v_array);if ( f_bool(v_needs_interpolation) ) { var v_s;(v_s = "");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_item) { if ( f_bool(( f_bool(( f_bool(f_isa(v_item, "Var")) && f_bool((v_item.f_sigil() == "@")) )) || f_bool(( f_bool(f_isa(v_item, "Apply")) && f_bool((v_item.f_code() == "prefix:<@>")) )) )) ) { (v_s = ( f_string(v_s) + f_string(( f_string("(function(a_) { ") + f_string(( f_string("for (var i_ = 0; i_ < a_.length ; i_++) { a.push(a_[i_]) }") + f_string(( f_string("})(") + f_string(( f_string(v_item.f_emit()) + f_string("); ") )) )) )) )) )) } else { (v_s = ( f_string(v_s) + f_string(( f_string("a.push(") + f_string(( f_string(v_item.f_emit()) + f_string("); ") )) )) )) } })(a_[i_]) } })(this.v_array);return(( f_string("(function () { var a = []; ") + f_string(( f_string(v_s) + f_string(" return a })()") )) )) } else { return(( f_string("[") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_array).join(", ")) + f_string("]") )) )) }
  }
...
(function () {
  ...
  Lit$Hash.f_emit = function () {
    var v_self = this;
    var v_fields;var v_str;(v_fields = this.v_hash);(v_str = "");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { (v_str = ( f_string(v_str) + f_string(( f_string(v_field[0].f_emit()) + f_string(( f_string(":") + f_string(( f_string(v_field[1].f_emit()) + f_string(",") )) )) )) )) })(a_[i_]) } })((v_fields));return(( f_string("{ ") + f_string(( f_string(v_str) + f_string(" }") )) ))
  }
...
(function () {
  ...
  Lit$Object.f_emit = function () {
    var v_self = this;
    var v_fields;var v_str;(v_fields = this.v_fields);(v_str = "");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { (v_str = ( f_string(v_str) + f_string(( f_string("v_") + f_string(( f_string(v_field[0].f_buf()) + f_string(( f_string(": ") + f_string(( f_string(v_field[1].f_emit()) + f_string(",") )) )) )) )) )) })(a_[i_]) } })((v_fields));return(( f_string("{ __proto__:") + f_string(( f_string(Main.f_to_javascript_namespace(this.v_class)) + f_string(( f_string(", ") + f_string(( f_string(v_str) + f_string("}") )) )) )) ))
  }
...
(function () {
  ...
  Var.f_emit = function () {
    var v_self = this;
    var v_table;var v_ns;(v_table = { "$":"v_","@":"List_","%":"Hash_","&":"Code_", });(v_ns = "");if ( f_bool(this.v_namespace) ) { (v_ns = ( f_string(Main.f_to_javascript_namespace(this.v_namespace)) + f_string(".") )) } else {  };return(( f_bool((this.v_twigil == ".")) ? ( f_string("this.v_") + f_string(( f_string(this.v_name) + f_string("") )) ) : ( f_bool((this.v_name == "/")) ? ( f_string(v_table[this.v_sigil]) + f_string("MATCH") ) : ( f_string(v_table[this.v_sigil]) + f_string(( f_string(v_ns) + f_string(this.v_name) )) ))))
  }
  Var.f_emit;  // v8 bug workaround
  // method plain_name
  Var.f_plain_name = function () {
    var v_self = this;
    if ( f_bool(this.v_namespace) ) { return(( f_string(this.v_namespace) + f_string(( f_string(".") + f_string(this.v_name) )) )) } else {  };return(this.v_name)
  }
...
(function () {
  ...
  Bind.f_emit = function () {
    var v_self = this;
    if ( f_bool(f_isa(this.v_parameters, "Lit::Array")) ) { (v_a = this.v_parameters.f_array());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = { __proto__:Bind, v_parameters: v_var,v_arguments: { __proto__:Index, v_obj: this.v_arguments,v_index_exp: { __proto__:Val$Int, v_int: v_i,},},});(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));return(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(this.v_parameters, "Lit::Hash")) ) { (v_a = this.v_parameters.f_hash());(v_b = this.v_arguments.f_hash());(v_str = "do { ");(v_i = 0);v_arg;(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_arg = { __proto__:Val$Undef, });(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var2) { if ( f_bool((v_var2[0].f_buf() == v_var[0].f_buf())) ) { (v_arg = v_var2[1]) } else {  } })(a_[i_]) } })((v_b));(v_bind = { __proto__:Bind, v_parameters: v_var[1],v_arguments: v_arg,});(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));return(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(this.v_parameters, "Lit::Object")) ) { (v_class = this.v_parameters.f_class());(v_a = this.v_parameters.f_fields());(v_b = this.v_arguments);(v_str = "do { ");(v_i = 0);v_arg;(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = { __proto__:Bind, v_parameters: v_var[1],v_arguments: { __proto__:Call, v_invocant: v_b,v_method: v_var[0].f_buf(),v_arguments: [],v_hyper: 0,},});(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));return(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(this.v_parameters, "Call")) ) { return(( f_string("(") + f_string(( f_string(this.v_parameters.f_invocant().f_emit()) + f_string(( f_string(".v_") + f_string(( f_string(this.v_parameters.f_method()) + f_string(( f_string(" = ") + f_string(( f_string(this.v_arguments.f_emit()) + f_string(")") )) )) )) )) )) )) } else {  };return(( f_string("(") + f_string(( f_string(this.v_parameters.f_emit()) + f_string(( f_string(" = ") + f_string(( f_string(this.v_arguments.f_emit()) + f_string(")") )) )) )) ))
  }
...
(function () {
  ...
  Call.f_emit = function () {
    var v_self = this;
    var v_invocant;var v_meth;(v_invocant = this.v_invocant.f_emit());if ( f_bool((v_invocant == "self")) ) { (v_invocant = "this") } else {  };if ( f_bool((this.v_method == "values")) ) { if ( f_bool(this.v_hyper) ) { f_die("not implemented") } else { return(( f_string("@{") + f_string(( f_string(v_invocant) + f_string("}") )) )) } } else {  };if ( f_bool(( f_bool((this.v_method == "perl")) || f_bool((this.v_method == "isa")) )) ) { if ( f_bool(this.v_hyper) ) { return(( f_string("(function (a_) {") + f_string(( f_string(" var out = []; for(var i = 0; i < a_.length; i++) { ") + f_string(( f_string("out.push( f_") + f_string(( f_string(this.v_method) + f_string(( f_string("(a_[i]) ) } return out;") + f_string(( f_string(" })(") + f_string(( f_string(v_invocant) + f_string(")") )) )) )) )) )) )) )) } else {  };return(( f_string("f_") + f_string(( f_string(this.v_method) + f_string(( f_string("(") + f_string(( f_string(v_invocant) + f_string(( f_string(( f_bool(this.v_arguments) ? ( f_string(", ") + f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(", ")) ) : "")) + f_string(")") )) )) )) )) )) } else {  };if ( f_bool((this.v_method == "join")) ) { return(( f_string(v_invocant) + f_string(( f_string(".") + f_string(( f_string(this.v_method) + f_string(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(", ")) + f_string(")") )) )) )) )) )) } else {  };if ( f_bool(( f_bool((this.v_method == "yaml")) || f_bool(( f_bool((this.v_method == "say")) || f_bool((this.v_method == "chars")) )) )) ) { if ( f_bool(this.v_hyper) ) { return(( f_string("(function (a_) {") + f_string(( f_string(" var out = []; for(var i = 0; i < a_.length; i++) { ") + f_string(( f_string("out.push( Main.") + f_string(( f_string(this.v_method) + f_string(( f_string("(a_[i]) ) } return out;") + f_string(( f_string(" })(") + f_string(( f_string(v_invocant) + f_string(")") )) )) )) )) )) )) )) } else { if ( f_bool((this.v_arguments != null)) ) { return(( f_string("Main.") + f_string(( f_string(this.v_method) + f_string(( f_string("(") + f_string(( f_string(v_invocant) + f_string(( f_string(", ") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(", ")) + f_string(")") )) )) )) )) )) )) } else { return(( f_string("Main.") + f_string(( f_string(this.v_method) + f_string(( f_string("(") + f_string(( f_string(v_invocant) + f_string(")") )) )) )) )) } } } else {  };(v_meth = this.v_method);if ( f_bool((v_meth == "postcircumfix:<( )>")) ) { (v_meth = "") } else {  };if ( f_bool(this.v_hyper) ) { return(( f_string("(function (a_) {") + f_string(( f_string(" var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_") + f_string(( f_string(v_meth) + f_string(( f_string("() ) } return out;") + f_string(( f_string(" })(") + f_string(( f_string(v_invocant) + f_string(")") )) )) )) )) )) )) } else { return(( f_string(v_invocant) + f_string(( f_string(".f_") + f_string(( f_string(v_meth) + f_string(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(", ")) + f_string(")") )) )) )) )) )) }
  }
...
(function () {
  ...
  Apply.f_emit = function () {
    var v_self = this;
    var v_code;(v_code = this.v_code);if ( f_bool(f_isa(v_code, "Str")) ) {  } else { return(( f_string("(") + f_string(( f_string(this.v_code.f_emit()) + f_string(( f_string(")->(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(", ")) + f_string(")") )) )) )) )) };if ( f_bool((v_code == "self")) ) { return("this") } else {  };if ( f_bool((v_code == "false")) ) { return("0") } else {  };if ( f_bool((v_code == "make")) ) { return(( f_string("(v_MATCH.v_capture = ") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(", ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "say")) ) { return(( f_string("say(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" + ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "print")) ) { return(( f_string("print(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" + ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "warn")) ) { return(( f_string("warn(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" + ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "defined")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" ")) + f_string(" != null)") )) )) } else {  };if ( f_bool((v_code == "substr")) ) { return(( f_string("(") + f_string(( f_string(this.v_arguments[0].f_emit()) + f_string(( f_string(").substr(") + f_string(( f_string(this.v_arguments[1].f_emit()) + f_string(( f_string(", ") + f_string(( f_string(this.v_arguments[2].f_emit()) + f_string(")") )) )) )) )) )) )) } else {  };if ( f_bool((v_code == "prefix:<~>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" ")) + f_string(").f_string()") )) )) } else {  };if ( f_bool((v_code == "prefix:<!>")) ) { return(( f_string("( f_bool(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" ")) + f_string(") ? false : true)") )) )) } else {  };if ( f_bool((v_code == "prefix:<?>")) ) { return(( f_string("( f_bool(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" ")) + f_string(") ? true : false)") )) )) } else {  };if ( f_bool((v_code == "prefix:<$>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" ")) + f_string(").f_scalar()") )) )) } else {  };if ( f_bool((v_code == "prefix:<@>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "prefix:<%>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" ")) + f_string(").f_hash()") )) )) } else {  };if ( f_bool((v_code == "infix:<~>")) ) { return(( f_string("( f_string(") + f_string(( f_string(this.v_arguments[0].f_emit()) + f_string(( f_string(")") + f_string(( f_string(" + f_string(") + f_string(( f_string(this.v_arguments[1].f_emit()) + f_string(") )") )) )) )) )) )) } else {  };if ( f_bool((v_code == "infix:<+>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" + ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<->")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" - ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<>>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" > ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<&&>")) ) { return(( f_string("( f_bool(") + f_string(( f_string(this.v_arguments[0].f_emit()) + f_string(( f_string(")") + f_string(( f_string(" && f_bool(") + f_string(( f_string(this.v_arguments[1].f_emit()) + f_string(") )") )) )) )) )) )) } else {  };if ( f_bool((v_code == "infix:<||>")) ) { return(( f_string("( f_bool(") + f_string(( f_string(this.v_arguments[0].f_emit()) + f_string(( f_string(")") + f_string(( f_string(" || f_bool(") + f_string(( f_string(this.v_arguments[1].f_emit()) + f_string(") )") )) )) )) )) )) } else {  };if ( f_bool((v_code == "infix:<eq>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" == ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<ne>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" != ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<==>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" == ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<!=>")) ) { return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(" != ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "ternary:<?? !!>")) ) { return(( f_string("( f_bool(") + f_string(( f_string(this.v_arguments[0].f_emit()) + f_string(( f_string(")") + f_string(( f_string(" ? ") + f_string(( f_string(this.v_arguments[1].f_emit()) + f_string(( f_string(" : ") + f_string(( f_string(this.v_arguments[2].f_emit()) + f_string(")") )) )) )) )) )) )) )) } else {  };(v_code = ( f_string("f_") + f_string(this.v_code) ));if ( f_bool(this.v_namespace) ) { (v_code = ( f_string(Main.f_to_javascript_namespace(this.v_namespace)) + f_string(( f_string(".") + f_string(v_code) )) )) } else {  };return(( f_string(v_code) + f_string(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_arguments).join(", ")) + f_string(")") )) )) ))
  }
...
(function () {
  ...
  Return.f_emit = function () {
    var v_self = this;
    return(( f_string("return(") + f_string(( f_string(this.v_result.f_emit()) + f_string(")") )) ))
  }
...
(function () {
  ...
  If.f_emit = function () {
    var v_self = this;
    var v_cond;(v_cond = this.v_cond);if ( f_bool(( f_bool(f_isa(v_cond, "Apply")) && f_bool((v_cond.f_code() == "prefix:<!>")) )) ) { (v_if = { __proto__:If, v_cond: v_cond.f_arguments()[0],v_body: this.v_otherwise,v_otherwise: this.v_body,});return(v_if.f_emit()) } else {  };if ( f_bool(( f_bool(f_isa(v_cond, "Var")) && f_bool((v_cond.f_sigil() == "@")) )) ) { (v_cond = { __proto__:Apply, v_code: "prefix:<@>",v_arguments: [v_cond],}) } else {  };return(( f_string("if ( f_bool(") + f_string(( f_string(v_cond.f_emit()) + f_string(( f_string(") ) { ") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_body).join(";")) + f_string(( f_string(" } else { ") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_otherwise).join(";")) + f_string(" }") )) )) )) )) )) ))
  }
...
(function () {
  ...
  For.f_emit = function () {
    var v_self = this;
    return(( f_string("(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { ") + f_string(( f_string("(function (") + f_string(( f_string(this.v_topic.f_emit()) + f_string(( f_string(") { ") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_body).join(";")) + f_string(( f_string(" })(a_[i_]) } })") + f_string(( f_string("(") + f_string(( f_string(this.v_cond.f_emit()) + f_string(")") )) )) )) )) )) )) )) ))
  }
...
(function () {
  ...
  Method.f_emit = function () {
    var v_self = this;
    var v_sig;var v_invocant;var v_pos;var v_str;(v_sig = this.v_sig);(v_invocant = v_sig.f_invocant());(v_pos = v_sig.f_positional());(v_str = (function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })((v_pos)).join(", "));return(( f_string("function ") + f_string(( f_string(this.v_name) + f_string(( f_string("(") + f_string(( f_string(v_str) + f_string(( f_string(") { ") + f_string(( f_string({ __proto__:MiniPerl6$Javascript$LexicalBlock, v_block: this.v_block,v_needs_return: 1,}.f_emit()) + f_string(" }") )) )) )) )) )) ))
  }
...
(function () {
  ...
  Sub.f_emit = function () {
    var v_self = this;
    var v_sig;var v_pos;var v_str;(v_sig = this.v_sig);(v_pos = v_sig.f_positional());(v_str = (function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })((v_pos)).join(", "));return(( f_string("function ") + f_string(( f_string(this.v_name) + f_string(( f_string("(") + f_string(( f_string(v_str) + f_string(( f_string(") { ") + f_string(( f_string({ __proto__:MiniPerl6$Javascript$LexicalBlock, v_block: this.v_block,v_needs_return: 1,}.f_emit()) + f_string(" }") )) )) )) )) )) ))
  }
...
(function () {
  ...
  Do.f_emit = function () {
    var v_self = this;
    return(( f_string("(function () { ") + f_string(( f_string({ __proto__:MiniPerl6$Javascript$LexicalBlock, v_block: this.v_block,v_needs_return: 1,}.f_emit()) + f_string(" })()") )) ))
  }
...
(function () {
  ...
  MiniPerl6$Grammar.f_var_sigil = function (v_str, v_pos) {
    var v_grammar = this;
    var v_MATCH = null;(v_MATCH = { __proto__:MiniPerl6$Match, v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,});(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool(("$" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) })()) || f_bool(( f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool(("%" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) })()) || f_bool(( f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool(("@" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool(("&" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) })()) )) )) )) })());return(v_MATCH)
  }
...
(function () {
  ...
  MiniPerl6$Grammar.f_char_any = function (v_str, v_pos) {
    var v_grammar = this;
    var v_MATCH = null;(v_MATCH = { __proto__:MiniPerl6$Match, v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,});(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return((function () { return(( f_bool(("" != (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) })()) })());return(v_MATCH)
  }
  ...
  MiniPerl6$Grammar.f_exp_stmts = function (v_str, v_pos) {
    var v_grammar = this;
    var v_MATCH = null;(v_MATCH = { __proto__:MiniPerl6$Match, v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,});(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp"] = v_m2);return(1) } else { return(0) } })()) && f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool((";" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(1) })()) )) })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp_stmts(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp_stmts"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool(( f_bool((";" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(1) })()) )) })()) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = (function () { var a = []; a.push((v_MATCH["exp"]).f_scalar()); (function(a_) { for (var i_ = 0; i_ < a_.length ; i_++) { a.push(a_[i_]) }})(((v_MATCH["exp_stmts"]).f_scalar()));  return a })())) })()) || f_bool(1) )) )) )) )) )) )) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool(( f_bool((";" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(1) })()) )) })()) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = [(v_MATCH["exp"]).f_scalar()])) })()) || f_bool(1) )) )) )) })()) )) })()) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool((function () { return((v_MATCH.v_capture = [])) })()) || f_bool(1) )) })()) )) })());return(v_MATCH)
  }
  MiniPerl6$Grammar.f_exp_stmts;  // v8 bug workaround
  // method exp_seq
  MiniPerl6$Grammar.f_exp_seq = function (v_str, v_pos) {
    var v_grammar = this;
    var v_MATCH = null;(v_MATCH = { __proto__:MiniPerl6$Match, v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,});(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp"] = v_m2);return(1) } else { return(0) } })()) && f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool(( f_bool(("," == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp_seq(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp_seq"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool(( f_bool(("," == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(1) })()) )) })()) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = (function () { var a = []; a.push((v_MATCH["exp"]).f_scalar()); (function(a_) { for (var i_ = 0; i_ < a_.length ; i_++) { a.push(a_[i_]) }})(((v_MATCH["exp_seq"]).f_scalar()));  return a })())) })()) || f_bool(1) )) )) )) )) )) )) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool(( f_bool(("," == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(1) })()) )) })()) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = [(v_MATCH["exp"]).f_scalar()])) })()) || f_bool(1) )) )) )) })()) )) })()) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool((function () { return((v_MATCH.v_capture = [])) })()) || f_bool(1) )) })()) )) })());return(v_MATCH)
  }
...
(function () {
  ...
  MiniPerl6$Grammar.f_bind = function (v_str, v_pos) {
    var v_grammar = this;
    var v_MATCH = null;(v_MATCH = { __proto__:MiniPerl6$Match, v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,});(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return((function () { return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool(( f_bool((":=" == (v_str).substr(v_MATCH.f_to(), 2))) ? (1 + (v_MATCH.v_to = (2 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp2(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp2"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = { __proto__:Bind, v_parameters: (v_MATCH["exp"]).f_scalar(),v_arguments: (v_MATCH["exp2"]).f_scalar(),})) })()) || f_bool(1) )) )) )) )) )) )) })()) })());return(v_MATCH)
  }
  MiniPerl6$Grammar.f_bind;  // v8 bug workaround
  // method call
  MiniPerl6$Grammar.f_call = function (v_str, v_pos) {
    var v_grammar = this;
    var v_MATCH = null;(v_MATCH = { __proto__:MiniPerl6$Match, v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,});(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return((function () { return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool(( f_bool(("." == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_ident(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["ident"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool(( f_bool(("(" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp_seq(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp_seq"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool(( f_bool((")" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = { __proto__:Call, v_invocant: (v_MATCH["exp"]).f_scalar(),v_method: (v_MATCH["ident"]).f_scalar(),v_arguments: (v_MATCH["exp_seq"]).f_scalar(),v_hyper: "",})) })()) || f_bool(1) )) )) )) )) )) )) )) )) )) })()) })());return(v_MATCH)
  }
  MiniPerl6$Grammar.f_call;  // v8 bug workaround
  // method apply
  MiniPerl6$Grammar.f_apply = function (v_str, v_pos) {
    var v_grammar = this;
    var v_MATCH = null;(v_MATCH = { __proto__:MiniPerl6$Match, v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,});(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return((function () { return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_optional_namespace_before_ident(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["optional_namespace_before_ident"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_full_ident(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["full_ident"] = v_m2);return(1) } else { return(0) } })()) && f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool((function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool(( f_bool(("(" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp_seq(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp_seq"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((")" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) )) )) )) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_exp_seq(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["exp_seq"] = v_m2);return(1) } else { return(0) } })()) && f_bool((function () { var v_m2;(v_m2 = v_grammar.f_opt_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) )) )) })()) )) })()) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = { __proto__:Apply, v_namespace: (v_MATCH["optional_namespace_before_ident"]).f_scalar(),v_code: (v_MATCH["full_ident"]).f_scalar(),v_arguments: (v_MATCH["exp_seq"]).f_scalar(),})) })()) || f_bool(1) )) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool((function () { return((v_MATCH.v_capture = { __proto__:Apply, v_namespace: (v_MATCH["optional_namespace_before_ident"]).f_scalar(),v_code: (v_MATCH["full_ident"]).f_scalar(),v_arguments: [],})) })()) || f_bool(1) )) })()) )) })()) )) )) })()) })());return(v_MATCH)
  }
...
(function () {
  ...
  MiniPerl6$Grammar$Regex.f_named_capture_body = function (v_str, v_pos) {
    var v_grammar = this;
    var v_MATCH = null;(v_MATCH = { __proto__:MiniPerl6$Match, v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,});(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return(( f_bool((function () { return(( f_bool(( f_bool(("(" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_rule(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["rule"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool(( f_bool((")" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = { "capturing_group":(v_MATCH["rule"]).f_scalar(), })) })()) || f_bool(1) )) )) )) )) })()) || f_bool(( f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool(( f_bool(("[" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_rule(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["rule"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool(( f_bool(("]" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = (v_MATCH["rule"]).f_scalar())) })()) || f_bool(1) )) )) )) )) })()) || f_bool(( f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool(( f_bool(("<" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_metasyntax_exp(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());(v_MATCH["metasyntax_exp"] = v_m2);return(1) } else { return(0) } })()) && f_bool(( f_bool(( f_bool((">" == (v_str).substr(v_MATCH.f_to(), 1))) ? (1 + (v_MATCH.v_to = (1 + v_MATCH.f_to()))) : 0)) && f_bool(( f_bool((function () { return((v_MATCH.v_capture = { __proto__:Rul$Subrule, v_metasyntax: (v_MATCH["metasyntax_exp"]).f_scalar(),})) })()) || f_bool(1) )) )) )) )) })()) || f_bool((function () { (v_MATCH.v_to = v_pos1);return(( f_bool((function () { return(f_die("invalid alias syntax")) })()) || f_bool(1) )) })()) )) )) )) })());return(v_MATCH)
  }
...
(function () {
  ...
  Rul.f_constant = function (v_str) {
    var v_len;(v_len = Main.chars(v_str));if ( f_bool((v_str == "\\")) ) { (v_str = "\\\\") } else {  };if ( f_bool((v_str == "'")) ) { (v_str = "\\'") } else {  };if ( f_bool(v_len) ) { return(( f_string("( ( '") + f_string(( f_string(v_str) + f_string(( f_string("' eq substr( $str, $MATCH.to, ") + f_string(( f_string(v_len) + f_string(( f_string(")) ") + f_string(( f_string("  ?? (1 + ( $MATCH.to := ") + f_string(( f_string(v_len) + f_string(( f_string(" + $MATCH.to ))") + f_string(( f_string("  !! false ") + f_string(")") )) )) )) )) )) )) )) )) )) } else { return("1") }
  }
})();
...
(function () {
  ...
  Rul$Or.f_emit = function () {
    var v_self = this;
    return(( f_string("do { ") + f_string(( f_string("my $pos1 := $MATCH.to; do{ ") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_or_list).join("} || do { $MATCH.to := $pos1; ")) + f_string("} }") )) )) ))
  }
...
(function () {
  ...
  Rul$Concat.f_emit = function () {
    var v_self = this;
    return(( f_string("(") + f_string(( f_string((function (a_) { var out = []; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_concat).join(" && ")) + f_string(")") )) ))
  }
...
(function () {
  ...
  Rul$Subrule.f_emit = function () {
    var v_self = this;
    var v_meth;(v_meth = ( f_bool((1 + f_index(this.v_metasyntax, "."))) ? this.v_metasyntax : ( f_string("$grammar.") + f_string(this.v_metasyntax) )));return(( f_string("do { ") + f_string(( f_string("my $m2 := ") + f_string(( f_string(v_meth) + f_string(( f_string("($str, $MATCH.to); ") + f_string(( f_string("if $m2 { $MATCH.to := $m2.to; $MATCH{'") + f_string(( f_string(this.v_metasyntax) + f_string(( f_string("'} := $m2; 1 } else { false } ") + f_string("}") )) )) )) )) )) )) ))
  }
...
(function () {
  ...
  Rul$SubruleNoCapture.f_emit = function () {
    var v_self = this;
    var v_meth;(v_meth = ( f_bool((1 + f_index(this.v_metasyntax, "."))) ? this.v_metasyntax : ( f_string("$grammar.") + f_string(this.v_metasyntax) )));return(( f_string("do { ") + f_string(( f_string("my $m2 := ") + f_string(( f_string(v_meth) + f_string(( f_string("($str, $MATCH.to); ") + f_string(( f_string("if $m2 { $MATCH.to := $m2.to; 1 } else { false } ") + f_string("}") )) )) )) )) ))
  }
...
(function () {
  ...
  Rul$Var.f_emit = function () {
    var v_self = this;
    var v_table;(v_table = { "$":"$","@":"$List_","%":"$Hash_","&":"$Code_", });return(( f_string(v_table[this.v_sigil]) + f_string(this.v_name) ))
  }
...
(function () {
  ...
  Rul$Constant.f_emit = function () {
    var v_self = this;
    var v_str;(v_str = this.v_constant);return(Rul.f_constant(v_str))
  }
...
(function () {
  ...
  Rul$SpecialChar.f_emit = function () {
    var v_self = this;
    var v_char;(v_char = this.v_char);if ( f_bool((v_char == "n")) ) { (v_rul = { __proto__:Rul$SubruleNoCapture, v_metasyntax: "is_newline",});(v_rul = v_rul.f_emit());return(v_rul) } else {  };if ( f_bool((v_char == "N")) ) { (v_rul = { __proto__:Rul$SubruleNoCapture, v_metasyntax: "not_newline",});(v_rul = v_rul.f_emit());return(v_rul) } else {  };if ( f_bool((v_char == "d")) ) { (v_rul = { __proto__:Rul$SubruleNoCapture, v_metasyntax: "digit",});(v_rul = v_rul.f_emit());return(v_rul) } else {  };if ( f_bool((v_char == "s")) ) { (v_rul = { __proto__:Rul$SubruleNoCapture, v_metasyntax: "space",});(v_rul = v_rul.f_emit());return(v_rul) } else {  };return(Rul.f_constant(v_char))
  }
...
(function () {
  ...
  Rul$InterpolateVar.f_emit = function () {
    var v_self = this;
    say(( f_string("# TODO: interpolate var ") + f_string(( f_string(this.v_var.f_emit()) + f_string("") )) ));return(f_die())
  }
...
(function () {
  ...
  Rul$NamedCapture.f_emit = function () {
    var v_self = this;
    say(( f_string("# TODO: named capture ") + f_string(( f_string(this.v_capture_ident) + f_string(( f_string(" := ") + f_string(( f_string(this.v_rule_exp.f_emit()) + f_string("") )) )) )) ));return(f_die())
  }
...
(function () {
  ...
  Rul$NegateCharClass.f_emit = function () {
    var v_self = this;
    say("TODO NegateCharClass");return(f_die())
  }
...
(function () {
  ...
  Rul$CharClass.f_emit = function () {
    var v_self = this;
    say("TODO CharClass");return(f_die())
  }
...
(function () {
  ...
  Rul$Capture.f_emit = function () {
    var v_self = this;
    say("TODO RulCapture");return(f_die())
  }
