...
(defmethod sv-emit ((sv-self mp-Var))
  (block mp6-function
    (let ((sv-table nil)(sv-ns nil)) (setf sv-table (let ((h (make-hash-table :test 'equal))) (setf (gethash "$" h) "$")(setf (gethash "@" h) "$List_")(setf (gethash "%" h) "$Hash_")(setf (gethash "&" h) "$Code_") h))(setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (sv-namespace sv-self)) (sv-string "::")))) (progn ))(if (sv-bool (sv-eq (sv-twigil sv-self) ".")) (concatenate 'string (sv-string "$self->{") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string "}")))) (if (sv-bool (sv-eq (sv-name sv-self) "/")) (concatenate 'string (sv-string (gethash (sv-sigil sv-self) sv-table)) (sv-string "MATCH")) (concatenate 'string (sv-string (gethash (sv-sigil sv-self) sv-table)) (sv-string (concatenate 'string (sv-string sv-ns) (sv-string (sv-name sv-self))))))))))

;; method name
(if (not (ignore-errors (find-method 'sv-name () ())))
  (defgeneric sv-name (sv-self)
      (:documentation "a method")))
(defmethod sv-name ((sv-self mp-Var))
  (block mp6-function
    (progn (if (sv-bool (sv-namespace sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string (sv-namespace sv-self)) (sv-string (concatenate 'string (sv-string "::") (sv-string (sv-name sv-self))))))) (progn ))(return-from mp6-function (sv-name sv-self)))))
...
(defmethod sv-emit ((sv-self mp-Bind))
  (block mp6-function
    (progn (if (sv-bool (typep (sv-parameters sv-self) 'mp-Lit-Array)) (let ((sv-a nil)(sv-str nil)(sv-i nil)) (setf sv-a (sv-array (sv-parameters sv-self) ))(setf sv-str "do { ")(setf sv-i 0)(dolist (sv-var sv-a) (let ((sv-bind nil)) (setf sv-bind (let ((m (make-instance 'mp-Bind))) (setf (sv-parameters m) sv-var)(setf (sv-arguments m) (let ((m (make-instance 'mp-Index))) (setf (sv-obj m) (sv-arguments sv-self))(setf (sv-index_exp m) (let ((m (make-instance 'mp-Val-Int))) (setf (sv-int m) sv-i) m)) m)) m))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string " ") (sv-string (concatenate 'string (sv-string (sv-emit sv-bind )) (sv-string "; ")))))))(setf sv-i (+ sv-i 1))))(return-from mp6-function (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit (sv-parameters sv-self) )) (sv-string " }")))))) (progn ))(if (sv-bool (typep (sv-parameters sv-self) 'mp-Lit-Hash)) (let ((sv-a nil)(sv-b nil)(sv-str nil)(sv-i nil)(sv-arg nil)) (setf sv-a (sv-hash (sv-parameters sv-self) ))(setf sv-b (sv-hash (sv-arguments sv-self) ))(setf sv-str "do { ")(setf sv-i 0)(dolist (sv-var sv-a) (let ((sv-bind nil)) (setf sv-arg (make-instance 'mp-Val-Undef))(dolist (sv-var2 sv-b) (progn (if (sv-bool (sv-eq (sv-buf (elt sv-var2 0) ) (sv-buf (elt sv-var 0) ))) (progn (setf sv-arg (elt sv-var2 1))) (progn ))))(setf sv-bind (let ((m (make-instance 'mp-Bind))) (setf (sv-parameters m) (elt sv-var 1))(setf (sv-arguments m) sv-arg) m))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string " ") (sv-string (concatenate 'string (sv-string (sv-emit sv-bind )) (sv-string "; ")))))))(setf sv-i (+ sv-i 1))))(return-from mp6-function (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit (sv-parameters sv-self) )) (sv-string " }")))))) (progn ))(if (sv-bool (typep (sv-parameters sv-self) 'mp-Lit-Object)) (let ((sv-class nil)(sv-a nil)(sv-b nil)(sv-str nil)(sv-i nil)(sv-arg nil)) (setf sv-class (sv-class (sv-parameters sv-self) ))(setf sv-a (sv-fields (sv-parameters sv-self) ))(setf sv-b (sv-arguments sv-self))(setf sv-str "do { ")(setf sv-i 0)(dolist (sv-var sv-a) (let ((sv-bind nil)) (setf sv-bind (let ((m (make-instance 'mp-Bind))) (setf (sv-parameters m) (elt sv-var 1))(setf (sv-arguments m) (let ((m (make-instance 'mp-Call))) (setf (sv-invocant m) sv-b)(setf (sv-method m) (sv-buf (elt sv-var 0) ))(setf (sv-arguments m) nil)(setf (sv-hyper m) 0) m)) m))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string " ") (sv-string (concatenate 'string (sv-string (sv-emit sv-bind )) (sv-string "; ")))))))(setf sv-i (+ sv-i 1))))(return-from mp6-function (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit (sv-parameters sv-self) )) (sv-string " }")))))) (progn ))(concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit (sv-parameters sv-self) )) (sv-string (concatenate 'string (sv-string " = ") (sv-string (concatenate 'string (sv-string (sv-emit (sv-arguments sv-self) )) (sv-string ")")))))))))))
...
(defmethod sv-emit ((sv-self mp-Call))
  (block mp6-function
    (let ((sv-invocant nil)(sv-meth nil)(sv-call nil)) (setf sv-invocant (sv-emit (sv-invocant sv-self) ))(if (sv-bool (sv-eq sv-invocant "self")) (progn (setf sv-invocant "$self")) (progn ))(if (sv-bool (sv-eq (sv-method sv-self) "values")) (progn (if (sv-bool (sv-hyper sv-self)) (progn (progn (write-line (format nil "~{~a~}" (list "not implemented")) *error-output*) (sb-ext:quit))) (progn (return-from mp6-function (concatenate 'string (sv-string "@{") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string "}")))))))) (progn ))(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "perl") (sv-or (sv-eq (sv-method sv-self) "yaml") (sv-or (sv-eq (sv-method sv-self) "say") (sv-or (sv-eq (sv-method sv-self) "join") (sv-or (sv-eq (sv-method sv-self) "chars") (sv-eq (sv-method sv-self) "isa"))))))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "[ map { Main::") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "( $_, ") (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " } @{ ") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string " } ]")))))))))))))))))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main::") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))))))) (progn ))(setf sv-meth (sv-method sv-self))(if (sv-bool (sv-eq sv-meth "postcircumfix:<( )>")) (progn (setf sv-meth "")) (progn ))(setf sv-call (concatenate 'string (sv-string "->") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))(if (sv-bool (sv-hyper sv-self)) (progn (concatenate 'string (sv-string "[ map { $_") (sv-string (concatenate 'string (sv-string sv-call) (sv-string (concatenate 'string (sv-string " } @{ ") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string " } ]"))))))))) (progn (concatenate 'string (sv-string sv-invocant) (sv-string sv-call)))))))
...
(defmethod sv-emit ((sv-self mp-Apply))
  (block mp6-function
    (let ((sv-ns nil)(sv-code nil)) (setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (sv-namespace sv-self)) (sv-string "::")))) (progn ))(setf sv-code (concatenate 'string (sv-string sv-ns) (sv-string (sv-code sv-self))))(if (sv-bool (typep sv-code 'mp-Str)) (progn ) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit (sv-code sv-self) )) (sv-string (concatenate 'string (sv-string ")->(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))(if (sv-bool (sv-eq sv-code "self")) (progn (return-from mp6-function "$self")) (progn ))(if (sv-bool (sv-eq sv-code "false")) (progn (return-from mp6-function "0")) (progn ))(if (sv-bool (sv-eq sv-code "make")) (progn (return-from mp6-function (concatenate 'string (sv-string "return(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "say")) (progn (return-from mp6-function (concatenate 'string (sv-string "Main::say(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "print")) (progn (return-from mp6-function (concatenate 'string (sv-string "Main::print(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "warn")) (progn (return-from mp6-function (concatenate 'string (sv-string "warn(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "array")) (progn (return-from mp6-function (concatenate 'string (sv-string "@{") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "}")))))) (progn ))(if (sv-bool (sv-eq sv-code "prefix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(\"\" . ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "prefix:<!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string " ? 0 : 1)")))))) (progn ))(if (sv-bool (sv-eq sv-code "prefix:<?>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string " ? 1 : 0)")))))) (progn ))(if (sv-bool (sv-eq sv-code "prefix:<$>")) (progn (return-from mp6-function (concatenate 'string (sv-string "${") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "}")))))) (progn ))(if (sv-bool (sv-eq sv-code "prefix:<@>")) (progn (return-from mp6-function (concatenate 'string (sv-string "@{") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "}")))))) (progn ))(if (sv-bool (sv-eq sv-code "prefix:<%>")) (progn (return-from mp6-function (concatenate 'string (sv-string "%{") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "}")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " . ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<+>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " + ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<->")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " - ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<>>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " > ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<x>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " x ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<&&>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " && ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<||>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " || ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<eq>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " eq ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<ne>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ne ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<==>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " == ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "infix:<!=>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " != ")) (sv-string ")")))))) (progn ))(if (sv-bool (sv-eq sv-code "ternary:<?? !!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string " ? ") (sv-string (concatenate 'string (sv-string (sv-emit (elt (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string " : ") (sv-string (concatenate 'string (sv-string (sv-emit (elt (sv-arguments sv-self) 2) )) (sv-string ")")))))))))))))) (progn ))(concatenate 'string (sv-string sv-code) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))
