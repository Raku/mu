...
class CompUnit {
    sub set_secure_mode( $args_secure ) {
        ...
        return 'use constant KP6_DISABLE_INSECURE_CODE => ' ~ $value ~ ';' ~ "\n";
    };
    method emit_perl5( $args_secure ) {
        ...
        if ($.body) {
          ...
          '{ package ' ~ $.name ~ '; ' ~ "\n"
        ~ '# Do not edit this file - Perl 5 generated by ' ~ $Main::_V6_COMPILER_NAME ~ "\n"
        ~ 'use v5;' ~ "\n"
        ~ 'use strict;' ~ "\n"
        ~ 'no strict "vars";' ~ "\n"
...
class Val::Buf {
    method emit_perl5 { 
        # '\'' ~ $.buf ~ '\'' 
        #'::DISPATCH( $::Str, \'new\', ' ~ Main::singlequote() ~ Main::mangle_string( $.buf ) ~ Main::singlequote ~ ' )' ~ "\n";
        #TODO mangle_string
...
class Assign {
    method emit_perl5 {
        ...
        '::DISPATCH_VAR( ' ~ $node.emit_perl5 ~ ', \'STORE\', ' ~ $.arguments.emit_perl5 ~ ' )' ~ "\n";
    }
}
