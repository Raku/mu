...
, ::DISPATCH( $::Code, 'new', { code => sub { my $arity; $arity = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$arity' } )  unless defined $arity; INIT { $arity = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$arity' } ) }
;
