...
do { do { if (::DISPATCH(::DISPATCH(::DISPATCH( $GLOBAL::Code_VAR_defined, 'APPLY', $::NamedArgument )
,"true"),"p5landish") ) { }  else { do { do {::MODIFIED($::NamedArgument);
$::NamedArgument = ::DISPATCH( ::DISPATCH( $::Class, 'new', ::DISPATCH( $::Str, 'new', 'NamedArgument' )
 )
, 'PROTOTYPE',  )
} } } }
; ::DISPATCH( ::DISPATCH( $::NamedArgument, 'HOW',  )
, 'add_attribute', ::DISPATCH( $::Str, 'new', '_argument_name_' )
 )
; ::DISPATCH( ::DISPATCH( $::NamedArgument, 'HOW',  )
...
};{ my $_param_index = 0; } ::DISPATCH( $GLOBAL::Code_infix_58__60__126__62_, 'APPLY', ::DISPATCH( ::DISPATCH( $self, "_argument_name_" )
, 'perl',  )
