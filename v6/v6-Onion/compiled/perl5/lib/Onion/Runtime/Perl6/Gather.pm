...
; ::DISPATCH( $::Gather, 'new', ::DISPATCH( $::Code, 'new', { code => sub { my $i; $i = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$i' } )  unless defined $i; INIT { $i = ::DISPATCH( $::Scalar, 'new', { modified => $_MODIFIED, name => '$i' } ) }
;
