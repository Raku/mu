...
=head2 Numeric operators
    ...
    multi sub *infix:<+>($x, $y) returns Num { ... }
    multi sub *infix:<->($x, $y) returns Num is equiv(&*infix:<+>) { ... }
    multi sub *infix:<*>($x, $y) returns Num is tighter(&*infix:<+>) { ... }
    multi sub *infix:</>($x, $y) returns Num is equiv(&*infix:<*>) { ... }
    ...
    # unary ops
    multi sub prefix:<+>($x) returns Num is tighter(&*infix:<*>) { ... }
    multi sub prefix:<->($x) returns Num is equiv(&*prefix:<+>) { ... }
    multi sub prefix:<+^>($x) returns Num is equiv(&*prefix:<+>) { ... }

    # exponentiation
    multi sub *infix:<**>($x, $y) returns Num is tighter(&*prefix:<+>) { ... }
    
=head2 String operators

    # concatenation
    multi sub *infix:<~>($s1, $s2) returns Str is equiv(&*infix:<+>) { ... }

    # bitwise or, xor, and, shifts
    multi sub *infix:<~|>($x, $y) returns Str is equiv(&*infix:<+>) { ... }
    multi sub *infix:<~^>($x, $y) returns Str is equiv(&*infix:<+>) { ... }
    multi sub *infix:<~&>($x, $y) returns Str is equiv(&*infix:<*>) { ... }
    multi sub *infix:«~<<»($x, $y) returns Str is equiv(&*infix:<*>) { ... }
    multi sub *infix:«~>>»($x, $y) returns Str is equiv(&*infix:<*>) { ... }
    ...
    # unary ops
    multi sub prefix:<~>($x) returns Str is equiv(&*prefix:<+>) { ... }
    multi sub prefix:<~^>($x) returns Str is equiv(&*prefix:<+>) { ... }
...
=head2 Boolean operators
    ...
    multi sub prefix:<?>($x) returns Bool is equiv(&*prefix:<+>) { ... }
    multi sub prefix:<?^>($x) returns Bool is equiv(&*prefix:<+>) { ... }
    multi sub prefix:<!>($x) return Bool is equiv(&*prefix:<+>) { ... }

=head2 Relational operators

    multi sub infix:<==>($x, $y) returns bit is looser(&*infix:<..>) 
        is assoc('chain') { ... }
    ...
    multi sub infix:<eq>($x, $y) returns bit is equiv(&*$infix:<==>) { ... }
    multi sub infix:<ne>($x, $y) returns bit is equiv(&*$infix:<==>) { ... }
    multi sub infix:<lt>($x, $y) returns bit is equiv(&*$infix:<==>) { ... }
    multi sub infix:<le>($x, $y) returns bit is equiv(&*$infix:<==>) { ... }
    multi sub infix:<gt>($x, $y) returns bit is equiv(&*$infix:<==>) { ... }
    multi sub infix:<ge>($x, $y) returns bit is equiv(&*$infix:<==>) { ... }

    multi sub infix:<=:=>($x, $y) returns bit is equiv(&*$infix:<==>) { ... }
    
=head2 Logical operators

    multi sub infix:<&&>($x, $y) returns Scalar is looser(&*infix:<==>) { ... }
    multi sub infix:<||>($x, $y) returns Scalar is looser(&*infix:<&&>) { ... }
    multi sub infix:<^^>($x, $y) returns Scalar is equiv(&*infix:<||>) { ... }
    multi sub infix:<//>($x, $y) returns Scalar is equiv(&*infix:<||>) { ... }

    multi sub infix:<and>($x, $y) returns Scalar is looser(&*infix:«==>») 
        { ... }
    multi sub infix:<or>($x, $y) returns Scalar is looser(&*infix:<and>) 
        { ... }
    multi sub infix:<xor>($x, $y) returns Scalar is equiv(&*infix:<or>) 
        { ... }
