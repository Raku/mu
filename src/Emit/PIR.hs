...
This is an autogenerated file from src/Emit/PIR.hs-drift.
...
instance YAML Stmt where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    "StmtComment" -> do  let YamlSeq [aa] = e
				 liftM StmtComment (fromYAML aa)
	    "StmtLine" -> do  let YamlSeq [aa , ab] = e
			      liftM2 StmtLine (fromYAML aa) (fromYAML ab)
	    "StmtPad" -> do  let YamlSeq [aa , ab] = e
			     liftM2 StmtPad (fromYAML aa) (fromYAML ab)
	    "StmtRaw" -> do  let YamlSeq [aa] = e
			     liftM StmtRaw (fromYAML aa)
	    "StmtIns" -> do  let YamlSeq [aa] = e
...
instance YAML LValue where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    ...
	    "PMC" -> do  let YamlSeq [aa] = e
			 liftM PMC (fromYAML aa)
	    "STR" -> do  let YamlSeq [aa] = e
			 liftM STR (fromYAML aa)
	    "INT" -> do  let YamlSeq [aa] = e
			 liftM INT (fromYAML aa)
	    "NUM" -> do  let YamlSeq [aa] = e
...
instance YAML Literal where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    "LitStr" -> do  let YamlSeq [aa] = e
			    liftM LitStr (fromYAML aa)
	    "LitInt" -> do  let YamlSeq [aa] = e
...
instance YAML SubFlag where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    "SubMAIN" -> return SubMAIN
	    "SubLOAD" -> return SubLOAD
	    "SubANON" -> return SubANON
	    "SubMETHOD" -> return SubMETHOD
	    "SubMULTI" -> do  let YamlSeq [aa] = e
...
instance YAML ObjType where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    "PerlScalar" -> return PerlScalar
	    "PerlArray" -> return PerlArray
	    "PerlHash" -> return PerlHash
	    "PerlInt" -> return PerlInt
	    "PerlPair" -> return PerlPair
	    "PerlRef" -> return PerlRef
	    "PerlEnv" -> return PerlEnv
	    "Sub" -> return Sub
...
instance YAML ArgFlag where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    "MkArgFlatten" -> return MkArgFlatten
