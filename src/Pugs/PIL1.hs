...
This is an autogenerated file from src/Pugs/PIL1.hs-drift.
...
instance YAML PIL_Stmts where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    "PNil" -> return PNil
	    "PStmts" -> do  let YamlMap assocs = e
			    let [aa , ab] = map snd assocs
...
instance YAML PIL_Expr where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    "PRawName" -> do  let YamlMap assocs = e
			      let [aa] = map snd assocs
			      liftM PRawName (fromYAML aa)
	    "PExp" -> do  let YamlMap assocs = e
			  let [aa] = map snd assocs
			  liftM PExp (fromYAML aa)
	    "PLit" -> do  let YamlMap assocs = e
			  let [aa] = map snd assocs
			  liftM PLit (fromYAML aa)
	    "PThunk" -> do  let YamlMap assocs = e
			    let [aa] = map snd assocs
...
instance YAML TCxt where
    fromYAML n@MkYamlNode{tag=t, el=e} = case deTag n of
	    "TCxtVoid" -> return TCxtVoid
	    "TCxtLValue" -> do  let YamlSeq [aa] = e
				liftM TCxtLValue (fromYAML aa)
	    "TCxtItem" -> do  let YamlSeq [aa] = e
			      liftM TCxtItem (fromYAML aa)
	    "TCxtSlurpy" -> do  let YamlSeq [aa] = e
