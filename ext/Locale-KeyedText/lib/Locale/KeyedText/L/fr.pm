...
my Str %TEXT_STRINGS is readonly = (
    ...
    'LKT_ARG_NO_ARY'
        => q[<CLASS>.<METH>(): argument <ARG> n'est pas un objet Array',]
           ~ q[ mais contient '<VAL>'.],
    'LKT_ARG_NO_HASH'
        => q[<CLASS>.<METH>(): argument <ARG> n'est pas un objet Hash',]
           ~ q[ mais contient '<VAL>'.],
    'LKT_ARG_NO_EXP_TYPE'
        => q[<CLASS>.<METH>(): argument <ARG> n'est pas <EXP_TYPE>,]
           ~ q[ mais contient '<VAL>'.],
    ...
    'LKT_ARG_HASH_VAL_UNDEF'
        => q[<CLASS>.<METH>(): argument <ARG> est un objet Hash,]
    ...
    'LKT_ARG_HASH_VAL_NO_ARY'
        => q[<CLASS>.<METH>(): argument <ARG> est un objet Hash comme attendu,]
           ~ q[ mais la valeur pour sa clef '<KEY>' n'est pas un objet Array,]
           ~ q[ mais contient '<VAL>'.],
    'LKT_ARG_HASH_VAL_NO_HASH'
        => q[<CLASS>.<METH>(): argument <ARG> est un objet Hash comme attendu,]
           ~ q[ mais la valeur pour sa clef '<KEY>' n'est pas un objet Hash,]
