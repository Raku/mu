...
Rosetta::Emulator::DBI is Copyright (c) 2002-2006, Darren R. Duncan.  All
...
Rosetta::Emulator::DBI is free software; you can redistribute it and/or
...
Rosetta::Emulator::DBI distribution, in the file named "GPL"; if not, write
...
Any versions of Rosetta::Emulator::DBI that you modify and distribute must
carry prominent notices stating that you changed the files and the date of
any changes, in addition to preserving this original copyright notice and
other credits.  Rosetta::Emulator::DBI is distributed in the hope that it
will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty
of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.

While it is by no means required, the copyright holders of
Rosetta::Emulator::DBI would appreciate being informed any time you create
a modified version of Rosetta::Emulator::DBI that you are willing to
