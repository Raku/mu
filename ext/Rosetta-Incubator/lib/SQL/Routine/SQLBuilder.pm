...
class SQL::Routine::SQLBuilder-0.220.0 {

    # External packages used by the SQL::Routine::SQLBuilder class, that do export symbols:
    # (None Yet)

    # Attributes of every SQL::Routine::SQLBuilder object:
    # (None Yet)
...
This document describes SQL::Routine::SQLBuilder version 0.220.0.
...
SQL::Routine::SQLBuilder: L<Rosetta::Engine::Generic>.
...
SQL::Routine::SQLBuilder is Copyright (c) 2002-2006, Darren R. Duncan.  All
...
files is making a combined work based on SQL::Routine::SQLBuilder.  Thus,
...
you permission to link SQL::Routine::SQLBuilder with independent files,
