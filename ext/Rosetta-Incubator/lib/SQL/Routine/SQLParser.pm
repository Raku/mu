...
class SQL::Routine::SQLParser-0.30.0 {

    # External packages used by the SQL::Routine::SQLParser class, that do export symbols:
    # (None Yet)

    # Attributes of every SQL::Routine::SQLParser object:
    # (None Yet)
...
This document describes SQL::Routine::SQLParser version 0.30.0.
...
SQL::Routine::SQLParser is Copyright (c) 2002-2006, Darren R. Duncan.  All
...
files is making a combined work based on SQL::Routine::SQLParser.  Thus,
...
you permission to link SQL::Routine::SQLParser with independent files,
