...
Consider supporting object-relational databases, such as those that violate
first normal forms by storing compound user-defined data types in record
fields or 'references' or arrays or 'set' data types.
