...
as input and that Rosetta::Model stores.  This document is to
Rosetta::Model and Rosetta what the published SQL:2003 standard documents
are to SQL and conformant databases (or they are what the Perl 6 Synopsis
are to the Perl 6 language and its implementations).
