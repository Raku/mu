...
use_ok( 'SQL::Routine' );
skip( q{is( SQL::Routine.meta.identifier.version, 0.710.0,
    'SQL::Routine is the correct version' );} );

use_ok( 'SQL::Routine::L::en' );
skip( q{is( SQL::Routine::L::en.meta.identifier.version, 0.390.0,
    'SQL::Routine::L::en is the correct version' );} );

# Rosetta:

use_ok( 'Rosetta' );
skip( q{is( Rosetta.meta.identifier.version, 0.490.0,
    'Rosetta is the correct version' );} );

use_ok( 'Rosetta::L::en' );
skip( q{is( Rosetta::L::en.meta.identifier.version, 0.200.0,
    'Rosetta::L::en is the correct version' );} );

use_ok( 'Rosetta::Validator' );
skip( q{is( Rosetta::Validator.meta.identifier.version, 0.490.0,
    'Rosetta::Validator is the correct version' );} );

use_ok( 'Rosetta::Validator::L::en' );
skip( q{is( Rosetta::Validator::L::en.meta.identifier.version, 0.150.0,
