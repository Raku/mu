...
is(url_encode('with space'), 'with+space', 'got the right encoded string');
is(url_encode('with more than one space'), 'with+more+than+one+space', 'got the right encoded string');
is(url_encode('string & stuff'), 'string+%26+stuff', 'got the right encoded string');
