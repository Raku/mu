...
skip( 1, q{is( Muldis::DB::AST.WHO.version, 0.0.1,
    'Muldis::DB::AST is the correct version' );} );

use_ok( 'Muldis::DB' );
skip( 1, q{is( Muldis::DB.WHO.version, 0.0.1,
    'Muldis::DB is the correct version' );} );

use_ok( 'Muldis::DB::Validator' );
skip( 1, q{is( Muldis::DB::Validator.WHO.version, 0.0.1,
...
skip( 1, q{is( Muldis::DB::Engine::Example.WHO.version, 0.0.1,
