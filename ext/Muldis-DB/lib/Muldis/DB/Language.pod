...
Details are in these other documents: L<Muldis::DB::Language::Core>,
L<Muldis::DB::Language::Ext::Num>, L<Muldis::DB::Language::Ext::Temporal>,
L<Muldis::DB::Language::Ext::Spatial>.
...
control all entities in a DBMS.

Details are in these other documents: L<Muldis::DB::Language::Catalog>.
