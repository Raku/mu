...
module Muldis::DB::Validator-0.2.0 {
...
This document describes Muldis::DB::Validator version 0.2.0 for Perl 6.
...
L<Muldis::DB::Literal-(0.2.0)|Muldis::DB::Literal>, L<Muldis::DB::Interface-0.2.0|Muldis::DB::Interface>.
