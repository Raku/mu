...
This document is Muldis::DB::Copying version 0.3.1.
...
This Muldis::DB core distribution is currently licensed with a few parts
under the GNU Lesser General Public License (LGPL), version 3.0 or later,
and most parts under the GNU General Public License (GPL), version 3.0 or
later.
...
recipients of covered works.  As an exception to this, the single most
commonly used component of Muldis DB, the small component that is the only
mandatory one, is being released under the LGPL instead; the majority of
components in the core distribution, all of which are GPL, are technically
optional for use.
