...
business with; rather, the copyright holder intends to build a business
with Muldis::DB in the same ways that the GPL permits everyone else to,
such as by selling GPL|AGPL-licensed copies for a fee, and support
services, and warranties, and sponsored improvements, and by using
Muldis::DB as a platform to build other works on; a unique selling
