...
This document is Muldis::DB::Copying version 0.1.0.
...
permissions concerning linking, such as by using the LGPL rather than GPL.
...
license.  A broad release under a license like BSD or Artistic would be
...
a broad release under the GPL or AGPL licenses would be best, but is
willing to consider switching to an LGPL licensed broad release instead, as
a compromise on ideals, to help increase adoption.
...
any reasonable means by which the most people possible can use Muldis::DB.
