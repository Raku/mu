...
my $tree2 = Tree::Simple::new('my other tree');
...
is($tree2.depth(), 0, '... got the right depth value for $tree2');
...
is($tree2.depth(), 1, '... $tree2 has a depth of 1');
...
$tree.add_children(
    Tree::Simple::new('my tree 3'),
    Tree::Simple::new('my tree 4')
);
...
$tree.get_child(1).add_child(Tree::Simple::new('tree 1.1'));
