...
I<TODO:  Change the terminology of the QDRDBMS to say "convey" rather than
"distribute" as per the GPL v3, after the latter is released final, if
...
to choose to link with QDRDBMS.)  Conjecture:  Additional permissions would
have the narrowest scope possible, such as to only exempt FLOS software,
and only apply to the 2 files C<lib/QDRDBMS/AST.pm> and C<lib/QDRDBMS.pm>.
