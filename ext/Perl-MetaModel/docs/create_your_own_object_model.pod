        ...
        MetaClass => {
            ...
            'method_table' => {
                'create_instance' => { 
                    return {
			'class' => AbstractClass,
			AbstractClass.instance_vars
		    };
                },
                'add_method_to_class' => sub ($class: $label) {
...
C<\&abstractMethodHandler> (which will throw an appropriate error if called).
            ...
            'method_table' => {
                'create_instance' => { 
                    return {
                        ...
                        'class' => Class,
                        Class.instance_vars # overrides parent's vars
                    }; 
                },
                'add_method_to_class' => sub ($class: $label, $impl) {
...
Here is what that would look like:

    {
        ...
        MetaClass => {
            ...
            'method_table' => {
                'add_method_to_class' => sub ($class: $label, $impl) {
                    $class<method_table>{$label} = sub ($self: @args) {
