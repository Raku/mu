...
eval_is '+([1,2,3] +# [1,2,3])',   3, "infix:<+[hash]> works (1)";
eval_is '+([1,2,3] +# [1,2,3,4])', 4, "infix:<+[hash]> works (2)";
eval_is '+([1,2,3] -# [1,2,3])',   0, "infix:<-[hash]> works (1)";
eval_is '+([1,2,3] -# [1,2,3,4])', 0, "infix:<-[hash]> works (2)";
