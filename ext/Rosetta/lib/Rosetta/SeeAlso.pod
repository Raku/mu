...
subject, some specified in the next paragraph.

See also the brand new release of their book containing the full proposal,
...
The web site for The Third Manifesto has reproduced several chapters and
appendicies from the aforementioned new 3rd edition of the book.  Chapter 4
...
the the complete grammar of the teaching language "Tutorial D", which is a
computationally complete programming language with fully integrated
database functionality, whose principal purpose is to serve as a teaching
vehicle.

=item B<Database in Depth>

See Christopher J. Date's "Database in Depth: Relational Theory for
Practitioners, 1st edition, Oreilly, 2005 (ISBN: 0-596-10012-4)" at
...
as Rosetta is, so you have the freedom to examine the project source code,
change it, and redistribute it:
...
L<TripleStore>, L<Data::Table>, L<ORM>, L<OOPS>, L<SQL::Statement>,
L<SQL::Parser>, L<SQL::Translator>, L<SQL::YASP>, L<SQL::Generator>,
L<SQL::Schema>, L<SQL::Abstract>, L<SQL::Snippet>, L<SQL::Catalog>.
