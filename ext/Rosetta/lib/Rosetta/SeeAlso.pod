...
a DBMS and the language interface to such a DBMS.  Rosetta has officially
incorporated this blueprint into its own design, and implements its rules
without compromise.  The TTM web site contains various useful documents and
links on the subject, some being specified further below.
...
L<Alzabo>, L<DBIx::SQLEngine>, L<SPOPS>, L<DBIx::SearchBuilder>,
