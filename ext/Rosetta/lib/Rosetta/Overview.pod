...
=head1 OLDER DOCUMENTATION TO REWRITE/REMOVE: HIGH LEVEL DATA STRUCTURES
...
Details of individual schema objects and SQL statements are covered in
other documents rather than in this one.
