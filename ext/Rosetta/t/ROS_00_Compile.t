...
skip( 1, q{is( Rosetta.meta.identifier.version, 0.723.0,
...
skip( 1, q{is( Rosetta::Model.meta.identifier.version, 0.723.0,
...
skip( 1, q{is( Rosetta::Validator.meta.identifier.version, 0.723.0,
...
skip( 1, q{is( Rosetta::Engine::Example.meta.identifier.version, 0.723.0,
...
skip( 1, q{is( Rosetta::Shell.meta.identifier.version, 0.1.0,
    'Rosetta::Shell is the correct version' );} );

use Rosetta::Shell::L::en; pass "(dummy instead of broken use_ok)";
skip( 1, q{is( Rosetta::Shell::L::en.meta.identifier.version, 0.1.0,
