...
{
    my $dt = date( :year(2000), :month(1), :day(5),
                            :tz('UTC'),
                          );
...
{
    my $dt = date( :year(2000), :month(2), :day(29),
                            :tz('UTC'),
                          );
...
{
    my $dt = date( :year(-6), :month(2), :day(25),
                            :tz('UTC'),
                          );
...
{
    my $dt = date( :year(1996), :month(2), :day(1));
...
{
    my $dt = date( :year(1996), :month(5), :day(1));
...
{
    my $dt = date( :year(1996), :month(8), :day(1));
...
{
    my $dt = date( :year(1996), :month(11), :day(1));
