...
different, and 'P5' notes a Perl5 compatibility syntax.  For the full
specification, see L<S05>. See also:

The related Apocalypse, which justifies the changes:

  http://dev.perl.org/perl6/doc/design/apo/A05.html 

And the related Exegesis, wihch explains it more detail:
