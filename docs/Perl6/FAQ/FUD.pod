...
of those modules, and still end up with the things getting exported to teh right place.
...
misdesissions. In Perl 6 due to the dynamic grammar you can change them.
