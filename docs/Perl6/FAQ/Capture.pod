...
A: They have been superceded by Captures.
...
A Capture object may hold named arguments that occurs twice or more.  When it's
...
into the currently constructing Capture (e.g. an argument list):
...
instead of:
  ...
  my @y2 := @$x; # $x contains no positional parts
