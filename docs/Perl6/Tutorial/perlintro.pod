...
Perl documentation.  You can read that documentation using the C<grok>
...
Assuming your code is in a file named "foo.pl", you can invoke your program as:
...
(Note that C<print> and C<say> do the same thing, only C<say> appends a newline
...
=begin AUTHORS
Kirrily "Skud" Robert L<skud@cpan.org|mailto:skud@cpan.org> (original Author)
and Moritz Lenz L<moritz@fau2ik3.org|mailto:moritz@faui2k3.org> ("translation"
to Perl 6)

Some fixup by David Koenig
L<karhu@u.washington.edu|mailto:karhu@u.washington.edu>
=end AUTHORS
