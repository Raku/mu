...
subroutine or method cannot usually be accessed when the subroutine or method is called.  To change this, declare the variable with C<env>.
...
Perl rules also support named rules,grammars,backreferences, lookaheads, and all kinds of
other complex details.  Read all about them in L<XXX>,
