...
Take a look at our development wiki at L<http://dev.pugscode.org/> to see
what needs to be done, and where you could help.
...
=item L<http://dev.pugscode.org/browser/>

Browsable Pugs source code.

=item L<http://svn.perl.org/perl6/pugs/trunk/>

Read-only mirror of Pugs VCS head.

=item L<http://smoke.pugscode.org/>
