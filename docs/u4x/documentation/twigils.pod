...
The above will print C<2 1 3>. It is illegal to use self-declared parameters
inside a block that already has an explicit signature, or that is the body of a
L<routine>.
