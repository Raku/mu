...
Instances of most types are defiC<defined($instance)> is C<True>.
...
grammar or anything else that does the I<Abstraction> role. It is
generally accessible with the same name as a class.
