...
How does this compare with Perl 5? If @Xs and @Ys can be assumed to be
...
from the last section could also be written like this:[2]
...
[2] // is scheduled for inclusion in perl 5.10. For those interested,
