...
Some abbreviations and acronyms are also explained as tooltips on
L<http://irclog.perlgeek.de/perl6/today>.

=head2 Terms

resig
  A branch on which Jonathan REworks SIGnature binding
  
dalek
  an IRC bot who reports commits to various source code repositories
