...
But I know why: the good ol' trinary C<? :> has now become C<?? ::>, so
...
This should teach me to B<read> the documentation: the trinary (operator?
...
Good to see the postfix C<if> still working.
