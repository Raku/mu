...
JŸrgen Bšmmels reported an imcc segfault, which Leopold Toetsch answered
...
=item * macro expansion in imcc by JŸrgen Bšmmels, following 
a lengthy discussion

L<http://xrl.us/oxw5>

=item * Macros in imcc from JŸrgen Bšmmels
