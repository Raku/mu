...
=item split
 ...
 multi sub Perl6::Str::split (  Str $delimiter ,  Str ?$input = $CALLER::_, Int ?$limit = inf ) returns List
 multi sub Perl6::Str::split ( Rule $delimiter ,  Str ?$input = $CALLER::_, Int ?$limit = inf ) returns List
 multi sub Perl6::Str::split (      Str $input :  Str $delimiter          , Int ?$limit = inf ) returns List
 multi sub Perl6::Str::split (      Str $input : Rule $delimiter          , Int ?$limit = inf ) returns List
