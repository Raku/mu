...
- standard methods:
    - .wait    # wait for invocant to finish
...
- IO objects and containers gets concurrency love!
    - $obj.sleep_until_readable # horrible name, fixme
    - $obj.sleep_until_writable # horrible name, fixme
    - $obj.sleep_until_either_readable_or_writable_or_passed_time(3); # fixme fixme
