...
Form a mental map of the new syntax. It's not an easy task. There is
is only a limited prototype interpreter available for Perl 6, so if
you forget how a particular feature works you can't just experiment.
Mainly, you'll have to search through the list archives--over, and
