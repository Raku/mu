...
ok(!( "\c[SOLIDUS]" ~~ m/^<!BidiES>.$/ ), q{Don't match negated (European Number Separator)} );
ok(!( "\c[SOLIDUS]" ~~ m/^<-BidiES>$/ ), q{Don't match inverted (European Number Separator)} );
...
ok(!( "\c[LEFT PARENTHESIS]" ~~ m/^<!Math>.$/ ), q{Don't match negated (Sm + OtherMath)} );
ok(!( "\c[LEFT PARENTHESIS]" ~~ m/^<-Math>$/ ), q{Don't match inverted (Sm + OtherMath)} );
